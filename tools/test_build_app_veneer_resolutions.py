...
class AppVeneerResolutionTests(unittest.TestCase):
    ...
    def test_complete_and_fail_closed(self):
        ...
        self.assertEqual(26, summary["resolved_symbols"])
        self.assertEqual(24, summary["resolved_unique_vas"])
        self.assertEqual(20, summary["materialized_symbols"])
        self.assertEqual(20, summary["materialized_unique_vas"])
        self.assertEqual(6, summary["already_strong_symbols"])
        self.assertEqual(93, summary["blocked_symbols"])
    ...
    def test_ambiguous_and_ownerless_entries_are_blocked(self):
        ...
        for symbol in ("send_touch_click_event", "touch_pmic_reset_assert",
                       "FUN_00016574", "ext3cebc"):
