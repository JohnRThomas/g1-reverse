...
1. Inspect from /tmp: PYTHONSAFEPATH=1 ${BASE}/.venv/bin/python ${BASE}/tools/recon_kit.py info 0xADDR. It prints readable function/callee names plus the raw FUN_* and address back-map; use those readable names in C bodies while preserving the catalog NAME for prove/save identity.
