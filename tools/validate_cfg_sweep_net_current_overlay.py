#!/usr/bin/env python3
"""Fail-closed validator for the 1,142-source CPUNET CFG overlay."""
...
def main():
    ...
    if expected["previous_current_inventory_count"] != 1131:
    ...
    print("CPUNET current CFG overlay validated: 1142 PASS, unresolved=0")
