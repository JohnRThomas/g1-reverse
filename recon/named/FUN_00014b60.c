...
char *FUN_00014b60(int a1, u32 a2, int a3, int a4, int a5, int a6, double dval)
{
    ...
    local_80 = in_d0;
LAB_b8e:
    pcVar3 = (u32)libc_fatal_error_and_abort(0xf8bce, uVar9, param_3, uVar8);
LAB_b94:
    ...
    if ((pcVar17 < 0xf) && (pcVar14 != 0)) {
        if ((int)puVar4 < 1) {
            ...
            if ((int)(puVar4 << 0x17) < 0) {
                uVar12 = uVar12 & 0xf;
                iVar13 = 3;
                local_80 = __divdf3(iVar7, HI(local_80), P32(0x888e0 + 0x20), P32(0x888e0 + 0x24));
                puVar15 = 0x888e0;
            } else {
                iVar13 = 2;
            }
