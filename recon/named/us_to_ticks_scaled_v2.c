/* named: us_to_ticks_scaled_v2 */
/* Reconstructed us_to_ticks_scaled_v2 @ 0x125c0  (parity: 300/300 trials, PROVEN) */
...
void us_to_ticks_scaled_v2(uint32_t *param_1, uint32_t param_2, uint32_t param_3)
{
  ...
  __muldf3((int32_t)uVar3, (int32_t)(uVar3 >> 32), 0x63f11168UL, 0x3f91df46UL);
  __fixdfdi();
