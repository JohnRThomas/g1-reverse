    ...
    if (param_12 == 0) {
      ...
      for (local_2f4 = 0; (int)local_2f4 < (int)(uint)local_2da; local_2f4 = local_2f4 + 1) {
        if (bVar6) {
          ...
          for (uVar14 = local_2f4; (((int)uVar14 < (int)(uint)local_2da && (uVar15 = (uint)puVar2[uVar14], uVar15 != 0xd)) && (uVar15 != 10)); uVar14 = uVar14 + 1) {
            ...
            if (iVar3 == 0) {
              ...
              if (iVar3 < 0) {
                if (1 < *(volatile int*)0x2000230c) { if (*(volatile int*)0x20007554 == 0) DEBUG_PRINT(0xaaa58,0xaad64,uVar15); else debug_print(0); }
        ...
        if (iVar3 == 0) {
          ...
          if (iVar4 < 0) {
            if (1 < *(volatile int*)0x2000230c) { if (*(volatile int*)0x20007554 == 0) DEBUG_PRINT(0xaaa58,0xaad64,uVar14); else debug_print(0); }
          } else {
