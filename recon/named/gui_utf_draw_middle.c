...
LAB_e7c:
    ...
    if (param_12 == 0) {
      ...
      if (iVar3 << 0x1e < 0) clean_fb_data(*(volatile int*)0x2000a034,0,param_4,param_5,param_6,param_7);
      ...
      for (local_2f4 = 0; (int)local_2f4 < (int)(uint)local_2da; local_2f4 = local_2f4 + 1) {
        if (bVar6) {
          ...
          for (uVar14 = local_2f4; (((int)uVar14 < (int)(uint)local_2da && (uVar15 = (uint)puVar2[uVar14], uVar15 != 0xd)) && (uVar15 != 10)); uVar14 = uVar14 + 1) {
            ...
            if (iVar3 == 0) {
              ...
              if (iVar3 < 0) {
                if (1 < *(volatile int*)0x2000230c) { if (*(volatile int*)0x20007554 == 0) DEBUG_PRINT(0xaaa58,0xaad64,uVar15); else debug_print(0xaaa58,0xaad64,uVar15); }
        ...
        if (iVar3 == 0) {
          ...
          if (iVar4 < 0) {
            if (1 < *(volatile int*)0x2000230c) { if (*(volatile int*)0x20007554 == 0) DEBUG_PRINT(0xaaa58,0xaad64,uVar14); else debug_print(0xaaa58,0xaad64,uVar14); }
          } else {
            ...
            if ((uint)(param_6 - param_4) < uVar18) {
              ...
              fb_blit_rows_copy(*(volatile int*)0x2000a034,(int)local_2cc,iVar4,iVar1,local_2f0,uVar8 + param_5);
              iVar3 = count_chars_in_default_font_table(*puVar16,*puVar17); uVar11 = local_2d4 + iVar3; uVar18 = uVar11;
            } else {
              fb_blit_rows_copy(*(volatile int*)0x2000a034,(int)local_2cc,iVar4,iVar1,local_2f0 + uVar11,uVar8 + param_5);
