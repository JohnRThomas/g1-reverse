                 ...
                 uint param_4,uint param_5,int param_6,uint param_7)
{
  ...
  local_54 = param_3;
  if (param_1 == (byte *)0x0) {
    printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"in_packaged != ((void *)0)"),0xf04ef,0x394);
...
LAB_0004ace6:
          ...
          z_log_msg_runtime_create(0x88188,0x2480,&descriptor,0);
          param_2 = param_2 + -2;
          pbVar13 = pbVar12;
          goto LAB_0004acba;
        }
...
LAB_0004adbe:
  while(1) {
    ...
    if (local_78 != 0) {
      ...
      printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"scpy_cnt < sizeof(cpy_str_pos)"),0xf04ef,0x448);
