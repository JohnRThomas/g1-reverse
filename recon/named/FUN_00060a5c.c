...
extern void mutex_lock_syscall_handler(void *object, uint32_t inherited_r1, uint32_t, uint32_t);
...
void FUN_00060a5c(uint8_t *device)
{
    ...
    mutex_lock_syscall_handler(state + 0x48, (uint32_t)(inherited >> 32), 0, 0);
