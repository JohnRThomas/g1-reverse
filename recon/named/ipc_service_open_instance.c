/* readable reconstruction; identity: FUN_0004cb90 @ 0x0004cb90
 * public-name: ipc_service_open_instance
...
unsigned int ipc_service_open_instance(int param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4)
{
    ...
    if (param_1 == 0) {
        ipc_log_forward(0x881d8,0x1040,0,2,0,param_2,param_3,param_4);
        uVar1 = 0xffffffea;
    } else if (*(int **)(param_1 + 8) == (int *)0) {
        ipc_log_forward(0x881d8,0x1040,0,2,param_1,param_2,param_3,param_4);
        uVar1 = 0xfffffffb;
    } else {
