...
int bt_gatt_subscribe(int param_1, int *param_2, unsigned param_3, unsigned param_4)
{
  ...
  if (param_1 == 0) {
    printk(0x00099cbd,0x000f3ebd,0x000f46b8,0x14dc,param_4);
    printk(0x000f4a0a,0,0,0,0);
    assert_post_action(0x000f46b8,0x14dc);
  }
  if (param_2 == 0) {
    printk(0x00099cbd,0x000f4b3d,0x000f46b8,0x14dd,param_4);
    printk(0x000f4a0a,0,0,0,0);
