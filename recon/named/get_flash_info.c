...
uint32_t get_flash_info(int param_1, uint32_t param_2, uint32_t *param_3, uint8_t *param_4){
    ...
    log_message(0x000a69f3);
    if (param_3==0 || param_4==0){ log_message(0x000a6a0b); return 0xffffffff; }
    ...
    *puVar4 = 0x1e;
    ...
    if (iVar2==0){
        if (0 < *(volatile int*)0x2000230cUL){
            ...
            if (c==0){ log_message(0x000a40e6,0x000a76cb,v); }
            else { debug_print(0x000a40e6,0x000a76cb,v); }
        }
