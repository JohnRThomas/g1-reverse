  ...
  case 0:
    ...
    *(int*)0x20009ff4 = 0;
    while (*piVar2 < 8) {
      ...
      uVar6 = get_localized_string_ptr(B(0x200034f3 + (uint)B(0x2001cdce)),1);
...
LAB_00040c64:
    ...
    *(int*)0x20009ff4 = 0;
    while (*piVar2 < 8) {
      ...
      iVar7 = device_info_text_width_get();
      iVar8 = device_info_text_height_get_clamped();
      gui_utf_draw(0,0x000aa608,1,uVar6,iVar5 + 0x1b,iVar7 + 0x68,iVar8 + 0x42,1,0,0,0,0);
      iVar5 = device_info_text_width_get();
      iVar7 = device_info_text_height_get_clamped();
      ...
      iVar8 = device_info_text_width_get();
      iVar12 = device_info_text_height_get_clamped();
      gui_utf_draw(0,0x000aa60e,3,iVar5 + 0xc2,iVar7 + 3,iVar8 + 0xea,iVar12 + 0x1e,1,0,0,0,0);
      iVar5 = device_info_text_width_get();
      iVar7 = device_info_text_height_get_clamped();
      iVar8 = device_info_text_width_get();
      iVar12 = device_info_text_height_get_clamped();
      gui_utf_draw(0,0x000f212c,3,iVar5 + 0xde,iVar7 + 3,iVar8 + 0xec,iVar12 + 0x1e,1,0,0,0,0);
      iVar5 = device_info_text_width_get();
      iVar7 = device_info_text_height_get_clamped();
      ...
      if ((*(char *)(*(int *)(iVar5 + 0x1014) + 2) != '\x05') &&
         (iVar5 = get_device_info(), uVar6 = 0x000f7a30,
...
LAB_00040b66:
  ...
  case 0x11:
    ...
    iVar7 = device_info_text_width_get();
    iVar8 = device_info_text_height_get_clamped();
    gui_utf_draw(0,0x000f341d,3,iVar4 + 0x22e,iVar5 + 3,iVar7 + 0x23e,iVar8 + 0x1e,1,1,0,0,0);
    uVar6 = device_info_text_width_get();
    iVar4 = device_info_text_height_get_clamped();
