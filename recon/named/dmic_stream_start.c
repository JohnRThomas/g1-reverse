...
uint dmic_stream_start(void)
{
  ...
  if ((*(volatile ushort*)(iVar8 + 0x105c) & 2) != 0) {
    if (2 < *(volatile int*)0x2000230c) {
      if (*(volatile int*)0x20007554 == 0) log_message(0xa4038,0xa41b0);
      else debug_print(0);
    }
    iVar8 = z_device_is_ready(0x87d40);
    if (iVar8 == 0) {
      if (0 < *(volatile int*)0x2000230c) {
        if (*(volatile int*)0x20007554 == 0) log_message(0xa404b,0xa41b0,*(volatile int*)puVar2);
        else debug_print(0);
      }
    } else {
      if (2 < *(volatile int*)0x2000230c) {
        if (*(volatile int*)0x20007554 == 0) log_message(0,0xa41b0,*(volatile int*)puVar2);
        else debug_print(0);
      }
