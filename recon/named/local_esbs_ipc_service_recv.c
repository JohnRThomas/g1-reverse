...
#define MASTER_CONTEXT  (*(volatile uint8_t **)0x200069fc)
#define EVEN_AI_STATE   (*(volatile uint8_t *)0x20018d98)
#define LOG_TAG         0x00099b89u
                                     ...
                                     const uint8_t *packet)
{
    ...
    case 10:
        ...
        if (LOG_LEVEL > 0) {
            if (LOG_SINK == 0)
                log_message(0x00099297u, LOG_TAG, LOG_TAG, 0x2fdu);
            else
                debug_print(0x00099297u, LOG_TAG, LOG_TAG, 0x2fdu);
        }
    ...
    case 11:
        ...
        if (LOG_LEVEL > 0) {
            if (LOG_SINK == 0)
                log_message(0x000992e1u, LOG_TAG, LOG_TAG, 0x30au);
            else
                debug_print(0x000992e1u, LOG_TAG, LOG_TAG, 0x30au);
        }
