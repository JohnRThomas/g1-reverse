...
unsigned int delAudioStreamRecord(unsigned char param_1)
{
    ...
    if (2 < *(volatile int*)0x2000230cUL) {
        if (*(volatile unsigned int*)0x20007554UL == 0) {
            log_message(0xa420e, ((unsigned long)"delAudioStreamRecord"));
        } else {
            debug_print(0xa420e, ((unsigned long)"delAudioStreamRecord"));
        }
    }
    ...
    *(unsigned short*)(buf + 2) = 1;
    buf[0] = 4;
    buf[4] = param_1;
    iVar2 = k_msgq_put(0x20003890UL, buf, 0, 0);
    if (iVar2 == 0) {
