...
uint32_t FUN_00067794(int param_1, int *param_2, uint32_t param_3, uint32_t param_4){
    if (param_2 == 0){
        printk(0x00099cbd, 0x000f6c00, 0x000f6fef, 0x102);
        assert_post_action(0x000f6fef, 0x102);
    }
        ...
        *(volatile uint8_t*)(iVar6+0x27) = (uint8_t)cVar2;
        ...
        if (cVar2 == 0){
            if (param_2[0] == param_2[1]){
                printk(0x00099cbd, 0x000f702b, 0x000f6fef, 0xf3);
                assert_post_action(0x000f6fef, 0xf3);
            }
