...
#define LOG_WITH_U32(message_, value_) do {                            \
  ...
  gatt_dm_log_helper(0x88130, 0x1840, (int)record_);                         \
} while (0)
...
#define local_24 frame.log[1]
  ...
  if (*(volatile int*)piVar2 != param_1) {
    ...
    gatt_dm_log_helper(0x88130,0x1040,(int)frame.log);
    uVar8 = 0xfffffff2;
    goto LAB_eaa6;
  }
  ...
  if (bVar1 == 3) {
    ...
    if (iVar3 != 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"bt_uuid_cmp(attr->uuid, ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2803), }}))) == 0"),0xf11bc,0x19c); uVar9 = 0x19c; goto LAB_eb7e; }
    ...
    if (piVar10 == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"cur_gatt_chrc != ((void *)0)"),0xf11bc,0x1a8); uVar9 = 0x1a8; goto LAB_eb7e; }
  ...
  if (bVar1 < 4) {
    if (bVar1 != 2) {
      ...
      if (iVar4 != 0) {
        ...
        if (iVar4 != 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"bt_uuid_cmp(attr->uuid, ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2800), }}))) == 0 || bt_uuid_cmp(attr->uuid, ((struct bt_uuid *) ((struct bt_uuid_16[]) {{ .uuid = { BT_UUID_TYPE_16 }, .val = (0x2801), }}))) == 0"),0xf11bc,0x127); uVar9 = 0x127; goto LAB_eb7e; }
      }
      uVar9 = 0xf13bc;
      if (iVar3 == 0) {
LAB_eb88:
        local_28 = 2; local_24 = uVar9;
        gatt_dm_log_helper(0x88130,0x1040,(int)&local_28);
      } else {
        piVar5 = (int*)bt_gatt_dm_attr_service_val(iVar3);
        if (piVar5 == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"cur_service_val != ((void *)0)"),0xf11bc,0x13b); uVar9 = 0x13b; goto LAB_eb7e; }
