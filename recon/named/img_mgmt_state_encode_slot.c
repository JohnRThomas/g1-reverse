...
unsigned img_mgmt_state_encode_slot(unsigned param_1,unsigned param_2,unsigned param_3){
  ...
  if (iVar1==0){
    ...
    uVar2 = 0;
    if (iVar1!=0 && (iVar1=zcbor_tstr_encode_ptr(param_1,(void*)0xf349f,5))!=0 &&
        (iVar1=cbor_encode_uint32(param_1,param_2>>1))!=0 &&
        (iVar1=zcbor_tstr_encode_ptr(param_1,(void*)0xf272f,4))!=0 &&
        (iVar1=cbor_encode_uint32(param_1,param_2&1))!=0 &&
        (iVar1=zcbor_tstr_encode_ptr(param_1,(void*)0xf6589,7))!=0){
      ...
      if (iVar1!=0 && (iVar1=zcbor_tstr_encode_ptr(param_1,(void*)0xf4a01,4))!=0 &&
          ...
          (iVar1=zcbor_tstr_encode_ptr(param_1,(void*)0xf274b,9))!=0 &&
          (iVar1=cbor_encode_simple(param_1,(param_3>>2)&1))!=0 &&
          (iVar1=zcbor_tstr_encode_ptr(param_1,(void*)0xf5702,6))!=0 &&
          (iVar1=cbor_encode_simple(param_1,param_3&1))!=0 &&
          (iVar1=zcbor_tstr_encode_ptr(param_1,(void*)0xf2755,9))!=0 &&
