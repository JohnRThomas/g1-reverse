...
int post_notification_cmd_response(int param_1,int param_2,int param_3,int param_4,int param_5,int *param_6){
  ...
  if (param_1==0||param_2==0||param_3==0||param_4==0||param_5==0||param_6==0) {
    if (1 < *lvl) { if(*g8==0) DEBUG_PRINT(0xa7ef6,0xa831f,param_5,0,param_1,param_2,param_3); else debug_print(0); }
    return 0;
  }
  if (2 < *lvl) { if(*g8==0) DEBUG_PRINT(0xa7f12,0xa831f,VB(param_4+1),0,param_1,param_2,param_3); else debug_print(0); }
  if (VB(param_4+1) == 4) {
    ...
    if (2 < *lvl) { if(*g8==0) DEBUG_PRINT(0xa7f41,0xa831f); else debug_print(0xa7f41); }
  } else {
    if (VH(param_4+2) != 0x1b4) {
      if (*lvl < 1) return 0;
      if (*g8 != 0) { debug_print(0xa7f79,0xa831f,0xa8300); return 0; }
  ...
  if (iVar5 == 0) DEBUG_PRINT(format,0xa831f); else debug_print(0);
LAB_341a8:
