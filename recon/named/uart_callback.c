...
void uart_callback(int param_1,unsigned char *param_2,unsigned int param_3){
  ...
  switch (*param_2) {
  case 0:
    if (2 < *lvl) { if(*g8==0) log_message(0xa797b,0xa7b56,VI((int)param_2+8),0,param_1); else debug_print(); }
  ...
  case 1:
    ...
    log_message(0xa7999,0xa7b56); return;
  case 2:
    ...
    log_message(0xa79ab, VI((int)param_2+0xc), param_3, uVar7 & 0xffff, param_1);
