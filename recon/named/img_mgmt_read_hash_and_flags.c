...
int img_mgmt_read_hash_and_flags(int param_1, uint32_t *param_2, int param_3, uint32_t *param_4)
{
    int iVar1, iVar2;
    ...
    iVar1 = img_mgmt_impl_erased_val(param_1, &local_45);
    if (iVar1 != 0) return 2;
    iVar2 = img_mgmt_impl_read(param_1, 0, local_40, 0x20);
...
LAB_000520f6:
    ...
    iVar1 = img_mgmt_impl_read(param_1, iVar2, &local_44);
    ...
    if ((iVar1 == 0) && (local_44 == 0x6907)) {
        ...
        while (uVar6 = uVar4 + 4, uVar6 <= uVar5) {
            iVar1 = img_mgmt_impl_read(param_1, uVar4, &local_44);
...
LAB_00052142:
                ...
                if (param_3 != 0) {
                    ...
                    iVar1 = img_mgmt_impl_read(param_1, uVar6, (void*)(intptr_t)param_3);
                    if (iVar1 != 0) return iVar1;
                }
                uVar7 = 1;
                uVar4 = uVar6;
