...
int flash_write_and_verify_blob(char *param_1, unsigned int param_2, int param_3, int param_4)
{
    ...
    local_1c = param_2;
    iVar6 = attr_store_set(0xff20, 0x3c00ffff, param_3, param_4, (int)param_1);
    if ((iVar6 == 0) && (iVar6 = attr_store_set(0x4444, 0x10000, 0, 0, 0), iVar6 == 0) &&
        ...
        iVar6 = attr_store_set(0xff20, 0x3c00f091, 0, 0, 0);
