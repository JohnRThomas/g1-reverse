 ...
 * public-name: rpmsg_create_ept_bound
 * durable-map: recon/catalogs/function_names_app.json
 * callees (readable <= raw @ address):
 *   rpmsg_create_ept_bound                   <= FUN_0004d0c4 @ 0x0004d0c4
...
int rpmsg_create_ept_bound(int *param_1, int param_2, int param_3, unsigned int param_4)
{
  int uVar1;
