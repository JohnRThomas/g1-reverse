                                    ...
                                    uint32_t length, uint32_t unused)
{
    ...
    if (buffer == 0) {
        if (*(volatile uint32_t *)(uintptr_t)0x20007554u == 0u)
            log_message(0x0009e324u, 0x0009e508u, 0xd2u, 0u);
        else
            debug_print(0x0009e324u, 0x0009e508u, 0xd2u, 0u);
        return -1;
    }
    ...
    if (status != 0) {
        log_message(0x0009e36du, status);
        result = status;
        goto out;
    }
    ...
    if (status != 0) {
        log_message(0x0009e385u, status, address, length);
        result = status;
        goto out;
    }
