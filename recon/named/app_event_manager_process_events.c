...
L5ea:
  ...
  for(;;){
    ...
    if (!((unsigned int)puVar12 >= 0xfa9b4u && (unsigned int)puVar12 < 0xfaa14u)) {
      printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"(aeh->type_id >= _event_type_list_start) && (aeh->type_id < _event_type_list_end)"),0xf1681,0xa3);
    ...
    while (*(volatile int*)(puVar12+8) != (int)piVar13 && iVar6 == 0) {
      if (piVar13 == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"es != ((void *)0)"),0xf1681,0xb5); assert_post_action(0xf1681,0xb5); }
      if (*piVar13 == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"el != ((void *)0)"),0xf1681,0xb9); assert_post_action(0xf1681,0xb9); }
      { int pc = *(volatile int*)(*piVar13 + 4);
        if (pc == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"),((unsigned long)"el->notification != ((void *)0)"),0xf1681,0xba); assert_post_action(0xf1681,0xba); }
        iVar6 = ((int(*)(int))pc)(r4);
      }
      piVar13 = piVar13 + 1;
    }
