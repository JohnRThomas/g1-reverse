...
void random(unsigned param_1, unsigned char *param_2, uint param_3)
{
    ...
    default:
        snprintk(&request_name, 10, 0xf5071);
        goto LAB_00017fb6;
    }
...
LAB_00017fb6:
    ...
    snprintk(&log_record, 0x1e, 0x9a1ea, puVar3[6], uVar9, uVar8, uVar7, uVar6, uVar5, &request_name);
    if (0 < *piVar2) {
        uVar9 = (uint)*param_2;
        ...
        if (*dbg == 0) {
            log_message(0x9a20d, 0x9a2bf, &log_record, param_3, uVar9, uVar8, uVar7, uVar6, uVar5, puVar11,
    ...
    if ((*(volatile char *)(iVar10 + 0x248) == '\0') && (*(volatile int *)(iVar10 + 0x220) == 0)) {
        ...
        *(volatile unsigned *)(iVar10 + 0x35c) = 1;
        ...
        if (param_3 < 0x101) {
            ...
            log_message(0x9a295, 0x9a2bf);
            return;
        }
        if (*dbg == 0) {
            uVar4 = 0x59;
LAB_000180e2:
            log_message(0x9a275, 0x9a2b1, uVar4, param_3, uVar9, uVar8, uVar7, uVar6, uVar5, puVar11);
            return;
        }
        uVar4 = 0x59;
LAB_000180d4:
        debug_print(0x9a275, 0x9a2b1, uVar4, param_3);
    }
    return;
}
