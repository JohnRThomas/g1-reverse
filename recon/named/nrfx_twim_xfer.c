...
L6796e:
    ...
    r3 = R8(r1);
    if (r3 == 2) {
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"), 0xf78d1, 0xf6fef, 0x259, param_4);
        r1 = 0x259;
        goto L67968;
    }
    if (r3 == 3) {
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"), 0xf7921, 0xf6fef, 0x25a, param_4);
        r1 = 0x25a;
        goto L67968;
    }
    /* fall through */
...
L67a06:
    ...
    /* case 3 : L67a9a */
    if ((r8 & 0x10) != 0) {
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"), 0xf7971, 0xf6fef, 0x1d4, param_4);
        r1 = 0x1d4;
        goto L67968;
    }
    if (r10 != 0) {
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"), 0xf7987, 0xf6fef, 0x1d5, param_4);
        r1 = 0x1d5;
        goto L67968;
    }
    if ((r8 & 4) != 0) {
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n"), 0xf799d, 0xf6fef, 0x1d6, param_4);
        r1 = 0x1d6;
        goto L67968;
    }
    r3 = 0x100;
