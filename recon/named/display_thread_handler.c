...
void display_thread_handler(int param_1)
{
    ...
    k_timer_init(0x20004ce0, 0x7d86d, 0);
    ...
    do {
        ...
        bVar3 = 0;
        {
            ...
            iVar9 = k_msgq_get(0x200038c4, local, (int)uVar14, (int)((uint64_t)uVar14 >> 32));
        }
...
LAB_495a8:
            ...
            if (local[0] == 2) {
                if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefcdf, 0xf01aa, 0); else debug_print(); }
                if (local_3e == 0) {
                    if (3 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefd03, 0xf01aa, 0); else debug_print(); }
                    uVar12 = 1; uVar10 = (unsigned char)base[0xd5]; goto LAB_492ee;
                }
                if (local_3e == 2) {
                    if (lo == 1) {
                        if (3 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefd2d, 0xf01aa, b1); else debug_print(); }
                        uVar12 = 1;
LAB_492e8:
...
LAB_49270:
                ...
                switch (local[0]) {
                case 3:
                    if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefd6f, 0xf01aa, 0); else debug_print(); }
                    PC8 = 2;
                    if (local_3e == 0) {
                        if (3 < PIV5) { iVar9 = PIV6; uVar12 = 0xefd03;
LAB_4943a:
                            if (iVar9 == 0) DEBUG_PRINT(uVar12, 0xf01aa, 0); else debug_print();
                        }
LAB_49442:
...
LAB_4947e:
                    ...
                    goto LAB_49488;
                case 4:
                    if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefe74, 0xf01aa, uVar8); else debug_print(); }
                    setDelayExitValue(uVar8); uVar12 = 3; uVar10 = (unsigned char)base[0xd5]; break;
                case 5:
                    if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefebc, 0xf01aa, 0); else debug_print(); }
                    uVar12 = 4; uVar10 = (unsigned char)base[0xd5]; break;
                case 6:
                    if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefef4, 0xf01aa, 0); else debug_print(); }
                    uVar12 = 5; uVar10 = (unsigned char)base[0xd5]; break;
                case 7:
                    if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xeff2c, 0xf01aa, 0); else debug_print(); }
                    uVar12 = 6; uVar10 = (unsigned char)base[0xd5]; break;
                case 8:
                    if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xeff5c, 0xf01aa, 0); else debug_print(); }
                ...
                if (cVar1 == 0) {
                    if (bVar3) {
                        if (local[0] == 2) {
                            ...
                            if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefb9f, 0xf01aa, 0); else debug_print(); }
                            if (local_3e == 0) {
                                if (3 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefbb7, 0xf01aa, 0); else debug_print(); }
                                cVar1 = base[0xd5]; PC8_1 = base[0xd5];
LAB_49204:
                                display_reflash_handler(param_1, cVar1, iVar13, 1); PC8 = 1;
                            } else if (local_3e == 2) {
                                if (lo == 1) {
                                    if (3 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefbe5, 0xf01aa, b1); else debug_print(); }
                            ...
                            if (2 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefc2d, 0xf01aa, 0); else debug_print(); }
                            PC16 = 0;
                            if (local_3e == 0) {
...
LAB_492ac:
                                ...
                                if ((signed char)lo == 1) {
                                    if (3 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xefc92, 0xf01aa, b1); else debug_print(); }
                ...
                if (0 < PIV5) { if (PIV6 == 0) DEBUG_PRINT(0xeffaf, 0xf01aa, 0); else debug_print(); }
