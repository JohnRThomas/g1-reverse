...
void ancs_connected(int param_1, int param_2)
{
  ...
  log_message(((unsigned long)"%s -- type: 0x%x, role:0x%x force_bind %d"), auStack_38, (unsigned)bVar1, (unsigned)bVar2, uVar6);
  if (param_2 == 0) {
    ...
    bt_conn_le_param_update(param_1, 0x20002f60);
    iVar5 = get_device_info();
