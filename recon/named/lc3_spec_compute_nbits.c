...
int lc3_spec_compute_nbits(int param_1, int param_2, int param_3, int param_4, int *param_5, int param_6, unsigned char *param_7)
{
    ...
    iVar12 = 0;
    uVar2 = 1;
    local_50 = 0x8ed50 + (uint)(iVar5 + -0x28 < param_3) * 0x800;
    uVar1 = 0;
    iVar8 = 0;
    local_4c = 0;
    local_48 = 0;
...
LAB_0006f436:
                        do {
                            ...
                            uVar6 = (int)uVar6 >> 1;
                            uVar7 = uVar7 + 1;
                            iVar8 = iVar8 + (uint)*(volatile unsigned short *)(0x8d3d0 + (uint)pbVar14[uVar4] * 0x22 + 0x20);
                        } while (uVar6 != 0);
                        uVar6 = uVar7;
                        ...
                        uVar6 = (int)uVar6 >> 1;
                        iVar8 = iVar8 + (*(volatile unsigned short *)(0x8d3d0 + (uint)*pbVar14 * 0x22 + 0x20) - 0x1000);
                ...
                iVar12 = iVar12 + 2;
                iVar8 = iVar8 + (uint)*(volatile unsigned short *)(0x8d3d0 + ((uint)*pbVar14 * 0x11 + uVar9 + uVar10 * 4) * 2);
