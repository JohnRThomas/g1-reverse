 ...
 * public-name: gatt_reset_cf_and_change_aware
...
void gatt_reset_cf_and_change_aware(unsigned p1,unsigned p2,unsigned p3,unsigned p4){
  unsigned uVar1; int iVar2; unsigned char* puVar3; int iVar4;
  atomic_and_4(0x20006448, 0xfffffff7, p3, p4, p4);
  reschedule_on_sys_work_q(0x200063a0, 0, 0x148, 0);
  uVar1 = 0xf2b3a;
  iVar4=0;
