...
extern int  adjust_owner_prio.isra.0(int,int);
...
int k_mutex_lock(int *param_1,int param_2,int *param_3,int param_4){
  ...
  (void)param_2;
MAIN:
  if (z_spin_lock_valid(0x2000b470) == 0) {
  ...
  if ((((int)param_3) | param_4) == 0) {
    if (z_spin_unlock_valid(0x2000b470) != 0) return 0xfffffff0;
    printk(0,0,0,0,0,0); printk(0,0,0,0,0,0); assert_post_action(0,0);
    goto MAIN;
  }
  ...
  { int r1 = cVar5;
    ...
    if (r1 < -0x7f) r1 = -0x7f;
    iVar3 = 0;
    if (cVar1 > r1) iVar3 = adjust_owner_prio.isra.0(0,0);
  }
  ...
  if (p[2] != 0) {
    ...
    if (adjust_owner_prio.isra.0(p[2], iVar4) != 0) goto L72504;
  }
  if (iVar3 != 0) goto L72504;
  if (z_spin_unlock_valid(0x2000b470) != 0) return 0xfffffff5;
  printk(0,0,0,0,0,0); printk(0,0,0,0,0,0); assert_post_action(0,0);
  goto MAIN;
L72504:
  z_reschedule(0x2000b470, 0);
  return 0xfffffff5;
L7244e:
  p[3] = p[3] + 1;
  p[4] = iVar4;
  p[2] = VI(0x2000b450);
  if (z_spin_unlock_valid(0x2000b470) != 0) return 0;
  printk(0,0,0,0,0,0); printk(0,0,0,0,0,0); assert_post_action(0,0);
  goto MAIN;
}
