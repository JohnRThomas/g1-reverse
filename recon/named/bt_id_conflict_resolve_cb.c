...
void bt_id_conflict_resolve_cb(int param_1, int *param_2){
    ...
    unsigned uVar3;
    if (param_2 == 0){
        printk(0x99cbd, 0x000f3537, 0x000f3509, 0x36c);
        uVar3=0x36c; assert_post_action(0x000f3509, uVar3); return;
    }
    int iVar4 = *param_2;
    if (iVar4 == 0){
        printk(0x99cbd, 0x000f354f, 0x000f3509, 0x36d);
        uVar3=0x36d; assert_post_action(0x000f3509, uVar3); return;
    } else if (param_1 == 0){
        printk(0x99cbd, 0x000f3572, 0x000f3509, 0x36e);
        ...
        printk(0x99cbd, 0x000f358a, 0x000f3509, 0x370);
