...
LAB_0002dd2a:
    ...
    if (param_1[0xd5] == '\x01') {
        ...
        if (2 < *piVar9) {
            ...
            else            { debug_print(0); iVar13 = 0xa35f7; }
        }
        goto LAB_0002ce1c;
    }
    uVar19 = uVar19 + 1;
...
LAB_0002d9f0:
    ...
    if (param_1[0xd5] == '\x01') {
        ...
        if (2 < *piVar8) {
            ...
            else            { debug_print(0); iVar13 = 0xa3480; }
        }
        goto LAB_0002ce1c;
    }
    uVar19 = uVar19 + 1;
...
LAB_0002d7ee:
    ...
    if (param_1[0xd5] == '\x01') {
        ...
        if (2 < *piVar7) {
            ...
            else            { debug_print(0); iVar13 = 0xa33bf; }
        }
        goto LAB_0002ce1c;
    }
    uVar19 = uVar19 + 1;
...
LAB_0002cbe8:
            ...
            else             { debug_print(0);                      iVar13 = 0xa2ad4; }
        }
        goto LAB_0002ce1c;
    }
    uVar19 = uVar19 + 1;
...
LAB_0002d71c:
    ...
    if (param_1[0xd5] == '\x01') {
        ...
        if (2 < *piVar7) {
            ...
            else            { debug_print(0); iVar13 = 0xa3305; }
        }
        goto LAB_0002ce1c;
    }
    uVar19 = uVar19 + 1;
