...
void ble_privacy_id_remove(int param_1)
{
    ...
    if(*(volatile unsigned char*)0x20002120U == 0){
        ...
        bt_le_adv_legacy_invoke(0x000810ab,0);
        ...
        if(iVar3==0){
            if(*(volatile unsigned char*)(iVar2+0x120) < *(volatile unsigned char*)(iVar2+0x121)){
                ...
                *(unsigned char*)(param_1+8) &= 0xfb;
                ...
                local_24 = 0x000f36e0;
                local_28 = 2;
                bt_id_addr_update_thunk(0x00088150,0x1040,&local_28);
            }
        } else {
            local_44 = 0x000f36b3;
            local_48 = 3;
            iStack_40 = iVar3;
            bt_id_addr_update_thunk(0x00088150,0x1840,&local_48);
        }
LAB_00055142:
        if(*(char*)(iVar2+0x121) != 0){
            addr_res_enable(1);
        }
        bt_le_adv_legacy_invoke(0x00081081,0);
        return;
    }
