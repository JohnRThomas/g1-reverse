...
LAB_96a:
            ...
            if (*(volatile int*)piVar2 == 0) { iVar4 = get_device_info(); DEBUG_PRINT(0xa8b67,(uint)*(byte *)(*(int *)(iVar4 + 0xfec) + 0x5e)); }
...
LAB_85e:
  ...
  if (*(volatile int*)piVar2 == 0) { uVar5 = device_info_text_width_get(); DEBUG_PRINT(0xa8ba0,uVar5,param_1); return; }
