...
void format_message_relative_time(undefined4 param_1,int param_2)
{
  ...
  if (*(volatile int*)piVar2 == 0) log_message(0xa8ac7,iVar4,param_2,uVar9);
...
LAB_96a:
            ...
            if (*(volatile int*)piVar2 == 0)
              log_message(0xa8b3f,param_2,calendar[0] & 0xffff,calendar[0] >> 0x10,calendar[1] & 0xffff,calendar[1] >> 0x10,calendar[2] & 0xffff,calendar[2] >> 0x10);
            else debug_print(0xa8b3f,param_2,calendar[0] & 0xffff,calendar[0] >> 0x10);
            if (*(volatile int*)piVar2 == 0) { iVar4 = get_device_info(); log_message(0xa8b67,(uint)*(byte *)(*(int *)(iVar4 + 0xfec) + 0x5e)); }
            else { iVar4 = get_device_info(); debug_print(0xa8b67,*(byte *)(*(int *)(iVar4 + 0xfec) + 0x5e)); }
...
LAB_85e:
  ...
  if (*(volatile int*)piVar2 == 0) { uVar5 = device_info_text_width_get(); log_message(0xa8ba0,uVar5,param_1); return; }
  uVar5 = device_info_text_width_get(); debug_print(0xa8ba0,uVar5,param_1);
  return;
}
