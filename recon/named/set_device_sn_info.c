...
uint32_t set_device_sn_info(int param_1, uint32_t param_2, uint32_t *param_3, uint8_t *param_4){
    ...
    log_message(0x000a72e1);
    if (param_3==0 || param_4==0){ log_message(0x000a72fc); uVar1=0xffffffff; }
        ...
        if (2 < *(volatile int*)0x2000230cUL){
            if (*(volatile int*)0x20007554UL == 0){ uVar1=get_device_serial_buf(); log_message(0x000a71e0,0x000a76f2,uVar1); }
            else { uVar1=get_device_serial_buf(); debug_print(0x000a71e0,0x000a76f2,uVar1); }
        }
        *puVar4=0x1c; puVar4[1]=1; puVar4[3]=1; cVar3=5; puVar4[2]=3; puVar4[4]=0; *param_4=5;
        do {
            iVar2 = read_sys_settting_from_flash(auStack_9c);
            if (iVar2==0 && (iVar2=memcmp(param_1, auStack_87, 0xe))==0){ log_message(0x000a7209); goto done; }
            cVar3 = cVar3 - 1;
