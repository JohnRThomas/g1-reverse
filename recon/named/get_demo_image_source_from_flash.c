...
void get_demo_image_source_from_flash(void){
  ...
  puVar2 = malloc(0x50);
  if (puVar2 == 0) { log_message(0x000a8d69,0x000a8e27,0x54); return; }
  ...
  if (local_42 == 1) {
    ...
    for (iVar3 = 0; iVar3 < iVar6; iVar3 = iVar3 + 1) {
      ...
      if (iVar7 != 0) { log_message(0x000a8d7f,0x000a8e27,0x7e); goto END; }
      ...
      if (VI(0x20009fcc) != 0) {
        VI(0x20009fc8) = 0;
        iVar7 = get_device_info();
        memcpy(VI(iVar7 + iVar3*4 + 0xb90), VI(0x20009fcc), 0x140);
      }
