...
void get_demo_image_source_from_flash(void){
  ...
  puVar2 = malloc(0x50);
  if (puVar2 == 0) { log_message(((unsigned long)"[%s-%d]malloc error \n"),((unsigned long)"get_demo_image_source_from_flash"),0x54); return; }
