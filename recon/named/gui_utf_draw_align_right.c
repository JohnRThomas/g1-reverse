        ...
        if (iVar3 == 0) {
          ...
          if (iVar4 < 0) {
            ...
            if ((u32)(param_6 - (i32)param_4) < local_2f4) {
              ...
              fb_blit_rows_copy(*(volatile u32*)0x2000a034UL, local_2cc, iVar4, iVar1, local_2e8, uVar8 + param_5);
              iVar3 = count_chars_in_default_font_table(*puVar2, *puVar13);
              local_2f8 = (u32)iVar3 + (u32)local_2d4;
              local_2f4 = local_2f8;
            } else {
              fb_blit_rows_copy(*(volatile u32*)0x2000a034UL, local_2cc, iVar4, iVar1, local_2e8 + local_2f8, uVar8 + param_5);
              iVar3 = count_chars_in_default_font_table(*puVar2, *puVar13);
