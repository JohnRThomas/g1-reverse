...
L67956:
    printk(0x99cbd, 0xf707c, 0xf6fef, 0x251, param_4);
    r1 = 0x251;
    goto L67968;

L67968:
    r0 = (uint32_t)assert_post_action(0xf6fef, (int)r1);
...
L6796e:
    ...
    r3 = R8(r1);
    if (r3 == 2) {
        printk(0x99cbd, 0xf78d1, 0xf6fef, 0x259, param_4);
        r1 = 0x259;
        goto L67968;
    }
    if (r3 == 3) {
        printk(0x99cbd, 0xf7921, 0xf6fef, 0x25a, param_4);
        r1 = 0x25a;
        goto L67968;
    }
    /* fall through */
...
L67a06:
    ...
    /* case 3 : L67a9a */
    if ((r8 & 0x10) != 0) {
        printk(0x99cbd, 0xf7971, 0xf6fef, 0x1d4, param_4);
        r1 = 0x1d4;
        goto L67968;
    }
    if (r10 != 0) {
        printk(0x99cbd, 0xf7987, 0xf6fef, 0x1d5, param_4);
        r1 = 0x1d5;
        goto L67968;
    }
    if ((r8 & 4) != 0) {
        printk(0x99cbd, 0xf799d, 0xf6fef, 0x1d6, param_4);
        r1 = 0x1d6;
        goto L67968;
    }
    r3 = 0x100;
...
L67c96:
    ...
    r0 = r4;
    r0 = (uint32_t)__nrfy_internal_twim_events_process((int)r4, 0x00040202);
    r10 = r0;
...
L67cce:
    ...
    r0 = (uint32_t)__nrfy_internal_twim_events_process((int)r4, 0x40000);
    goto L67ce8;
L67cde:
    R32(r4 + 0x14) = r1;
    goto L67c96;
