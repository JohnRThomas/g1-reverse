...
L9e:
    if(param_3==3){
        if(*(volatile int*)0x2000230c>0){
            if(*(volatile int*)0x20007554==0) DEBUG_PRINT(0xa25b9,0xa2660,param_2); else debug_print();
        }
    } else {
        if(*(volatile int*)0x2000230c>0){
            if(*(volatile int*)0x20007554==0) DEBUG_PRINT(0xa25d9,0xa2660,param_2); else debug_print();
        }
    }
    goto Ltail;
L4a:
    if(*(volatile int*)0x2000230c>0){
        if(*(volatile int*)0x20007554==0) DEBUG_PRINT(0xa2597,0xa2660,param_2); else debug_print();
    }
    if(param_2==0x10){
