    ...
    if(iVar2<=iVar4){
      if(1 < *(volatile int*)0x2000230cUL){
        if(*(volatile int*)0x20007554UL == 0){
          log_message(((unsigned long)"%s(): NOT MATCH(cmd=%x)! ipc_receiver_index: %d, len:%d, received_data: %02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x\n"),((unsigned long)"ipc0_ept_recv"),uVar1,iVar2,param_2,uVar1,(unsigned)param_1[1],(unsigned)param_1[2],(unsigned)param_1[3],(unsigned)param_1[4],(unsigned)param_1[5],(unsigned)param_1[6],(unsigned)param_1[7]);
        } else {
          debug_print(((unsigned long)"%s(): NOT MATCH(cmd=%x)! ipc_receiver_index: %d, len:%d, received_data: %02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x\n"),((unsigned long)"ipc0_ept_recv"),uVar1,iVar2,param_2,uVar1,
