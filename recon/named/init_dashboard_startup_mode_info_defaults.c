...
void init_dashboard_startup_mode_info_defaults(void){
  ...
  *(volatile int*)dst = *(volatile int*)0x2007fc00UL + 1;
  *(volatile unsigned char*)(dst+4) = *(volatile unsigned char*)0x2007fc04UL;
  *(volatile unsigned char*)(dst+5) = *(volatile unsigned char*)0x2007fc05UL;
  *(volatile int*)(dst+6) = *(volatile int*)0x2007fc08UL;
  *(volatile int*)(dst+0xa) = *(volatile int*)0x2007fc0cUL;
  *(volatile unsigned char*)(dst+0x5d) = *(volatile unsigned char*)0x2007fc5fUL;
  *(volatile unsigned char*)(dst+0x5e) = *(volatile unsigned char*)0x2007fc60UL;
  *(volatile unsigned char*)(dst+0x61) = *(volatile unsigned char*)0x2007fc62UL;
  *(volatile unsigned char*)(dst+0x60) = *(volatile unsigned char*)0x2007fc61UL;
  *(volatile unsigned char*)(dst+0x63) = *(volatile unsigned char*)0x2007fc68UL;
  { unsigned char b = *(volatile unsigned char*)0x2007fc69UL;
    if (b <= 3) *(volatile unsigned char*)0x2001b816UL = b; }
  *(volatile int*)(dst+0x0e) = *(volatile int*)0x2007fc10UL;
  *(volatile int*)(dst+0x12) = *(volatile int*)0x2007fc14UL;
  *(volatile int*)(dst+0x16) = *(volatile int*)0x2007fc18UL;
  *(volatile int*)(dst+0x1a) = *(volatile int*)0x2007fc1cUL;
  ...
  *(volatile int*)(dst+0x33) = *(volatile int*)0x2007fc35UL;
  *(volatile int*)(dst+0x37) = *(volatile int*)0x2007fc39UL;
