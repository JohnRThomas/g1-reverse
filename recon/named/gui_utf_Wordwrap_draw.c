...
static u16 tbl1(u32 i) { return *(volatile u16*)(0x00088434UL + 2u*i); }
static u16 tbl2(u32 i) { return *(volatile u16*)(0x0008843eUL + 2u*i); }
          ...
          if (iVar3 < 0) {
            ...
            if (uVar18 < param_9) {
              ...
              for (iVar5 = 0; iVar3 - iVar5 != 0 && iVar5 <= iVar3; iVar5 = iVar5 + 1) {
                *pbVar9 = *pbVar9 & *(volatile u8*)0x200034f6UL;
                pbVar9 = pbVar9 + 1;
              }
            }
            bVar20 = 0;
...
LAB_00045422:
                ...
                if (0x28 < (i32)(uVar16 - uVar18)) {
                  if (*(volatile i32*)0x2000230cUL < 2) goto LAB_00045314;
                  iVar3 = *(volatile i32*)0x20007554UL;
                  uVar13 = 0x000aabe8UL;
                  goto LAB_00045458;
                }
                iVar3 = 0;
