...
int bt_att_recv(int param_1, int param_2)
{
    ...
    if (*(volatile int16_t*)(param_2 + 0x10) == 0) {
        att_log_emit_3arg(0x00088100, 0x1040, (int)(intptr_t)logbuf);
        return 0;
    }
    ...
    do {
        ...
        if (*(volatile uint8_t*)(0x0008b2b4 + iVar6 * 8) == *pbVar3) {
            ...
            joined:
                if (iVar7 != 0) {
                    att_log_emit_3arg(0x00088100, 0x1080, (int)(intptr_t)logbuf);
                    goto LAB_d9c;
                }
            }
            iVar8 = iVar8 + iVar6 * 8;
            if ((unsigned)*(volatile uint16_t*)(param_2 + 0x10) < (unsigned)*(volatile uint8_t*)(iVar8 + 1)) {
                att_log_emit_3arg(0x00088100, 0x2040, (int)(intptr_t)logbuf);
    ...
    att_log_emit_3arg(0x00088100, 0x1880, (int)(intptr_t)logbuf);
