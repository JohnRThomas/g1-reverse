...
void box_placement_animation_step(uint8_t *s){volatile uint8_t*busy=(uint8_t*)0x20018c66,*flag=(uint8_t*)0x20003023;volatile uint16_t*last=(uint16_t*)0x2000f6e4;volatile float*deadline=(float*)0x20007a04;
