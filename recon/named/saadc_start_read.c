...
LAB_f874:
      *(volatile u32*)(long)(iVar11 + 0x5f4) = uVar4;
      ...
      if ((u32)param_2[3] < uVar10) {
        ...
        z_log_msg_runtime_create(0x000880e0u, 0x2040u, capacity_error, 0);
        uVar9 = 0xfffffff4u;
        goto LAB_f7d6;
      }
...
LAB_f7c6:
    ...
    z_log_msg_runtime_create(0x000880e0u, 0x1840u, validation_error, 0);
  } else {
LAB_f782:
    range_error[0] = 2;
    range_error[1] = uVar9;
    z_log_msg_runtime_create(0x000880e0u, 0x1040u, range_error, 0);
  }
  uVar9 = 0xffffffeau;
LAB_f7d6:
