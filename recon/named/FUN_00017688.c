...
void FUN_00017688(const uint8_t *pin, uint32_t flags)
{
    ...
    if ((combined & 0x30) == 0x30) {
        printk((void *)0x99cbd, (void *)0x99c84, (void *)0x99c53, 0x3ca);
        printk((void *)0x99cda);
        assert_post_action((void *)0x99c53, 0x3ca);
    } else if ((combined & 0x30002) == 0x10002) {
        printk((void *)0x99cbd, (void *)0x99d17, (void *)0x99c53, 0x3ce);
        printk((void *)0x99d5e);
        assert_post_action((void *)0x99c53, 0x3ce);
    } else if ((combined & 6) == 4) {
        printk((void *)0x99cbd, (void *)0x99dad, (void *)0x99c53, 0x3d1);
    ...
    bit = 1u << line;
    if ((*enabled & bit) == 0) {
        printk((void *)0x99cbd, (void *)0x99de0, (void *)0x99c53, 0x3e4);
        printk((void *)0x99e1e);
