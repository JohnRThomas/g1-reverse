...
LAB_2c: if (iVar3 == 0) DEBUG_PRINT(uVar9,0xaad8e,uVar13); else debug_print(uVar9,0xaad8e,uVar13); }
            } else {
            ...
            if (iVar4 < 0) { if (1 < *(volatile int*)0x2000230c) { iVar3 = *(volatile int*)0x20007554; uVar9 = 0xaaa58; goto LAB_2c; } }
              ...
              if ((uint)(param_6 - param_4) < uVar15) {
                ...
                fb_blit_rows_copy(*(volatile int*)0x2000a034,(int)local_2cc,iVar4,iVar1,param_4,uVar8 + param_5);
                iVar3 = count_chars_in_default_font_table(*puVar2,*puVar10);
                uVar14 = iVar3 + local_2d4; uVar15 = uVar14;
              } else {
                fb_blit_rows_copy(*(volatile int*)0x2000a034,(int)local_2cc,iVar4,iVar1,uVar14 + param_4,uVar8 + param_5);
                iVar3 = count_chars_in_default_font_table(*puVar2,*puVar10);
