 ...
 * Raw function identity: 0x00072fe8.  See ../include/g1_recovered_layouts.h. */
...
uint32_t k_work_cancel(int param_1, uint32_t param_2, uint32_t param_3, uint32_t param_4){
  ...
  int iVar3;
  if (param_1 == 0){
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f82e0) /*=0xf82e0*/,((unsigned long)&rodata_f820f) /*=0xf820f*/,0x221,param_4);
    assert_post_action(((unsigned long)&rodata_f820f) /*=0xf820f*/,0x221);
  }
  if ((int32_t)((uint32_t)*(int*)(param_1+0xc) << 0x17) < 0){
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f8262) /*=0xf8262*/,((unsigned long)&rodata_f820f) /*=0xf820f*/,0x222,param_4);
