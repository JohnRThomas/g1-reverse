 ...
 *   param_2          => struct g1_layout_bignum_state__param_0427               [param_0427; G1-original]
 * Raw function identity: 0x00078ac8.  See ../include/g1_recovered_layouts.h. */
...
int bigint_diff(int param_1,int param_2,int param_3,int param_4)
{
  ...
  if (iVar1 == 0) {
    ...
    iVar3 = iVar2;
    if (iVar2 != 0) goto control_label_00078af6;
    uVar4 = 0x232;
  }
  else {
    if (bVar15) {
  ...
  iVar2 = __assert_func(((unsigned long)&rodata_f8cd5) /*=0xf8cd5*/,uVar4,iVar3,((unsigned long)&rodata_f8c42) /*=0xf8c42*/);
control_label_00078af6:
  *(int *)(iVar2 + 0x10) = 1;
