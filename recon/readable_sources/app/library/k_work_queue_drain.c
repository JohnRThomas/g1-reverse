...
{
    if (!obj) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f586b) /*=0xf586b*/,((unsigned long)&rodata_f820f) /*=0xf820f*/,0x2ed,0,requested,a,b); assert_post_action(((unsigned long)&rodata_f820f) /*=0xf820f*/,0x2ed); }
    if (k_is_in_isr()) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"!k_is_in_isr()") /*=0xf3d75*/,((unsigned long)&rodata_f820f) /*=0xf820f*/,0x2ee,obj,requested,a,b); assert_post_action(((unsigned long)&rodata_f820f) /*=0xf820f*/,0x2ee); }
    uint32_t bp=__get_BASEPRI(); __set_BASEPRI_MAX(0x20); __ISB();
    if (!z_spin_lock_valid(((unsigned long)&timer_spinlock) /*=0x2000b480*/)) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"z_spin_lock_valid(l)") /*=0xf0920*/,((unsigned long)&rodata_f08c7) /*=0xf08c7*/,0x72,obj,requested,a,b); printk(((unsigned long)"\tInvalid spinlock %p\n") /*=0xf0935*/,((unsigned long)&timer_spinlock) /*=0x2000b480*/); assert_post_action(((unsigned long)&rodata_f08c7) /*=0xf08c7*/,0x72); }
    ...
    if (!(flags&6)) {
        if (!requested && !*(uint32_t *)(obj+0xd8)) {
            ...
            printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"z_spin_unlock_valid(l)") /*=0xf08f4*/,((unsigned long)&rodata_f08c7) /*=0xf08c7*/,0xf0,obj,requested,a,b); printk(((unsigned long)"\tNot my spinlock %p\n") /*=0xf090b*/,((unsigned long)&timer_spinlock) /*=0x2000b480*/); assert_post_action(((unsigned long)&rodata_f08c7) /*=0xf08c7*/,0xf0);
        }
