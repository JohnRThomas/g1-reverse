 ...
 *   param_1          => struct g1_layout_img_mgmt_upload_action__param_0179     [param_0179; library]
 *   local_f0         => struct g1_layout_img_upload_chunk__stack_1126           [stack_1126; G1-original]
 *   local_d4         => struct g1_layout_img_mgmt_upload_scratch__stack_1128    [stack_1128; G1-original]
 * Raw function identity: 0x000521fc.  See ../include/g1_recovered_layouts.h. */
...
unsigned img_mgmt_upload(int param_1)
{
    ...
    if (uVar2 == 0) {
        if (decoded.present == 0) {
            uVar4 = img_mgmt_upload_good_rsp(control_handle);
            return uVar4;
        }
        ...
        if (parsed.count == 0) {
            ...
            if (uVar2 != 0) {
                ...
                z_log_msg_runtime_create(((unsigned long)&rodata_88208) /*=0x88208*/, 0x1840, &diagnostic, 0);
                goto control_label_00052300;
            }
            {
                ...
                if (next_progress == puVar1[2]) {
                    ...
                    img_mgmt_upload_good_rsp(control_handle);
