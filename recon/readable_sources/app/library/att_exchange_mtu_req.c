 ...
 * Raw function identity: 0x00082396.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_00082396 @ 0x00082396
 * public-name: att_exchange_mtu_req
...
unsigned att_exchange_mtu_req(unsigned* param_1,int param_2){
  ...
  *(unsigned short*)((int)param_1+0x2e)=uVar1;
  (void)__atomic_fetch_or((unsigned*)(*(int*)*param_1+4), 0x1000u,
                          __ATOMIC_ACQ_REL);
  gatt_recompute_max_mtu(param_1);
  return 0;
}
