...
int lc3_spec_compute_nbits(int param_1, int param_2, int param_3, int param_4, int *param_5, int param_6, unsigned char *param_7)
{
    uint uVar1, uVar2, uVar4, uVar6, uVar7, uVar9, uVar10;
    int iVar3, iVar5, iVar8, iVar11, iVar12, iVar13;
    unsigned char *pbVar14;
    unsigned short *puVar15;
    int local_50, local_4c, local_48, local_3c;
    ...
    iVar12 = 0;
    uVar2 = 1;
    local_50 = ((unsigned long)&lc3_spectrum_lookup) /*=0x8ed50*/ + (uint)(iVar5 + -0x28 < param_3) * 0x800;
    uVar1 = 0;
    iVar8 = 0;
    local_4c = 0;
    local_48 = 0;
    ...
    do {
        ...
        if (*param_5 <= iVar13) iVar13 = *param_5;
        if ((iVar12 < iVar13) && (iVar8 <= param_6)) {
            puVar15 = (unsigned short *)(param_4 + (iVar12 + 1) * 2);
            do {
                uVar9 = (uint)(puVar15[-1] >> 1);
                uVar10 = (uint)(*puVar15 >> 1);
                iVar11 = (uint)(uVar9 != 0) + (uint)(uVar10 != 0);
                pbVar14 = (unsigned char *)(local_50 + uVar1 * 4);
                uVar6 = (uint)(unsigned short)((puVar15[-1] | *puVar15) >> 3);
                iVar8 = iVar8 + iVar11 * 0x800;
                if (uVar6 != 0) {
                    if (param_3 < iVar5) {
                        uVar7 = 0;
control_label_0006f436:
                        do {
                            uVar4 = uVar7;
                            if (2 < (int)uVar7) uVar4 = 3;
                            uVar6 = (int)uVar6 >> 1;
                            uVar7 = uVar7 + 1;
                            iVar8 = iVar8 + (uint)*(volatile unsigned short *)(((unsigned long)&lc3_spectrum_bits) /*=0x8d3d0*/ + (uint)pbVar14[uVar4] * 0x22 + 0x20);
                        } while (uVar6 != 0);
                        uVar6 = uVar7;
                        ...
                        uVar6 = (int)uVar6 >> 1;
                        iVar8 = iVar8 + (*(volatile unsigned short *)(((unsigned long)&lc3_spectrum_bits) /*=0x8d3d0*/ + (uint)*pbVar14 * 0x22 + 0x20) - 0x1000);
                        local_3c = local_3c + iVar3;
                        if (uVar6 != 0) {
                            uVar7 = 1;
                            goto control_label_0006f436;
                        }
                        uVar6 = 1;
                        iVar3 = 0x1000;
                        uVar7 = uVar6;
                ...
                iVar12 = iVar12 + 2;
                iVar8 = iVar8 + (uint)*(volatile unsigned short *)(((unsigned long)&lc3_spectrum_bits) /*=0x8d3d0*/ + ((uint)*pbVar14 * 0x11 + uVar9 + uVar10 * 4) * 2);
    ...
    *param_5 = local_48;
    if (param_7 != (unsigned char *)0x0) {
        if ((iVar5 <= param_3) && (param_6 < local_4c + local_3c * 0x800)) {
            *param_7 = 1;
            goto control_label_0006f3ea;
        }
        *param_7 = 0;
    }
