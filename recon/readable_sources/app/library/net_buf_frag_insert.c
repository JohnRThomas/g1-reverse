...
{
    if (!owner) {
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"parent") /*=0xf5407*/, ((unsigned long)&rodata_f539a) /*=0xf539a*/, 0x241);
        assert_post_action(((unsigned long)&rodata_f539a) /*=0xf539a*/, 0x241);
    }
    if (!node) {
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)&rodata_f542d) /*=0xf542d*/, ((unsigned long)&rodata_f539a) /*=0xf539a*/, 0x242);
