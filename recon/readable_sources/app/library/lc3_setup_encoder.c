 ...
 *   param_4          => struct g1_layout_param_0101_false_union__param_0101     [param_0101; G1-original]
 * Raw function identity: 0x00068f94.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_00068f94 @ 0x00068f94
 * public-name: lc3_setup_encoder
...
undefined1 * lc3_setup_encoder(int param_1,int param_2,int param_3,undefined1 *param_4)
{
      ...
      if (param_3 == 8000) { iVar2=0; uVar3=3; iVar5=0; uVar8=0; uVar9=0; }
        ...
        if (param_3 == 16000) uVar9=1;
          ...
          if (param_3 != 32000) {
            ...
            iVar5=0; iVar2=1; uVar3=3; uVar9=4; uVar8=0; goto control_label_9026;
          }
          uVar9=3;
        }
        iVar2=0; uVar3=3; iVar5=0; uVar8=0;
      }
      goto control_label_9026;
    }
    uVar3=3; iVar5=0;
    ...
    if (param_2 == 8000) {
      if (param_3 == 8000) { iVar2=0; uVar3=4; iVar5=1; uVar8=0; uVar9=0; }
        ...
        if (param_3 == 24000) uVar9=2;
          ...
          if (param_3 != 32000) {
            if (param_3 != 48000) return (undefined1*)0;
            iVar2=1; uVar3=4; uVar8=0; iVar5=iVar2; uVar9=uVar3; goto control_label_9026;
          }
          uVar9=3;
        }
  ...
  if (param_2 == 16000) {
    ...
    uVar9=1; uVar8=1;
    if (param_3 == 16000) goto control_label_9106;
control_label_8ffe:
    uVar8=uVar9;
    ...
    uVar9=uVar8;
    if (param_3 != 16000) goto control_label_8ffe;
control_label_9106:
    if (iVar5==2) return (undefined1*)0;
    iVar2=0; uVar9=1;
  }
...
control_label_9026:
  ...
  memset_bytes((int)param_4,0,0x4b0);
  ...
  *(undefined1 **)(param_4 + 0x4a0) = puVar7 + iVar6 * 0x14;
  ...
  memset_bytes((int)puVar7,0,(iVar5 + (((int)(lVar1 * param_3 >> 0x28) - (param_3 >> 0x1f)) + iVar5) / 2
                        + iVar2) * 4);
  return param_4;
}
