 ...
 *   local_28         => struct g1_layout_lc3_energy_locals__stack_1361          [stack_1361; G1-original]
 * Raw function identity: 0x00068b68.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_00068b68 @ 0x00068b68
 * public-name: lc3_energy_compute
 * durable-map: recon/catalogs/function_names_app.json
 * callees (readable <= raw @ address):
 *   lc3_energy_compute                       <= FUN_00068b68 @ 0x00068b68
 *   memset_bytes                             <= FUN_00086c78 @ 0x00086c78
 * address symbols (name @ address):
 *   lc3_energy_n1_table                      @ 0x0008bc60
...
float * lc3_energy_compute(int param_1, int param_2, float *param_3, float *param_4)
{
    int bVar1;
    float *pfVar2;
    ...
    iVar5 = *(volatile int *)(((unsigned long)&lc3_energy_n1_table) /*=0x8bc60*/ + (param_1 * 5 + param_2) * 4);
    local_28[0] = 0.0f;
    local_28[1] = 0.0f;
    if (iVar5 < 1) {
        iVar5 = 0;
    ...
    iVar8 = param_1 * 0x514 + param_2 * 0x104 + ((unsigned long)&lc3_band_lim) /*=0x90c50*/;
    pfVar2 = param_4;
    iVar4 = iVar5;
    fVar10 = 0.0f;
    if (iVar5 < iVar6) {
