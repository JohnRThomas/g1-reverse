...
{
  if (task_endpoint == 0) {
    printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f6a4a) /*=0xf6a4a*/,((unsigned long)&rodata_f6a09) /*=0xf6a09*/,99);
    task_endpoint = (int)(assert_post_action(((unsigned long)&rodata_f6a09) /*=0xf6a09*/,99) >> 32);
  }
