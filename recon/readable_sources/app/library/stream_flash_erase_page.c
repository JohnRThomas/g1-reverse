 ...
 * Raw function identity: 0x0004e124.  See ../include/g1_recovered_layouts.h. */
...
int stream_flash_erase_page(int param_1,unsigned int param_2){
  ...
  if(iVar1==0){
    if(*(int*)(param_1+0x20)!=local.result.selected){
      ...
      else{ s.b=((unsigned long)&rodata_f1036) /*=0xf1036*/; s.a=3; s.c=iVar2; z_log_msg_runtime_create(((unsigned long)&rodata_880d8) /*=0x880d8*/,0x1840,&s,0); iVar1=iVar2; }
    }
  } else { s.b=((unsigned long)&rodata_f1015) /*=0xf1015*/; s.a=3; s.c=iVar1; z_log_msg_runtime_create(((unsigned long)&rodata_880d8) /*=0x880d8*/,0x1840,&s,0); }
  return iVar1;
}
