 ...
 * Raw function identity: 0x0005f450.  See ../include/g1_recovered_layouts.h. */
...
int net_buf_append_bytes(int param_1,unsigned param_2,int param_3,int param_4,int param_5,int param_6,int (*param_7)(int,int,int),int param_8){
  ...
  int iVar1=((unsigned long)&acl_tx_pool) /*=0x20003a7c*/;
  int iVar5=0;
  while(1){
    iVar3+=0xc;
    ...
    net_buf_simple_add_mem(iVar3,param_3,uVar4);
    param_2=param_2-uVar4; iVar5=iVar5+uVar4; param_3=param_3+uVar4;
    if(param_2==0) return iVar5;
    if(param_7==0){ iVar3=net_buf_alloc_len((unsigned)*(unsigned char*)(param_1+0xa)*0x34+iVar1,param_2,param_5,param_6); }
