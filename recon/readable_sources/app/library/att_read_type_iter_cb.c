 ...
 *   param_3          => struct g1_layout_bt_att_read_group_data__param_0228     [param_0228; library]
 * Raw function identity: 0x00058808.  See ../include/g1_recovered_layouts.h. */
                  ...
                  struct request_58808 *request, uint32_t arg3)
{
    ...
    *request->payload = (uint16_t)value;
    status = att_chan_read(owner, context, request->buffer, 0,
                          ADDR_attr_read_type_cb_THUMB /*=0x81bd1*/, request);
    if (status < 0) {
