 ...
 *   param_1          => struct g1_layout_img_mgmt_req_ctx__param_0176           [param_0176; G1-original]
 * Raw function identity: 0x00051c98.  See ../include/g1_recovered_layouts.h. */
...
unsigned img_mgmt_state_read(int param_1, unsigned param_2, unsigned param_3, unsigned param_4)
{
  ...
  uStack_24 = param_2;
  uVar2 = zcbor_tstr_encode_ptr(iVar6, ((unsigned long)&rodata_f275f) /*=0xf275f*/, 6, param_4, param_1);
  if (uVar2 != 0) {
...
control_label_00051cde:
    ...
    if (uVar1 == 2) {
      iVar8 = 1;
      iVar5 = iVar8;
      if (uVar3 != uVar2) goto control_label_00051d30;
control_label_00051d1e:
      iVar9 = 0;
      iVar8 = iVar5;
    }
    else {
      iVar8 = 5;
      iVar5 = 5;
      if ((uVar3 == uVar2) || (iVar5 = iVar8, 2 < uVar1)) goto control_label_00051d1e;
control_label_00051d30:
    ...
    if (iVar5 == 0) goto control_label_00051cde;
