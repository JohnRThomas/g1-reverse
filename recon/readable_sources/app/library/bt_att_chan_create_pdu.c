...
int bt_att_chan_create_pdu(unsigned int param_1, unsigned int param_2, int param_3)
{
    ...
    if (uStack_40 < param_3 + 1U) {
        ...
        local_48 = 4;
        local_3c = param_3 + 1U;
        goto control_label_00058624;
    }
    iVar1 = att_op_get_type(param_2);
    if (iVar1 == 2) {
        if ((param_2 == 0xf) || (param_2 == 0x21)) goto control_label_000586e2;
        if (*(int *)(param_1 + 0x148) == 0) {
            ...
            goto control_label_000586ce;
        }
        local_44 = ((unsigned long)&rodata_f449a) /*=0xf449a*/;
        uStack_40 = param_1;
    } else {
        if (iVar1 == 4) {
control_label_000586e2:
