    ...
    if (z_device_is_ready(device) != 0) {
        ...
        if (result < 0 && *(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/ > 0) {
            if (*(volatile uint32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0u) {
                log_message((const void *)((unsigned long)&rodata_9f0db) /*=0x9f0db*/,
                             (const void *)((unsigned long)&rodata_9f1cf) /*=0x9f1cf*/);
            } else {
                debug_print((const void *)((unsigned long)&rodata_9f0db) /*=0x9f0db*/,
                             (const void *)((unsigned long)&rodata_9f1cf) /*=0x9f1cf*/, 0);
            }
        }
    } else if (*(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/ > 0) {
        if (*(volatile uint32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0u) {
            log_message((const void *)((unsigned long)&rodata_9f0b0) /*=0x9f0b0*/,
                         (const void *)((unsigned long)&rodata_9f1cf) /*=0x9f1cf*/, device->name);
        } else {
            debug_print((const void *)((unsigned long)&rodata_9f0b0) /*=0x9f0b0*/,
                         (const void *)((unsigned long)&rodata_9f1cf) /*=0x9f1cf*/, device->name);
        }
    }
    return 0;
