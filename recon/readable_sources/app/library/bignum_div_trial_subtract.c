 ...
 *   param_1          => struct g1_layout_bignum_state__param_0427               [param_0427; G1-original]
 * Raw function identity: 0x00087184.  See ../include/g1_recovered_layouts.h. */
...
unsigned int bignum_div_trial_subtract(void *param_1, void *param_2)
{
  ...
  if (*(int*)((char*)param_1+0x10) < *(int*)((char*)param_2+0x10)) {
    ...
    iVar11 = bignum_compare_abs(param_1);
    if (-1 < iVar11) {
      iVar11=0;
      puVar2 = puVar6;
      do {
