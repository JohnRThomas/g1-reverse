 ...
 *   param_1          => struct g1_layout_bt_gatt_attr__param_0255               [param_0255; library]
 * Raw function identity: 0x0005a9f4.  See ../include/g1_recovered_layouts.h. */
  ...
  if(param_1!=0 && (uVar1=(unsigned int)*(unsigned short*)(param_1+0x10), uVar1==0)){
    ...
    while(1){
      if((volatile unsigned int*)((unsigned long)&rodata_88070) /*=0x88070*/ < puVar2){
        printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f49a5) /*=0xf49a5*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0x713);
