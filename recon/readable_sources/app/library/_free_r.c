...
void _free_r(int* param_1, int param_2, int param_3, int param_4){
    ...
    piVar1 = (int*)param_2;
    piVar3 = (int*)((unsigned long)&g_malloc_free_list) /*=0x2000cc20*/;
    piVar4 = (int*)*(volatile uint32_t*)((unsigned long)&g_malloc_free_list) /*=0x2000cc20*/;
    if(piVar4 != 0){
