 ...
 * Raw function identity: 0x00072cd4.  See ../include/g1_recovered_layouts.h. */
...
unsigned submit_to_queue_locked(volatile uint32_t *param_1, volatile int *param_2, uint32_t param_3, uint32_t param_4){
    ...
    v = param_1[2];
    if (v == 0){
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f8247) /*=0xf8247*/,((unsigned long)&rodata_f820f) /*=0xf820f*/,0x14e,param_4);
  ...
  L_d16:
    r5 = *param_2;
    if (r5 == 0) goto L_d96;
    if (*(volatile int*)(((unsigned long)&_kernel) /*=0x2000b448*/+8) == r5){
        int rc = k_is_in_isr();
