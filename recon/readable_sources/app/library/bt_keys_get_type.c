...
int bt_keys_get_type(int param_1,int param_2,int param_3,int param_4)
{
  int iVar1;
  if (param_3 == 0) {
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f52ac) /*=0xf52ac*/,((unsigned long)&rodata_f5268) /*=0xf5268*/,0xd2,param_4);
    assert_post_action(((unsigned long)&rodata_f5268) /*=0xf5268*/,0xd2);
  }
  iVar1 = bt_keys_find();
