 ...
 * Raw function identity: 0x00058930.  See ../include/g1_recovered_layouts.h. */
...
unsigned int bt_att_accept(int param_1, int *param_2)
{
  ...
  if (local_1c == 0) {
    ...
    *puVar1 = param_1;
    ...
    att_log_emit_3arg(((unsigned long)&rodata_88100) /*=0x88100*/, 0x1880, dummy);
  } else {
    att_log_emit_3arg(((unsigned long)&rodata_88100) /*=0x88100*/, 0x1840, dummy);
  }
  return 0xfffffff4;
}
