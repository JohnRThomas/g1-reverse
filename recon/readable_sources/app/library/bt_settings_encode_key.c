 ...
 *   param_4          => struct g1_layout_bt_settings_encode_key_arg__param_0184 [param_0184; G1-original]
 * Raw function identity: 0x00052e7c.  See ../include/g1_recovered_layouts.h. */
...
void bt_settings_encode_key(int param_1,int param_2,int param_3,uint8_t *param_4,int param_5){
  ...
  if(param_5 == 0){
    snprintk(param_1,param_2,((unsigned long)&rodata_f2c25) /*=0xf2c25*/,param_3,b6,b5,b4,b3,b2,b1,b0);
  } else {
    snprintk(param_1,param_2,((unsigned long)&rodata_f2c01) /*=0xf2c01*/,param_3,b6,b5,b4,b3,b2,b1,b0,param_5);
  }
}
