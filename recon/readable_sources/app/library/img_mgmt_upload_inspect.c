 ...
 *   0x00051a3c       => struct g1_layout_img_mgmt_upload_state__global_1117     [global_1117; library]
 *   param_2          => struct g1_layout_param_0101_false_union__param_0101     [param_0101; G1-original]
 *   param_1          => struct g1_layout_img_mgmt_upload_req__param_0175        [param_0175; library]
 * Raw function identity: 0x000518a8.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_000518a8 @ 0x000518a8
 * public-name: img_mgmt_upload_inspect
...
unsigned img_mgmt_upload_inspect(int *param_1, unsigned *param_2)
{
    ...
    uVar4 ^= 1;
    iVar2 = img_mgmt_slot_in_use(uVar4);
    if (iVar2 != 0) {
        P2u(0xc) = 0xffffffff;
        return 9;
    }
    uVar4 = img_mgmt_flash_area_id(uVar4);
    P2u(0xc) = uVar4;
    ...
    if (iVar2 != 0) {
        ...
        z_log_msg_static_create_img_mgmt(((unsigned long)&rodata_88208) /*=0x88208*/, 0x2040, &diagnostic);
        return 10;
    }
