 ...
 * Raw function identity: 0x0005c5f0.  See ../include/g1_recovered_layouts.h. */
...
extern uint8_t *gatt_find_conn_in_known_table(void);
...
{
    uint8_t *group = gatt_find_conn_in_known_table();
