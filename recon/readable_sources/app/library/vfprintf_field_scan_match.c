 ...
 *   param_2          => struct g1_layout_vfprintf_scan_ctx__param_0432          [param_0432; G1-original]
 * Raw function identity: 0x00079278.  See ../include/g1_recovered_layouts.h. */
...
control_label_00079306:
      ...
      } else if ((uVar2 != 2) || ((int)((unsigned)*(unsigned char *)(iVar1 + (unsigned)*(unsigned char *)*param_3) << 0x1c) < 0)) goto control_label_00079306;
    }
    iVar6 = iVar6 + 1;
    puVar5 = unaff_r6;
    if (-1 < (int)(*param_2 << 0x1b)) {
    ...
    *param_3 = *param_3 + 1;
    ...
    if ((uVar2 == 0) ||
       ((iVar4 + -1 < 1 &&
        ...
        iVar4 != 0)))) goto control_label_00079306;
  } while(1);
}
