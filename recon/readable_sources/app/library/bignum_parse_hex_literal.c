...
control_label_000873e6:
    while (1) {
        ...
        if (uVar2 != 0) {
            ...
            goto control_label_000874b6;
        }
        if (0x20 < bVar1) {
            if (bVar1 != 0x29) goto control_label_000874e8;
            *param_1 = iVar4 + 2;
            break;
        }
        iVar4 = iVar7;
...
code_r0x000874aa:
    ...
    if (param_3 < (unsigned int *)puVar11) {
        ...
        iVar12 = 1;
        *puVar11 = 0;
control_label_000874b6:
        *puVar11 = (uVar2 & 0xf) | *puVar11 << 4;
        iVar4 = iVar7;
    }
    goto control_label_000873e6;
}
