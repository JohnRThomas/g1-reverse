 ...
 *   local_138        => struct g1_layout_lc3_sns_shaping_coeffs__stack_1377     [stack_1377; library]
 * Raw function identity: 0x0006bfc8.  See ../include/g1_recovered_layouts.h. */
                  ...
                  int param_5, int param_6)
{
    ...
    pfVar7 = buf;
    iVar8 = *(volatile int *)(param_1 * 0x514 + param_2 * 0x104 + ((unsigned long)&lc3_band_lim) /*=0x90c50*/ + 0x100);
    iVar6 = iVar8;
    if (0x3f < iVar8) {
        iVar6 = 0x40;
    }
    ...
    piVar9 = (int *)(((unsigned long)&lc3_band_lim) /*=0x90c50*/ + param_1 * 0x514 + param_2 * 0x104);
    if (0 < iVar8) {
        iVar8 = 0;
        iVar5 = 0;
        do {
