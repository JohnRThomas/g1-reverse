 ...
 *   param_1          => struct g1_layout_virtqueue__param_0712                  [param_0712; library]
 * Raw function identity: 0x00085a9c.  See ../include/g1_recovered_layouts.h. */
...
extern int firmware_function_000859b2(void *lock, uint32_t inherited_r1, uint32_t zero,
                        uint32_t one);
...
int virtqueue_return_rx_buffer(uint8_t *context, uint8_t *record)
{
    ...
    return firmware_function_000859b2(lock, (uint32_t)(inherited >> 32), 0, 1);
}
