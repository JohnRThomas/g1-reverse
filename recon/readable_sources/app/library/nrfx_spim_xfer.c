 ...
 *   param_2          => struct g1_layout_nrfx_spim_xfer_desc_t__param_0346      [param_0346; library]
 * Raw function identity: 0x00067304.  See ../include/g1_recovered_layouts.h. */
...
{
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, message, ((unsigned long)&rodata_f6df0) /*=0xf6df0*/, line);
