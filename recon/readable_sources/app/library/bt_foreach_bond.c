 ...
 *   0x0005e750       => struct g1_layout_bt_bond_iter_scratch__global_1253      [global_1253; library]
 * Raw function identity: 0x0005e6d4.  See ../include/g1_recovered_layouts.h. */
...
void bt_foreach_bond(uint32_t param_1, void* param_2, uint32_t param_3){
  ...
  (void)local_1c;
  if(param_2==0){
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f52c0) /*=0xf52c0*/,((unsigned long)&rodata_f5268) /*=0xf5268*/,0xa0);
