 ...
 *   param_2          => struct g1_layout_att_pdu_buf_view__param_0236           [param_0236; library]
 * Raw function identity: 0x000590bc.  See ../include/g1_recovered_layouts.h. */
...
uint32_t att_prepare_write_req(int* param_1, int param_2){
