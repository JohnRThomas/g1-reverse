...
#include <stdint.h>
extern int snprintf_engine_bounded(int a, int b, int c, int d, int e, int f, int g);
void vsnprintf_impl(int param_1, int param_2, int param_3, int param_4) {
    snprintf_engine_bounded(*(volatile int*)((unsigned long)&g_libc_heap_ctrl) /*=0x20002d20*/, param_1, param_2, param_3, param_4, param_2, param_3);
}
