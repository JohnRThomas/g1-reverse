 ...
 *   param_3          => struct g1_layout_dtoa_scratch__param_0423               [param_0423; G1-original]
 * Raw function identity: 0x00078110.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_00078110 @ 0x00078110
 * public-name: dtoa
 ...
 *   rodata_98768                             @ 0x00098768
 *   rodata_f8c42                             @ 0x000f8c42
 *   rodata_f8c53                             @ 0x000f8c53
 */
...
extern int bignum_any_bit_set_from(int,int);

byte *dtoa(int param_1, int *param_2, int *param_3, int *param_4, int *param_5, uint param_6)
{
  byte bVar2;
  ...
  iVar13 = *(volatile int*)((unsigned long)&rodata_98768) /*=0x98768*/;
  iVar6 = strlen(iVar13);
  ...
  if (iVar7 == 0) {
    ...
    if (iVar7 == 0) {
      ...
      iVar7 = hex_nibble_from_ascii(pbVar19[iVar6]);
      ...
      if (iVar7 != 0) {
        ...
        iVar7 = hex_nibble_from_ascii(0);
        pbVar21 = (byte*)0x1;
        bVar4 = iVar7 == 0;
        pbVar12 = pbVar19;
        goto control_label_00078192;
      }
    }
    fraction_start = 0;
    bVar4 = 1;
...
control_label_00078192:
    ...
    } else if (fraction_start == 0) goto control_label_000781d2;
    scale = (uint32_t)((uintptr_t)fraction_start - (uintptr_t)pbVar18) * 4u;
  }
control_label_000781d2:
  pbVar12 = pbVar18;
  if ((*pbVar18 & 0xdf) == 0x50) {
    ...
    uint32_t rlo;
    rlo = hex_nibble_from_ascii(*pbVar10);
    if (((rlo - 1U) & 0xff) < 0x19) {
      byte *pp = pbVar10;
      uint32_t exponent_value = rlo - 0x10u;
      for (;;) {
        pp++;
        rlo = hex_nibble_from_ascii(*pp);
        pbVar12 = pp;
  ...
  *param_2 = (int32_t)(uintptr_t)pbVar12;
  ...
  iVar7 = 0;
control_label_00078258:
  if (7 < digit_count_minus_one) {
    iVar7 = iVar7 + 1;
    digit_count_minus_one >>= 1;
    goto control_label_00078258;
  }
  ...
  while (pbVar21 = pbVar18, pbVar19 < pbVar21) {
    if (((pbVar21[-1] != bVar2) || (pbVar18 = pbVar21 + -1 + (1 - iVar6), pbVar18 < pbVar19)) ||
      ...
      uVar9 = hex_nibble_from_ascii(pbVar21[-1]);
      uVar3 = uVar23 & 0xff;
      uVar23 = uVar23 + 4;
  ...
  *(volatile int*)(iVar7 + 0x10) = iVar17;
  ...
  if (precision < iVar8) {
    ...
    uVar22 = bignum_any_bit_set_from(iVar7, iVar8);
    if (uVar22 != 0) {
      uVar23 = iVar8 - 1;
      uVar22 = 1;
      if ((1u << (uVar23 & 0x1f) & puVar20[(int)uVar23 >> 5]) != 0) {
        if (((int)uVar23 < 2) || (iVar17 = bignum_any_bit_set_from(iVar7, iVar8 - 2), iVar17 == 0)) {
          uVar22 = 2;
        } else {
          uVar22 = 3;
        }
    ...
    bignum_shift_right_bits(iVar7, iVar8);
  } else {
    if (iVar8 < precision) {
      scale -= (uint32_t)(precision - iVar8);
      iVar7 = lshift(param_1, iVar7, precision - iVar8);
      puVar20 = (uint*)(iVar7 + 0x14);
    }
    uVar22 = 0;
  }
  iVar8 = iVar7;
  if (param_3[2] < (int32_t)scale) goto control_label_000782f2;
  if ((int32_t)scale < param_3[1]) {
    int32_t distance = param_3[1] - (int32_t)scale;
    if (precision <= distance) {
      iVar6 = param_3[3];
      if (iVar6 == 2) {
        if (param_6 != 0) goto control_label_000783e8;
      } else {
        if (iVar6 != 3) {
          if ((iVar6 != 1) || (precision != distance)) goto control_label_000783e8;
          if (precision == 1) goto control_label_000783b6;
          param_6 = bignum_any_bit_set_from(iVar7, precision - 1);
        }
        if (param_6 == 0) {
control_label_000783e8:
          Bfree(param_1, iVar7);
          *param_5 = 0;
          return (byte*)0x50;
        }
      }
control_label_000783b6:
      *param_4 = param_3[1];
    ...
    if (uVar22 == 0) {
      if (shift_index != 0) uVar22 = bignum_any_bit_set_from(iVar7, shift_index);
    } else {
      uVar22 = 1;
    }
    precision -= distance;
    ...
    bignum_shift_right_bits(iVar7, distance);
    scale = param_3[1];
  } else {
    status_base = 1;
  }
  if (uVar22 == 0) goto control_label_000784da;
  iVar17 = param_3[3];
  if (iVar17 != 2) {
    uVar23 = param_6;
...
control_label_0007846e:
    status_base |= 0x10;
    goto control_label_000784da;
  }
  param_6 = 1 - param_6;
  uVar23 = param_6;
joined_r0x0007846c:
  if (uVar23 == 0) goto control_label_0007846e;
...
control_label_000782f2:
  ...
  uVar22 = 1;
control_label_000784d6:
  status_base = uVar22 | 0x20;
control_label_000784da:
  *param_5 = iVar8;
