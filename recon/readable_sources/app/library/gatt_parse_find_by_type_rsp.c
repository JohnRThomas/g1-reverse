 ...
 *   local_5c         => struct g1_layout_gatt_find_by_type_rsp_locals__stack_1232 [stack_1232; G1-original]
 *   local_3c         => struct g1_layout_gatt_handle_range__stack_1233          [stack_1233; G1-original]
 * Raw function identity: 0x0005bbf4.  See ../include/g1_recovered_layouts.h. */
...
void gatt_parse_find_by_type_rsp(unsigned param_1, int param_2, unsigned char *param_3, int param_4, char *param_5){
  ...
  }
  {
    ...
    while((uVar3b = uVar3b & 0xffff), *param_3 <= uVar3b){
      ...
      uVar1 = *puVar10;
      if(uVar1==0 || (uVar9=puVar10[1], uVar9==0) || uVar9 < uVar1) goto control_label_bc40;
