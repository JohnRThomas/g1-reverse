 ...
 * Raw function identity: 0x0005f304.  See ../include/g1_recovered_layouts.h. */
...
int net_buf_frag_last(int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
  int iVar1;
  if (param_1 == 0) {
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f45be) /*=0xf45be*/, ((unsigned long)&rodata_f539a) /*=0xf539a*/, 0x236, param_4);
