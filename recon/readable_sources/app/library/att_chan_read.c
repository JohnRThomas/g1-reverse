 ...
 *   param_3          => struct g1_layout_net_buf__param_0280                    [param_0280; library]
 *   param_1          => struct g1_layout_bt_att_chan__param_0606                [param_0606; library]
 * Raw function identity: 0x00081e2a.  See ../include/g1_recovered_layouts.h. */
...
extern uint32_t net_buf_simple_tailroom(void *); /* FUN_00083730 */
                      ...
                      uint32_t offset, read_filter_fn filter, void *user_data)
{
    ...
    for (;;) {
        ...
        uint32_t tailroom = net_buf_simple_tailroom(fragment + 0x0c);
        ...
        if (length == 0) {
            ...
            tailroom = net_buf_simple_tailroom(fragment + 0x0c);
