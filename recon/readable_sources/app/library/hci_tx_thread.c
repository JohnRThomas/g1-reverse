...
void hci_tx_thread(void)
{
    ...
    for (;;) {
        ...
        *(volatile uint32_t *)(event_table + 12) = flags;
        ...
        uint32_t count = bt_conn_prepare_tx_events(((unsigned long)&g_20002958) /*=0x20002958*/) + 1u;
        ...
        for (uint32_t remaining = count; remaining != 0;
            ...
            if (type == 4) {
                ...
                if (state == 0) {
                    ...
                    *pending = (void *)net_buf_ref(buffer);
                    ...
                    if (error != 0) {
                        ...
                        bt_log_forward_3arg(((unsigned long)&rodata_88138) /*=0x88138*/, 0x1840u, &record);
                ...
                bt_log_forward_3arg(((unsigned long)&rodata_88138) /*=0x88138*/, 0x1880u, &record);
            }
        }
