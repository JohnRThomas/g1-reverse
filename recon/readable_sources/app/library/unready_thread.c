 ...
 * Raw function identity: 0x00073e88.  See ../include/g1_recovered_layouts.h. */
...
void unready_thread(uint8_t *thread)
{
    if ((int8_t)thread[0x0d] < 0) {
        thread[0x0d] &= 0x7f;
        dlist_unlink_node((void *)((unsigned long)&g_sched_ready_runq) /*=0x2000b464*/, thread);
    }
    update_cache(*(void **)((unsigned long)&g_current_thread_ptr) /*=0x2000b450*/ == (void *)thread);
}
