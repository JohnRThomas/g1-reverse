 ...
 *   local_30         => struct g1_layout_cbor_skip_locals__stack_1568           [stack_1568; G1-original]
 * Raw function identity: 0x00086064.  See ../include/g1_recovered_layouts.h. */
...
#define local_24 (local_30[3])
    ...
    if(param_2 != 0){ uVar5 = 0xe; goto control_label_0008606e; }
    ...
    while(1){
        ...
        if(iVar4 == 0) return 0;
        if(local_24 <= local_30[0]) goto control_label_0008610e;
        bVar1 = *local_30[0];
    }
    if((bVar1 & 0x1f) == 0x1f){
        if(uVar9 - 4 < 2){
...
control_label_00086162:
            ...
            goto control_label_000860ee;
        }
        iVar4 = cbor_decode_extract_value(local_30, &local_38, 8);
        if(iVar4 == 0) return 0;
        if(4 < uVar9) goto control_label_000860ee;
    } else {
        iVar4 = cbor_decode_extract_value(local_30, &local_38, 8);
        if(iVar4 == 0) return 0;
        if(uVar9 == 4){
            ...
            *(unsigned char*)&local_30[4] = 0;
            goto control_label_00086162;
        }
        if(4 < uVar9){
            if(uVar9 != 5) goto control_label_000860ee;
            iVar4 = 0;
            bVar8 = 0;
            goto control_label_00086146;
        }
    }
    if(uVar9 - 2 < 2){
