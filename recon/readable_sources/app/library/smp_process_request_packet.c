 ...
 *   param_1          => struct g1_layout_smp_pkt_ctx__param_0173                [param_0173; library]
 * Raw function identity: 0x000513e8.  See ../include/g1_recovered_layouts.h. */
...
extern void firmware_function_000861aa(int *a, int b, unsigned c, unsigned short d, int e);
...
uint smp_process_request_packet(int *param_1, int param_2)
{
    ...
    do {
        ...
        if (uVar11 == 0) {
control_label_000513fa:
            smp_free_buf(param_2, *param_1);
            iVar4 = 0;
            iVar9 = *param_1;
control_label_00051506:
            smp_free_buf(iVar4, iVar9);
            return uVar11;
        }
        if (uVar11 < 8) {
            uVar11 = 9;
            goto control_label_000513fa;
        }
...
control_label_000514f4:
                ...
                if ((iVar8 == 0) || (iVar8 = cbor_encode_int32(piVar6, uVar11), iVar8 == 0)) goto control_label_000514f4;
            ...
            iVar9 = *param_1;
            goto control_label_00051506;
        }
        uVar11 = local_38 & 5;
        if ((local_38 & 5) != 0) {
            uVar11 = 8;
            goto control_label_000515f8;
        }
        ...
        *piVar6 = param_2;
        firmware_function_000861aa(piVar6 + 1, 4, *(volatile unsigned *)(param_2 + 0xc),
...
control_label_000515aa:
        ...
        if (pcVar12 == (codef)0x0) goto control_label_000515aa;
        ...
        if (uVar11 != 0) goto control_label_000514b2;
        ...
        if ((pending != 0) && ((uVar3 & 0x18) == 0)) {
            ...
            if (pcVar12 == (codef)0x0) {
                ...
                if (uVar11 == 0) goto control_label_00051594;
                if (iVar4 == 0) goto control_label_000515f8;
            }
            goto control_label_000514b2;
        }
        smp_make_rsp_hdr(&local_38, &error_record,
        ...
        *(volatile short *)(*piVar6 + 0x10) = (short)piVar6[1] - (short)*(volatile int *)(*piVar6 + 0xc);
        smp_write_hdr(param_1[2]);
control_label_00051594:
        pcVar12 = *(codef *)(uintptr_t)(*param_1 + 0x2c);
        uVar11 = (*pcVar12)((void *)(uintptr_t)iVar4);
        if (uVar11 != 0) goto control_label_000515f8;
