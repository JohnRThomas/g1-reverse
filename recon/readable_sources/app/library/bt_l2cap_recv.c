 ...
 * Raw function identity: 0x00057cc4.  See ../include/g1_recovered_layouts.h. */
...
#include <stdint.h>
extern void l2cap_le_recv_pdu(int);
...
void bt_l2cap_recv(uint32_t param_1, int param_2, int param_3){
    ...
    if (*(volatile uint16_t*)(param_2+0x10) < 4){
        log_msg_3arg_thunk(((unsigned long)&rodata_88160) /*=0x88160*/, 0x1040, stackbuf);
    ...
    if (iVar1 == 0){
        log_msg_3arg_thunk(((unsigned long)&rodata_88160) /*=0x88160*/, 0x1880, stackbuf);
        net_buf_unref(param_2); return;
    }
    ...
    if (*(volatile uint8_t*)(iVar1+0xb4) != 4){
        int iVar2 = atomic_get_word(iVar1+0x10);
        if ((iVar2 << 0x1e) >= 0){
            if ((uint16_t)(*(volatile uint16_t*)(iVar1+0xb6) - 0x80) <= 0x7f){
                net_buf_put(iVar1+0x98, param_2);
                k_work_submit(iVar1+0x88); return;
            }
            l2cap_le_recv_pdu(iVar1);
            net_buf_unref(param_2); return;
        }
    }
    log_msg_3arg_thunk(((unsigned long)&rodata_88160) /*=0x88160*/, 0x1080, stackbuf);
    net_buf_unref(param_2); return;
}
