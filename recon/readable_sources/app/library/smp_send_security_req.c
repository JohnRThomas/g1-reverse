 ...
 * Raw function identity: 0x0005d964.  See ../include/g1_recovered_layouts.h. */
...
int smp_send_security_req(int param_1)
{
    ...
    if (uVar7 == 3) {
        ...
        if (iVar6 != 3) goto control_label_5da60;
        if (cac != 0) {
            uVar7 = *(volatile uint32_t*)(cac + 0xc);
            if (uVar7 == 0) goto MAIN;
            goto control_label_5da60;
        }
    } else if (uVar7 > 3) {
        ...
        if ((uint32_t)(uVar7 - 1) <= 1) goto control_label_5da60;
    }
MAIN:
    ...
    if (*(volatile uint8_t*)(param_1 + 10) <= 2) goto control_label_5da60;
    if ((*(volatile uint8_t*)(iVar3 + 0xd) & 1) == 0) return -0x16;
    if (*(volatile uint8_t*)(param_1 + 10) == 3) goto control_label_5da60;
