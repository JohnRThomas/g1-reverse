 ...
 *   local_60         => struct g1_layout_lc3_mdct_fft_workspace__stack_1375     [stack_1375; G1-original]
 * Raw function identity: 0x0006b3c8.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_0006b3c8 @ 0x0006b3c8
 * public-name: lc3_mdct_fft
...
float * lc3_mdct_fft(int param_1, uint param_2, float *param_3, float *param_4)
{
  float *pfVar1;
  float *pfVar2;
  float *pfVar3;
  ...
  if ((local_90 - 1 & local_90) == 0) {
    ...
    param_3 = param_4;
    uVar26 = 0;
    piVar22 = (int *)((unsigned long)&g_20002cf4) /*=0x20002cf4*/;
    while( 1 ) {
      param_4 = pfVar12;
      local_78 = uVar26 ^ 1;
      iVar20 = *(int *)*piVar22;
  ...
  iVar20 = 0;
  iVar19 = ((unsigned long)&g_20002cb8) /*=0x20002cb8*/ + local_7c * 4;
  while( 1 ) {
    pfVar12 = param_3;
