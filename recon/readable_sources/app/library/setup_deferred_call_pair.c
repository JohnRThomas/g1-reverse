 ...
 *   param_1          => struct g1_layout_deferred_call_pair_ctx__param_0436     [param_0436; G1-original]
 *   param_2          => struct g1_layout_deferred_call_pair__param_0437         [param_0437; G1-original]
 * Raw function identity: 0x00079780.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_00079780 @ 0x00079780
 * public-name: setup_deferred_call_pair
 * durable-map: recon/catalogs/function_names_app.json
 * callees (readable <= raw @ address):
 *   setup_deferred_call_pair                 <= FUN_00079780 @ 0x00079780
...
void setup_deferred_call_pair(uint32_t *param_1, uint32_t *param_2){
  volatile uint32_t *puVar1 = (volatile uint32_t*)((unsigned long)&g_misc_deferred_call_desc) /*=0x20002f0c*/;
  ...
  volatile uint32_t *puVar2=(volatile uint32_t*)((unsigned long)&g_misc_deferred_req_params) /*=0x20002ef8*/;
  puVar2[0]=param_2[0];
