...
int net_buf_simple_add(int *param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
    ...
    if (uVar2 < param_2) {
        printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f54a8) /*=0xf54a8*/, ((unsigned long)&rodata_f543a) /*=0xf543a*/, 0x3e);
        assert_post_action(((unsigned long)&rodata_f543a) /*=0xf543a*/, 0x3e);
    }
