 ...
 *   param_1          => struct g1_layout_nrfx_spim_t__param_0342                [param_0342; library]
 *   param_2          => struct g1_layout_nrfx_spim_config__param_0343           [param_0343; library]
 * Raw function identity: 0x00066ec0.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_00066ec0 @ 0x00066ec0
 * public-name: nrfx_spim_configure
...
void nrfx_spim_configure(int *param_1, uint32_t *param_2)
{
  ...
  int iVar7 = ((unsigned long)&g_nrfx_spim_cb) /*=0x2000b384*/;
  uint32_t uVar9 = *(volatile uint32_t*)(p2 + 0x14);
  uint32_t uVar14 = *(volatile uint8_t*)(p1 + 4);
  uint32_t uVar13;

  if (uVar9 == 0x001e8480UL) { uVar13 = ((unsigned long)&g_sram_base_word) /*=0x20000000*/; }
    ...
    if (uVar9 == 0x0007a120UL) { uVar13 = 0x08000000UL; }
      ...
      if (uVar9 != ((unsigned long)&rodata_f4240) /*=0xf4240*/) goto FAIL;
      uVar13 = 0x10000000UL;
    }
  }
