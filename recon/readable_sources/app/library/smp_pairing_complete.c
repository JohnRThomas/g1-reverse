 ...
 * Raw function identity: 0x0005daf0.  See ../include/g1_recovered_layouts.h. */
    ...
    if (*(char *)(iVar7 + 0xd) == '\a') {
        if (param_2 == 0) {
            ...
            if (puVar6 != (uint32_t *)0x0) {
                ...
                if (pcVar5 == 0) goto control_label_0005dba4;
                do {
                    (*pcVar5)(iVar7, iVar8);
control_label_0005dba4:
                    if (puVar9 == (uint32_t *)0x0) break;
                    do {
                        pcVar5 = (void (*)(int,int))*puVar9;
                        if (puVar9[3] == 0) {
                            puVar9 = (uint32_t *)0x0;
                            if (pcVar5 == 0) goto control_label_0005dbba;
                            break;
                        }
            ...
            goto control_label_0005dbba;
        }
        uVar3 = param_2 - 1U & 0xff;
        if (uVar3 < 0xf) goto control_label_0005db1a;
        uVar3 = 9;
    } else {
        local_1c = ((unsigned long)&rodata_f4f89) /*=0xf4f89*/;
        local_20 = 2;
        smp_log_message(((unsigned long)&rodata_88180) /*=0x88180*/, 0x1080, &local_20);
        uVar3 = 7;
control_label_0005db1a:
    ...
    if ((iVar8 != 0) && (piVar4 = (int *)*(void * volatile *)((unsigned long)&g_bt_conn_auth_info_cb_list) /*=0x2000ad20*/, piVar4 != (int *)0x0)) {
        ...
        if (pcVar5 != 0) goto control_label_0005dbf8;
        while (iVar8 != 0) {
            do {
...
control_label_0005dbf8:
            (*pcVar5)(iVar7, uVar3);
        }
    }
control_label_0005dbba:
