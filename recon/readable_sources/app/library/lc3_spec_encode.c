 ...
 *   param_7          => struct g1_layout_lc3_spec_encode_ctx__param_0389        [param_0389; library]
 * Raw function identity: 0x0006f9c0.  See ../include/g1_recovered_layouts.h. */
#include "g1_app_symbols.h"
/* readable reconstruction; identity: FUN_0006f9c0 @ 0x0006f9c0
 * public-name: lc3_spec_encode
...
#define lc3_spec_encode       lc3_spec_encode
#define lc3_get_bits_left     lc3_get_bits_left
#define lc3_put_bits_generic  lc3_put_bits_generic
#define lc3_ac_write_renorm   lc3_ac_write_renorm
...
#define SPECTRUM_LOOKUP \
    ((const uint8_t (*)[2][256][4])((unsigned long)&lc3_spectrum_lookup) /*=0x8ed50*/)
             ...
             unsigned symbol)
{
    ...
    if (coder->range < ((unsigned long)&rodata_10000) /*=0x10000*/)
