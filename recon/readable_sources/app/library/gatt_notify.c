 ...
 *   param_3          => struct g1_layout_bt_gatt_notify_params__param_0259      [param_0259; library]
 * Raw function identity: 0x0005b680.  See ../include/g1_recovered_layouts.h. */
                        ...
                        if(iVar1 == 0){
                            ...
                            if(piVar5 != 0){
                                ...
                                while(iVar2 = process_queue((int)piVar5, iVar1+0xc), piVar5 = piVar6, iVar2 != 0){
                                    while(1){
                                        if(piVar5 == 0) goto control_label_00059a5a;
