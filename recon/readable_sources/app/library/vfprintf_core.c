 ...
 *   param_2          => struct g1_layout_fmt_conv_spec__param_0430              [param_0430; G1-original]
 * Raw function identity: 0x00078f88.  See ../include/g1_recovered_layouts.h. */
...
control_label_00078fae:
  ...
  if (uVar5 < 0x79) {
    if (0x57 < uVar5) {
      ...
      pbVar6 = param_3;
      if (uVar5 == 0x25) goto control_label_00078ff8;
      if (uVar5 < 0x26) {
        if (uVar5 != 0) { state.kind = 3; state.base = 10; goto control_label_00079156; }
        goto control_label_00079140;
      }
      if (uVar5 - 0x45 < 3) { state.kind = 5; goto control_label_00079156; }
      state.kind = 3; state.base = 10;
    }
  } else {
    state.kind = 3; state.base = 10;
...
control_label_00079156:
  ...
  if (-1 < (int)(state.flags << 0x19)) {
    while ((int)((uint)(*(volatile byte*)(iVar1 + (uint)*(byte*)*param_2)) << 0x1c) < 0) {
      ...
      if (iVar2 - 1 < 1) {
        ...
        if (iVar2 != 0) goto control_label_00079138;
      } else {
        *param_2 = *param_2 + 1;
      }
    }
  ...
  if (state.kind < 3) {
    ...
    iVar2 = param_1;
    if (*(volatile unsigned*)((unsigned long)&rodata_79274) /*=0x79274*/ == 0) goto control_label_00078fae;
  }
  if (iVar2 == 1) return state.assignments;
  if (iVar2 == 2) {
  control_label_00079138:
    if ((state.assignments == 0) || ((int)((uint)*(unsigned short*)(param_2 + 3) << 0x19) < 0)) {
    control_label_00079140:
      state.assignments = -1;
    }
