...
{
    if (lock == 0u) {
        printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f23d4) /*=0xf23d4*/, ((unsigned long)&rodata_f22d5) /*=0xf22d5*/, 0x1a6u);
        assert_post_action(((unsigned long)&rodata_f22d5) /*=0xf22d5*/, 0x1a6u);
    }
