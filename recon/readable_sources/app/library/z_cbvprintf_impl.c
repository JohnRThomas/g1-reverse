 ...
 *   local_60         => struct g1_layout_cbvprintf_ptr_counter__stack_0784      [stack_0784; G1-original]
 *   local_44         => struct g1_layout_cbvprintf_scratch__stack_0785          [stack_0785; library]
 * Raw function identity: 0x000113a8.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_000113a8 @ 0x000113a8
 * public-name: z_cbvprintf_impl
...
#define extract_decimal extract_decimal
#define encode_uint     encode_uint
#define _ldiv5          _ldiv5
#define _get_digit      _get_digit
#define outs            outs
