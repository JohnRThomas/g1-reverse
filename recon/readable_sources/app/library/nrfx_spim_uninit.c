 ...
 *   param_1          => struct g1_layout_nrfx_spim_t__param_0344                [param_0344; library]
 * Raw function identity: 0x00067248.  See ../include/g1_recovered_layouts.h. */
...
void nrfx_spim_uninit(int *param_1, uint32_t param_2, uint32_t param_3, uint32_t param_4){
  ...
  if (*(volatile int*)(((unsigned long)&g_nrfx_spim_cb) /*=0x2000b384*/ + uVar3*0x24) != 0){
    *(volatile uint32_t*)(*param_1 + 0x308) = 0x80152;
    cleanup_arg3 = 0x80152;
    spim_abort(*param_1, ((unsigned long)&g_nrfx_spim_cb) /*=0x2000b384*/ + uVar3*0x24);
  }
  int iVar4 = uVar3*0x24 + ((unsigned long)&g_nrfx_spim_cb) /*=0x2000b384*/;
  int iVar2 = *param_1;
  ...
  *(volatile uint8_t*)(uVar3*0x24 + ((unsigned long)&g_nrfx_spim_cb) /*=0x2000b384*/ + 0x1c) = 0;
}
