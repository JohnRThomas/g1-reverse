 ...
 *   param_1          => struct g1_layout_arm_mpu_region__param_0170             [param_0170; library]
 *   local_38         => struct g1_layout_arm_mpu_configure_locals__stack_1112   [stack_1112; G1-original]
 * Raw function identity: 0x00050c54.  See ../include/g1_recovered_layouts.h. */
...
NEXT:
    ...
    goto LOOP;
SANITY_ERROR:
    diagnostic.message = ((unsigned long)&rodata_f2158) /*=0xf2158*/;
    diagnostic.value = uVar6;
    goto DO_LOG;
REGION_ERROR:
    diagnostic.message = ((unsigned long)&rodata_f217b) /*=0xf217b*/;
