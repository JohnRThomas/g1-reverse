...
void net_buf_simple_pull_5f594(int *param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
    ...
    if (ushort_val < param_2) {
        printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f5474) /*=0xf5474*/, ((unsigned long)&rodata_f543a) /*=0xf543a*/, 0x199U, param_4);
        unsigned long long rv = assert_post_action(((unsigned long)&rodata_f543a) /*=0xf543a*/, 0x199U);
