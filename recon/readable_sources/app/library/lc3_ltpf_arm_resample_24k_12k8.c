 ...
 * public-name: lc3_ltpf_arm_resample_24k_12k8
 * durable-map: recon/catalogs/function_names_app.json
 * callees (readable <= raw @ address):
 *   lc3_ltpf_arm_resample_24k_12k8           <= FUN_0006a700 @ 0x0006a700
 */
...
void lc3_ltpf_arm_resample_24k_12k8(long long *param_1, int param_2, short *param_3, int param_4){
