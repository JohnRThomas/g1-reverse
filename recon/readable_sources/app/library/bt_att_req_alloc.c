...
int bt_att_req_alloc(int param_1, int param_2, int param_3)
{
  ...
  uVar2 = param_1;
  iVar1 = k_current_get();
  if (*(volatile int*)((unsigned long)&att_handle_rsp_thread) /*=0x2000ae9c*/ == iVar1) {
    param_2 = 0;
    param_1 = param_2;
  }
  iVar1 = k_mem_slab_alloc(((unsigned long)&req_slab) /*=0x20003798*/, &local_14, param_1, param_2, uVar2);
  if (iVar1 == 0) {
