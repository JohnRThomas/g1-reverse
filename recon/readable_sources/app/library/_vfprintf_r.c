 ...
 * Raw function identity: 0x00076ed4.  See ../include/g1_recovered_layouts.h. */
...
int _vfprintf_r(int param_1, int param_2, unsigned char *param_3, uint *param_4)
{
    ...
    pbVar7 = param_3;
    local_8c = param_4;
control_label_00076f6a:
    pbVar6 = pbVar7;
    if (*pbVar6 != 0) goto code_r0x00076f72;
    goto control_label_00076f76;
code_r0x00076f72:
    pbVar7 = pbVar6 + 1;
    if (*pbVar6 != 0x25) goto control_label_00076f6a;
control_label_00076f76:
    iVar8 = (int)pbVar6 - (int)param_3;
    if (iVar8 != 0) {
        iVar2 = libc_write_buffer_via_putc(param_1, param_2, param_3, iVar8);
        if (iVar2 == -1) {
control_label_000770da:
            if ((-1 < *(volatile int *)(param_2 + 100) << 0x1f) &&
                (-1 < (int)((uint)*(volatile unsigned short *)(param_2 + 0xc) << 0x16))) {
                g1_recon_retarget_lock_release_recursive(*(volatile unsigned *)(param_2 + 0x58));
            }
    ...
    if (*pbVar6 == 0) goto control_label_000770da;
    local_88 = 0;
    local_7c = 0;
    local_45 = 0;
    local_30 = 0;
