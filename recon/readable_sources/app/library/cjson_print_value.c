 ...
 *   param_2          => struct g1_layout_cjson_printbuffer__param_0321          [param_0321; library]
 *   param_1          => struct g1_layout_cjson_printbuffer__param_0323          [param_0323; library]
 *   local_40         => struct g1_layout_cjson_print_value_locals__stack_1292   [stack_1292; G1-original]
 * Raw function identity: 0x000646c0.  See ../include/g1_recovered_layouts.h. */
...
#define firmware_data_0006498c ((unsigned long)&rodata_f6977) /*=0xf6977*/
      ...
      if (puVar5 != (undefined1 *)0x0) {
        ...
        *(int *)(param_2 + 8) = *(int *)(param_2 + 8) + iVar6;
        ...
        if (puVar5 != (undefined1 *)0x0) {
          ...
          *puVar8 = 0x7d;
          puVar8[1] = 0;
control_label_000648d0:
          *(int *)(param_2 + 0xc) = *(int *)(param_2 + 0xc) + -1;
          goto control_label_00064728;
        }
      }
    }
    else if (uVar9 == 0x80) {
  ...
  switch(uVar9) {
  case 1:
    local_44 = *firmware_data_00064990;
    local_40[0] = *(undefined2 *)(firmware_data_00064990 + 1);
...
switchD_000646e2_caseD_3:
    ...
    break;
  case 2:
    puVar7 = firmware_data_00064994;
    goto control_label_00064706;
  case 4:
    puVar7 = firmware_data_0006498c;
control_label_00064706:
    local_44 = *puVar7;
...
control_label_00064728:
  ...
  case 8:
    ...
    if (iVar6 == 0) {
      ...
      iVar6 = double_is_unordered(uVar12,uVar14,0xffffffff,firmware_data_00064998);
      if ((iVar6 == 0) && (iVar6 = __aeabi_dcmple(uVar12,uVar14,0xffffffff,firmware_data_00064998), iVar6 == 0))
      goto control_label_000647a8;
      uVar13 = uVar12;
      uVar17 = uVar9;
      iVar6 = snprintf(&local_44,0x1a,firmware_data_0006499c);
      iVar4 = vsnprintf_setup(&local_44,firmware_data_000649a0,&local_50);
      uVar3 = uStack_4c;
      uVar2 = local_50;
      if (iVar4 == 1) {
        ...
        uVar16 = __muldf3(uVar13,uVar14,0,firmware_data_000649a4);
        iVar4 = __aeabi_dcmple((int)uVar15,(uint)((ulonglong)uVar15 >> 0x20) & 0x7fffffff,(int)uVar16,
                             (int)((ulonglong)uVar16 >> 0x20));
        if (iVar4 == 0) goto control_label_00064840;
      }
      else {
control_label_00064840:
        iVar6 = snprintf(&local_44,0x1a,firmware_data_000649a8);
      }
      if (0x19 < iVar6) goto switchD_000646e2_caseD_3;
    }
    else {
control_label_000647a8:
      strcpy(&local_44,firmware_data_0006498c);
      iVar6 = 4;
    }
    puVar5 = (undefined1 *)growbuf_ensure_capacity(param_2,iVar6 + 1);
    if (puVar5 == (undefined1 *)0x0) goto switchD_000646e2_caseD_3;
