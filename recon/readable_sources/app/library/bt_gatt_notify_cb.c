 ...
 *   local_28         => struct g1_layout_gatt_notify_cb_locals__stack_1226      [stack_1226; library]
 * Raw function identity: 0x0005b754.  See ../include/g1_recovered_layouts.h. */
...
int bt_gatt_notify_cb(int param_1, int *param_2)
{
  ...
  if (param_2 == 0) {
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f4b3d) /*=0xf4b3d*/, ((unsigned long)&rodata_f46b8) /*=0xf46b8*/, 0xae3);
...
LAB:
    ...
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f4b44) /*=0xf4b44*/, ((unsigned long)&rodata_f46b8) /*=0xf46b8*/, 0xae4);
    printk(((unsigned long)&rodata_f4a0a) /*=0xf4a0a*/);
    uVar2 = 0xae4;
    assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/, uVar2);
    param_2 = (int *)0xae4;
