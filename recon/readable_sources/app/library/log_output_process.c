                  ...
                  unsigned char param_6,int param_7,unsigned char *param_8,uint param_9,uint param_10)
{
  ...
  if (uVar8 == 0) {
    uVar6 = 0x0007eee9;
    if (param_4 == 1) uVar6 = ((unsigned long)&rodata_4daad) /*=0x4daad*/;
    if (param_7 == 0) {
      if (param_9 != 0) {
        iVar2 = 0;
        uVar6 = ((unsigned long)&rodata_a7993) /*=0xa7993*/;
        uVar1 = ((unsigned long)&rodata_f7b6f) /*=0xf7b6f*/;
        goto control_label_dcaa;
      }
      goto control_label_dd7a;
    }
    iVar2 = 0;
control_label_dc74:
    iVar3 = cbpprintf_external(uVar6,ADDR_cbvprintf_wrapper_THUMB /*=0x7eec1*/,param_1,param_7);
    if (iVar3 < 0) {
      printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"err >= 0") /*=0xf0f1b*/,((unsigned long)&rodata_f0e73) /*=0xf0e73*/,0x219);
      uVar6 = 0x219;
control_label_db3e:
      assert_post_action(((unsigned long)&rodata_f0e73) /*=0xf0e73*/,uVar6);
    }
    uVar6 = ((unsigned long)&rodata_a7993) /*=0xa7993*/;
    uVar1 = ((unsigned long)&rodata_f7b6f) /*=0xf7b6f*/;
    if (param_9 != 0) {
control_label_dcaa:
      ...
      do {
        ...
        else print_formatted(param_1,((unsigned long)&rodata_f7b6d) /*=0xf7b6d*/);
        uVar9 = uVar9 + 1;
      } while (uVar9 != 0x10);
      uVar9 = 0;
      print_formatted(param_1,((unsigned long)&rodata_f0f24) /*=0xf0f24*/);
      do {
        uVar7 = (uint)(unsigned char)local_38[uVar9];
        if ((U8(((unsigned long)&rodata_f8a6b) /*=0xf8a6b*/ + uVar7) & 0x97) == 0) uVar7 = 0x2e;
        print_formatted(param_1,((unsigned long)&rodata_f0f26) /*=0xf0f26*/,uVar7);
        while (1) {
          uVar9 = uVar9 + 1;
          if (uVar9 == 0x10) {
            local_38 = local_38 + uVar4;
            local_3c = local_3c - uVar4;
            if (local_3c != 0) goto control_label_dcaa;
            goto control_label_dd74;
          }
          if ((uVar9 & 7) == 0) print_formatted(param_1,uVar1);
...
control_label_dd74:
    if (uVar8 == 0) goto control_label_dd7a;
  } else {
    if (4 < uVar8) {
      printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"level <= 4U") /*=0xf0ed7*/,((unsigned long)&rodata_f0e73) /*=0xf0e73*/,0x1bf);
      uVar6 = 0x1bf;
      goto control_label_db3e;
    }
    ...
    if ((param_10 & 2) != 0) {
      if ((param_10 & 0x44) == 0) {
        uVar4 = print_formatted(param_1,((unsigned long)&rodata_f0ee7) /*=0xf0ee7*/,param_2);
      } else {
        uVar4 = U32(((unsigned long)&g_2000a0e4) /*=0x2000a0e4*/);
        if (uVar4 != 0) {
          uVar9 = (param_2 / U32(((unsigned long)&g_2000a0e0) /*=0x2000a0e0*/)) / uVar4;
          uVar7 = (param_2 / U32(((unsigned long)&g_2000a0e0) /*=0x2000a0e0*/) - uVar4 * uVar9) * 1000;
          uVar10 = uVar7 / uVar4;
          uVar4 = print_formatted(param_1,((unsigned long)&rodata_f0ef0) /*=0xf0ef0*/,uVar9/0xe10,(uVar9%0xe10)/0x3c,
    ...
    if ((param_10 & 1) != 0) {
      iVar2 = U32(((unsigned long)&rodata_8acc4) /*=0x8acc4*/ + uVar8*4);
      if (iVar2 == 0) iVar2 = ((unsigned long)&rodata_f0ed2) /*=0xf0ed2*/;
      print_formatted(param_1,((unsigned long)&rodata_a8c37) /*=0xa8c37*/,iVar2);
    }
    if ((param_10 & 8) == 0) iVar2 = 0;
    else iVar2 = print_formatted(param_1,((unsigned long)&rodata_f0f0c) /*=0xf0f0c*/,U32(((unsigned long)&rodata_8acd8) /*=0x8acd8*/ + uVar8*4));
    if (param_3 != 0) {
      iVar5 = print_formatted(param_1,((unsigned long)&rodata_f0f12) /*=0xf0f12*/,param_3);
      iVar2 = iVar2 + iVar5;
    }
    if (param_4 != 0) {
      iVar5 = print_formatted(param_1,((unsigned long)&rodata_f0f16) /*=0xf0f16*/,param_4);
      iVar2 = iVar2 + iVar5;
    }
    iVar2 = iVar2 + iVar3;
    uVar6 = ((unsigned long)&rodata_4daad) /*=0x4daad*/;
    if (param_7 != 0) goto control_label_dc74;
    uVar6 = ((unsigned long)&rodata_a7993) /*=0xa7993*/;
    uVar1 = ((unsigned long)&rodata_f7b6f) /*=0xf7b6f*/;
    if (param_9 != 0) goto control_label_dcaa;
  }
  if ((int)(param_10 << 0x1f) < 0) {
    print_formatted(param_1,((unsigned long)&rodata_a8c37) /*=0xa8c37*/,((unsigned long)&rodata_f0ed2) /*=0xf0ed2*/);
  }
  newline_print(param_1,param_10);
control_label_dd7a:
