...
extern unsigned long long img_mgmt_flash_area_id(void);
...
extern void z_log_msg_static_create_img_mgmt(unsigned a, unsigned b, void*c);
int img_mgmt_read(unsigned param_1, unsigned param_2, unsigned param_3, unsigned param_4){
    unsigned local_1c; unsigned s[4]; int iVar1;
    unsigned long long uVar2 = img_mgmt_flash_area_id();
    ...
    if ((int)uStack_28 < 0){ iVar1 = 0xe; }
        ...
        if (local_24 == 0){
            ...
            if (iVar1 != 0){
                ...
                z_log_msg_static_create_img_mgmt(((unsigned long)&rodata_88208) /*=0x88208*/, 0x1840, s);
                iVar1 = 0xb;
            }
        } else {
            s[1] = ((unsigned long)&rodata_f25fb) /*=0xf25fb*/; s[0] = 4;
            z_log_msg_static_create_img_mgmt(((unsigned long)&rodata_88208) /*=0x88208*/, 0x2040, s);
            iVar1 = 10;
        }
    }
    return iVar1;
