 ...
 *   local_38         => struct g1_layout_smp_pairing_req_local__stack_1249      [stack_1249; library]
 * Raw function identity: 0x0005d5c0.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_0005d5c0 @ 0x0005d5c0
 * public-name: smp_pairing_req
 ...
 *   smp_pairing_req                          <= FUN_0005d5c0 @ 0x0005d5c0
...
extern int bt_conn_security_sufficient(int,int);
extern int smp_log_message(uint32_t,uint32_t,void*);
extern int atomic_set_bit(int,int);
extern uint32_t send_pairing_rsp(void);

uint smp_pairing_req(int param_1, int param_2)
{
  int iVar12 = *(volatile int*)(param_1 + 0xf0);
  int iVar3 = conn_auth_cb_get_or_init();
  ...
  *(volatile uint8_t*)(param_1 + 0x10) = 2;
  uint8_t uVar2 = smp_build_auth_flags(param_1, pbVar13[2]);
  ...
  *(volatile uint8_t*)(param_1 + 8) = bVar8;
  ...
  iVar4 = bt_conn_security_sufficient(param_1, *(volatile int*)(iVar12 + 0xc0));
  if (iVar4 == 0) return 3;
...
control_label_d80e:
  ...
  iVar3 = conn_auth_cb_get_or_init();
  int iVar4b = *(volatile int*)(param_1 + 0xf0);
  int *piVar7 = (int*)(intptr_t)conn_auth_cb_get_or_init();
  ...
  switch (uStack_40) {
    ...
    default: {
      ...
      smp_log_message(((unsigned long)&rodata_88180) /*=0x88180*/, 0x1840, &s);
      return 8;
    }
  }
