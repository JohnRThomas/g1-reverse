 ...
 *   0x00066254       => struct g1_layout_nrfx_pdm_drv_state__global_1326        [global_1326; library]
 * Raw function identity: 0x00066214.  See ../include/g1_recovered_layouts.h. */
...
{
    unsigned int iVar1 = ((unsigned long)&g_pdm_cb) /*=0x2000b330*/;
    unsigned int uVar2;

    if (*(volatile unsigned char*)(((unsigned long)&g_pdm_cb) /*=0x2000b330*/ + 0x10) != 0) {
        if (*(volatile unsigned char*)(((unsigned long)&g_pdm_cb) /*=0x2000b330*/ + 0x11) == 0) {
            *(volatile unsigned char*)(((unsigned long)&g_pdm_cb) /*=0x2000b330*/ + 0x11) = 2;
            *(volatile unsigned char*)(iVar1 + 0x14) = 1;
            *(volatile unsigned int*)(0xe000e100UL + 0x104) = 0x40;
            uVar2 = 0x0bad0000UL;
        } else {
            if (*(volatile unsigned char*)(((unsigned long)&g_pdm_cb) /*=0x2000b330*/ + 0x11) != 1) {
                uVar2 = 0x0bad000bUL;
            } else {
                uVar2 = 0x0bad0000UL;
            }
