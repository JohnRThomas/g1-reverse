...
void bt_smp_distribute_keys(int *param_1, int param_2)
{
    ...
    if ((int)(uVar2 << 0x1f) < 0) {
        uVar5 = 6;
control_label_0005e264:
        atomic_set_bit((int)piVar9, uVar5);
    } else {
        if ((int)(uVar2 << 0x1e) < 0) {
            uVar5 = 8;
            goto control_label_0005e264;
        }
        if ((int)(uVar2 << 0x1d) < 0) {
            uVar5 = 10;
            goto control_label_0005e264;
    ...
    if (*(volatile int *)(*param_1 + 0xc0) == 0) {
        ...
        local_64 = 0x200;
        local_70 = 0x01000003;
        smp_log_message(((unsigned long)&rodata_88180) /*=0x88180*/, 0x1c40, &local_70);
        return;
    }
        ...
        if ((iVar1 == 0) && (iVar1 = smp_create_pdu(piVar9, 6), uVar5 = ((unsigned long)&rodata_f519d) /*=0xf519d*/, iVar1 != 0)) {
            ...
            if (iVar1 != 0) {
                ...
                *puVar4 = local_2c;
                ...
                goto control_label_0005e2f2;
            }
        }
        local_50 = 2;
        local_4c = uVar5;
        smp_log_message(((unsigned long)&rodata_88180) /*=0x88180*/, 0x1040, &local_50);
    }
control_label_0005e2f2:
    if ((short)param_1[-2] != 0) return;
    uVar8 = 0;
control_label_0005e1fa:
