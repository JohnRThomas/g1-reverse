 ...
 * Raw function identity: 0x0006efdc.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_0006efdc @ 0x0006efdc
 * public-name: lc3_sns_put_data
...
void lc3_sns_put_data(int param_1,int *param_2,int param_3,int param_4){
  ...
  if ((int)uVar4 < 0x21) {
    ...
    uVar5 = uVar5 + 10;
    iVar2 = p2[1];
    if ((int)uVar5 < 0x21) goto control_label_effe;
control_label_f0f2:
    lc3_put_bits_generic(param_1,iVar2,5);
    uVar5 = VI(param_1+0x20);
    uVar4 = uVar5 + 1;
    iVar2 = p2[2] >> 1;
    if (0x20 < (int)uVar4) goto control_label_f108;
control_label_f014:
    VI(param_1+0x20) = uVar4;
    VI(param_1+0x1c) = VI(param_1+0x1c) | (iVar2 << (uVar5 & 0xff));
  } else {
    ...
    iVar2 = p2[1];
    uVar5 = uVar4 + 5;
    if (0x20 < (int)uVar5) goto control_label_f0f2;
control_label_effe:
    VI(param_1+0x20) = uVar5;
    VI(param_1+0x1c) = VI(param_1+0x1c) | (iVar2 << (uVar4 & 0xff));
    uVar4 = uVar5 + 1;
    iVar2 = p2[2] >> 1;
    if ((int)uVar4 < 0x21) goto control_label_f014;
control_label_f108:
  ...
  if (iVar2 == 0) {
    ...
    goto control_label_f0ac;
  }
  if (uVar5 == 0) {
    if ((int)(uVar4+2) < 0x21) goto control_label_f086;
control_label_f116:
    ...
    if (0x20 < (int)(uVar4+2)) goto control_label_f116;
control_label_f086:
    uVar5 = uVar4 + 2;
    VI(param_1+0x20) = uVar5;
    uVar6 = uVar4 + 3;
