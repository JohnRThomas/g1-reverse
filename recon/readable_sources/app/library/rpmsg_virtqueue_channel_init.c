 ...
 *   param_2          => struct g1_layout_rpmsg_vqueue_channel_cfg__param_0399   [param_0399; G1-original]
 *   param_6          => struct g1_layout_rpmsg_vq_alloc_info__param_0400        [param_0400; G1-original]
 *   param_5          => struct g1_layout_rpmsg_virtio_shm_pool__param_0401      [param_0401; library]
 *   param_4          => struct g1_layout_metal_io_region__param_0402            [param_0402; library]
 * Raw function identity: 0x00071358.  See ../include/g1_recovered_layouts.h. */
    ...
    *(int**)(*(int*)(*(int*)(param_2 + 0x2c) + 0x18) + 0x28) = param_4;
    if (iVar4 == 0) {
        ...
        *(int*)(param_1 + 4) = param_1;
        if (*(char*)(param_1 + 0x90) == 0) goto control_label_00071498;
    } else {
        *(int*)param_1 = param_1;
        *(int*)(param_1 + 4) = param_1;
