...
unsigned gpio_nrfx_pin_configure(int param_1, unsigned param_2, unsigned param_3, unsigned param_4)
{
    ...
    if((param_3 & ((unsigned long)&rodata_30000) /*=0x30000*/) == 0){
        gpiote_in_uninit(uVar8);
        if(iVar2 == 0x0bad0000){
            iVar9 = gpiote_lock_release((unsigned char)(record.param2>>24));
            if(iVar9 != iVar2){
                printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f0ac7) /*=0xf0ac7*/, ((unsigned long)&rodata_f5e79) /*=0xf5e79*/, 0x6c);
                uVar4 = 0x6c;
control_label_00061674:
                assert_post_action(((unsigned long)&rodata_f5e79) /*=0xf5e79*/, uVar4);
            }
        }
control_label_00061734:
        uVar4 = 0;
    } else {
        record.param3 = 0; record.param4 = 0;
        iVar3 = gpiote_in_init(uVar8, 0, &record.param3);
        if(iVar3 != 0x0bad0000) goto control_label_000616ce;
        if(iVar2 == iVar3){
            iVar3 = gpiote_lock_release((unsigned char)(record.param2>>24));
            if(iVar3 != iVar2){
                printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f0ac7) /*=0xf0ac7*/, ((unsigned long)&rodata_f5e79) /*=0xf5e79*/, 0x7f);
                uVar4 = 0x7f;
                goto control_label_00061674;
            }
        }
        uVar1 = record.param3;
...
control_label_000616f8:
                ...
                *((unsigned char*)&record.param3 + 1) = (unsigned char)(((param_3 ^ ((unsigned long)&rodata_10000) /*=0x10000*/) << 0xf) >> 0x1f);
                *((unsigned char*)&record.param3 + 2) = (unsigned char)uVar6;
                ...
                goto control_label_0006172e;
            }
            if(0x106 < uVar5){
                if(uVar5 == 0x202){ uVar5 = 5; }
                else if(uVar5 == 0x300){ uVar5 = 3; }
                else { if(uVar5 != 0x200) goto control_label_000616ce; uVar5 = 2; }
                goto control_label_000616f8;
            }
            if(uVar5 == 6) goto control_label_000616f8;
            if(uVar5 < 7){
                if(uVar5 != 0){ if(uVar5 != 2) goto control_label_000616ce; uVar5 = 4; }
                goto control_label_000616f8;
            }
            if(uVar5 == 0x100){ uVar5 = 1; goto control_label_000616f8; }
        } else {
...
control_label_0006172e:
            if(iVar2 == 0x0bad0000) goto control_label_00061734;
        }
control_label_000616ce:
        uVar4 = 0xffffffea;
    }
    return uVar4;
}
