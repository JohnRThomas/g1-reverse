...
unsigned gpio_nrfx_pin_configure(int param_1, unsigned param_2, unsigned param_3, unsigned param_4)
{
    ...
    if((param_3 & ((unsigned long)&rodata_30000) /*=0x30000*/) == 0){
        ...
        if(iVar2 == 0x0bad0000){
            ...
            if(iVar9 != iVar2){
                printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"err == NRFX_SUCCESS") /*=0xf0ac7*/, ((unsigned long)&rodata_f5e79) /*=0xf5e79*/, 0x6c);
                uVar4 = 0x6c;
...
control_label_00061734:
        ...
        if(iVar2 == iVar3){
            ...
            if(iVar3 != iVar2){
                printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"err == NRFX_SUCCESS") /*=0xf0ac7*/, ((unsigned long)&rodata_f5e79) /*=0xf5e79*/, 0x7f);
                uVar4 = 0x7f;
