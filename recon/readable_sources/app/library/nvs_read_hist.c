 ...
 * Raw function identity: 0x0004cab4.  See ../include/g1_recovered_layouts.h. */
...
extern uint firmware_function_0007e53e(int,uint,unsigned,uint);
extern int nvs_log_err(int,int,void*);
extern int nvs_al_size(unsigned,int);
extern int firmware_function_0007e672(int,void*);
extern uint firmware_function_0007e6e2(int,void*,void*);
  ...
  if (*(volatile char*)(param_1 + 0x10) == 0) {
    ...
    if ((uint)*(volatile unsigned short*)(param_1 + 0xc) + iVar2 * -2 < param_4) {
      ...
      do {
        ...
        uVar1 = firmware_function_0007e6e2(param_1, &frame.cursor, &frame.item[0]);
        if (uVar1 != 0) return uVar1;
        if ((frame.item[0] == param_2) &&
            (iVar2 = firmware_function_0007e672(param_1, &frame.item[0]), iVar2 != 0)) {
          uVar4 = uVar4 + 1;
        }
        uVar1 = uVar3;
...
LAB:
        ...
        if ((uVar1 != 0) && (param_5 <= uVar4)) {
          ...
          uVar1 = firmware_function_0007e53e(param_1,
