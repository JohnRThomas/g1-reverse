 ...
 * Raw function identity: 0x000735cc.  See ../include/g1_recovered_layouts.h. */
...
{
    if (!obj) { printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f82df) /*=0xf82df*/,((unsigned long)&rodata_f820f) /*=0xf820f*/,0x411); assert_post_action(((unsigned long)&rodata_f820f) /*=0xf820f*/,0x411); }
    if (!request) { printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f8291) /*=0xf8291*/,((unsigned long)&rodata_f820f) /*=0xf820f*/,0x412); assert_post_action(((unsigned long)&rodata_f820f) /*=0xf820f*/,0x412); }
    if (k_is_in_isr()) { printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f3d75) /*=0xf3d75*/,((unsigned long)&rodata_f820f) /*=0xf820f*/,0x413); assert_post_action(((unsigned long)&rodata_f820f) /*=0xf820f*/,0x413); }
