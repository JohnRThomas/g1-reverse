 ...
 *   param_2          => struct g1_layout_vfprintf_conv_state__param_0421        [param_0421; G1-original]
 *   local_2c         => struct g1_layout_float_render_locals__stack_1422        [stack_1422; G1-original]
 * Raw function identity: 0x0007712c.  See ../include/g1_recovered_layouts.h. */
...
control_label_000771b6:
    ...
    *param_2 = uVar13 & 0xfffffffb;
    ...
    if (iVar4 != 0) {
      ...
      goto control_label_000771b6;
    }
    if (param_2[1] == 0xffffffff) {
      uVar11 = 6;
control_label_00077214:
      param_2[1] = uVar11;
    }
    else if (((bVar12 & 0xdf) == 0x47) && (param_2[1] == 0)) {
      uVar11 = 1;
      goto control_label_00077214;
    }
    uVar13 = uVar13 | 0x400;
    *param_2 = uVar13;
    {
    ...
    if (bVar12 == 0x67) {
      if ((ADD3NEG(local_34)) || ((int)param_2[1] < (int)local_34)) {
        bVar12 = 0x65;
        goto control_label_0007728c;
      }
control_label_0007724e:
...
control_label_000772e6:
        ...
        if ((int)(*param_2 << 0x1f) < 0) {
          uVar13 = local_34 + 1;
          goto control_label_000772e6;
        }
      }
control_label_000772e8:
      uVar10 = 0;
      ...
      if (bVar12 == 0x47) {
        if ((!ADD3NEG(local_34)) && ((int)local_34 <= (int)param_2[1])) {
          bVar12 = 0x67;
          goto control_label_0007724e;
        }
        bVar12 = 0x45;
      }
      else if (0x65 < bVar12) {
        if (bVar12 != 0x66) goto control_label_0007724e;
        uVar13 = param_2[1];
        if ((int)local_34 < 1) {
          ...
          param_2[4] = local_34;
          if ((uVar13 == 0) && (-1 < (int)(*param_2 << 0x1f))) goto control_label_000772e8;
          uVar13 = uVar13 + 1 + local_34;
        }
        goto control_label_000772e6;
      }
control_label_0007728c:
      local_34 = local_34 - 1;
...
control_label_0007752c:
      ...
      uVar13 = local_30;
      if (iVar4 != 0) {
        iVar4 = (*param_4)(param_1, param_3, ((unsigned long)&rodata_f7a30) /*=0xf7a30*/, 1);
        uVar13 = local_30;
        if (iVar4 == -1) {
          return 0xffffffff;
        }
      ...
      if ((local_30 == 0 && local_34 == 0) && (-1 < (int)(*param_2 << 0x1f))) goto control_label_0007737a;
      iVar4 = (*param_4)(param_1, param_3, uVar7, uVar3);
      if (iVar4 == -1) {
        return 0xffffffff;
      }
