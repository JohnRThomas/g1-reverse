 ...
 * Raw function identity: 0x00047c48.  See ../include/g1_recovered_layouts.h. */
...
void proxy_thread_handler(int param_1)
{
    ...
    if (*piVar1 < 3) goto control_label_00047c76;
        ...
        if ((*(char *)(param_1 + 1) != '\x01') && (*(char *)(param_1 + 1) != '\b')) {
            ...
            if (iVar16 == 0) {
                ...
                case 0:
                    if (2 < *piVar1) {
                        if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                            log_message(((unsigned long)&rodata_ef0a1) /*=0xef0a1*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                        } else {
                            debug_print();
                        }
                    }
                    ...
                    *(char *)((unsigned long)&g_2001d431) /*=0x2001d431*/ = '\x01';
                    goto control_label_00047c76;
                case 1:
                    if (2 < *piVar1) {
                        if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                            log_message(((unsigned long)&rodata_ef0c9) /*=0xef0c9*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                        } else {
                            debug_print();
                        }
                    }
                    ...
                    if (*(char *)((unsigned long)&g_2001d431) /*=0x2001d431*/ != '\0') {
                        ...
                        if (2 < *piVar1) {
                            if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                log_message(((unsigned long)&rodata_ef135) /*=0xef135*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/,
                ...
                case 2:
                    if (2 < *piVar1) {
                        if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                            log_message(((unsigned long)&rodata_ef16d) /*=0xef16d*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                        } else {
                            debug_print();
                        }
                    }
                    ...
                    if (message.field.subtype == '\0') {
                        *(byte *)((unsigned long)&g_2001d34a) /*=0x2001d34a*/ = message.field.value - 1;
                        ...
                        if (iVar16 == 0) goto control_label_00047de2;
                        ...
                        if (iVar16 == 0) {
                            ...
                            if (2 < *piVar1) {
                                if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                    log_message(((unsigned long)&rodata_ef1a8) /*=0xef1a8*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                } else {
                                    debug_print();
                                }
                            }
                            ...
                            if (iVar16 == 0) {
                                ...
                                *piVar5 = *piVar5 + 1;
                                ...
                                while (iVar15 = (*(int (**)())(param_1 + 0x788))(puVar22, puVar10[1]), iVar15 < 0) {
                                    if (1 < *piVar1) {
                                        if (*piVar19 == 0) {
                                            log_message(((unsigned long)&rodata_ef1ea) /*=0xef1ea*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                        } else {
                                            debug_print();
                                        }
                                    }
                                    iVar16 = iVar16 + -1;
                                    if (iVar16 == 0) {
                                        if (*piVar1 < 2) goto control_label_00047c76;
                                        iVar16 = *(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
                                        uVar9 = ((unsigned long)&rodata_ef214) /*=0xef214*/;
                                        uVar13 = ((unsigned long)&rodata_ef76f) /*=0xef76f*/;
                                        goto control_label_00047c6a;
                                    }
                                    if (1 < *piVar1) {
                                        if (*piVar19 == 0) {
                                ...
                                *piVar6 = *piVar6 + iVar12;
                                ...
                                goto control_label_00048054;
                            }
                        }
control_label_00047e22:
                        if (0 < *piVar1) {
                            iVar16 = 0x400000;
                            iVar12 = *(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
                            uVar9 = ((unsigned long)&rodata_9ea0a) /*=0x9ea0a*/;
                            uVar13 = ((unsigned long)&rodata_ef76f) /*=0xef76f*/;
                            goto control_label_00047e36;
                        }
                        goto control_label_00047c76;
                    }
                    if (message.field.subtype != '\x01') goto control_label_00047c76;
                    if (*(char *)((unsigned long)&g_2001d262) /*=0x2001d262*/ == '\0') {
                        if (2 < *piVar1) {
                            if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                log_message(((unsigned long)&rodata_ef260) /*=0xef260*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                            } else {
                                debug_print();
                            }
                        }
...
control_label_0004820e:
                        ...
                        while (iVar15 = (*(int (**)())(param_1 + 0x788))(puVar10, puVar10[1]), iVar15 < 0) {
                            if (1 < *piVar1) {
                                if (*piVar19 == 0) {
                                    log_message(((unsigned long)&rodata_ef2df) /*=0xef2df*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                } else {
                                    debug_print();
                                }
                            }
                        ...
                        *piVar4 = *piVar4 + iVar16;
                        if (2 < *piVar1) {
                            if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                log_message(((unsigned long)&rodata_ef2fc) /*=0xef2fc*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, iVar16, *piVar4);
                            } else {
                                debug_print(((unsigned long)&rodata_ef2fc) /*=0xef2fc*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, iVar16, *piVar4);
                            }
                        }
control_label_00048054:
                    ...
                    *piVar19 = 0;
                    finish_audio_proxy_transfer();
                    if (*piVar1 < 1) goto control_label_00047c76;
                    if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                        iVar16 = get_device_info();
                        iVar16 = **(int **)(iVar16 + 0xfec);
                        uVar9 = ((unsigned long)&rodata_ef29b) /*=0xef29b*/;
                        uVar13 = ((unsigned long)&rodata_ef76f) /*=0xef76f*/;
                        goto control_label_000480f4;
                    }
                    iVar16 = get_device_info();
                    iVar16 = **(int **)(iVar16 + 0xfec);
                    uVar9 = ((unsigned long)&rodata_ef29b) /*=0xef29b*/;
                ...
                case 3:
                    if (2 < *piVar1) {
                        if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                            log_message(((unsigned long)&rodata_ef338) /*=0xef338*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                        } else {
                            debug_print();
                        }
                    }
...
control_label_00047de2:
                        ...
                        if (iVar16 != 0) goto control_label_00047e22;
                        ...
                        do {
                            ...
                            if (2 < *piVar1) {
                                ...
                                if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                    ...
                                    log_message(((unsigned long)&rodata_ef377) /*=0xef377*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, iVar21, uVar9, *(undefined4 *)(iVar15 + 0x14),
                        ...
                        *(char *)(iVar15 + 5) = cVar23;
                        ...
                        if ((-1 < iVar16) || (*piVar1 < 2)) goto control_label_00047c76;
                        iVar12 = *(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
                        uVar9 = ((unsigned long)&rodata_ef0fb) /*=0xef0fb*/;
                        uVar13 = ((unsigned long)&rodata_ef76f) /*=0xef76f*/;
                    }
control_label_00047e36:
                    if (iVar12 == 0) {
control_label_000480f4:
                    ...
                    *(uint16_t *)transfer_packet.bytes =
                    ...
                    do {
                        ...
                        if (iVar12 < 5000) {
                            if (2 < *piVar1) {
                                if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                    log_message(((unsigned long)&rodata_ef40d) /*=0xef40d*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                } else {
                                    debug_print();
                                }
                            }
                        ...
                        if (1 < *piVar1) {
                            if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                log_message(((unsigned long)&rodata_a125e) /*=0xa125e*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, iVar16);
                            } else {
                                debug_print();
                            }
                        }
                    ...
                    *(uint16_t *)transfer_packet.bytes =
                    ...
                    do {
                        ...
                        if (iVar12 < 5000) {
                            if (2 < *piVar1) {
                                if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                    log_message(((unsigned long)&rodata_ef437) /*=0xef437*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                } else {
                                    debug_print();
                                }
                            }
                ...
                case 6:
                    ...
                    do {
                        ...
                        if (iVar12 < 5000) {
                            if (2 < *piVar1) {
                                if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                    log_message(((unsigned long)&rodata_ef472) /*=0xef472*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                } else {
                                    debug_print();
                                }
                            }
                        ...
                        *(uint16_t *)transfer_packet.bytes = 0x10a;
                        ...
                        do {
                            ...
                            if (iVar12 < 5000) {
                                if (2 < *piVar1) {
                                    if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                                        log_message(((unsigned long)&rodata_a116d) /*=0xa116d*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                    } else {
                                        debug_print();
                                    }
                                }
                            ...
                            if (1 < *piVar1) {
                                if (*piVar19 == 0) {
                                    log_message(((unsigned long)&rodata_a1027) /*=0xa1027*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, iVar16);
                                } else {
                                    debug_print();
                                }
                            }
