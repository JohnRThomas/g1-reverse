 ...
 *   local_1fa        => struct g1_layout_ble_get_req_hdr_tmp__stack_0848        [stack_0848; G1-original]
 *   local_118        => struct g1_layout_ble_get_req_locals__stack_0850         [stack_0850; G1-original]
 * Raw function identity: 0x0001a064.  See ../include/g1_recovered_layouts.h. */
...
#define LOG_MODE  (*(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define AUDIO_LOAD_STATUS (*(volatile uint8_t *)((unsigned long)&g_ui_mode_flag) /*=0x20018462*/)
