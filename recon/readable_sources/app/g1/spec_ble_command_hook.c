...
#define firmware_data_0000f1e4 ((unsigned long)&rodata_9d7f7) /*=0x9d7f7*/
#define firmware_data_0000f1e8 ((volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/)
#define firmware_data_0000f1ec ((volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define firmware_data_0000f1f0 ((unsigned long)"spec_ble_command_hook") /*=0x9dfa9*/
#define firmware_data_0000f458 0x00000000u
#define firmware_data_0000f46c ((volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/)
#define firmware_data_0000f470 ((volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define firmware_data_0000f474 ((unsigned long)"%s(): pos=%s, tx_data_len=%d\n\n") /*=0x9d92b*/
#define firmware_data_0000f478 ((unsigned long)&rodata_a1f20) /*=0xa1f20*/
#define firmware_data_0000f4a0 ((unsigned long)&rodata_f3c02) /*=0xf3c02*/
#define firmware_data_0000f4a4 ((unsigned long)"teleprompter_info") /*=0x9db03*/
#define firmware_data_0000f4a8 ((unsigned long)"%s(): simulator:SCHEDULE \350\247\246\345\217\221.\n\n") /*=0x9db91*/
#define firmware_data_0000f76c ((volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define firmware_data_0000f770 ((unsigned long)"spec_ble_command_hook") /*=0x9dfa9*/
#define firmware_data_0000f794 ((volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/)
#define firmware_data_0000fa50 ((unsigned long)&rodata_9dd70) /*=0x9dd70*/
#define firmware_data_0000fa54 ((volatile int *)((unsigned long)&g_battery_percent) /*=0x200069e8*/)
#define firmware_data_0000fa64 ((unsigned long)"TX:%d,fail:%d,RX:%d,Signal:%d") /*=0x9dd73*/
#define firmware_data_0000fa68 ((unsigned long)&rodata_9dd91) /*=0x9dd91*/
#define firmware_data_0000fa6c ((volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/)
#define firmware_data_0000fa70 ((volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define firmware_data_0000fa74 ((unsigned long)"spec_ble_command_hook") /*=0x9dfa9*/
#define firmware_data_0000fa84 ((volatile int *)((unsigned long)&g_ble_switch_status_reason) /*=0x20007aac*/)
#define firmware_data_0000fa88 ((unsigned long)&rodata_9ddbf) /*=0x9ddbf*/
#define firmware_data_0000fa8c ((unsigned long)&rodata_9ddc8) /*=0x9ddc8*/
#define firmware_data_0000faac ((volatile int *)((unsigned long)&g_panel_spi_id) /*=0x2000a074*/)
#define firmware_data_0000fab0 ((unsigned long)"2024-12-28 20:20:45") /*=0x99899*/
#define firmware_data_0000fab4 ((unsigned long)&g_2000ff4e) /*=0x2000ff4e*/
#define firmware_data_0000fca0 0x00000000u
#define firmware_data_0000fca8 0x00000000u
#define firmware_data_0000fcc8 ((volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define firmware_data_0000fce0 ((unsigned long)&rodata_f1031) /*=0xf1031*/
...

{
  ...
  iVar5 = strcmp((uintptr_t)&local_520,firmware_data_0000f1e4);
  if (iVar5 == 0) {
    if (2 < *firmware_data_0000f1e8) {
      if (*firmware_data_0000f1ec == 0) {
        log_message(PTR_s__s____test_BLE_REQ_POST_BT_UNPAI_0000f1f4,firmware_data_0000f1f0);
      }
      else {
        debug_print(PTR_s__s____test_BLE_REQ_POST_BT_UNPAI_0000f1f4,firmware_data_0000f1f0);
      }
    }
    uVar12 = 1;
    local_520 = 0x47;
    goto control_label_0000ef7e;
  }
  ...
  if (iVar5 != 0) {
    ...
    if (2 < *firmware_data_0000f1e8) {
      if (*firmware_data_0000f1ec == 0) {
        log_message(PTR_DAT_0000f1fc,firmware_data_0000f1f0,&local_5a0,&local_420);
      }
      else {
        debug_print(PTR_DAT_0000f1fc,firmware_data_0000f1f0,&local_5a0,&local_420);
      }
    }
    piVar6 = (int *)&local_5a0;
    puVar11 = (undefined *)(uintptr_t)PTR_FUN_0007c244_1_0000f200;
    goto control_label_0000effe;
  }
    ...
    if (iVar5 == 0) {
      ...
      if (iVar5 == 0) {
        ...
        if (iVar7 != 0) {
          ...
          if (2 < *firmware_data_0000f1e8) {
            if (*firmware_data_0000f1ec == 0) {
              log_message(PTR_s__s____buf__s_0000f220,firmware_data_0000f1f0,&local_420);
            }
            else {
              debug_print(0);
            }
          ...
          if (2 < *piVar6) {
            if (*firmware_data_0000f1ec == 0) {
              log_message(PTR_s__s____cmd__s_0000f224,firmware_data_0000f1f0,&local_5c0);
            }
            else {
              debug_print(0);
            }
          ...
          if (2 < *piVar6) {
            if (*firmware_data_0000f1ec == 0) {
              log_message(PTR_s__s____en__s_0000f228,firmware_data_0000f1f0,&local_5a0);
            }
            else {
              debug_print(0);
            }
          ...
          if (2 < *piVar6) {
            if (*firmware_data_0000f1ec == 0) {
              ...
              debug_print(PTR_s__s____enable___d__sec__d_0000f22c,firmware_data_0000f1f0,uVar12,iVar4);
            }
          }
          uVar12 = 6;
          goto control_label_0000ef7e;
        ...
        piVar6 = firmware_data_0000f46c;
        if (iVar5 != 0) {
          pcVar14 = (char *)(iVar5 + 5);
          if (2 < *firmware_data_0000f46c) {
            if (*firmware_data_0000f470 == 0) {
              log_message(firmware_data_0000f474,PTR_s_spec_ble_command_hook_0000f460,pcVar14,param_2);
            }
            else {
              debug_print(firmware_data_0000f474,PTR_s_spec_ble_command_hook_0000f460,pcVar14,param_2);
            }
          }
          local_5a0 = 0;
          local_5c4 = 0;
          memset_bytes((uintptr_t)auStack_59c,0,0x7c);
          debug_print_hex_dump(firmware_data_0000f478,pcVar14,8);
          pcVar13 = pcVar14;
          do {
            pcVar18 = pcVar13;
            pcVar13 = pcVar18 + 1;
          ...
          piVar1 = firmware_data_0000f470;
          if (*piVar6 < 3) {
            if (iVar4 == 4) goto control_label_0000f2fc;
            if (iVar4 != 9) goto control_label_0000fc12;
          }
          else {
            if (*firmware_data_0000f470 == 0) {
...
control_label_0000f2fc:
            ...
            if (iVar4 != 0x9) {
control_label_0000fc12:
              if (iVar4 == 0xa) {
                if (2 < *piVar6) {
                  if (*firmware_data_0000fcc8 == 0) {
                ...
                cjson_object_add_number((int)firmware_data_0000fca0,uVar8,PTR_s_enable_0000fcd4);
                cjson_object_add_number((int)firmware_data_0000fca8,uVar8,PTR_s_direction_0000fcd8);
                cjson_add_string_to_object(uVar8,firmware_data_0000fce0,PTR_DAT_0000fcdc);
                ...
                goto control_label_0000f3f4;
              }
              if (iVar4 == 0x58) {
                if (2 < *piVar6) {
                  if (*firmware_data_0000f470 == 0) {
                    log_message(firmware_data_0000f4a8,PTR_s_spec_ble_command_hook_0000f460);
                  }
                  else {
                    debug_print(0);
                  }
              ...
              if (iVar4 == 0x4b) {
                ...
                if (2 < *piVar6) {
                  if (*firmware_data_0000f76c == 0) {
                    log_message(PTR_s__s____22_len__d_0000f774,firmware_data_0000f770,
                ...
                if (2 < *piVar6) {
                  if (*firmware_data_0000f76c == 0) {
                    log_message(PTR_s__s_____cmd_type__s__title__s__ms_0000f778,firmware_data_0000f770,
                                &local_5c4,&local_5c0,&local_420);
                  }
                  else {
                    debug_print(PTR_s__s_____cmd_type__s__title__s__ms_0000f778,firmware_data_0000f770,
                                 &local_5c4,&local_5c0,&local_420);
                  }
                }
                piVar6 = &local_5c0;
                puVar11 = (undefined *)(uintptr_t)PTR_FUN_0007c244_1_0000f77c;
control_label_0000effe:
              ...
              if (2 < *piVar6) {
                if (*firmware_data_0000f76c == 0) {
                  log_message(PTR_s__s______cmd_type__s__value__s__t_0000f780,firmware_data_0000f770,
                              &local_5c4,&local_5a0,2);
                }
                else {
                  debug_print(PTR_s__s______cmd_type__s__value__s__t_0000f780,firmware_data_0000f770,
                              &local_5c4,&local_5a0,2);
                }
              }
              uVar12 = 2;
          ...
          uVar8 = cjson_create_object(0);
          cjson_object_add_number((int)firmware_data_0000f458,uVar8,PTR_s_enable_0000f498);
          cjson_add_string_to_object(uVar8,firmware_data_0000f4a0,PTR_DAT_0000f49c);
          uVar12 = cjson_create_object(0);
          cjson_add_item_to_object_thunk(uVar12,firmware_data_0000f4a4,uVar8);
          uVar8 = cjson_print_pretty(uVar12);
          uVar9 = strlen(0);
          if (2 < *piVar6) {
            if (*firmware_data_0000f470 == 0) {
              ...
              do {
                ...
                while (iVar10 = (**(code **)(iVar4 + 0xc))((uintptr_t)&local_5a0,0x6b), iVar10 != 0) {
                  ...
                  if ((*(char *)(iVar4 + 0x365) == '\0') || (*(char *)(iVar4 + 0x366) == '\0')) {
                    if (*firmware_data_0000f794 < 1) {
                      return 0;
                    }
                    iVar4 = *firmware_data_0000f76c;
                    puVar11 = (undefined *)(uintptr_t)PTR_s__s____unable_to_audio_transfer__d_0000f79c;
                    goto control_label_0000f660;
                  }
                }
                iVar5 = iVar5 + 1;
...
control_label_0000f660:
          if (iVar4 != 0) {
            debug_print(0);
            return 0;
          }
          log_message((uintptr_t)puVar11,firmware_data_0000f770);
          return 0;
        }
          ...
          *(undefined4 *)(iVar4 + 0x8d0) = 0;
          ...
          if (iVar5 != 0) {
            ...
            if (iVar5 == 0) {
              ...
              if (iVar5 != 0) {
                local_420 = strncmp((uintptr_t)&local_520,firmware_data_0000fa50,2);
                if (local_420 == 0) {
                  memset_bytes((uintptr_t)&local_41c,0,0xc4);
                  uVar19 = *firmware_data_0000fa54;
                  iVar5 = *(int *)PTR_DAT_0000fa58;
                  iVar7 = *(int *)PTR_DAT_0000fa5c;
                  uVar16 = *(uint *)PTR_DAT_0000fa60;
                  puVar11 = (undefined *)(uintptr_t)firmware_data_0000fa64;
control_label_0000f7ec:
                  vdprintf_to_fd((uintptr_t)&local_420,0,200,puVar11,uVar16,iVar7,iVar5,uVar19);
control_label_0000f9d4:
                  uVar12 = 200;
                  pcVar17 = *(code **)(iVar4 + 0xc);
                  goto control_label_0000f9d8;
                }
                iVar5 = strncmp((uintptr_t)&local_520,firmware_data_0000fa68,2);
                if (iVar5 == 0) {
                  if (0 < *firmware_data_0000fa6c) {
                    puVar11 = (undefined *)(uintptr_t)PTR_s__s____sys_reboot_because_reboot_c_0000fa78;
                    if (*firmware_data_0000fa70 == 0) goto control_label_0000f82a;
                    debug_print(PTR_s__s____sys_reboot_because_reboot_c_0000fa78,firmware_data_0000fa74);
                  }
                  do {
                    k_sleep(0x4000,0);
                    puVar11 = (undefined *)sys_reboot(1);
control_label_0000f82a:
                ...
                if (iVar5 == 0) {
                  ...
                  if (iVar4 == 1) {
                    *firmware_data_0000fa70 = 0;
                    return 0;
                  }
                  *firmware_data_0000fa70 = 1;
                  return 0;
                }
                local_420 = strncmp((uintptr_t)&local_520,PTR_DAT_0000fa80,2);
                if (local_420 == 0) {
                  memset_bytes((uintptr_t)&local_41c,0,0x10);
                  uVar19 = *firmware_data_0000fa84;
                  *(uint *)(iVar4 + 0x7e8) = uVar19;
                  puVar11 = (undefined *)(uintptr_t)firmware_data_0000fa88;
control_label_0000f87e:
                  vdprintf_to_fd((uintptr_t)&local_420,0,0x14,puVar11,uVar19);
                  (**(code **)(iVar4 + 0xc))((uintptr_t)&local_420,0x14);
                  goto control_label_0000f6c2;
                }
                local_420 = strncmp((uintptr_t)&local_520,firmware_data_0000fa8c,2);
                if (local_420 == 0) {
                  memset_bytes((uintptr_t)&local_41c,0,0x10);
                  ...
                  vdprintf_to_fd((uintptr_t)&local_420,0,0x14,firmware_data_0000fa88);
                  (**(code **)(iVar4 + 0xc))((uintptr_t)&local_420,0x14);
                  goto control_label_0000f70c;
                }
...
control_label_0000f932:
                  ...
                  if (local_420 == 0) {
                    ...
                    vdprintf_to_fd((uintptr_t)&local_420,0,200,PTR_s_net_build_time___s__app_build_ti_0000fab8,
                                 firmware_data_0000fab4,firmware_data_0000fab0,1,4,5,*firmware_data_0000faac);
                    goto control_label_0000f9d4;
                  }
...
control_label_0000f70c:
          *(undefined4 *)(iVar4 + 0x8d0) = 0;
        }
        iVar5 = -0x6fc;
control_label_0000f742:
      ...
      if (2 < iVar4) {
        if (*firmware_data_0000f1ec == 0) {
          log_message(PTR_s__s____pos__s__new_log_level_set__0000f218,firmware_data_0000f1f0,iVar5,iVar4);
        }
        else {
          debug_print(PTR_s__s____pos__s__new_log_level_set__0000f218,firmware_data_0000f1f0,iVar5,iVar4);
        }
      }
      uStack_51f = 2;
      ...
      if (2 < *firmware_data_0000f1e8) {
        if (*firmware_data_0000f1ec == 0) {
          log_message(PTR_s__s____pos__s__new_screen_id__d_0000f210,firmware_data_0000f1f0,iVar5,uVar12);
        }
        else {
          debug_print(PTR_s__s____pos__s__new_screen_id__d_0000f210,firmware_data_0000f1f0,iVar5,uVar12);
        }
      }
      uStack_51f = 3;
    ...
    if (2 < *firmware_data_0000f1e8) {
      if (*firmware_data_0000f1ec == 0) {
        log_message(PTR_DAT_0000f208,firmware_data_0000f1f0,iVar5,iVar4);
      }
      else {
        debug_print(PTR_DAT_0000f208,firmware_data_0000f1f0,iVar5,iVar4);
      }
    }
    if (iVar4 != 0) {
      iVar4 = 1;
