 ...
 *   param_5          => struct g1_layout_battery_model_state__param_0000        [param_0000; G1-original]
 *   param_8          => struct g1_layout_battery_model_state__param_0001        [param_0001; G1-original]
 *   local_258        => struct g1_layout_battery_model_sample__stack_0751       [stack_0751; G1-original]
 *   local_254        => struct g1_layout_batt_soc_calc_tmp__stack_0752          [stack_0752; G1-original]
 *   local_23c        => struct g1_layout_battery_model_update_locals__stack_0754 [stack_0754; G1-original]
 *   local_200        => struct g1_layout_battery_model_sample_buf__stack_0756   [stack_0756; G1-original]
 *   local_1e0        => struct g1_layout_batt_model_calc_scratch5__stack_0757   [stack_0757; G1-original]
 *   local_1d0        => struct g1_layout_battery_calc_locals__stack_0758        [stack_0758; G1-original]
 *   local_1b8        => struct g1_layout_batt_sample_pair__stack_0759           [stack_0759; G1-original]
 *   local_1a0        => struct g1_layout_batt_model_calc_scratch5_b__stack_0760 [stack_0760; G1-original]
 *   local_190        => struct g1_layout_batt_model_calc_scratch5_c__stack_0761 [stack_0761; G1-original]
 *   local_150        => struct g1_layout_batt_calc_locals__stack_0763           [stack_0763; G1-original]
 * Raw function identity: 0x0000c358.  See ../include/g1_recovered_layouts.h. */
...
#define firmware_data_0000cad0  0.9998999834060669f      /* 0x3f7ff972 */
#define firmware_data_0000cad4  9.999999747378752e-05f   /* 0x38d1b717 */
#define firmware_data_0000cad8  3600.0f                  /* 0x45610000 */
#define firmware_data_0000cae0  (-0.05000000074505806f)  /* 0xbd4ccccd */
#define firmware_data_0000cae4  1.0499999523162842f      /* 0x3f866666 */
#define firmware_data_0000caf0  0.0f                     /* 0x00000000 */
#define firmware_data_0000caf4  100.0f                   /* 0x42c80000 */
#define firmware_data_0000d230  0.0f
#define firmware_data_0000d234  (-0.05000000074505806f)
#define firmware_data_0000d238  1.0499999523162842f
#define firmware_data_0000d23c  0.0f
#define firmware_data_0000d57c  0.0f
/* DAT_0000cae8/caec : the 64-bit double literal passed to FUN_0000de18 */
#define firmware_data_0000cae8  ((int)0xd2f1a9fc)
#define firmware_data_0000caec  ((int)0x3f70624d)
/* pointer globals (both point at 0x20002d1c) */
#define firmware_data_0000cadc  ((volatile float *)((unsigned long)&g_spline_nan_sentinel) /*=0x20002d1c*/)
#define firmware_data_0000d578  ((volatile float *)((unsigned long)&g_spline_nan_sentinel) /*=0x20002d1c*/)
...
control_label_0000c546:
      ...
      if (iVar21 < 1) goto control_label_0000c580;
    }
    local_270 = local_1d0;
    iVar18 = 0;
    do {
    ...
    if (0 < local_240) {
      ...
      iVar18 = iVar21;
      if (0 < iVar21) goto control_label_0000c51e;
      iVar18 = 0x7fffffff;
      goto control_label_0000c546;
    }
    if (0 < iVar21) {
      local_268 = local_240 << 2;
      iVar18 = -0x80000000;
      goto control_label_0000c51e;
    }
    local_268 = local_240 << 2;
  }
control_label_0000c580:
  local_27c = local_1b8;
  uVar27 = fminf(fVar41,uVar25);
  fVar28 = (float)fmaxf(uVar27,uVar26);
  local_258[0] = *pfVar10 == fVar28;
  ...
  iVar18 = __aeabi_dcmpgt((int)uVar44,(int)((ulonglong)uVar44 >> 0x20),firmware_data_0000cae8,firmware_data_0000caec);
  if (iVar18 == 0) {
control_label_0000c72a:
    fVar29 = param_5[0x5da];
  }
  else {
    uVar44 = __extendsfdf2(float_bits(fVar29));
    iVar18 = __aeabi_dcmpgt((int)uVar44,(int)((ulonglong)uVar44 >> 0x20),firmware_data_0000cae8,firmware_data_0000caec);
    if ((iVar18 == 0) || (-1 < (int)((uint)(param_3 < 0.0f) << 0x1f))) goto control_label_0000c72a;
    fVar29 = fVar29 / fVar30;
  }
  fVar30 = param_5[0x5dd] * firmware_data_0000cad0 + fVar29 * firmware_data_0000cad4;
  fVar42 = param_5[0x5dc] * firmware_data_0000cad0 + fVar30 * firmware_data_0000cad4;
  ...
  if (0 < local_26c) {
    pfVar15 = local_278;
    do {
      *pfVar15 = *pfVar15 * firmware_data_0000cad8;
      pfVar15 = pfVar15 + 1;
  ...
  local_200[7] = fVar38;
  fVar35 = (float)expf(-((fVar35 * firmware_data_0000caf0 * param_4) / local_23c[0]));
  ...
  iVar18 = 0;
  local_200[iVar21 + -1] =
       -(((param_4 * firmware_data_0000caf0) / fVar36) * fVar35) * (param_5[iVar21 + 0x5d5] * fVar39 + 1.0f);
  ...
  uVar25 = fmaxf(firmware_data_0000cae0,local_1e0[(int)fVar35 + -1]);
  fVar36 = param_5[0x5d5];
  fVar39 = (float)fminf(firmware_data_0000cae4,uVar25);
  fVar35 = param_5[0x13];
  pfVar20 = local_200;
  local_1e0[(int)fVar36 + -1] = fVar39;
  pfVar10 = pfVar20;
...
control_label_0000d2aa:
        pfVar15 = (float *)0x0;
      }
control_label_0000d2ac:
...
control_label_0000cc1a:
    ...
    if ((fVar39 < fVar35) && ((int)((uint)(fVar35 < fVar36) << 0x1f) < 0)) {
      if (fVar35 == fVar36) {
        pfVar15 = (float *)0x1;
        goto control_label_0000d2ac;
      }
      goto control_label_0000cc1a;
    }
    fVar38 = firmware_data_0000d23c;
    if (fVar35 < fVar36 == (NAN(fVar35) || NAN(fVar36))) goto control_label_0000d2aa;
  }
  ...
  if (0 < local_280) {
    ...
    do {
      fVar40 = *pfVar15;
      pfVar15 = pfVar15 + 1;
      *pfVar9 = (iVar18 == 0 ? fVar38 : firmware_data_0000caf0)
                + -fVar36 * fVar43 + -fVar37 * fVar28 + -fVar40 * param_2;
      pfVar9 = pfVar9 + 1;
    } while (pfVar10 != pfVar15);
  }
  fVar38 = param_5[0x5d5];
  local_200[0] = firmware_data_0000caf0;
  local_200[1] = firmware_data_0000caf0;
  local_200[2] = firmware_data_0000caf0;
  local_200[3] = firmware_data_0000caf0;
  ...
  fVar28 = fVar39 * firmware_data_0000caf4;
  if (local_280 < 1) {
    local_24c = 1;
    local_248 = local_280;
    iVar18 = strtod_has_more_digits(local_258,&local_24c);
    if (iVar18 != 0) {
      local_200[4] = firmware_data_0000d57c;
      local_200[5] = firmware_data_0000d57c;
      local_200[6] = firmware_data_0000d57c;
      local_200[7] = firmware_data_0000d57c;
    }
  }
  else {
    pfVar9 = local_23c + 3;
    ...
    iVar18 = strtod_has_more_digits(local_258,&local_24c);
    if (iVar18 != 0) {
      local_200[4] = firmware_data_0000d230;
      local_200[5] = firmware_data_0000d230;
      local_200[6] = firmware_data_0000d230;
      local_200[7] = firmware_data_0000d230;
    }
    pfVar9 = local_23c + 3;
  ...
  uVar25 = fmaxf(firmware_data_0000d234,local_150[(int)fVar34 + -1]);
  fVar40 = param_5[0x5d5];
  fVar38 = (float)fminf(firmware_data_0000d238,uVar25);
  local_150[(int)fVar40 + -1] = fVar38;
  pfVar9 = param_5;
  do {
    fVar38 = *pfVar15;
  ...
  *param_7 = fVar28 * 3.0f;
  ...
  if (iVar18 != 0) goto control_label_0000d162;
  ...
  if (iVar18 == 0) {
    if (param_2 < 0.0f) {
      ...
      fVar28 = firmware_data_0000d57c;
      if (param_2 != 0.0f) {
        fVar28 = 1.0f;
      }
    }
    iVar18 = float_is_nan(param_5[0x4b]);
    if (iVar18 == 0) goto control_label_0000d4ac;
control_label_0000d34a:
    fVar29 = fVar28 * *firmware_data_0000d578;
  }
  else {
    fVar28 = *firmware_data_0000d578;
    iVar18 = float_is_nan(param_5[0x4b]);
    if (iVar18 != 0) goto control_label_0000d34a;
control_label_0000d4ac:
    if (param_5[0x4b] < firmware_data_0000d57c) {
      fVar29 = -fVar28;
    }
    else {
      fVar29 = fVar28;
      if (param_5[0x4b] == firmware_data_0000d57c) {
        fVar29 = fVar28 * firmware_data_0000d57c;
      }
    }
  }
  if (fVar29 == -1.0f) {
    fVar29 = *firmware_data_0000d578;
