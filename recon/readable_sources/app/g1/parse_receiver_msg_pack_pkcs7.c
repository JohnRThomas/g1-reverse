 ...
 * Raw function identity: 0x00019da4.  See ../include/g1_recovered_layouts.h. */
...
unsigned int parse_receiver_msg_pack_pkcs7(int param_1, unsigned char *param_2, unsigned int param_3)
{
  ...
  if (param_2 == 0) {
    if (*E == 0) log_message(((unsigned long)&rodata_9b371) /*=0x9b371*/,((unsigned long)&rodata_9e0b2) /*=0x9e0b2*/,0xe4);
    else debug_print(((unsigned long)&rodata_9b371) /*=0x9b371*/,((unsigned long)&rodata_9e0b2) /*=0x9e0b2*/,0xe4);
    return 0xca;
  }
  if (param_1 == 0) {
    if (*E == 0) log_message(0x9b38f,((unsigned long)&rodata_9e0b2) /*=0x9e0b2*/,0xe9);
    else debug_print(0);
    return 0xca;
  }
  if (param_3 < 4) {
    if (*E != 0) { debug_print(((unsigned long)&rodata_9b3b5) /*=0x9b3b5*/,((unsigned long)&rodata_9e0b2) /*=0x9e0b2*/,0xef,param_3); return 0xca; }
    log_message(((unsigned long)&rodata_9b3b5) /*=0x9b3b5*/,((unsigned long)&rodata_9e0b2) /*=0x9e0b2*/,0xef,param_3);
    return 0xca;
  }
  {
    ...
    if (pb != b0) {
      ...
      else log_message(((unsigned long)&rodata_9b3e0) /*=0x9b3e0*/,((unsigned long)&rodata_9e0b2) /*=0x9e0b2*/,0x109,b0,pb);
      return 0xca;
    }
    unsigned int h0 = *H6f0;
    if (bVar1 != h0) {
      if (*E != 0) debug_print(((unsigned long)&rodata_9b413) /*=0x9b413*/,((unsigned long)&rodata_9e0b2) /*=0x9e0b2*/,0x10f,bVar1);
      else log_message(((unsigned long)&rodata_9b413) /*=0x9b413*/,((unsigned long)&rodata_9e0b2) /*=0x9e0b2*/,0x10f,bVar1,h0);
      return 0xca;
    }
    {
      ...
      *H6f2 = (unsigned short)(param_3 + (uVar4 - 4));
      ...
      if (*E == 0) log_message(((unsigned long)&rodata_9b44a) /*=0x9b44a*/, param_1);
      else debug_print(0);
      return 0xc9;
    }
  }
