 ...
 *   param_1          => struct g1_layout_pdm_clock_config__param_0294           [param_0294; G1-original]
 *   param_2          => struct g1_layout_pdm_config_g1__param_0295              [param_0295; G1-original]
 * Raw function identity: 0x0005fc7c.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_0005fc7c @ 0x0005fc7c
 * public-name: pdm_configure_clock_and_init
 * durable-map: recon/catalogs/function_names_app.json
 * callees (readable <= raw @ address):
 *   __aeabi_uldivmod                         <= FUN_0000e244 @ 0x0000e244
 *   pdm_configure_clock_and_init             <= FUN_0005fc7c @ 0x0005fc7c
...
extern int log_forward_zero_arg(int,...);

#define VU(a)  (*(volatile uint*)(a))
#define VB(a)  (*(volatile byte*)(a))

undefined4 pdm_configure_clock_and_init(int param_1,uint *param_2)
{
  ...
  if (VB(iVar5 + 0x51) != 0) {
    log_forward_zero_arg(((unsigned long)&rodata_881a0) /*=0x881a0*/,0x1040,(int)stk);
    return 0xfffffff0;
  }
  ...
  if (uVar8 == 1) {
    *(volatile uint64_t*)((char*)param_2 + 0x1c) = 0;      /* param_2[7],param_2[8]=0 strd */
    ...
    uVar2 = 0;
    if (VB((int)param_2 + 0x26) == 1) goto control_label_fd14;
  } else {
    ...
    uVar2 = 0x10;
    if ((VB((int)param_2 + 0x26) == 1) && (uVar8 - 1 < 2)) goto control_label_fd14;
  }
  goto err_ea;
...
control_label_fd14:
  ...
  if (((uVar9 == uVar2) || (uVar9 == 1)) && (param_2[6] == 0)) {
    ...
    if ((char)puVar7[1] == 0x10) {
      ...
      while (1) {
        ...
        if ((local_70 <= uVar9) && (uVar9 <= param_2[1])) {
          ...
          if (uVar3 < uVar6) {
            ...
            else if (uVar8 == 0) goto control_label_fe56;
          } else {
            uVar6 = uVar3 - uVar6;
            if (uVar6 < uVar8) { uVar8 = uVar6; if (uVar6 == 0) goto control_label_fe56; }
          }
        }
        pbVar11 = pbVar11 + 2;
        if (local_68 != 1) break;
      ...
      if (uVar8 != 0xffffffff) goto control_label_fe56;
      goto err_ea;
    }
  }
  goto err_ea;
...
control_label_fe56:
  log_forward_zero_arg(((unsigned long)&rodata_881a0) /*=0x881a0*/,0x20c0,(int)stk);
  ...
  if (uVar9 != 0x0bad0000) {
    log_forward_zero_arg(((unsigned long)&rodata_881a0) /*=0x881a0*/,0x1840,(int)stk);
    return 0xfffffffb;
  }
