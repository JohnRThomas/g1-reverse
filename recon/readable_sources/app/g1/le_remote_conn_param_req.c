...
void le_remote_conn_param_req(int event)
{
    ...
    if (connection == 0) {
        struct diagnostic_record diagnostic = {
            3, ((unsigned long)&rodata_f2db7) /*=0xf2db7*/, identifier
        };

        bt_log_forward_3arg(((unsigned long)&rodata_88138) /*=0x88138*/, 0x1840, &diagnostic);
