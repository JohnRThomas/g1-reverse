...
void format_message_relative_time(undefined4 param_1,int param_2)
{
  ...
  iVar4 = get_timestamp();
  piVar2 = (int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
  ...
  if (iVar4 == 6) {
    ...
    if (uVar10 - 0x3c <= 0x7fffffc3u) {
      if (uVar9 - 0x3c < 0xdd4) { uVar9 = uVar9 / 0x3c; uVar5 = ((unsigned long)&rodata_a8b01) /*=0xa8b01*/; }
      else {
        if (0x1c1f < uVar9 - 0xe10) {
          if (uVar9 - 0x2a30 <= ((unsigned long)&rodata_1274f) /*=0x1274f*/) {
          ...
          uVar5 = ((unsigned long)&rodata_a8b19) /*=0xa8b19*/;
...
LAB_948:
        ...
        uVar9 = uVar9 / 0xe10; uVar5 = ((unsigned long)&rodata_a8b0d) /*=0xa8b0d*/;
      }
LAB_858:
    ...
    uVar5 = ((unsigned long)&rodata_a8b2b) /*=0xa8b2b*/;
    if (uVar10 - 0x3c <= 0x7fffffc3u) {
      if (uVar9 - 0x3c < 0xdd4) { uVar9 = uVar9 / 0x3c; uVar5 = ((unsigned long)&rodata_a8b2f) /*=0xa8b2f*/; }
      else {
        if (0x1c1f < uVar9 - 0xe10) {
          if (((unsigned long)&rodata_1274f) /*=0x1274f*/ < uVar9 - 0x2a30) {
            uVar5 = ((unsigned long)&rodata_a8b96) /*=0xa8b96*/;
...
LAB_96a:
            uVar9 = (uint)uVar1; uVar5 = ((unsigned long)&rodata_a8b21) /*=0xa8b21*/;
          } else {
            calendar[0] = 0; calendar[1] = 0; calendar[2] = 0;
            unix_timestamp_to_datetime(param_2,calendar);
            ...
            if (*(char *)(*(int *)(iVar4 + 0xfec) + 0x5e) != 0) {
              if ((ushort)(calendar[1] >> 16) < 0xd) {
                uVar5 = ((unsigned long)&rodata_a8b8a) /*=0xa8b8a*/;
                ...
                uVar5 = ((unsigned long)&rodata_a8b7e) /*=0xa8b7e*/;
              }
            }
          }
LAB_920:
        ...
        uVar9 = uVar9 / 0xe10; uVar5 = ((unsigned long)&rodata_a8b37) /*=0xa8b37*/;
      }
      goto LAB_858;
    }
  }
