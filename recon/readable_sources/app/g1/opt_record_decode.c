 ...
 *   param_2          => struct g1_layout_opt_record__param_0461                 [param_0461; G1-original]
 * Raw function identity: 0x0007c4f4.  See ../include/g1_recovered_layouts.h. */
  ...
  *(volatile unsigned*)(param_2 + 0x10) = uVar4;
  if ((bVar1 & 8) == 0){
   ...
   control_label_c58a:
    ...
    uVar6 = uVar7;
    if (uVar3 != 0) goto control_label_c58a;
  }
