 ...
 *   param_8          => struct g1_layout_imu_ahrs_quaternion__param_0069        [param_0069; G1-original]
 * Raw function identity: 0x00026624.  See ../include/g1_recovered_layouts.h. */
                  ...
                  volatile struct fusion_state *state)
{
    ...
    if (ax != 0.0f || ay != 0.0f || az != 0.0f) {
         ...
         * (Sd = -Sd + Sn*Sm), NOT VMLS.F32 (Sd = Sd - Sn*Sm). */
