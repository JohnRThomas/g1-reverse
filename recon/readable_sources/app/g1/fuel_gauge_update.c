 ...
 *   local_3c         => struct g1_layout_fuel_gauge_reading__stack_0783         [stack_0783; G1-original]
 * Raw function identity: 0x00010b18.  See ../include/g1_recovered_layouts.h. */
...
#define firmware_data_00010f74 94.5f
#define firmware_data_00010f78 95.0f
#define firmware_data_00010f7c 200.0f
#define firmware_data_00010f80 ((uint8_t *)((unsigned long)&g_20018da2) /*=0x20018da2*/)
#define firmware_data_00010f84 0x408f4000u
#define firmware_data_00010f88 1000.0f
...

{
  ...
  plVar4 = firmware_data_00010bec;
  fVar3 = firmware_data_00010be8;
  iVar13 = 0xb;
  fVar15 = firmware_data_00010be4;
  while (iVar8 = fuel_gauge_poll_should_stop(), iVar8 == 0) {
    ...
    fuel_gauge_unlock();
    if (iVar8 < 0) {
      log_message(firmware_data_00010bf0);
      return iVar8;
    }
    ...
    if ((((fVar14 != 0.0) || (iVar13 = iVar13 + -1, iVar13 == 0)) ||
        (-1 < (int)((uint)(fVar15 < firmware_data_00010bf4) << 0x1f))) ||
       (fVar15 == 0.0 || fVar15 < 0.0 != NAN(fVar15))) {
      lVar16 = k_uptime_get_3();
      *plVar4 = lVar16;
      goto control_label_00010c00;
    }
    k_sleep(0xa4,0);
  }
...
control_label_00010c00:
  piVar5 = firmware_data_00010f48;
  if (0 < *firmware_data_00010f48) {
    ...
    if (*firmware_data_00010f4c == 0) {
      log_message(firmware_data_00010f54,firmware_data_00010f50,(int)uVar17,uVar11,(int)uVar18,
                  (int)((ulonglong)uVar18 >> 0x20),(int)uVar19,(int)((ulonglong)uVar19 >> 0x20));
    }
    else {
      debug_print(firmware_data_00010f54,firmware_data_00010f50,(int)uVar17,uVar11,(int)uVar18,
                  (int)((ulonglong)uVar18 >> 0x20),(int)uVar19,(int)((ulonglong)uVar19 >> 0x20));
    }
  }
  iVar13 = k_uptime_get_3();
  fVar3 = firmware_data_00010f58;
  if (((fVar15 == 0.0) || (*firmware_data_00010f60 == fVar15)) &&
     (fVar15 < firmware_data_00010f58 != (NAN(fVar15) || NAN(firmware_data_00010f58)))) {
    if (firmware_data_00010f9c < (uint)(iVar13 - *firmware_data_00010f5c)) {
      *firmware_data_00010fa0 = 1;
    }
  }
  else {
    *firmware_data_00010f5c = iVar13;
    *firmware_data_00010f60 = fVar15;
  }
  ...
  if (0 < *piVar5) {
    ...
    if (*firmware_data_00010f4c == 0) {
      ...
      log_message(firmware_data_00010f64,firmware_data_00010f50,(int)uVar17,uVar11,(int)uVar18,
                  (int)((ulonglong)uVar18 >> 0x20),uVar9);
    }
    else {
      uVar9 = get_product_code_buf();
      debug_print(firmware_data_00010f64,firmware_data_00010f50,(int)uVar17,uVar11,uVar18,uVar9);
    }
  }
  fVar15 = firmware_data_00010fa4;
  if (((((int)((uint)(fVar14 < 0.0) << 0x1f) < 0) ||
       (fVar14 < firmware_data_00010f68 == (NAN(fVar14) || NAN(firmware_data_00010f68)))) ||
      (fVar15 = firmware_data_00010f58, fVar14 < fVar3 == (NAN(fVar14) || NAN(fVar3)))) ||
     (((fVar15 = fVar14, fVar14 < firmware_data_00010f6c != (NAN(fVar14) || NAN(firmware_data_00010f6c)) ||
       (-1 < (int)((uint)(fVar14 < firmware_data_00010f70) << 0x1f))) &&
      ((fVar14 < firmware_data_00010f74 != (NAN(fVar14) || NAN(firmware_data_00010f74)) ||
       (-1 < (int)((uint)(fVar14 < firmware_data_00010f78) << 0x1f))))))) {
  ...
  *(undefined1 *)(iVar13 + 0xfc2) = uVar7;
  iVar13 = get_device_info();
  fVar14 = local_44 * fVar3 - firmware_data_00010f7c;
  *(char *)(iVar13 + 0xfc0) = (0.0 < fVar15) * (char)(int)fVar15;
  iVar13 = get_device_info();
  pbVar6 = firmware_data_00010f80;
  ...
  if (local_40 == 0.0) {
    ...
    if (5 < bVar12) {
      *pbVar6 = 0;
      ...
      uVar17 = __aeabi_dadd((int)uVar17,(int)((ulonglong)uVar17 >> 0x20),firmware_data_00010f40,firmware_data_00010f44);
      uVar17 = __muldf3((int)uVar17,(int)((ulonglong)uVar17 >> 0x20),0,firmware_data_00010f84);
      iVar13 = get_device_info();
      uVar7 = __fixunsdfsi((int)uVar17,(int)((ulonglong)uVar17 >> 0x20));
      fVar15 = local_40 * firmware_data_00010f88;
      *(undefined1 *)(iVar13 + 0xfc5) = uVar7;
      iVar13 = get_device_info();
      *(char *)(iVar13 + 0xfc8) = (char)(int)fVar15;
      goto control_label_00010dca;
    }
  }
  else {
    uVar17 = __extendsfdf2(g1_float_bits(local_40));
  ...
  *pbVar6 = bVar12;
control_label_00010dca:
  iVar13 = get_device_info();
  *(char *)(iVar13 + 0xfc6) = (0.0 < local_3c[0]) * (char)(int)local_3c[0];
  iVar13 = get_device_info();
  bVar1 = local_3c[0] < firmware_data_00010f8c;
  bVar2 = NAN(firmware_data_00010f8c);
  *(short *)(iVar13 + 0xfca) = (short)(int)(local_3c[0] * fVar3);
  if ((((bVar1 == (NAN(local_3c[0]) || bVar2)) &&
       ((int)((uint)(local_3c[0] < firmware_data_00010f90) << 0x1f) < 0)) ||
      ((local_3c[0] < firmware_data_00010f94 == (NAN(local_3c[0]) || NAN(firmware_data_00010f94)) &&
    ...
    *(undefined1 *)(iVar13 + 0xfea) = 0xc;
    ...
    if (0 < *piVar5) {
      if (*firmware_data_00010f4c == 0) {
        log_message(firmware_data_00010f98,firmware_data_00010f50);
      }
      else {
        debug_print(0);
      }
