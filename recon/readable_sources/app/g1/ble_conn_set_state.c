 ...
 * Raw function identity: 0x00056704.  See ../include/g1_recovered_layouts.h. */
...
void ble_conn_set_state(int param_1, uint param_2)
{
  ...
  if (uVar7 == param_2) {
    ...
    bt_conn_call_4arg_zero(((unsigned long)&log_module_bt_conn) /*=0x88108*/, 0x1c80, &s);
    return;
  }
    ...
    case 0: {
      ...
      switch (uVar7) {
        ...
        case 1: {
          ...
          poll_signal_event_locked(((unsigned long)&g_ble_conn_poll_signal) /*=0x20002990*/, 0);
          break;
        }
      ...
      if (*(volatile uint8_t*)(param_1+2) != 4) {
        ...
        *(volatile uint32_t*)(param_1+0x58) = 0;
        if (*(volatile uint8_t*)(param_1+3) == 1) {
          ...
          k_work_schedule(param_1+0x60, 0, ((unsigned long)&rodata_28000) /*=0x28000*/, 0);
        }
      }
      break;
    default: {
