 ...
 *   local_2c         => struct g1_layout_new_task_locals__stack_0910            [stack_0910; G1-original]
 * Raw function identity: 0x0002c99c.  See ../include/g1_recovered_layouts.h. */
...
extern int firmware_function_0007ce5c(u32, u32);                        /* exact wait entry */
...
#define wait_for_event firmware_function_0007ce5c
#define task_wait_ticks firmware_function_0007ce5c /* FUN_0007ce5c @ 0x0007ce5c */
...
control_label_0002e00e:
            trigger_screen_state_change(uVar14, param_1, 1);
            goto control_label_0002e012;
        }
            ...
            if (((*(char *)(*(int *)(param_1 + 0x1014) + 1) == '\0') &&
                ...
                if (((*param_2 == 2) && (iVar18 = get_task_signal_mode(), iVar18 == 0)) ||
                    ...
                    if (*param_1 == '\x01') {
                        ...
                        goto control_label_0002e084;
                    }
                    if (*piVar10 < 1) goto control_label_0002cf58;
                    iVar18 = g_log_use_alt_sink;
                    uVar14 = 0xa37a8;
                    goto control_label_0002e184;
                }
control_label_0002e084:
                ...
                if (iVar18 == 1) {
                    if (param_1[0x108f] == '\0') {
                        ...
                        if (param_1[0xd5] != '\x05') goto control_label_0002e040;
                        if (0 < *piVar10) {
                            iVar18 = g_log_use_alt_sink;
                            uVar14 = 0xa37c8;
control_label_0002e184:
                            if (iVar18 == 0) log_message(uVar14,((unsigned long)"process_for_IDLE") /*=0xa3875*/);
                            else             debug_print(uVar14,((unsigned long)"process_for_IDLE") /*=0xa3875*/);
                        }
                        goto control_label_0002cf58;
                    }
                    clear_active_task();
                    if (*param_1 == '\x01') {
                        sync_message_signal_to_slave(1);
...
control_label_0002ca34:
    iVar13 = local_2c[0];
    if (iVar18 == 10) goto control_label_0002ce1c;
control_label_0002ca3c:
    iVar13 = local_2c[0];
    if (iVar18 != 0xb) goto control_label_0002ce1c;
    goto control_label_0002cf58;

CASE6:
    if (2 < g_log_level) {
        if (g_log_use_alt_sink == 0) log_message(((unsigned long)"%s(): switch -> E_ID_SCREEN_DASHBOARD\n") /*=0xa2aad*/,((unsigned long)"process_for_new_task") /*=0xa3a0f*/);
    ...
    while (1) {
        ...
        if ((((*param_2 == 1) && (iVar18 = get_task_signal_mode(), iVar18 == 0)) ||
            ...
            if (iVar18 != 1) {
                ...
                update_persist_task_status_to_idle(param_1);
                iVar13 = ((unsigned long)&rodata_a2ad4) /*=0xa2ad4*/;
                if (*piVar2 < 3) goto control_label_0002ce1c;
                uVar19 = (u8)param_1[0xd5];
                iVar18 = g_log_use_alt_sink;
            ...
            goto control_label_0002cb9a;
        }
        iVar18 = now_has_persist_task(param_1, param_1[0xd5]);
        if (iVar18 == 1) {
            if (2 < *piVar2) {
                if (g_log_use_alt_sink == 0) log_message(((unsigned long)"%s(): #2 %d: %d %d I will go to next screen, goodbye!\n") /*=0xa2b22*/,((unsigned long)&rodata_a39bb) /*=0xa39bb*/,(u32)(u8)param_1[0xd5], *(u32 *)(param_1 + 0xdf),(u32)(u8)param_1[0xe3]);
                else            debug_print(((unsigned long)"%s(): #2 %d: %d %d I will go to next screen, goodbye!\n") /*=0xa2b22*/,((unsigned long)&rodata_a39bb) /*=0xa39bb*/,(u32)(u8)param_1[0xd5], *(u32 *)(param_1 + 0xdf),(u32)(u8)param_1[0xe3]);
            }
            uVar17 = *(u32 *)(param_1 + 0xdf);
            if (uVar17 == 0xb) goto control_label_0002cb9a;
            if      (uVar17 == 7)  { uVar17 = 7;    goto control_label_0002cb9a; }
            else if (uVar17 == 8)  { uVar17 = 8;    goto control_label_0002cb9a; }
            else if (uVar17 == 9)  { uVar17 = 9;    goto control_label_0002cb9a; }
            else if (uVar17 == 10) { uVar17 = 10;   goto control_label_0002cb9a; }
            else if (uVar17 == 0xc){ uVar17 = 0xc;  goto control_label_0002cb9a; }
            else if (uVar17 == 0xe){ uVar17 = 0xe;  goto control_label_0002cb9a; }
            else if (uVar17 == 0xf){ uVar17 = 0xf;  goto control_label_0002cb9a; }
            else if (uVar17 == 0x10){uVar17 = 0x10; goto control_label_0002cb9a; }
            else if (uVar17 == 0x11){uVar17 = 0x11; goto control_label_0002cb9a; }
        ...
        if (param_1[0xd5] == '\x04') {
            ...
            iVar18 = g_log_use_alt_sink;
            uVar14 = 0xa2bc0;
            goto control_label_0002cd00;
        }
        if (param_1[0xfe6] == '\x01') {
            uVar14 = 0x667;
            goto control_label_0002cd18;
        }
        uVar19 = uVar19 + 1;
        if (((uVar19 & 0xf) == 0) && (2 < *piVar2)) {
            if (g_log_use_alt_sink == 0) log_message(((unsigned long)"%s(): [dashboard]\347\255\211\345\276\205\351\200\200\345\207\272:%d, expect_ts: %d, imu:%d, unread_msg_num:%d, persist_task:%d/%d - %d\n") /*=0xa2c0b*/,((unsigned long)&rodata_a39bb) /*=0xa39bb*/,uVar19,**(u32 **)(param_1 + 0xff0), (u32)*param_2,(u32)(u8)param_1[0xdd],(u32)(u8)param_1[0xe3], *(u32 *)(param_1 + 0xdf),(u32)(u8)param_1[0xdc]);
...
CASE8:
    ...
    *(u8 *)(iVar18 + 0xdd) = uVar11;
    ...
    if (2 < *piVar7) {
        if (g_log_use_alt_sink == 0) log_message(((unsigned long)&rodata_a291d) /*=0xa291d*/,((unsigned long)"process_for_schedule_show") /*=0xa3916*/,(u32)(u8)param_1[0xd5]);
        else            debug_print(((unsigned long)&rodata_a291d) /*=0xa291d*/,((unsigned long)"process_for_schedule_show") /*=0xa3916*/,(u32)(u8)param_1[0xd5]);
    }
    sync_to_slave(param_1, 8, 0);
    update_persist_task_status_to_idle(param_1);
    local_2c[0] = ((unsigned long)&rodata_a3311) /*=0xa3311*/;
    goto control_label_0002d118;

CASE9:
    if (2 < g_log_level) {
        if (g_log_use_alt_sink == 0) log_message(((unsigned long)"%s(): switch -> E_ID_SCREEN_TELEPROMPTER\n") /*=0xa2e31*/,((unsigned long)"process_for_new_task") /*=0xa3a0f*/);
...
CASE17:
    ...
    piVar2 = (volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
    uVar19 = 0;
    goto control_label_0002dd2a;

control_label_0002cf58:
    iVar18 = 0xb;
    goto control_label_0002c9b6;

control_label_0002dd2a:
    if ((param_1[1] == '\x01') || (iVar18 = get_device_info(), *(char *)(iVar18 + 1) == '\b'))
        goto control_label_0002dd30;
    if (**(char **)(param_1 + 0x101c) == '\0') {
        local_2c[0] = ((unsigned long)&rodata_a35df) /*=0xa35df*/;
        if (*param_2 != 2) {
            if (*piVar9 < 3) goto control_label_0002d2da;
            uVar19 = (u8)param_1[0xd5];
            iVar18 = g_log_use_alt_sink;
            uVar14 = ((unsigned long)&rodata_a3886) /*=0xa3886*/;
            goto control_label_0002d5b8;
        }
        sync_to_slave(param_1, 8, 0);
        if (*piVar9 < 3) goto control_label_0002d9fc;
        bVar1 = param_1[0xd5];
        iVar18 = g_log_use_alt_sink;
        uVar14 = ((unsigned long)&rodata_a3886) /*=0xa3886*/;
        goto control_label_0002d9f0;
    }
    if (param_1[0xd5] == '\x01') {
...
control_label_0002dc06:
            if (iVar18 == 0) log_message(uVar14,((unsigned long)"process_for_even_ai_show") /*=0xa38a5*/,(u32)bVar1);
            else             debug_print(uVar14,((unsigned long)"process_for_even_ai_show") /*=0xa38a5*/,(u32)bVar1);
        }
        goto control_label_0002db7c;
    }
    ...
    if (((*(char *)(*(int *)(param_1 + 0x100c) + 7) == '\0') ||
        ...
        if (*param_2 == 2) {
            ...
            if (2 < *piVar8) {
                ...
                goto control_label_0002dc06;
            }
        } else {
            if (2 < *piVar8) {
                if (g_log_use_alt_sink == 0) log_message(((unsigned long)&rodata_a294a) /*=0xa294a*/,((unsigned long)"process_for_even_ai_show") /*=0xa38a5*/,(u32)(u8)param_1[0xd5]);
                else            debug_print(((unsigned long)&rodata_a294a) /*=0xa294a*/,((unsigned long)"process_for_even_ai_show") /*=0xa38a5*/,(u32)(u8)param_1[0xd5]);
            }
            sync_to_slave(param_1, 8, 0);
        }
        goto control_label_0002db7c;
    ...
    if (param_1[0xd5] == '\x01') {
        if (2 < *piVar8) {
            if (g_log_use_alt_sink == 0) log_message(((unsigned long)&rodata_a2de3) /*=0xa2de3*/,((unsigned long)"process_for_even_ai_show") /*=0xa38a5*/,(u32)(u8)param_1[0xd5]);
            else            debug_print(((unsigned long)&rodata_a2de3) /*=0xa2de3*/,((unsigned long)"process_for_even_ai_show") /*=0xa38a5*/,(u32)(u8)param_1[0xd5]);
        }
        set_task_wake_state(1);
...
control_label_0002d998:
    if ((param_1[1] == '\x01') || (iVar18 = get_device_info(), *(char *)(iVar18 + 1) == '\b'))
        goto control_label_0002d99e;
...
control_label_0002d9f0:
            ...
            goto control_label_0002d9fc;
        }
        if (*piVar8 < 3) goto control_label_0002d2da;
        uVar19 = (u8)param_1[0xd5];
        iVar18 = g_log_use_alt_sink;
        uVar14 = ((unsigned long)&rodata_a38be) /*=0xa38be*/;
        goto control_label_0002d5b8;
...
control_label_0002d7ee:
    if ((param_1[1] == '\x01') || (iVar18 = get_device_info(), *(char *)(iVar18 + 1) == '\b'))
        goto control_label_0002d7f4;
    if (**(char **)(param_1 + 0x1014) == '\0') {
        ...
        update_persist_task_status_to_idle(param_1);
        iVar13 = local_2c[0];
        if (*param_1 != '\x01') goto control_label_0002ce1c;
        uVar14 = 0xccd;
        goto control_label_0002cd18;
    }
    if (param_1[0xd5] == '\x01') {
...
control_label_0002d1b4:
    ...
    if (param_1[0xd5] == '\x01') {
        iVar13 = ((unsigned long)&rodata_a2ad4) /*=0xa2ad4*/;
        if (*piVar5 < 3) goto control_label_0002ce1c;
        uVar19 = (u8)param_1[0xd5];
        iVar18 = g_log_use_alt_sink;
        uVar14 = ((unsigned long)&rodata_a2de3) /*=0xa2de3*/;
...
control_label_0002d4ce:
    if ((param_1[1] == '\x01') || (iVar18 = get_device_info(), *(char *)(iVar18 + 1) == '\b'))
        goto control_label_0002d4d4;
...
control_label_0002d5b8:
        ...
        goto control_label_0002d0b4;
    }
    if (param_1[0xd5] == '\x01') {
        iVar13 = ((unsigned long)&rodata_a2ad4) /*=0xa2ad4*/;
        if (*piVar6 < 3) goto control_label_0002ce1c;
        uVar19 = (u8)param_1[0xd5];
        iVar18 = g_log_use_alt_sink;
        uVar14 = ((unsigned long)&rodata_a2de3) /*=0xa2de3*/;
...
control_label_0002d37c:
    if ((param_1[1] != '\x01') && (iVar18 = get_device_info(), *(char *)(iVar18 + 1) != '\b')) {
        if (*pcVar20 != '\0') {
            if (param_1[0xd5] != '\x01') goto control_label_0002d46a;
            iVar13 = ((unsigned long)&rodata_a2ad4) /*=0xa2ad4*/;
            if (*piVar6 < 3) goto control_label_0002ce1c;
            uVar19 = (u8)param_1[0xd5];
            iVar18 = g_log_use_alt_sink;
...
control_label_0002d6ce:
    if ((param_1[1] == '\x01') || (iVar18 = get_device_info(), *(char *)(iVar18 + 1) == '\b'))
        goto control_label_0002d6d4;
...
control_label_0002ccda:
    iVar18 = g_log_use_alt_sink;
    uVar14 = ((unsigned long)&rodata_a2ba7) /*=0xa2ba7*/;
control_label_0002cd00:
...
control_label_0002db7c:
        update_persist_task_status_to_idle(param_1);
    }
    set_task_wake_state(1);
    iVar13 = ((unsigned long)&rodata_a2a21) /*=0xa2a21*/;
control_label_0002ce1c:
    local_2c[0] = iVar13;
    iVar18 = local_2c[0];
    if (local_2c[0] != 0) {
        if (2 < g_log_level) {
            if (g_log_use_alt_sink == 0) log_message(((unsigned long)"%s(): #6 %d: timeout_suspend reason: %s\n") /*=0xa384c*/,((unsigned long)"process_for_new_task") /*=0xa3a0f*/,(u32)(u8)param_1[0xd5],local_2c[0]);
