...
#define firmware_data_0002fbd8 ((unsigned long)"audioStreamFileManagerHandler") /*=0xa4926*/
#define firmware_data_0002fbdc 0x000a4369u
#define firmware_data_0002fbe0 ((unsigned long)"%s(): start audio stream record!\r\n\n") /*=0xa4395*/
...
#define firmware_data_0002fbf4 ((unsigned long)"%s(): filesystem need format,try to format,please wait..\n") /*=0xa43b9*/
...
#define firmware_data_0002fc08 ((unsigned long)"%s(): filesystem format sucess\n") /*=0xa43f3*/
#define firmware_data_0002fc0c ((unsigned long)"%s(): find a free voice block(%d)!\r\n\n") /*=0xa4413*/
#define firmware_data_0002fc10 ((unsigned long)"%s(): voice_block_store_timestamp = %d, voice_stream_block_ts = %d\n") /*=0xa4439*/
#define firmware_data_0002fc14 ((unsigned long)"%s(): no free voice block,try to use the oldest voice block(%d)!\n") /*=0xa447d*/
#define firmware_data_0002fc18 ((volatile int *)((unsigned long)&g_20019daa) /*=0x20019daa*/)
#define firmware_data_0002fc1c ((unsigned long)"%s(): audio manager start check success,will fill up audio stream to Num%d block\n") /*=0xa44bf*/
...
#define firmware_data_0002fe80 ((unsigned long)"audioStreamFileManagerHandler") /*=0xa4926*/
#define firmware_data_0002fe84 ((unsigned long)"%s(): A start command occurred during recording to exit the recording\n") /*=0xa4511*/
#define firmware_data_0002fe88 ((volatile int *)((unsigned long)&g_20007bb8) /*=0x20007bb8*/)
#define firmware_data_0002fe8c ((unsigned long)"%s(): copy %d byte into audio cache\n") /*=0xa4558*/
#define firmware_data_0002fe90 ((unsigned long)"%s(): To complete a sector of data, perform flash write operations\n") /*=0xa457d*/
...
#define firmware_data_0002fe9c ((unsigned long)"%s(): the number of recording files exceeds the upper limit, system automatically stops\n") /*=0xa45c1*/
#define firmware_data_0002fea0 ((unsigned long)"%s(): Catch touch release is not recognized, start QuickNote exception recovery mechanism\n") /*=0xa461a*/
#define firmware_data_0002fea4 ((unsigned long)"%s(): received audio stop command,stop audio write process\n") /*=0xa46fd*/
#define firmware_data_0002fea8 ((unsigned long)"%s(): wirte addr = 0x%08x\n") /*=0xa4675*/
...
#define firmware_data_00030144 ((unsigned long)"audioStreamFileManagerHandler") /*=0xa4926*/
#define firmware_data_00030148 ((unsigned long)"%s(): wirte 4k voice data to flash,write address = 0x%08x\n") /*=0xa4690*/
#define firmware_data_0003014c ((unsigned long)"%s(): Copy remain %d byte data into cache memory\n") /*=0xa46cb*/
#define firmware_data_00030150 ((volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/)
#define firmware_data_00030154 ((unsigned long)"%s(): A delete command occurred during the recording process. The recording was stopped and the deletion action was performed,Delete num = %d\n") /*=0xa486b*/
#define firmware_data_00030158 ((unsigned long)"%s(): upgrade Num.%d voice manager block,total write sector num = %d, total write byte = %d ,crc32 = %d\n") /*=0xa4739*/
#define firmware_data_0003015c ((unsigned long)"%s(): voice block start addr = voice block end addr\n") /*=0xa47a2*/
