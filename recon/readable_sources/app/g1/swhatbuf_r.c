 ...
 * Raw function identity: 0x00086b7e.  See ../include/g1_recovered_layouts.h. */
/* readable reconstruction; identity: FUN_00086b7e @ 0x00086b7e
 * public-name: swhatbuf_r
...
unsigned int swhatbuf_r(unsigned int param_1,int param_2,unsigned int *param_3,unsigned int *param_4)
{
  int iVar1;
  unsigned int uVar2;
  unsigned int uVar3;
