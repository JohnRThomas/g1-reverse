...
int ble_whitelist_app(undefined4 param_1,undefined4 param_2,codeptr param_3,undefined4 param_4)
{
  ...
  iVar1 = strcmp(param_1,((unsigned long)&rodata_9e1a8) /*=0x9e1a8*/);
  if (iVar1 == 0) {
...
control_label_2270:
  ...
  if (iVar1 == 0) {
    ...
    iVar6 = *(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/;
    if (iVar1 < 0) goto control_label_2270;
    if (iVar6 < 3) return 0;
...
control_label_22b6: log_message(((unsigned long)&rodata_9e1eb) /*=0x9e1eb*/,((unsigned long)&rodata_9e53c) /*=0x9e53c*/,param_1,uVar5); return 0;
    ...
    iVar1 = strcmp(param_1,((unsigned long)&rodata_9e201) /*=0x9e201*/);
    if (iVar1 != 0) {
      iVar1 = strcmp(param_1,((unsigned long)&rodata_9e20e) /*=0x9e20e*/);
      if (iVar1 == 0) {
        iVar1 = get_device_info(0);
        ...
        if (iVar1 < 0) goto control_label_2270;
        if (iVar6 < 3) return 0;
        if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ != 0) { iVar1 = get_device_info(0); uVar5 = *(uint *)(iVar1 + 0x1050); goto control_label_22a0; }
        iVar1 = get_device_info(0); uVar5 = *(uint *)(iVar1 + 0x1050); goto control_label_22b6;
      }
      iVar1 = strcmp(param_1,((unsigned long)&rodata_9e21f) /*=0x9e21f*/);
      if (iVar1 == 0) {
        iVar1 = get_device_info(0);
        ...
        if (iVar1 < 0) goto control_label_2270;
        if (iVar6 < 3) return 0;
        if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) { iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 0xed5); goto control_label_22b6; }
        iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 0xed5); goto control_label_22a0;
      }
      iVar1 = strcmp(param_1,((unsigned long)&rodata_9e230) /*=0x9e230*/);
      if (iVar1 == 0) {
        iVar1 = get_device_info(0);
        ...
        if (iVar1 < 0) goto control_label_2270;
        if (iVar6 < 3) return 0;
        if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) { iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 0xf60); goto control_label_22b6; }
        iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 0xf60); goto control_label_22a0;
      }
      iVar1 = strcmp(param_1,((unsigned long)&rodata_9e23c) /*=0x9e23c*/);
      if (iVar1 == 0) {
        iVar1 = get_device_info(0);
        ...
        if (iVar1 < 0) goto control_label_2270;
        if (iVar6 < 3) return 0;
        if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) { iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 0xfea); goto control_label_22b6; }
        iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 0xfea); goto control_label_22a0;
      }
      iVar1 = strcmp(param_1,((unsigned long)&rodata_990cf) /*=0x990cf*/);
      if (iVar1 == 0) {
        iVar1 = get_device_info(0);
        ...
        if (iVar1 < 0) goto control_label_2270;
        if (iVar6 < 3) return 0;
        if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) { iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 1); goto control_label_22b6; }
        iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 1); goto control_label_22a0;
      }
      iVar1 = strcmp(param_1,((unsigned long)&rodata_9e249) /*=0x9e249*/);
      if (iVar1 != 0) {
        iVar1 = strcmp(param_1,((unsigned long)&rodata_9e259) /*=0x9e259*/);
        if (iVar1 != 0) return 0;
        iVar1 = get_device_info(0);
        ...
        if (iVar1 < 0) goto control_label_2270;
        if (iVar6 < 3) return 0;
        if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) { iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 0xef4); goto control_label_22b6; }
        iVar1 = get_device_info(0); uVar5 = (uint)*(byte *)(iVar1 + 0xef4); goto control_label_22a0;
      }
      iVar1 = get_device_info(0);
      if (*(int *)(iVar1 + 0xff4) == 0) return 0;
      iVar1 = get_device_info(0);
      uVar3 = 0x16a; uVar2 = *(undefined4 *)(iVar1 + 0xff4);
      goto control_label_2232;
    }
    iVar1 = get_device_info(0);
    ...
    if (iVar1 < 0) goto control_label_2270;
    if (iVar6 < 3) return 0;
    if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) { iVar1 = get_device_info(0); puVar4 = *(uint **)(iVar1 + 0xff0); goto control_label_22b4; }
