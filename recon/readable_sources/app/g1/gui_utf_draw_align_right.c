                        ...
                        if (status < 0) {
                            if (*log_level > 1) {
                                if (*use_alternate_log_sink == 0) {
                                    log_message(((unsigned long)&rodata_aaa58) /*=0xaaa58*/, ((unsigned long)&rodata_aad4b) /*=0xaad4b*/,
                                                codepoint, 0);
                                } else {
                                    debug_print();
                                }
...
invoke_callback:
    if (*log_level > 1) {
        if (*use_alternate_log_sink == 0) {
            log_message(((unsigned long)&rodata_aaa7f) /*=0xaaa7f*/, ((unsigned long)&rodata_aad4b) /*=0xaad4b*/, 0, 0);
        } else {
            debug_print();
        }
    }
