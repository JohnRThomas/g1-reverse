 ...
 *   0x000551dc       => struct g1_layout_ble_privacy_id_state__global_1168      [global_1168; G1-original]
 * Raw function identity: 0x00055094.  See ../include/g1_recovered_layouts.h. */
...
extern int bt_conn_lookup_state_le(unsigned long, unsigned long, unsigned long);
...
void ble_privacy_id_remove(int param_1)
{
    ...
    if(*(volatile unsigned char*)((unsigned long)&g_ble_rl_entries_max) /*=0x20002120*/ == 0){
        if(bVar1==0){
            printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"bt_dev.le.rl_entries > 0") /*=0xf369a*/,((unsigned long)&rodata_f3509) /*=0xf3509*/,0x433);
