...
int sc_set(int param_1, int param_2, codeptr param_3, int param_4)
{
  ...
  if (param_1 == 0) {
    ...
    short_diagnostic.label = ((unsigned long)&rodata_f2b65) /*=0xf2b65*/;
    log_msg_create_3arg(((unsigned long)&rodata_88128) /*=0x88128*/, 0x1040, &short_diagnostic);
  } else {
    ...
    if (iVar1 == 0) {
      ...
      if (local_44 == 0 || (iStack_50 = strtoul(local_44, 0, 10), iStack_50 == 0)) {
        ...
        if (puVar2 == 0) {
          ...
          puVar2 = (unsigned int*)find_sc_cfg_59bcc(0, (void*)((unsigned long)&rodata_f2b3a) /*=0xf2b3a*/);
          if (puVar2 == 0) {
            short_diagnostic.type = 2;
            short_diagnostic.label = ((unsigned long)&rodata_f4761) /*=0xf4761*/;
            log_msg_create_3arg(((unsigned long)&rodata_88128) /*=0x88128*/, 0x1040, &short_diagnostic);
            return -0xc;
          }
        ...
        if (-1 < iVar1) return 0;
        diagnostic.type = 3;
        diagnostic.label = ((unsigned long)&rodata_f4783) /*=0xf4783*/;
        diagnostic.value = iVar1;
        log_msg_create_3arg(((unsigned long)&rodata_88128) /*=0x88128*/, 0x1840, &diagnostic);
        return iVar1;
      }
      diagnostic.type = 3;
      diagnostic.label = ((unsigned long)&rodata_f4746) /*=0xf4746*/;
      diagnostic.value = iStack_50;
      log_msg_create_3arg(((unsigned long)&rodata_88128) /*=0x88128*/, 0x1840, &diagnostic);
    } else {
      diagnostic.type = 0x1000003;
      diagnostic.label = ((unsigned long)&rodata_f472a) /*=0xf472a*/;
      diagnostic.value = param_1;
      diagnostic.flags = 0x200;
      log_msg_create_3arg(((unsigned long)&rodata_88128) /*=0x88128*/, 0x1c40, &diagnostic);
    }
  }
  return -0x16;
}
