 ...
 * Raw function identity: 0x00026f74.  See ../include/g1_recovered_layouts.h. */
...
control_label_000270b8:
            ...
            if (param_1[0xd5] == '\x06') {
              if (param_2 != 1) goto control_label_00027148;
              if (499 < *(volatile uint16_t *)((unsigned long)&g_esb_sync_last_result) /*=0x2000f6e6*/) {
                *(volatile uint8_t *)((unsigned long)&g_esb_sync_tx_busy_flag) /*=0x20018d8f*/ = bVar3;
                goto control_label_000270da;
              }
            }
            else {
              bVar20 = param_2 == 1;
control_label_000270e0:
              if (!bVar20) goto control_label_00027148;
              if (499 < *(volatile uint16_t *)((unsigned long)&g_esb_sync_last_result) /*=0x2000f6e6*/) goto control_label_0002709c;
            }
control_label_000270ec:
            if (0 < *(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
              iVar8 = *(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
              log_format = 0x9ff6a;
              goto control_label_0002707a;
            }
          }
        }
        else {
          if ((param_1[0xd5] != '\x06') || (uVar16 != 2)) {
            if (param_2 == 0) goto control_label_0002709c;
            if (uVar16 == param_2) {
              if ((param_2 != 7) && (4 < param_2 - 0xc)) {
                if (*(volatile uint16_t *)((unsigned long)&g_esb_sync_last_result) /*=0x2000f6e6*/ < 500) goto control_label_000270ec;
                goto control_label_00027148;
              }
              *(volatile uint8_t *)((unsigned long)&g_esb_sync_tx_busy_flag) /*=0x20018d8f*/ = 1;
            }
            else {
control_label_00027148:
              *(volatile uint8_t *)((unsigned long)&g_esb_sync_tx_busy_flag) /*=0x20018d8f*/ = 1;
              if ((int32_t)param_2 < 3) goto control_label_000270da;
            }
            goto control_label_00027156;
          }
          if (param_2 != 0) {
            bVar20 = param_2 == 2;
            goto control_label_000270e0;
          }
          if (0 < *(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
            iVar8 = *(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
            log_format = ((unsigned long)"%s(): ESB send data after resume cmd, ignore it.\n") /*=0x9ff38*/;
            goto control_label_000270b8;
          }
        }
control_label_0002708e:
        *pbVar5 = 0;
      }
      else {
        if (param_2 != 0) {
...
control_label_0002707a:
          ...
          goto control_label_0002708e;
        }
control_label_0002709c:
        *(volatile uint8_t *)((unsigned long)&g_esb_sync_tx_busy_flag) /*=0x20018d8f*/ = 1;
control_label_000270da:
        *pbVar5 = bVar3;
control_label_00027156:
        cVar1 = param_1[0xda];
        if (param_1[0xd5] == '\n') {
        ...
        *(uint32_t *)(param_1 + 0xd0) = previous_value;
        if ((param_3 == (uint32_t *)0x0) || (param_4 == 0)) {
          uVar11 = 0;
control_label_000271d0:
          *(uint32_t *)(param_1 + 0xe5) = uVar11;
        }
        else {
          if (4 < param_4) {
            uVar11 = *param_3;
            goto control_label_000271d0;
          }
...
control_label_00027372:
          ...
          while (param_1[0x105a] != '\x02') {
            ...
            if (uVar16 == uVar17) {
              ...
              goto control_label_00027390;
            }
            k_msleep(1);
          }
          set_device_sync_timestamp(previous_value);
control_label_00027390:
          if (uVar17 <= uVar16) goto control_label_00026fa0;
          goto control_label_00027396;
        }
        cVar4 = param_1[0xee4];
        if (param_1[0xeb] == cVar4) {
          if (param_1[0xd5] == '\x10') {
            if ((param_1[0xe9] == param_1[0xcc]) && (param_1[0xce] == '\0')) {
              if (cVar4 != '\x02') goto control_label_00027304;
              goto control_label_000273f0;
            }
            param_1[0xda] = cVar1;
            if (0 < *(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
              iVar8 = *(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
              log_format = 0xa002c;
              goto control_label_00027298;
            }
          }
          else if (param_1[0xeb] == '\x02') {
            if (param_1[0xcc] == param_1[0xe9]) {
              if (param_1[0xce] == '\0') goto control_label_000273f0;
              param_1[0xda] = cVar1;
              if (0 < *(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
                iVar8 = *(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
                log_format = 0xa0066;
...
control_label_00027304:
            if (cVar4 == '\x01') {
              if (param_1[0xea] == param_1[0xcd]) {
                if (param_1[0xcf] == '\0') goto control_label_000273f0;
                param_1[0xda] = cVar1;
                if (0 < *(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
                  iVar8 = *(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
                  log_format = 0xa009a;
...
control_label_00027298:
          ...
          if (0 < *(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
            iVar8 = *(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
            log_format = ((unsigned long)&rodata_9ff92) /*=0x9ff92*/;
            goto control_label_00027298;
          }
        }
      }
