...
unsigned int log_msg_process(unsigned long param_1, unsigned long param_2) {
  ...
  if ((unsigned)((int)piVar1 - (int)piVar5) < 0xa0){
    ...
    printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"backend <= _log_backend_list_end") /*=0xf0cff*/,((unsigned long)&rodata_f0cae) /*=0xf0cae*/,0x126);
    printk(((unsigned long)"\tunexpected list end location\n") /*=0xf0d20*/);
    uVar4 = 0x126;
  } else {
    printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"log_backend_count_get() < (32 / 3U)") /*=0xf0cdb*/,((unsigned long)&rodata_f0cae) /*=0xf0cae*/,0x119);
    uVar4 = 0x119;
  }
