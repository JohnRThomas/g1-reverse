...
LAB_2c: if (iVar3 == 0) log_message(uVar9,((unsigned long)"gui_utf_draw_dark_light_split") /*=0xaad8e*/,uVar13); else debug_print(uVar9,((unsigned long)"gui_utf_draw_dark_light_split") /*=0xaad8e*/,uVar13); }
            } else {
  ...
  *(volatile char*)((unsigned long)&g_gui_dark_light_flag) /*=0x2001cdd4*/ = 0;
  if (1 < *(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/) {
    if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) log_message(((unsigned long)"%s(): dark_light_flag 0\n") /*=0xaab85*/,((unsigned long)"gui_utf_draw_dark_light_split") /*=0xaad8e*/);
