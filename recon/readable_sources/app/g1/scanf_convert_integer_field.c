 ...
 *   0x00079518       => struct g1_layout_scanf_field_parse_ctx__global_1431     [global_1431; G1-original]
 *   param_3          => struct g1_layout_fmt_conv_spec__param_0430              [param_0430; G1-original]
 *   param_2          => struct g1_layout_scanf_convert_ctx__param_0433          [param_0433; G1-original]
 *   local_34         => struct g1_layout_scanf_int_convert_locals__stack_1430   [stack_1430; G1-original]
 * Raw function identity: 0x0007932c.  See ../include/g1_recovered_layouts.h. */
        ...
        if (iVar1 != 0) {
            if (iVar12 == 1) {
                ...
                *param_2 = *param_2 & 0xfffffaff;
                ...
                if (uVar4 == 0) { iVar12 = 2; goto control_label_00079384; }
            } else if (iVar12 == 2) {
                ...
                *param_2 = *param_2 | 0x100;
                ...
                uVar4 = param_2[2]; param_2[2] = uVar4 - 1;
                if (uVar4 == 0) { iVar12 = 1; goto control_label_00079384; }
            }
            ...
            *(byte*)puVar11 = *pbVar5;
            ...
            if ((iVar1 - 1 < 1) && (iVar1 = ((fn)(uintptr_t)param_2[0x60])(param_1, (u32)(uintptr_t)param_3), iVar1 != 0)) {
                iVar12 = 0; goto control_label_000794a0;
            }
        }
        iVar12 = iVar12 + 1;
        puVar11 = puVar8;
