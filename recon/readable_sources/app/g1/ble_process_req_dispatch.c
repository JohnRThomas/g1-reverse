 ...
 *   local_b0         => struct g1_layout_ble_req_dispatch_locals__stack_0852    [stack_0852; G1-original]
 * Raw function identity: 0x00021460.  See ../include/g1_recovered_layouts.h. */
...
switchD_caseD_49:
    ...
    case 0x4e:
        if (load_i16(packet + 2) != 0) {
            ...
            safe_memcpy_checked((void *)((unsigned long)&g_2000ffa7) /*=0x2000ffa7*/, param_3 + 9,
...
control_label_00021706:
                    *puVar12 = returnStatus;
                    ...
                    if (*(volatile int8_t *)(*(volatile int32_t *)(iVar13 + 0x100c)) == 6) {
                        if (bVar10 == 0x40) goto control_label_0002175e;
                    } else if (bVar10 != 0x30) {
                        if (bVar10 == 0x40) {
control_label_0002175e:
                            iVar13 = get_device_info();
                            ...
                            *(volatile uint8_t *)(iVar13 + 0xdb) = 8;
                            ...
                            if (6 < *(volatile uint8_t *)(*(volatile int32_t *)(iVar13 + 0x100c))) {
                                ...
                                if (bVar10 == 0x50) {
                                    ...
                                    returnStatus = 9;
                                    puVar12 = *(volatile uint8_t **)(iVar13 + 0x100c);
                                    goto control_label_00021706;
                                }
                            }
                        }
                        goto control_label_000216b4;
                    }
                    iVar13 = get_device_info();
