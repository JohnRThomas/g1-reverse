...
#define G        ((unsigned long)&g_notification_display_buffer) /*=0x20004988*/          /* teleprompter state struct (r4) */
#define LL       ((unsigned long)&g_log_level) /*=0x2000230c*/          /* log level (r6) */
#define LP       ((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/          /* log-enable ptr (r8) */
#define HR       ((unsigned long)&g_20009ff0) /*=0x20009ff0*/          /* current hour  */
#define MN       ((unsigned long)&g_20009fec) /*=0x20009fec*/          /* current min   */
#define SC       ((unsigned long)&g_20009fe8) /*=0x20009fe8*/          /* current sec   */
#define CHR      ((unsigned long)&g_20009fe4) /*=0x20009fe4*/          /* cached hour   */
#define CMN      ((unsigned long)&g_20009fe0) /*=0x20009fe0*/          /* cached min    */
#define CSC      ((unsigned long)&g_20009fdc) /*=0x20009fdc*/          /* cached sec    */
#define BUF      ((unsigned long)&g_200049b8) /*=0x200049b8*/
#define OBJ      ((unsigned long)&g_ui_state_mutex) /*=0x20007b3c*/
#define FLAG7564 ((unsigned long)&g_20007564) /*=0x20007564*/
#define FLAG046a ((unsigned long)&g_2001046a) /*=0x2001046a*/
#define LOCK     ((unsigned long)&g_gui_canvas_flags) /*=0x2000a030*/
