 ...
 *   param_1          => struct g1_layout_k_thread_waitq_view__param_0412        [param_0412; library]
 * Raw function identity: 0x00073ec0.  See ../include/g1_recovered_layouts.h. */
...
void add_thread_to_wait_queue(volatile int *param_1, volatile int *param_2, uint32_t param_3, uint32_t param_4){
  ...
  *(volatile uint8_t*)((int)param_1+0xd) = *(volatile uint8_t*)((int)param_1+0xd) | 2;
  ...
  if(param_2!=0){
    ...
    if(param_1==piVar2){
      printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f84d6) /*=0xf84d6*/,((unsigned long)&rodata_f82f4) /*=0xf82f4*/,0xc1,param_4);
