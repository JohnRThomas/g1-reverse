                ...
                if(iVar1 == 0){
                    ...
                    if(iVar1 == 0){
                        ...
                        if(iVar1 == 0){
                            ...
                            if(CC == 0){ uVar2 = 0x3e4; goto control_label_00019090; }
                            uVar2 = 0x3e4;
                        } else {
                            if(C8 < 1) return iVar1;
                            if(CC == 0){ uVar2 = 0x3dc;
control_label_00019090:
                                log_message(((unsigned long)&rodata_9ab0c) /*=0x9ab0c*/, ((unsigned long)&rodata_9b15e) /*=0x9b15e*/, uVar2, iVar1); return iVar1; }
                            uVar2 = 0x3dc;
                        }
                    } else {
                        if(C8 < 1) return iVar1;
                        if(CC == 0){ uVar2 = 0x3d4; goto control_label_00019090; }
                        uVar2 = 0x3d4;
                    }
                } else {
                    if(C8 < 1) return iVar1;
                    if(CC == 0){ uVar2 = 0x3cc; goto control_label_00019090; }
                    uVar2 = 0x3cc;
                }
            } else {
                if(C8 < 1) return iVar1;
                if(CC == 0){ uVar2 = 0x3c4; goto control_label_00019090; }
                uVar2 = 0x3c4;
            }
        } else {
            if(C8 < 1) return iVar1;
            if(CC == 0){ uVar2 = 0x3bc; goto control_label_00019090; }
            uVar2 = 0x3bc;
        }
    } else {
        if(C8 < 1) return iVar1;
        if(CC == 0){ uVar2 = 0x3b4; goto control_label_00019090; }
        uVar2 = 0x3b4;
    }
