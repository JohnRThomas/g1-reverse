 ...
 *   0x00015100       => struct g1_layout_dtoa_r_scratch__global_0793            [global_0793; G1-original]
 *   local_2c         => struct g1_layout_dtoa_r_locals__stack_0792              [stack_0792; G1-original]
 * Raw function identity: 0x00014b60.  See ../include/g1_recovered_layouts.h. */
...
LAB_f4c:
    ...
    LAB_fd2:
        ...
        if (local_40 == 0) {
            if (((int)local_60 < 2) && (iVar7 == 0)) goto control_label_154f6;
        control_label_15522:
            iVar7 = 1;
        } else {
            ...
            control_label_154f6:
                ...
                bVar27 = (local_40 == 0);
                local_40 = puVar15;
                if (bVar27) goto control_label_15522;
            } else {
                puVar15 = 0;
            }
        ...
        control_label_1552e:
            ...
            iVar7 = 0x20 - uVar12;
            if (iVar7 < 5) {
                if (iVar7 != 4) goto control_label_1552e;
            } else {
                iVar7 = 0x1c - uVar12;
                local_68 = local_68 + iVar7;
                iVar10 = iVar10 + iVar7;
        ...
        if (bVar26 && ((iVar7 = (int)bignum_compare_abs(local_78, pcVar14)), iVar7 < 0)) {
            ...
            if (bVar28) {
                ...
                if ((0 < (int)pcVar3) || ((int)local_60 < 3)) goto control_label_150a8;
            } else if ((0 < (int)pcVar3) || ((int)local_60 < 3)) goto control_label_155a4;
        } else if ((0 < (int)pcVar17) || ((int)local_60 < 3)) {
            pcVar3 = pcVar17;
            if (!bVar28) goto control_label_155a4;
        control_label_150a8:
            pcVar20 = pcVar21;
            if (0 < iVar10) pcVar20 = (u32)lshift(param_1, pcVar21, iVar10);
            pcVar21 = pcVar20;
            if (local_40 == 0) goto control_label_155ea;
        ...
        control_label_155ea:
            ...
            while (1) {
                ...
                if (iVar6 == 0) {
                    if ((local_60 == 0) && ((uVar32 & 1) == 0)) {
                        if (uVar12 == 0x39) goto control_label_156c8;
                        if (0 < iVar7) goto control_label_1569c;
                        goto control_label_156a8;
                    }
                    if (iVar7 < 0) goto control_label_156a8;
                } else {
                    if ((iVar7 < 0) || ((local_60 == 0 && iVar7 == 0 && ((uVar32 & 1) == 0)))) {
                        if (0 < iVar6) goto control_label_1563c;
                        goto control_label_156a8;
                    }
                    if (0 < iVar6) goto control_label_156c2;
                }
                PC8(pcVar24) = (char)uVar12;
                if (pcVar17 + pcVar18 == pcVar3) goto control_label_15768;
                local_78 = (u32)multadd(param_1, local_78, 10, 0);
                pcVar24 = pcVar3;
                if (pcVar20 == pcVar21) {
            ...
            control_label_156c2:
                ...
                control_label_156c8:
                    PC8(pcVar24) = '9';
                    pcVar3 = pcVar24 + 1;
                    goto control_label_156d0;
                }
                cVar23 = (char)uVar12 + 1;
            }
            pcVar25 = pcVar24 + 1;
            PC8(pcVar24) = (char)cVar23;
            goto control_label_15190;
        }
        if (pcVar17 == 0) {
            pcVar14 = (u32)multadd(param_1, pcVar14, 5);
            iVar10 = (int)bignum_compare_abs(local_78, pcVar14);
            if (0 < iVar10) goto control_label_15586;
        }
    } else {
    control_label_153dc:
        local_70 = P64(((unsigned long)&rodata_88908) /*=0x88908*/ + (int)puVar4 * 8);
        if ((-1 < (int)local_50) || (0 < (int)pcVar17)) goto control_label_15338;
        if (pcVar17 == 0) goto control_label_153fa;
    control_label_15180:
        pcVar14 = 0;
        pcVar21 = 0;
    }
        ...
        if (pcVar17 == pcVar25 - pcVar18) {
            ...
            if ((iVar7 != 0) ||
                (((iVar7 = (int)__aeabi_dcmpeq(LO(uVar29), uVar9, LO(local_70), HI(local_70))), iVar7 != 0)
                 && (iVar10 << 0x1f < 0))) goto control_label_1545e;
            break;
        }
    }
    goto control_label_153a0;
control_label_1545e:
    pcVar25 = pcVar24;
    pcVar24 = pcVar25 - 1;
    if (PC8(pcVar24) != '9') goto control_label_15476;
