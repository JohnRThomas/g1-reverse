 ...
 *   param_1          => struct g1_layout_find_type_cb_ctx__param_0225           [param_0225; G1-original]
 *   param_3          => struct g1_layout_find_type_cb_ctx__param_0226           [param_0226; G1-original]
 *   local_3c         => struct g1_layout_ad_type_match_locals__stack_1195       [stack_1195; G1-original]
 * Raw function identity: 0x000583d0.  See ../include/g1_recovered_layouts.h. */
...
uint32_t find_type_cb(uint32_t *param_1, unsigned param_2, int *param_3)
{
    ...
    *(volatile uint16_t*)(sdesc + 2) = 0x2801;
    ...
    if (iVar1 == 0) goto control_label_584fc;
    sdesc[0] = 0;
    *(volatile uint16_t*)(sdesc + 2) = 0x2800;
    ...
    if ((int)uVar2 < 0) goto control_label_584fc;
