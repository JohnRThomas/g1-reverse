 ...
 *   0x000454a8       => struct g1_layout_gui_wordwrap_state__global_1026        [global_1026; G1-original]
 *   local_2f4        => struct g1_layout_utf_wordwrap_locals__stack_1027        [stack_1027; G1-original]
 * Raw function identity: 0x000451e0.  See ../include/g1_recovered_layouts.h. */
...
#define get_display_atomic_state atomic_get_3_0
#define get_glyph_spacing count_chars_in_default_font_table
#define load_glyph_resource resource_manger_get
#define clear_framebuffer_region clean_fb_data
#define refresh_display_region reflash_fb_data_to_lcd
                           ...
                           fnptr_t param_11, i32 param_12)
{
  ...
  if (param_10 == 0) {
    if (param_11 != 0) goto control_label_0004558c;
    if (param_12 == 0) {
      iVar3 = get_display_atomic_state();
      if ((i32)(iVar3 << 30) < 0) {
        clear_framebuffer_region(*(volatile u32*)((unsigned long)&g_gui_active_canvas) /*=0x2000a034*/, 0, param_4, param_5, param_6, param_7);
      }
      uVar14 = 0;
      uVar15 = 0;
      uVar12 = 0;
        ...
        if (iVar3 == 0) {
          ...
          if (iVar3 < 0) {
            ...
            if (((uVar8 >> 1) < uVar15) && (uVar14 < param_8 - 1)) {
              idx1 = 0;
control_label_000453d8:
              if (tbl1(idx1) != uVar16) goto code_r0x000453e0;
              if (uVar16 == 0) goto control_label_00045314;
              uVar7 = uVar18 + 1;
              uVar16 = uVar7;
              goto control_label_00045412;
code_r0x000453e0:
              idx1 = idx1 + 1;
              if (idx1 == 5) goto control_label_00045314;
              goto control_label_000453d8;

control_label_00045412:
              if ((i32)uVar16 < (i32)(u32)local_302) {
                idx2 = 0;
control_label_00045422:
                if (puVar2[uVar16] != tbl2(idx2)) goto control_label_0004543c;
                if (puVar2[uVar16] == 0) goto control_label_00045442;
                if (0x28 < (i32)(uVar16 - uVar18)) {
                  if (*(volatile i32*)((unsigned long)&g_log_level) /*=0x2000230c*/ < 2) goto control_label_00045314;
                  iVar3 = *(volatile i32*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
                  uVar13 = 0x000aabe8UL;
                  goto control_label_00045458;
                }
                iVar3 = 0;
...
control_label_00045458:
                ...
                goto control_label_00045314;
control_label_0004543c:
                idx2 = idx2 + 1;
                if (idx2 == 7) goto control_label_00045442;
                goto control_label_00045422;
control_label_00045442:
                uVar16 = uVar16 + 1;
                goto control_label_00045412;
              }
            }
control_label_00045314:
            ...
            if (uVar8 < uVar15) {
              ...
              draw_glyph_bitmap(*(volatile u32*)((unsigned long)&g_gui_active_canvas) /*=0x2000a034*/, local_2cc, local_2fc / 2, local_2f8, param_4, uVar12 + param_5);
              iVar3 = get_glyph_spacing(*puVar17, puVar17[1]);
              uVar15 = (u32)iVar3 + (u32)local_2fc;
              uVar19 = uVar15;
            } else {
              draw_glyph_bitmap(*(volatile u32*)((unsigned long)&g_gui_active_canvas) /*=0x2000a034*/, local_2cc, local_2fc / 2, local_2f8, param_4 + (i32)uVar19, uVar12 + param_5);
              iVar3 = get_glyph_spacing(*puVar17, puVar17[1]);
              uVar19 = uVar19 + (u32)iVar3 + (u32)local_2fc;
            }
control_label_0004537a:
            if (bVar20) goto control_label_0004537c;
          }
        } else if (iVar3 == -1) {
          if (uVar16 != 10) {
            bVar20 = (uVar16 == 0xd);
            goto control_label_0004537a;
          }
control_label_0004537c:
          if (local_2f8 == 0) {
            if (param_3 == 0) {
              uVar12 = uVar12 + 0x1b;
            } else {
    ...
    goto control_label_0004558c;
  }
  return 0;

control_label_0004558c:
  if (1 < *(volatile i32*)((unsigned long)&g_log_level) /*=0x2000230c*/) {
    if (*(volatile i32*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
