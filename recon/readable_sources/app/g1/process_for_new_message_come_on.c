 ...
 *   param_2          => struct g1_layout_new_message_evt__param_0079            [param_0079; G1-original]
 * Raw function identity: 0x0002c498.  See ../include/g1_recovered_layouts.h. */
...
extern void firmware_function_0007ce5c(int a, int b);
...
undefined1 process_for_new_message_come_on(byte *param_1, int param_2, char *param_3, unsigned *param_4)
{
    ...
    *(volatile undefined1 *)(param_2 + 7) = uVar3;
    ...
    do {
        ...
        firmware_function_0007ce5c(0x667, 0);
        if (*param_1 == 1) {
