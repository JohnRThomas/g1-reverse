 ...
 *   local_30         => struct g1_layout_hci_vs_init_locals__stack_0790         [stack_0790; G1-original]
 * Raw function identity: 0x00012080.  See ../include/g1_recovered_layouts.h. */
...
#define firmware_data_00012388 ((unsigned long)&g_ble_dev_state) /*=0x20002000*/
#define firmware_data_0001238c ((volatile int*)((unsigned long)&g_ble_dev_acl_buf_info) /*=0x20002078*/)
#define firmware_data_00012390 ((unsigned long)"Non-LE capable controller detected!") /*=0xf325b*/
#define firmware_data_00012394 ((unsigned long)&rodata_88138) /*=0x88138*/
#define firmware_data_00012398 ((volatile int*)((unsigned long)&g_ble_dev_le_features) /*=0x200020d8*/)
#define firmware_data_0001239c ((unsigned long)&g_ble_dev_le_pkts_sem) /*=0x20002108*/
#define firmware_data_000123a0 ((unsigned long)&rodata_f327f) /*=0xf327f*/
#define firmware_data_00012538 0x2008810UL
#define firmware_data_00012540 ((unsigned long)&rodata_88138) /*=0x88138*/
#define firmware_data_00012550 0x1000004UL
#define firmware_data_00012560 0x1000007UL
#define firmware_data_00012564 ((unsigned long)&rodata_f3324) /*=0xf3324*/
#define firmware_data_00012568 ((unsigned long)&g_ble_dev_state) /*=0x20002000*/
#define firmware_data_0001256c (*(volatile int*)((unsigned long)&rodata_1256c) /*=0x1256c*/)
#define firmware_data_00012578 ((unsigned long)"Firmware: %s (0x%02x) Version %u.%u Build %u") /*=0xf32f7*/
...
#define PTR_s_unknown_00012548 (*(volatile int*)((unsigned long)&rodata_12548) /*=0x12548*/)
#define PTR_PTR_s_reserved_00012544 (*(volatile int*)((unsigned long)&rodata_12544) /*=0x12544*/)
#define PTR_s_HW_Platform___s__0x_04x__0001254c (*(volatile int*)((unsigned long)&rodata_1254c) /*=0x1254c*/)
#define PTR_DAT_00012540 (*(volatile int*)((unsigned long)&rodata_12540) /*=0x12540*/)
#define PTR_PTR_s_reserved_00012554 (*(volatile int*)((unsigned long)&rodata_12554) /*=0x12554*/)
#define PTR_s_HW_Variant___s__0x_04x__00012558 (*(volatile int*)((unsigned long)&rodata_12558) /*=0x12558*/)
#define PTR_PTR_s_Standard_Bluetooth_controller_0001255c (*(volatile int*)((unsigned long)&rodata_1255c) /*=0x1255c*/)
...

{
  ...
  iVar5 = firmware_data_00012388;
  if ((*(uint *)(*(int *)(firmware_data_00012388 + 0x168) + 8) & 1) == 0) {
  ...
  puVar15 = firmware_data_0001238c;
  if (iVar1 != 0) {
    return iVar1;
  }
  uVar7 = *(undefined4 *)(*(int *)(local_30[0] + 0xc) + 5);
  *firmware_data_0001238c = *(undefined4 *)(*(int *)(local_30[0] + 0xc) + 1);
  puVar15[1] = uVar7;
  ...
  *(undefined2 *)(iVar5 + 0x76) = *(undefined2 *)(iVar1 + 5);
  ...
  if (-1 < (int)((uint)*(byte *)(iVar5 + 0x7c) << 0x19)) {
    local_1c = (undefined *)firmware_data_00012390;
    local_20 = 2;
    bt_log_forward_3arg(firmware_data_00012394,0x1040,&local_20);
    return -0x13;
  }
  iVar1 = bt_hci_cmd_send_sync(0x2003,0,local_30);
  puVar15 = firmware_data_00012398;
  if (iVar1 != 0) {
    return iVar1;
  }
  uVar7 = *(undefined4 *)(*(int *)(local_30[0] + 0xc) + 5);
  *firmware_data_00012398 = *(undefined4 *)(*(int *)(local_30[0] + 0xc) + 1);
  puVar15[1] = uVar7;
  net_buf_unref(local_30[0]);
  ...
  if ((int)((uint)*(byte *)(iVar5 + 0x7c) << 0x1a) < 0) {
    if (*(short *)(iVar5 + 0x104) == 0) {
      local_1c = (undefined *)firmware_data_000123a0;
      local_20 = 2;
      bt_log_forward_3arg(firmware_data_00012394,0x1040,&local_20);
      return -5;
    }
    ...
    if (*(short *)(iVar5 + 0x104) == 0) {
      ...
      *(undefined2 *)(iVar5 + 0x104) = *(undefined2 *)(iVar1 + 1);
      z_impl_k_sem_init(firmware_data_0001239c,*(undefined2 *)(iVar1 + 4));
    }
    net_buf_unref(local_30[0]);
  }
  ...
  if (-1 < (int)((uint)*(byte *)(iVar5 + 0xd8) << 0x1f)) {
    uVar8 = firmware_data_00012538;
    uVar7 = ((unsigned long)&g_sram_base_word) /*=0x20000000*/;
  }
  ...
  if (iVar5 == 0) {
    ...
    local_50 = firmware_data_00012550;
    ...
    local_3c = 0x200;
    local_54 = firmware_data_00012578;
    local_58 = firmware_data_00012560;
    bt_log_forward_3arg(PTR_DAT_00012540,0x3cc0,&local_58);
    net_buf_unref(local_34);
    iVar1 = bt_hci_cmd_send_sync(0xfc02,0,&local_34);
    iVar5 = firmware_data_00012568;
    puVar13 = firmware_data_00012564;
    if (iVar1 == 0) {
      *(undefined2 *)(firmware_data_00012568 + 0xc1) = *(undefined2 *)(*(int *)(local_34 + 0xc) + 1);
      net_buf_unref(local_34);
      if (-1 < (int)((uint)*(byte *)(iVar5 + 0xc1) << 0x1d)) goto control_label_000123fe;
      iVar1 = bt_hci_cmd_send_sync(0xfc03,0,&local_34);
      puVar13 = firmware_data_0001256c;
      if (iVar1 == 0) {
        *(undefined1 *)(iVar5 + 0xc0) = *(undefined1 *)(*(int *)(local_34 + 0xc) + 1);
        net_buf_unref(local_34);
        goto control_label_000123fe;
      }
    }
  }
  local_20 = 2;
