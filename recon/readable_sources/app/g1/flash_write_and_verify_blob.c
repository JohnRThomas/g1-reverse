 ...
 *   param_1          => struct g1_layout_flash_blob_write_req__param_0086       [param_0086; G1-original]
 * Raw function identity: 0x00030528.  See ../include/g1_recovered_layouts.h. */
            ...
            if ((iVar6 == 0) && (iVar6 = attr_store_set(0x4820, 4, 0, 0, 0), iVar6 == 0)) {
                ...
                if (uVar11 == 0) {
                    for (; uVar11 < uVar9; uVar11 = uVar11 + 4) {
                        ...
                        pbVar12 = pbVar12 + 4;
                        if (iVar6 != 0) goto control_label_00030622;
                    }
