...
void bt_id_conflict_resolve_cb(int param_1, int *param_2){
    ...
    unsigned uVar3;
    if (param_2 == 0){
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"conflict != ((void *)0)") /*=0xf3537*/, ((unsigned long)&rodata_f3509) /*=0xf3509*/, 0x36c);
        uVar3=0x36c; assert_post_action(((unsigned long)&rodata_f3509) /*=0xf3509*/, uVar3); return;
    }
    int iVar4 = *param_2;
    if (iVar4 == 0){
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"conflict->candidate != ((void *)0)") /*=0xf354f*/, ((unsigned long)&rodata_f3509) /*=0xf3509*/, 0x36d);
        uVar3=0x36d; assert_post_action(((unsigned long)&rodata_f3509) /*=0xf3509*/, uVar3); return;
    } else if (param_1 == 0){
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"resident != ((void *)0)") /*=0xf3572*/, ((unsigned long)&rodata_f3509) /*=0xf3509*/, 0x36e);
        ...
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"(conflict->candidate->state & BT_KEYS_ID_ADDED) == 0") /*=0xf358a*/, ((unsigned long)&rodata_f3509) /*=0xf3509*/, 0x370);
