 ...
 *   0x0004ecf8       => struct g1_layout_ble_discovery_state__global_1077       [global_1077; G1-original]
 *   param_2          => struct g1_layout_bt_gatt_dm_attr_ctx__param_0155        [param_0155; library]
 *   local_3c         => struct g1_layout_discovery_callback_locals__stack_1078  [stack_1078; G1-original]
 *   local_38         => struct g1_layout_discovery_result_flags__stack_1079     [stack_1079; G1-original]
 * Raw function identity: 0x0004ea78.  See ../include/g1_recovered_layouts.h. */
...
control_label_eb88:
        ...
        *piVar5 = *piVar10; piVar5[1] = piVar10[1];
        ...
        if (iVar4 == 0) goto control_label_eb88;
        iVar4 = piVar5[1];
        *(short*)((int)piVar2 + 0x16) = (short)iVar4;
        if (*(short*)(iVar3 + 4) == (short)iVar4) goto control_label_ebe6;
    ...
    if (param_2 == 0) {
      if ((uint)piVar2[0x4d] < 2) goto control_label_ebe6;
      piVar10 = piVar2 + 2;
