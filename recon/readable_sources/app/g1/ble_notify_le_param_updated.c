 ...
 *   param_1          => struct g1_layout_bt_conn_le_ctx__param_0208             [param_0208; library]
 * Raw function identity: 0x00056ae0.  See ../include/g1_recovered_layouts.h. */
...
void ble_notify_le_param_updated(int param_1, u32 p2, u32 p3, u32 p4){
    ...
    while(1){
        if(uVar1 < uVar3){
            printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f3a8d) /*=0xf3a8d*/, ((unsigned long)&rodata_f3a5d) /*=0xf3a5d*/, 0x634);
