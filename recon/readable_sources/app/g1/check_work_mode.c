...
#define firmware_data_00027a6c ((volatile int*)((unsigned long)&g_battery_percent) /*=0x200069e8*/)
#define firmware_data_00027a70 ((volatile int*)((unsigned long)&onboarding_pending_flag) /*=0x20018d93*/)
#define firmware_data_00027a74 ((volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/)
#define firmware_data_00027a78 ((volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define firmware_data_00027a7c ((unsigned long)"check_work_mode") /*=0xa1b00*/
#define firmware_data_00027a80 ((unsigned long)"%s(): MODE_NORMAL_STANBY_ID\n") /*=0xa0132*/
#define firmware_data_00027a84 ((volatile int*)((unsigned long)&g_wear_state_debounce_cnt) /*=0x20018d87*/)
#define firmware_data_00027a88 ((volatile int*)((unsigned long)&g_wear_off_confirm_cnt) /*=0x20018d92*/)
#define firmware_data_00027a8c 0xa014fUL
#define firmware_data_00027a90 ((volatile int*)((unsigned long)&g_nfc_link_retry_cnt) /*=0x20018d86*/)
#define firmware_data_00027a94 ((unsigned long)"%s(): EVENT_GLASS_HAS_FINISH_BIND\n") /*=0xa01c7*/
#define firmware_data_00027a98 ((unsigned long)"%s(): MODE_CHARGING_LOW_POWER_ID\n") /*=0xa0169*/
#define firmware_data_00027a9c 0xa018bUL
#define firmware_data_00027aa0 0xa01a7UL
#define firmware_data_00027aa4 ((unsigned long)"%s(): EVENT_PUT_IN_GLASS_BOX_CLOSE\n") /*=0xa01ea*/
#define firmware_data_00027aa8 ((volatile int*)((unsigned long)&g_last_standby_event_id) /*=0x2000302d*/)
#define firmware_data_00027aac ((unsigned long)"%s(): EVENT_PUT_IN_GLASS_BOX_OPEN\n") /*=0xa020e*/
#define firmware_data_00027ab0 ((unsigned long)"%s(): EVENT_ENTER_WARED\n") /*=0xa0231*/
#define firmware_data_00027ab4 ((unsigned long)"%s(): EVENT_UNWARED_OUTBOX\n") /*=0xa024a*/
#define firmware_data_00027ab8 ((volatile int*)((unsigned long)&g_last_reported_box_charge_pct) /*=0x20003029*/)
#define firmware_data_00027abc ((volatile int*)((unsigned long)&g_last_reported_box_charge_status) /*=0x20003028*/)
#define firmware_data_00027ac0 ((volatile int*)((unsigned long)&g_glassbox_status_debounce_cnt) /*=0x20018d85*/)
#define firmware_data_00027ac4 ((volatile int*)((unsigned long)&g_box_state_debounce_cnt) /*=0x20018d84*/)
#define firmware_data_00027ac8 ((volatile int*)((unsigned long)&g_charge_notify_state_init_flag) /*=0x2000302a*/)
#define firmware_data_00027cc0 ((volatile int*)((unsigned long)&g_last_reported_battery_pct) /*=0x20003027*/)
#define firmware_data_00027cc4 ((volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define firmware_data_00027cc8 ((unsigned long)"check_work_mode") /*=0xa1b00*/
#define firmware_data_00027ccc ((unsigned long)"%s(): EVENT_STATE_BATTERY_PERCENT %d\n") /*=0xa0266*/
#define firmware_data_00027cd0 ((volatile int*)((unsigned long)&g_box_state_debounce_cnt) /*=0x20018d84*/)
#define firmware_data_00027cd4 ((volatile int*)((unsigned long)&g_glassbox_lid_debounced_state) /*=0x20003026*/)
#define firmware_data_00027cd8 ((volatile int*)((unsigned long)&g_last_reported_box_charge_status) /*=0x20003028*/)
#define firmware_data_00027cdc ((volatile int*)((unsigned long)&g_glassbox_status_debounce_cnt) /*=0x20018d85*/)
#define firmware_data_00027ce0 ((volatile int*)((unsigned long)&g_last_reported_box_charge_pct) /*=0x20003029*/)
#define firmware_data_00027ce4 ((unsigned long)"%s(): EVENT_GLASS_BOX_SOC %d\n") /*=0xa030d*/
#define firmware_data_00027ce8 ((volatile int*)((unsigned long)&g_check_work_mode_ed5_field_cache) /*=0x20003025*/)
#define firmware_data_00027cec ((unsigned long)"%s(): EVENT_STATE_CHARGING %d\n") /*=0xa028c*/
#define firmware_data_00027cf0 ((unsigned long)"%s(): EVENT_GLASS_BOX_STATUS %d\n") /*=0xa02ab*/
...

{
  ...
  if (*firmware_data_00027a6c < 0x33) {
    if (*firmware_data_00027a6c < 0x28) {
      *firmware_data_00027a90 = 0;
      get_device_info();
      ...
      if ((byte)(*firmware_data_00027a84 + 1) < bVar8) {
        *firmware_data_00027a84 = *firmware_data_00027a84 + 1;
      }
      else {
        *firmware_data_00027a84 = bVar8;
        *firmware_data_00027a70 = 0;
        *firmware_data_00027a88 = 0;
        clear_app_switch_pending_flag();
        piVar2 = firmware_data_00027a74;
        if (param_1 == 0) {
          if (uVar4 != 4) {
            _event_id2 = get_device_info();
            set_shutdown_flag(_event_id2,1);
            change_work_mode_to(4);
            if (0 < *firmware_data_00027a74) {
              iVar5 = *firmware_data_00027a78;
              _event_id2 = firmware_data_00027aa0;
              goto control_label_00027964;
            }
          }
        }
        else if (param_2 == 0) {
          ...
          if (0 < *piVar2) {
            iVar5 = *firmware_data_00027a78;
            _event_id2 = firmware_data_00027a9c;
            goto control_label_00027964;
          }
        }
        else {
          ...
          if (0 < *piVar2) {
            iVar5 = *firmware_data_00027a78;
            _event_id2 = firmware_data_00027a98;
control_label_00027964:
            if (iVar5 == 0) {
    ...
    *firmware_data_00027a70 = 1;
    enter_wear_burial_point();
    if (uVar4 - 2 < 2) {
      get_device_info();
      iVar5 = display_panel_is_secondary();
      if ((iVar5 != 0) && (change_work_mode_to(2), 0 < *firmware_data_00027a74)) {
        iVar5 = *firmware_data_00027a78;
        _event_id2 = firmware_data_00027a8c;
        goto control_label_0002782c;
      }
    }
    else {
      _event_id2 = get_device_info();
      ...
      if (0 < *firmware_data_00027a74) {
        iVar5 = *firmware_data_00027a78;
        _event_id2 = firmware_data_00027a80;
control_label_0002782c:
        if (iVar5 == 0) {
          log_message(_event_id2,firmware_data_00027a7c);
        }
        else {
    ...
    pbVar7 = firmware_data_00027a88;
    *firmware_data_00027a84 = 0;
    bVar8 = *pbVar7 + 1;
    if (bVar8 < 2) {
control_label_00027844:
      *pbVar7 = bVar8;
    }
    else {
      *pbVar7 = 2;
      bVar8 = *firmware_data_00027a90 + 1;
      pbVar7 = firmware_data_00027a90;
      if (bVar8 < 10) goto control_label_00027844;
      *firmware_data_00027a90 = 0;
  ...
  pbVar7 = firmware_data_00027ce0;
  pcVar6 = firmware_data_00027ac8;
  piVar2 = firmware_data_00027a74;
  if (param_3 == 0) {
    *firmware_data_00027ac8 = -1;
    *pbVar7 = 0xff;
    *firmware_data_00027cd8 = 0xff;
    *firmware_data_00027cc0 = 0xff;
    *firmware_data_00027cd4 = 0xff;
    *firmware_data_00027ce8 = -1;
    *firmware_data_00027cdc = 4;
    *firmware_data_00027cd0 = 4;
    return;
  }
  if ((*firmware_data_00027ac8 == -1) || (iVar5 = get_device_info(), *(int *)(iVar5 + 0x9b4) == 2)) {
    iVar5 = get_device_info();
  ...
  if (param_1 == 0) {
    ...
    *firmware_data_00027ab8 = 0xff;
    *firmware_data_00027abc = 0xff;
    *firmware_data_00027ac0 = 4;
    *firmware_data_00027ac4 = 4;
  }
  else if (param_2 == 0) {
    if (0 < iVar5) {
      if (*firmware_data_00027a78 == 0) {
  ...
  pbVar7 = firmware_data_00027aa8;
  if (*firmware_data_00027aa8 != event_id) {
    send_event(event_id);
    *pbVar7 = event_id;
    return;
  }
  iVar5 = get_device_info();
  pbVar3 = firmware_data_00027cd4;
  pbVar7 = firmware_data_00027cd0;
  bVar8 = *(byte *)(iVar5 + 0xfc0);
  if ((*firmware_data_00027cc0 != bVar8) && (bVar8 < 0x65)) {
    *firmware_data_00027cc0 = bVar8;
    if (0 < *piVar2) {
      if (*firmware_data_00027cc4 == 0) {
    ...
    _event_id2 = 0xa;
    goto control_label_00027af8;
  }
  if (param_1 == 0) {
    if (*firmware_data_00027cd4 != 0) {
control_label_00027b70:
      uVar4 = 0;
control_label_00027b72:
      if ((byte)(*pbVar7 + 1) < 5) {
        *pbVar7 = *pbVar7 + 1;
        return;
      }
    ...
    *firmware_data_00027cd0 = 0;
    ...
    if (uVar4 == 0) {
      if (*pbVar3 != 0) goto control_label_00027b70;
    }
    else {
      *pbVar7 = 4;
      if (*pbVar3 != uVar4) goto control_label_00027b72;
    }
    *pbVar7 = 0;
    new_box_charging_status = get_glassbox_charge_status();
    pbVar3 = firmware_data_00027cdc;
    pbVar7 = firmware_data_00027cd8;
    if (*firmware_data_00027cd8 != new_box_charging_status) {
      bVar8 = *firmware_data_00027cdc;
      *firmware_data_00027cdc = bVar8 + 1;
      if (4 < (byte)(bVar8 + 1)) {
        iVar5 = *piVar2;
        *pbVar3 = 0;
      ...
      uVar4 = (uint)*pbVar7;
      if (*firmware_data_00027cc4 == 0) {
        log_message(_DAT_00027cf4,firmware_data_00027cc8,uVar4,new_box_charging_status);
        return;
      }
      ((log4_fn)debug_print)(_DAT_00027cf4,firmware_data_00027cc8,uVar4,new_box_charging_status);
      return;
    }
    *firmware_data_00027cdc = 0;
    uVar4 = get_glassbox_charge_percent();
    if ((*firmware_data_00027ce0 != uVar4) && (uVar4 < 0x65)) {
      iVar5 = *piVar2;
      *firmware_data_00027ce0 = (byte)uVar4;
      if (0 < iVar5) {
        if (*firmware_data_00027cc4 == 0) {
          log_message(firmware_data_00027ce4,firmware_data_00027cc8,uVar4,uVar4);
        }
        else {
          ((log3_fn)debug_print)(firmware_data_00027ce4,firmware_data_00027cc8,uVar4);
        }
      }
      _event_id2 = 0xf;
      goto control_label_00027af8;
    ...
    if (0 < *piVar2) {
      if (*firmware_data_00027cc4 == 0) {
        log_message(_DAT_00027cf8,firmware_data_00027cc8,(uint)*firmware_data_00027ce0,uVar4);
      }
      else {
        ((log2_fn)debug_print)(_DAT_00027cf8,firmware_data_00027cc8);
      }
    }
  }
  pcVar6 = (char *)get_device_info();
  if ((*pcVar6 == '\x01') && (iVar5 = get_device_info(), *(int *)(iVar5 + 0xf90) != 0)) {
    ...
    if ((iVar5 != 0xff) &&
       (iVar5 = get_device_info(), pcVar6 = firmware_data_00027ce8, *(char *)(iVar5 + 0xed5) != *firmware_data_00027ce8)) {
      iVar5 = get_device_info();
      _event_id2 = 0x12;
      *pcVar6 = *(char *)(iVar5 + 0xed5);
control_label_00027af8:
