...
void boot_write_swap_info(uintptr_t object,uint32_t low,uint32_t high){
 if(high>14){
  uint64_t result=__assert_func(((unsigned long)&rodata_f68d7) /*=0xf68d7*/,0x182,((unsigned long)&rodata_f693a) /*=0xf693a*/,((unsigned long)&rodata_f68c5) /*=0xf68c5*/,object,low);
  low=(uint32_t)(result>>32);high=((unsigned long)&rodata_f693a) /*=0xf693a*/;
  while(low>14){result=__assert_func(((unsigned long)&rodata_f68d7) /*=0xf68d7*/,0x182,((unsigned long)&rodata_f693a) /*=0xf693a*/,((unsigned long)&rodata_f691a) /*=0xf691a*/,object,low);low=(uint32_t)(result>>32);}
 }
