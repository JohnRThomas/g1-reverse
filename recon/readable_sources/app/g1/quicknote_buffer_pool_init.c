 ...
 *   param_1          => struct g1_layout_quicknote_buffer_pool__param_0119      [param_0119; G1-original]
 * Raw function identity: 0x00047148.  See ../include/g1_recovered_layouts.h. */
...
void quicknote_buffer_pool_init(int* param_1){
    ...
    param_1[1] = ((unsigned long)&rodata_46d8d) /*=0x46d8d*/;
    param_1[2] = ((unsigned long)&rodata_46f21) /*=0x46f21*/;
    param_1[3] = ADDR_panel_off_THUMB /*=0x46d2d*/;
    param_1[4] = ADDR_panel_on_THUMB /*=0x46dd9*/;
    param_1[5] = ((unsigned long)&rodata_35775) /*=0x35775*/;
    param_1[6] = ((unsigned long)&rodata_7d4d7) /*=0x7d4d7*/;
    param_1[7] = ((unsigned long)&rodata_7d4cb) /*=0x7d4cb*/;
    param_1[8] = ((unsigned long)&rodata_46ce9) /*=0x46ce9*/;
