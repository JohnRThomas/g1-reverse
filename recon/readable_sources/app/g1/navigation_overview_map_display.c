 ...
 *   param_2          => struct g1_layout_nav_overview_map_ctx__param_0111       [param_0111; G1-original]
 * Raw function identity: 0x0003e05c.  See ../include/g1_recovered_layouts.h. */
...
extern void firmware_function_0007d376(unsigned a, unsigned b, unsigned c, unsigned d);
extern void firmware_function_0007d37a(unsigned a);
...
void navigation_overview_map_display(unsigned param_1, int param_2)
{
    ...
    if (*(volatile unsigned char*)(((unsigned long)g_ipc_or_evt_ctx) /*=0x20004bb8*/ + 5) == 0) {
        ...
        if ((*(volatile unsigned char*)((unsigned long)&g_20010326) /*=0x20010326*/ == 1) &&
            ...
            *pcVar4 = 1;
            firmware_function_0007d37a(((unsigned long)&g_ble_work_queue) /*=0x20007574*/);
        }
        ...
        do {
            ...
            uVar13 = 0;
            lbuf32[0] = *(volatile unsigned*)((unsigned long)&rodata_a8c57) /*=0xa8c57*/;
            lbuf32[1] = *(volatile unsigned*)(((unsigned long)&rodata_a8c57) /*=0xa8c57*/ + 4);
            do {
                iVar9 = 0;
                do {
