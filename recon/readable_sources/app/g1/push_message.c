 ...
 *   param_1          => struct g1_layout_app_shared_ctx_blob__param_0007        [param_0007; G1-original]
 * Raw function identity: 0x00033f54.  See ../include/g1_recovered_layouts.h. */
...
unsigned char push_message(int param_1, int param_2, int param_3)
{
    ...
    if (param_1 == 0) {
        ...
        if (*(int *)(param_1 + 0x1b0) == 0) {
            ...
            if ((int)uVar9 == 0) goto control_label_00033fb2;
            if (iVar7 < 1) return 0;
            iVar7 = *g88;
    ...
    *(unsigned char *)(param_1 + 0xf) = 0;
    ...
    if (uVar8 < 0x14) {
        ...
        *(unsigned char *)(param_1 + 0xc) = bVar4;
        ...
        if (0 < iVar7) {
            if (*g88 == 0) {
                log_message(((unsigned long)&rodata_a7e3d) /*=0xa7e3d*/, ((unsigned long)&rodata_a823b) /*=0xa823b*/, uVar8, *(int *)(param_1 + 8), *(int *)(param_1 + 4), *(int *)(param_1 + 0x1b0));
            } else {
                debug_print(((unsigned long)&rodata_a7e3d) /*=0xa7e3d*/, ((unsigned long)&rodata_a823b) /*=0xa823b*/, uVar8, *(int *)(param_1 + 8), *(int *)(param_1 + 4), *(int *)(param_1 + 0x1b0));
            }
            final_r2 = uVar8;
        }
        bVar4 = *pbVar1 + 1;
        ...
        if (0 < iVar7) {
            if (*g88 == 0) {
                log_message(((unsigned long)&rodata_a7e85) /*=0xa7e85*/, ((unsigned long)&rodata_a823b) /*=0xa823b*/, 0x13, uVar6, *(int *)(param_1 + 4));
            } else {
                debug_print(((unsigned long)&rodata_a7e85) /*=0xa7e85*/, ((unsigned long)&rodata_a823b) /*=0xa823b*/, 0x13, uVar6, *(int *)(param_1 + 4));
            }
        }
        iVar2 = 10;
