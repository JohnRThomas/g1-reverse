...
control_label_0002edf8:
        iVar5 = iVar6;
        if (iVar6 != 0) goto control_label_0002ede2;
    } else {
        if (iVar6 != 0) {
            if (iVar7 != 0) {
                    ...
                    do {
                        if (iVar8 == iVar10 + iVar7) {
                            ...
                            if (iVar11 != 1) {
                                ...
                                goto control_label_0002eeb6;
                            }
                            if (0x40ffff < *puVar2v) goto control_label_0002eeb6;
                            ...
                            iVar9 = write_frame(((unsigned long)&rodata_87bf0) /*=0x87bf0*/, *puVar2v,
                                               iVar7, iVar10);
                            if (iVar9 != 0) {
                                if (*v < 1) goto control_label_0002eeb6;
                                iVar10 = *dbg;
...
control_label_0002ee16:
        ...
        if (0 < *v) goto control_label_0002ee16;
control_label_0002ede2:
        free(iVar5);
    }
    if (iVar7 == 0) return;
control_label_0002edce:
    free(iVar7);
    return;
}
