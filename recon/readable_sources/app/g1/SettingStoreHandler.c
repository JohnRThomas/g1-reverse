 ...
 * Raw function identity: 0x00023f04.  See ../include/g1_recovered_layouts.h. */
...
#define firmware_data_00024190 ((volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/)
#define firmware_data_00024194 ((volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define firmware_data_00024198 ((unsigned long)"getSettingStorageQueueCacheData") /*=0x9ecd5*/
#define firmware_data_0002419c ((unsigned long)"%s(): setting storage queue get failed\r\n\n") /*=0x9ea7b*/
#define firmware_data_000241a0 ((unsigned long)"SettingStoreHandler") /*=0x9ecf5*/
#define firmware_data_000241a4 0x9eaa5UL
#define firmware_data_000241a8 ((unsigned long)"%s(): received setting command .\n") /*=0x9ead2*/
#define firmware_data_000241ac ((unsigned long)"%s(): start setting  parameter check. language type = %d\n") /*=0x9eaf4*/
#define firmware_data_000241b0 ((unsigned long)"%s(): Setting Task received error language parameters.\n") /*=0x9eb2e*/
#define firmware_data_000241b4 ((unsigned long)&g_ui_mode_flag) /*=0x20018462*/
#define firmware_data_000241b8 0x9eb66UL
#define firmware_data_000241bc ((unsigned long)&rodata_87bf0) /*=0x87bf0*/
#define firmware_data_000241c0 ((unsigned long)&rodata_9e9ea) /*=0x9e9ea*/
#define firmware_data_000241c4 ((unsigned long)&rodata_9eba7) /*=0x9eba7*/
#define firmware_data_000241c8 ((unsigned long)&rodata_9ebc6) /*=0x9ebc6*/
#define firmware_data_000241cc 0x9ebe5UL
#define firmware_data_000241d0 ((unsigned long)&rodata_9ea0a) /*=0x9ea0a*/
#define firmware_data_000243dc (*(volatile int**)((unsigned long)&rodata_243dc) /*=0x243dc*/)
#define firmware_data_000243e0 (*(volatile int*)((unsigned long)&rodata_243e0) /*=0x243e0*/)
#define firmware_data_000243e4 (*(volatile int*)((unsigned long)&rodata_243e4) /*=0x243e4*/)
#define firmware_data_000243e8 (*(volatile int*)((unsigned long)&rodata_243e8) /*=0x243e8*/)
#define firmware_data_000243ec (*(volatile int*)((unsigned long)&rodata_243ec) /*=0x243ec*/)
#define firmware_data_000243f0 (*(volatile int*)((unsigned long)&rodata_243f0) /*=0x243f0*/)
#define firmware_data_000243f4 (*(volatile int*)((unsigned long)&rodata_243f4) /*=0x243f4*/)
#define firmware_data_000243f8 (*(volatile int*)((unsigned long)&rodata_243f8) /*=0x243f8*/)
...

{
  ...
  iVar4 = k_msgq_get(firmware_data_0002418c,local_20,0,0);
  piVar2 = firmware_data_00024194;
  piVar1 = firmware_data_00024190;
  if (iVar4 == 0) {
    if (2 < *firmware_data_00024190) {
      if (*firmware_data_00024194 == 0) {
        log_message(firmware_data_000241a8,firmware_data_000241a0);
      }
      else {
        debug_print(firmware_data_000241a8,firmware_data_000241a0);
      }
    }
    puVar3 = firmware_data_000243f4;
    puVar10 = firmware_data_000241bc;
    uVar8 = 0;
    switch(local_20[0]) {
    case 1:
      ...
      if (2 < *piVar1) {
        if (*firmware_data_00024194 == 0) {
          log_message(firmware_data_000241ac,firmware_data_000241a0,uVar8);
        }
        else {
          debug_print(firmware_data_000241ac,firmware_data_000241a0,uVar8);
        }
      }
      puVar10 = firmware_data_000241bc;
      iVar4 = firmware_data_000241b4;
      if (uVar8 - 1 < 0x12) {
        if (*(byte *)(firmware_data_000241b4 + 1) == uVar8) {
          iVar7 = *piVar1;
          bVar13 = SBORROW4(iVar7,2);
          iVar4 = iVar7 + -2;
          bVar12 = iVar7 == 2;
          goto control_label_00023fc4;
        }
        iVar7 = z_device_is_ready(firmware_data_000241bc);
        if (iVar7 != 0) {
          local_24 = 0;
          local_22 = 0;
          ...
          if (iVar7 == 0) {
            ...
            if (uVar8 != 0) goto control_label_00024044;
            iVar7 = get_device_info();
            pcVar11 = *(code **)(iVar7 + 0x1034);
            uVar6 = get_device_info();
            uVar8 = (*pcVar11)(uVar6,0x13e000,&local_24,3);
            if (uVar8 != 0) goto control_label_00024074;
            local_24 = 0;
            local_22 = 0;
            iVar7 = get_device_info();
            pcVar11 = *(code **)(iVar7 + 0x1030);
            ...
            if (iVar7 == 0) {
              *(undefined1 *)(iVar4 + 1) = ((unsigned long long)(local_24)>>8 & 0xffULL);
              ...
              iVar4 = *firmware_data_00024194;
              uVar6 = firmware_data_000241cc;
              uVar5 = firmware_data_000241a0;
              goto control_label_000240c6;
            }
          }
          goto control_label_0002401a;
        }
control_label_00023fda:
        if (*piVar1 < 1) break;
        uVar6 = *puVar10;
control_label_00023fe2:
        iVar4 = *firmware_data_00024194;
        uVar5 = firmware_data_000241c0;
        goto control_label_00023fea;
      }
      if (0 < *piVar1) {
        iVar4 = *firmware_data_00024194;
        uVar6 = firmware_data_000241b0;
        uVar5 = firmware_data_000241a0;
        goto control_label_00023f56;
      }
      break;
    case 2:
      iVar4 = z_device_is_ready(firmware_data_000241bc);
      if (iVar4 != 0) {
        local_24 = 0;
        local_22 = 0;
        ...
        if (iVar4 == 0) {
          ...
          uVar8 = ((code3)pcVar11)(uVar6,0x13e000,0x1000);
          if (uVar8 != 0) {
control_label_00024044:
            if (*piVar1 < 3) {
              return uVar8;
            }
            iVar4 = *firmware_data_00024194;
            uVar6 = firmware_data_000241c4;
            uVar5 = firmware_data_000241a0;
            uVar9 = uVar8;
control_label_000240c6:
            if (iVar4 != 0) {
          ...
          uVar8 = (*pcVar11)(uVar6,0x13e000,&local_24,3);
          if (uVar8 != 0) {
control_label_00024074:
            if (*piVar1 < 1) {
              return uVar8;
            }
            iVar4 = *firmware_data_00024194;
            uVar6 = firmware_data_000241c8;
            uVar5 = firmware_data_000241a0;
            uVar9 = uVar8;
            goto control_label_000240c6;
          }
          ...
          if (iVar4 == 0) {
            if (2 < iVar7) {
              if (*firmware_data_000243dc == 0) {
                log_message(firmware_data_000243e4,firmware_data_000243e0);
              }
              else {
                debug_print(firmware_data_000243e4,firmware_data_000243e0);
              }
            }
            *(undefined1 *)(firmware_data_000243e8 + 1) = 2;
            return 0;
          }
        }
        else {
control_label_0002401a:
          iVar7 = *piVar1;
        }
        goto control_label_00024178;
      }
control_label_000240dc:
      if (0 < *piVar1) {
        uVar6 = *puVar10;
        goto control_label_00023fe2;
      }
      break;
    case 3:
      uVar8 = (uint)local_20[4];
      if (2 < *piVar1) {
        if (*firmware_data_000243dc == 0) {
          log_message(firmware_data_000243ec,firmware_data_000243e0,uVar8);
        }
        else {
          debug_print(firmware_data_000243ec,firmware_data_000243e0,uVar8);
        }
      }
      puVar10 = firmware_data_000243f4;
      iVar4 = firmware_data_000243e8;
      if (*(byte *)(firmware_data_000243e8 + 2) == uVar8) {
        iVar4 = *piVar1;
        bVar13 = false;
        bVar12 = iVar4 == 0;
control_label_00023fc4:
        if (!bVar12 && iVar4 < 0 == bVar13) {
          iVar4 = *firmware_data_00024194;
          uVar6 = firmware_data_000241b8;
          uVar5 = firmware_data_000241a0;
          goto control_label_00023f56;
        }
      }
        ...
        if (uVar8 < 3) {
          iVar7 = z_device_is_ready(firmware_data_000243f4);
          if (iVar7 == 0) goto control_label_00023fda;
          local_24 = 0;
          local_22 = 0;
          iVar7 = get_device_info();
          pcVar11 = *(code **)(iVar7 + 0x1030);
          ...
          if (iVar7 == 0) {
            ...
            if (iVar7 == 0) {
              *(byte *)(iVar4 + 2) = local_22;
              ...
              iVar4 = *firmware_data_000243dc;
              uVar6 = firmware_data_000243f8;
              uVar5 = firmware_data_000243e0;
              goto control_label_000240c6;
            }
          }
          goto control_label_0002401a;
      ...
      break;
    case 4:
      iVar4 = z_device_is_ready(firmware_data_000243f4);
      puVar10 = puVar3;
      if (iVar4 == 0) goto control_label_000240dc;
      local_24 = 0;
      local_22 = 0;
      iVar4 = get_device_info();
      pcVar11 = *(code **)(iVar4 + 0x1030);
      uVar6 = get_device_info();
      iVar4 = (*pcVar11)(uVar6,0x13e000,&local_24,3);
      if (iVar4 != 0) goto control_label_0002401a;
      local_22 = 0;
      local_24 = CONCAT11(((unsigned long long)(local_24)>>8 & 0xffULL),0xaa);
      iVar4 = get_device_info();
      pcVar11 = *(code **)(iVar4 + 0x1038);
      ...
      if (iVar4 == 0) {
        ...
        *(undefined1 *)(firmware_data_000243e8 + 2) = 0;
        return 0;
      }
control_label_00024178:
      if (0 < iVar7) {
        uVar6 = 0x13e000;
        iVar4 = *firmware_data_00024194;
        uVar5 = firmware_data_000241d0;
control_label_00023fea:
        if (iVar4 == 0) {
          log_message(uVar5,firmware_data_000241a0,uVar6);
        }
        else {
          debug_print(uVar5,firmware_data_000241a0,uVar6);
        }
      }
      break;
    default:
  ...
  else if (0 < *firmware_data_00024190) {
    if (*firmware_data_00024194 == 0) {
      log_message(firmware_data_0002419c,firmware_data_00024198);
    }
    else {
      debug_print(firmware_data_0002419c,firmware_data_00024198);
    }
    if (0 < *piVar1) {
      iVar4 = *piVar2;
      uVar6 = firmware_data_000241a4;
      uVar5 = firmware_data_000241a0;
control_label_00023f56:
      if (iVar4 == 0) {
