...
control_label_00033d76:
    ...
    if (iVar5 == 0) {
        ...
        if (iVar11 == 0) {
            ...
            if (*(volatile char *)(iVar7 + 0xf) == 0) goto control_label_00033daa;
control_label_00033de4:
            if (param_1 != 0) goto control_label_00033e20;
control_label_00033de8:
            uVar6 = get_timestamp(0);
            iVar5 = iVar2 + iVar9 * 0x1b4;
            if (uVar6 <= (unsigned)(*(volatile int *)(iVar5 + 4) + 10)) goto control_label_00033daa;
        } else {
            if (*(volatile char *)(iVar7 + 0xf) == 0) {
control_label_00033d92:
                iVar7 = iVar9 + iVar11;
joined_00033edc:
                if (iVar7 < 10) goto control_label_00033e98;
                goto control_label_00033e3e;
            }
            if (param_1 == 0) {
                if (iVar8 == 0) goto control_label_00033d92;
                goto control_label_00033de8;
            }
            if (iVar8 == 0) goto control_label_00033d92;
control_label_00033e20:
            iVar5 = iVar2 + iVar9 * 0x1b4;
        }
        ...
        if (9 < iVar7) goto control_label_00033e3e;
        ...
        iVar10 = 1;
control_label_00033dc2:
        if (iVar8 == 0) {
            if (iVar11 != 0) {
                iVar7 = iVar9 + iVar11;
                if (9 < iVar7) goto control_label_00033e3e;
                if (iVar5 == 0) goto control_label_00033e98;
control_label_00033e8a:
                iVar9 = iVar9 + 1;
                goto control_label_00033d76;
            }
            goto control_label_00033dc8;
        }
        iVar8 = iVar2 + iVar9 * 0x1b4;
        if (*(volatile char *)(iVar8 + 0xf) != 0) goto control_label_00033de4;
        if ((iVar5 != 0) && (uVar6 = get_timestamp(0), (unsigned)(*(volatile int *)(iVar8 + 4) + 5) < uVar6)) {
            iVar11 = iVar11 + 1;
            iVar7 = iVar11 + iVar9;
            memset_bytes(iVar8, 0, 0x1b4);
            if (iVar7 < 10) {
                if (*(volatile int *)(iVar2 + iVar9 * 0x1b4) != 0) goto control_label_00033e8a;
                goto control_label_00033e98;
            }
            goto control_label_00033e3e;
        }
control_label_00033daa:
        iVar7 = iVar11 + iVar9;
        if (9 < iVar7) goto control_label_00033e3e;
        if ((*(volatile int *)(iVar2 + iVar9 * 0x1b4) != 0) || (iVar11 == 0)) goto control_label_00033dc8;
    }
control_label_00033e98:
