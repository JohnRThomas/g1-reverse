...
#define g_log_level   (*(volatile s32*)((unsigned long)&g_log_level) /*=0x2000230c*/)   /* DAT_00028f10 debug level */
#define g_log_use_alt_sink   (*(volatile u32*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define g_display_refresh_latch   (*(volatile u8 *)((unsigned long)&g_20018d96) /*=0x20018d96*/)   /* DAT_00028f00 */
#define g_display_device_marker   ((volatile s8 *)((unsigned long)&g_20018c6e) /*=0x20018c6e*/)    /* DAT_00029260 pcVar10 */
#define g_display_last_mode   (*(volatile s32*)((unsigned long)&g_2000a098) /*=0x2000a098*/)   /* DAT_00029270 */
#define g_display_rotation_started_ms   (*(volatile s32*)((unsigned long)&g_20007afc) /*=0x20007afc*/)   /* DAT_00029504 */
#define g_display_rotation_index   (*(volatile s32*)((unsigned long)&g_20007af8) /*=0x20007af8*/)   /* DAT_00029508 */
#define g_display_rotation_counter   (*(volatile s32*)((unsigned long)&g_20007af4) /*=0x20007af4*/)   /* DAT_0002950c */
...
extern s64  k_uptime_get(void);
extern void k_msleep(int);
...
void display_dispatch_thread(char *display)
{
  ...
  if (1 < g_log_level) DISPLAY_LOG_2(((unsigned long)&rodata_99969) /*=0x99969*/);
  ...
  for (;;) {
    ...
    if (B(0xfe8) == 0 && display_panel_is_secondary(display) == 0) {
      ...
      if (B(0xfe8) == 0) {
        ...
        if ((s32)uVar17 != 0) goto control_label_28d42;
    ...
    if (B(0xfe7) == 0) { iVar6 = 0; goto control_label_2933e; }
    ...
    if (B(0) == 1) {
     ...
     control_label_28eae:
      ...
      case 4:
        ...
        iVar5 = 0x1b4;
        if (pbVar15 != (u8*)0) { cVar16 = 1; goto control_label_290d2; }
        pbVar15 = (u8*)0; cVar13 = 1; goto control_label_2902a;
      case 5:
        iVar5 = 0x6a;
      ...
      case 15:
        pbVar15 = (u8*)PTR(0xfec);
        iVar5 = 0x6a;
        if (pbVar15 != (u8*)0) goto control_label_290d2;
       control_label_29134:
        pbVar15 = (u8*)0; cVar13 = cVar16; goto control_label_2902a;
      case 7:
        iVar5 = 0x0b;
        ...
        if (uVar7 != 2) {
          if (r[1] == r[0]) { r[3] = 2; }
            ...
            if (B(0) != 2 || B(0xcd) == B(0xea) ||
              ...
              if (pbVar15 != (u8*)0) { iVar5 = 0x198; goto control_label_290d2; }
              iVar5 = 0x198; goto control_label_29134;
            }
            iVar5 = 0x198; goto control_label_290d2;
          }
      ...
      case 16: {
        ...
        if (*s < 0x0c || (*s & 0xfd) != 0x0d) {
          ...
          iVar5 = 0x199; goto control_label_290d2;
        }
        display_mutex_unlock();
        goto control_label_290ca;
      }
         ...
         control_label_293fc:
          ...
          if (iVar11 == 0) {
            ...
            if (B(0xfe8) != 0) {
              ...
              cVar16 = B(0xec);
              if (cVar16 != 6 && cVar16 == 0) goto control_label_2933e;
              goto control_label_29102;
            }
