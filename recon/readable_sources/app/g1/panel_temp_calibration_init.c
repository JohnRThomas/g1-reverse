 ...
 *   local_32         => struct g1_layout_panel_temp_calibration_locals__stack_1277 [stack_1277; G1-original]
 * Raw function identity: 0x00062644.  See ../include/g1_recovered_layouts.h. */
...
int panel_temp_calibration_init(int param_1)
{
  ...
  if (iVar4 == 0) { iVar4 = -0x13; }
    ...
    if (iVar4 == 0) {
      ...
      iVar4 = layout_select_region(((unsigned long)&rodata_8ba94) /*=0x8ba94*/,puVar8[1],puVar8[1],(int)local_32);
      if (iVar4 != -0x16) {
        iVar4 = dev_write_reg3(*puVar8,3,0xc,(byte)local_32[0]);
        if (iVar4 != 0) return iVar4;
        iVar4 = layout_select_region(((unsigned long)&rodata_8ba94) /*=0x8ba94*/,puVar8[2],puVar8[2],(int)local_32);
        if (iVar4 != -0x16) {
          iVar4 = dev_write_reg3(*puVar8,3,0xd,(byte)local_32[0]);
          if (iVar4 != 0) return iVar4;
          iVar4 = flash_page_index_lookup(((unsigned long)&rodata_8ba88) /*=0x8ba88*/,puVar8[3] + -2000,puVar8[3],(int)local_32);
          if (iVar4 != -0x16) {
            iVar4 = dev_write_reg4(*puVar8,3,8,((uint)local_32[0] << 0x17) >> 0x18,local_32[0] & 1);
            if (iVar4 != 0) return iVar4;
            iVar4 = flash_page_index_lookup(((unsigned long)&rodata_8ba7c) /*=0x8ba7c*/,puVar8[4] + -0xc9e,puVar8[4],(int)local_32);
            if (iVar4 != -0x16) {
              iVar4 = dev_write_reg4(*puVar8,3,10,((uint)local_32[0] << 0x17) >> 0x18,local_32[0] & 1);
              if (iVar4 != 0) return iVar4;
              iVar4 = layout_select_region(((unsigned long)&rodata_8ba64) /*=0x8ba64*/,puVar8[5],puVar8[5],(int)local_32);
              if (iVar4 != -0x16) {
