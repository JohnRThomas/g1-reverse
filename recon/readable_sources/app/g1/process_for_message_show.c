 ...
 *   param_2          => struct g1_layout_msg_show_item__param_0080              [param_0080; G1-original]
 * Raw function identity: 0x0002c714.  See ../include/g1_recovered_layouts.h. */
...
control_label_0002c894:
    ...
    else if (*(char *)(param_2 + 1) == '\x04') goto control_label_0002c894;
    set_message_pending_state(5);
