...
| `FUN_00051c38` | `duplicate_owner_byproduct` | `` | all referencing reconstruction objects excluded from retained build |
...
| `FUN_00080a46` | `duplicate_owner_byproduct` | `` | all referencing reconstruction objects excluded from retained build |
...
| `cbpprintf_external` | `duplicate_owner_byproduct` | `` | all referencing reconstruction objects excluded from retained build |
...
| `floorf` | `duplicate_owner_byproduct` | `` | all referencing reconstruction objects excluded from retained build |
| `fmaf` | `duplicate_owner_byproduct` | `` | all referencing reconstruction objects excluded from retained build |
...
| `mpsc_pbuf_is_pending` | `genuine_sdk_library_external` | `g1_recon_z_log_msg_pending` | NCS-2.5.1:zephyr/libzephyr.a |
...
| `snprintk` | `genuine_sdk_library_external` | `att_timeout, format_bt_addr_str, random` | NCS-2.5.1:zephyr/libzephyr.a |
...
| `u8_to_dec` | `duplicate_owner_byproduct` | `` | all referencing reconstruction objects excluded from retained build |
