...
|---|---|---|---|---|
| `0x0004d7d8` | `FUN_0004d7d8` | `sdk_static_or_library_identity` | `sdk_static_source_unit_owner` | push {r0, r1, r4, lr}; ldr r0, [pc, #0xac]; configured SDK static helper requires source-unit linkage reconciliation |
...
| `0x00056e24` | `FUN_00056e24` | `sdk_static_or_library_identity` | `sdk_static_source_unit_owner` | ldr r3, [pc, #8]; ldr r2, [r3]; configured SDK static helper requires source-unit linkage reconciliation |
| `0x00077a28` | `strtol_reentrant` | `sdk_static_or_library_identity` | `newlib_identity_reconciliation` | cmp r3, #0x24; push.w {r4, r5, r6, r7, r8, sb, sl, lr}; readable spelling maps to the configured newlib reentrant strtol owner |
| `0x00077c8c` | `ext77c8c` | `true_missing_catalog_entry` | `already_resolved_by_cfg_verified_strong_owner` | push {r3, r4, r5, r6, r7, lr}; mov r6, r1; standalone exact-entry reconstruction accepted by cfg_verify |
| `0x00077d30` | `tail_77d30` | `true_missing_catalog_entry` | `already_resolved_by_cfg_verified_strong_owner` | push {r3, r4, r5, lr}; mov r4, r0; standalone exact-entry reconstruction accepted by cfg_verify |
