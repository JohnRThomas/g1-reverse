...
unsigned int gui_bmp_bitmap_draw_ex(unsigned int param_1, int param_2, int param_3, int param_4, unsigned char param_5)
{
    ...
    if (param_5 == 0) {
        ...
        iVar3 = FUN_0004588c(4, param_1, &local_24, &local_20, &local_1c, 0);
        if (iVar3 >= 0) {
            int cnt = local_20 * (local_24 / 2);
            FUN_00086c04(param_4, local_1c, cnt);
            for (int i = 0; i < cnt; i++) {
            ...
            if ((m & 2) != 0) {
                FUN_000471cc(*(volatile uint32_t*)0x2000a034UL, 0, param_2, param_3, local_24 + 2 + param_2, local_20 + param_3);
            }
            FUN_0007d53a(*(volatile uint32_t*)0x2000a034UL, param_4, local_24 / 2, local_20, param_2, param_3);
            iVar3 = FUN_000431a8();
            if ((iVar3 << 0x1e) < 0) {
                int r = FUN_000167a8();
                unsigned int v = *(volatile uint32_t*)(intptr_t)(r + 0xeb4);
                r = FUN_000167a8();
                FUN_00047260(v, *(volatile uint32_t*)(intptr_t)(r + 0xeb8), param_2, param_3, local_24 + 2 + param_2, local_20 + param_3);
            }
            return 0;
        }
        if (*(volatile int*)0x2000230cUL < 2) return 0xffffffff;
