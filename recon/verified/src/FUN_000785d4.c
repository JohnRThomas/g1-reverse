...
#include <stdint.h>
extern void* FUN_00076d6c(int);
extern void* FUN_00076a94(unsigned int,int,int,unsigned int);
extern void* FUN_000876d0(int,int,int);
unsigned int* FUN_000785d4(int param_1,unsigned int param_2){
  unsigned int* puVar1; void* uVar2; int iVar3,iVar4;
  if(*(int*)(param_1+0x24)==0){
    puVar1=(unsigned int*)FUN_00076d6c(0x10);
    *(unsigned int**)(param_1+0x24)=puVar1;
    if(puVar1==0) puVar1=(unsigned int*)FUN_00076a94(0x000f8cd5,0x66,0,0x000f8bb7);
  ...
  if(*(int*)(iVar4+0xc)==0){
    ...
    *(void**)(iVar4+0xc)=uVar2;
    ...
    if(puVar1==0){
      ...
      puVar1=(unsigned int*)FUN_000876d0(param_1,1,(iVar4+5)*4);
