...
extern int FUN_00086bc8(unsigned a, unsigned b, ...);
extern int FUN_00086cb6(int a, int b, unsigned char *c, int d);

int FUN_00076ed4(int param_1, int param_2, unsigned char *param_3, uint *param_4)
{
...
LAB_00076f76:
    ...
    if (iVar8 != 0) {
        iVar2 = FUN_00086cb6(param_1, param_2, param_3, iVar8);
        if (iVar2 == -1) {
LAB_000770da:
            if ((-1 < *(volatile int *)(param_2 + 100) << 0x1f) &&
                (-1 < (int)((uint)*(volatile unsigned short *)(param_2 + 0xc) << 0x16))) {
    ...
    while (1) {
        pbVar6 = pbVar7 + 1;
        iVar2 = FUN_00086bc8(0xf8b6b, *pbVar7);
        iVar8 = 0xf8b71;
        if (iVar2 == 0) break;
    ...
    iVar2 = FUN_00086bc8(0xf8b71, *pbVar6, 3);
    if (iVar2 != 0) {
        pbVar6 = pbVar6 + 1;
    ...
    param_3 = pbVar6 + 1;
    local_70 = *pbVar6;
    iVar8 = FUN_00086bc8(0xf8b75, local_70, 6);
    if (iVar8 == 0) {
        unaff_r7 = FUN_00077594(param_1, &local_88, param_2, 0x86cb7, &local_8c);
    } else {
        if (0x7712d == 0) {
