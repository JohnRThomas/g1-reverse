...
extern int FUN_0005160c(int a, int b, uint c);
extern uint FUN_00051870(int a, int b, int c, int d);
extern uint FUN_000518a8(void *a, void *b);
extern void FUN_00051fe4(void);
extern unsigned FUN_00052000(unsigned a);
extern void FUN_00052038(int a, int b, void *c, ...);
...
unsigned FUN_000521fc(int param_1)
{
    ...
    local_f4 = 0;
    FUN_00086c78(auStack_d8, 0, 0x20);
    local_d4[0] = -1;
    local_d4[1] = -1;
    (void)cfg;
    ...
    uVar2 = FUN_000518a8(auStack_d8, local_f0);
    iVar3 = local_d4[0];
    ...
    if (uVar2 == 0) {
        ...
        if (local_d4[0] == 0) {
            ...
            *(volatile char *)(puVar1 + 3) = (char)local_c0;
            ...
            FUN_00086c78((void *)(local_c0 + 0xd + (int)puVar1), 0, 0x20 - local_c0);
        }
        if (local_c8 == 0) {
        ...
        FUN_0004d944(0x88208, 0x1840, &local_108, 0);
LAB_00052300:
        iVar3 = FUN_0005160c(iVar5 + 4, 1, uVar2 & 0xffff);
        FUN_00052038(1, 0, auStack_b8);
        FUN_00051fe4();
        if (iVar3 == 0) {
            uVar4 = 7;
