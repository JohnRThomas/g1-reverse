...
extern int FUN_000785d4(int,int);
extern int FUN_00076a94(int,int,int,int);
extern void FUN_00086c04(int,int,int);
extern void FUN_00078654(int,int);
int FUN_00078698(int param_1,int param_2,int param_3,unsigned param_4){
  ...
  if(param_4!=0){
    if(*(int*)(param_2+8)<=iVar5){
      int iVar2=FUN_000785d4(param_1,*(int*)(param_2+4)+1);
      iVar1r=iVar2;
      if(iVar2==0){ iVar2=FUN_00076a94(0xf8cd5,0xb5,0,0xf8c42); }
      FUN_00086c04(iVar2+0xc,param_2+0xc,(*(int*)(param_2+0x10)+2)*4);
      FUN_00078654(param_1,param_2);
    }
