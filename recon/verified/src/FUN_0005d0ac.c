...
extern int FUN_0005ecdc(int, int, int, int);
...
int FUN_0005d0ac(int param_1)
{
    ...
    iVar7 = param_1 + 0x37;
    iVar8 = param_1 + 0x27;
    iVar1 = FUN_0005ecdc(param_1 + 0x97, iVar7, iVar8, *(volatile int*)(param_1 + 0xf0) + 0x97);
    if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
            ...
            if (iVar1 == 0) {
                ...
                if (iVar1 == 0) return 8;
                puVar4 = (uint32_t*)(intptr_t)FUN_0005f5d0(iVar1 + 0xc, 0x10);
                puVar5 = local_58;
                do {
                    uint32_t a = puVar5[0], b = puVar5[1];
                    puVar5 += 2;
