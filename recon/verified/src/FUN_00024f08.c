...
{
    int iVar2 = FUN_000256dc(*(volatile unsigned int*)0x20007a44UL, 0, param_1, 4, param_4);
    if (*(volatile char*)(param_1+2) == 0) {
        if (iVar2 != 0) return -1;
        iVar2 = FUN_000256dc(*(volatile unsigned int*)0x20007a44UL, 4, param_1 + 4, 4, param_4);
    }
    if (iVar2 != 0) iVar2 = 1;
    return -iVar2;
}
