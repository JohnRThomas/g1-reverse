...
extern int FUN_000257ec(unsigned int, unsigned int, void *, unsigned int);
...
int FUN_0007c968(unsigned int param_1, unsigned int *param_2, unsigned int param_3)
{
  ...
  if (param_2 == 0) {
    ...
    iVar1 = FUN_000257ec(param_1, 0x14, &local_14, 2);
    if (iVar1 == 0) {
      *(unsigned short *)((char *)param_2 + 2) = local_14;
      iVar1 = FUN_000257ec(param_1, 0x16, (void *)param_2, 1);
    }
  }
  return iVar1;
}
