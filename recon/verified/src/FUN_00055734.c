/* Reconstructed FUN_00055734 @ 0x55734  (parity: 300/300 trials, PROVEN) */
#include <stdint.h>
typedef unsigned int uint;
typedef unsigned undefined4;
typedef unsigned char undefined1;
extern void FUN_0004d944(unsigned a, int b, void *c, int d);
extern int FUN_00053cd4(int a, int b);
...
extern int FUN_000556b0(undefined1 *a, int *b);
extern void FUN_000566a4(int a);
extern void FUN_00056704(int a, int b);
extern int FUN_00081130(void *a);
extern int FUN_0008115c(unsigned a, unsigned b);
extern unsigned long long FUN_0008117a(void *a);
extern void FUN_00081180(unsigned a);
extern void FUN_00081196(int a, unsigned b);
extern void FUN_000811a4(undefined1 *a, int b, uint c);
extern int FUN_000811ce(undefined1 *a, unsigned b, unsigned c, int d, unsigned e, int f, int g);
extern int FUN_000812b2(void *a);
extern int FUN_000812d2(undefined1 *a, int b);
extern void FUN_00083740(int a, void *b, int c);

int FUN_00055734(undefined1 *param_1, int param_2, undefined4 param_3, undefined4 param_4, int param_5, undefined4 param_6)
{
    ...
    FUN_0008115c(*(volatile unsigned *)(puVar3 + 4), 0xffffdfff);
    FUN_00081180(0x200020d4);
    uVar4 = *puVar3;
    *param_1 = uVar4;
...
LAB_000557f6:
    ...
    iVar2 = FUN_00053cd4(0x2006, 0xf);
    if (iVar2 == 0) return -0x69;
    FUN_00083740(iVar2 + 0xc, (void *)0, 0xf);
    iVar2 = FUN_00053d70(0x2006, iVar2, 0);
    if (iVar2 != 0) return iVar2;
    if ((iVar8 == 0) &&
        (iVar2 = FUN_000811ce(param_1, param_3, param_4, param_5, param_6, iVar1b, iVar6), iVar2 != 0)) {
        return iVar2;
    }
    if ((*(volatile int *)(puVar3 + 4) << 0x1f < 0) && (iVar2 = FUN_000556b0(param_1, &local_54), iVar2 != 0)) {
        ...
        if (iVar2 != 0) {
            ...
            FUN_00056704(local_54, 0);
            FUN_000566a4(iVar6);
            return iVar2;
        }
        if (local_54 != 0) FUN_000566a4(local_54);
        uVar5 = 0;
