...
int FUN_0005c22c(int param_1, int *param_2){
  ...
  if (param_1==0){
    ...
    FUN_0007e2fa(0x000f4a0a); uVar3=0x13de; FUN_0007e2ec(0x000f46b8,uVar3); return uVar3;
  }
  if (param_2==0 || *param_2==0){
    FUN_0007e2fa(0x00099cbd,0x000f4c07,0x000f46b8,0x13df,param_1,(int)param_2);
    FUN_0007e2fa(0x000f4a0a); uVar3=0x13df; FUN_0007e2ec(0x000f46b8,uVar3); return uVar3;
  }
  if ((short)param_2[1]==0){
    FUN_0007e2fa(0x00099cbd,0x000f4cce,0x000f46b8,0x13e0,param_1,(int)param_2);
    FUN_0007e2fa(0x000f4a0a); uVar3=0x13e0; FUN_0007e2ec(0x000f46b8,uVar3); return uVar3;
  }
