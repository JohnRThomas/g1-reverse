/* Reconstructed FUN_000841fc @ 0x841fc  (CFG-directed candidate) */
/* Reconstructed FUN_000841fc @ 0x841fc  (dev_set_mode_register)
 *
 ...
 */
#include <stdint.h>
extern int FUN_00083e0e(int, int, int, int, unsigned char);
uint32_t FUN_000841fc(int param_1, int param_2, char param_3, uint32_t param_4,
                      char param_5)
{
  int eq = (param_2 == 1);
  ...
  return FUN_00083e0e(*(volatile int*)(param_1 + 0x1c), 4, uVar2,
                      param_4 & 0xff, mask);
}
