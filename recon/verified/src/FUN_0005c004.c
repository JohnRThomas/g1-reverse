...
extern void FUN_00082d2e(int,short,int*);
extern void FUN_00086c78(void*,int,int);
void FUN_0005c004(int param_1,int param_2,unsigned *param_3,int param_4,int *param_5){
  ...
  if (param_4 == 0x10) {
    ...
    if ((*param_5 == 0) || (iVar2 = FUN_00080d3e(), iVar2 == 0)) {
      local_4c[0] = 0; local_4a = 0x2802;
      FUN_00086c78(auStack_28,0,0x10);
