...
extern u32 *FUN_00078590(void);
extern u32  FUN_0000ef12(u32);
extern int  FUN_0000de2c(u32, u32, u32, u32);
extern int  FUN_0000ddf0(u32, u32, u32, u32);
extern int  FUN_0000dddc(u32, u32, u32, u32);
extern int  FUN_0000ddc8(u32, u32, u32, u32);
extern u32 *FUN_00086cda(u32 p1, u32 prec, u32 flags, char *sign, double val,
                         u32 *pdec, u32 conv, u32 *pnd, u32 zero);
extern u32  FUN_00086daa(u32 *buf, u32 dec, u32 conv);
extern int  FUN_00086e1c(u32 p1, u32 *p2, u32 *pw, u32 p3, outfn fn);

#define ADD3NEG(x) (((long long)(int)(x) + 3) < 0)

u32 FUN_0007712c(u32 param_1, u32 *param_2, u32 param_3, outfn param_4, int *param_5)
{
  ...
  *param_5 = (int)(puVar8 + 2);
  ...
  param_2[0x12] = uVar10;
  param_2[0x13] = uVar11;
  iVar4 = FUN_0000de2c(uVar10, uVar11 & 0x7fffffff, 0xffffffff, uVar1);
  if ((iVar4 == 0) &&
      (iVar4 = FUN_0000ddf0(uVar10, uVar11 & 0x7fffffff, 0xffffffff, 0x7fefffffU), iVar4 == 0)) {
    iVar4 = FUN_0000dddc(uVar10, uVar11, 0, 0);
...
LAB_000771b6:
    ...
    *param_2 = uVar13 & 0xfffffffb;
    ...
    iVar4 = FUN_0000de2c(uVar10, uVar11, uVar10, uVar11);
    ...
    *param_2 = uVar13;
    {
      ...
      _u.w[0] = param_2[0x12];
      _u.w[1] = param_2[0x13];
      puVar8 = FUN_00086cda(param_1, param_2[1], uVar13, &local_35, _u.d,
...
LAB_0007728c:
      local_34 = local_34 - 1;
      uVar10 = FUN_00086daa(param_2 + 0x14, local_34, bVar12);
...
LAB_0007752c:
        ...
        iVar6 = uVar13 - 1;
        iVar4 = FUN_0000ddc8(param_2[0x12], param_2[0x13], 0, 0);
        if (iVar4 == 0) {
