...
#define attr_store FUN_0004e9a0
#define uuid_store FUN_0004ea28
#define bt_gatt_discover FUN_0005b9cc
#define attr_find_by_handle FUN_0007f386
#define discovery_complete_error FUN_0007f40c
#define discovery_complete_not_found FUN_0007f438
#define bt_gatt_dm_attr_service_val FUN_0007f460
#define bt_gatt_dm_attr_chrc_val FUN_0007f4a0
#define bt_uuid_cmp FUN_00080d3e
...
#define LOG_WITH_U32(message_, value_) do {                            \
  ...
  FUN_0007f406(0x88130, 0x1840, (int)record_);                         \
} while (0)
...
#define local_24 frame.log[1]
  ...
  if (*(volatile int*)piVar2 != param_1) {
    ...
    FUN_0007f406(0x88130,0x1040,(int)frame.log);
    uVar8 = 0xfffffff2;
    goto LAB_eaa6;
  }
...
LAB_eaa6:
  ...
  if (bVar1 < 4) {
    if (bVar1 != 2) {
      if (param_2 == 0) { discovery_complete_not_found((int)0x2000a154); return 0; }
...
LAB_eb88:
        ...
        *(short*)((int)piVar2 + 0x10) = *(short*)(iVar3 + 4) + 1;
        ...
        LOG_WITH_U32(0xf1432, uStack_48);
      }
    ...
    LOG_WITH_U32(0xf1484, uStack_48);
    goto LAB_ec80;
  }
