...
undefined4 FUN_0002c714(char *param_1,int param_2,byte *param_3,undefined4 *param_4)
{
  ...
  *(undefined1 *)(param_2 + 8) = 0;
  FUN_0003443c(4);
  state_raw = FUN_0002c30c(param_1[0xfea],0xf);
  ...
  *(undefined1 *)(param_2 + 7) = uVar3;
  do {
    while( 1 ) {
      ...
      else { iVar4 = FUN_0003444c(); bVar10 = iVar4 == 2; }
      if (((bVar10) || (*(char *)(param_2 + 7) == '\0')) && (param_1[0xfea] == '\n')) break;
      if (((param_1[1] == '\x01') || (iVar4 = FUN_000167a8(), *(char *)(iVar4 + 1) == '\b')) ||
         (iVar4 = FUN_000167a8(), *(char *)(iVar4 + 0xfea) == '\f')) {
        if (2 < *(volatile int*)0x2000230c) {
          if (*(volatile int*)0x20007554 == 0) {
            DEBUG_PRINT(0xa294a,0xa39d6,(uint)*(byte *)(param_2 + 1));
          } else { FUN_00019c70(0xa294a,0xa39d6,(uint)*(byte *)(param_2 + 1)); }
        }
      ...
      if (*(char *)(param_2 + 1) != '\x04') {
        if (2 < *(volatile int*)0x2000230c) {
          ...
          } else { FUN_00019c70(0xa2977,0xa39d6,(uint)*(byte *)(param_2 + 1)); }
        }
      ...
      if (((uVar9 & 0xf) == 0) && (2 < *piVar2)) {
        if (*(volatile int*)0x20007554 == 0) {
          ...
          FUN_00019c70(0xa29be,0xa39d6,uVar9,
                      load_u32_le((const void *)(uintptr_t)load_u32_le(param_1 + 0xff0)),
                      (uint)*param_3,(uint)*(byte *)(param_2 + 9),(uint)*(byte *)(param_2 + 0xf),
                      load_u32_le((const void *)(uintptr_t)(param_2 + 0xb)),
                      (uint)*(byte *)(param_2 + 8));
...
LAB_0002c894:
    ...
    if ((*(char *)(param_2 + 1) == '\x06') ||
      ...
      if ((*(char *)(iVar4 + 0x108f) != '\0') &&
         (pcVar5 = (char *)FUN_000167a8(), *pcVar5 == '\x01')) {
        iVar4 = FUN_000167a8();
      ...
      if (2 < *(volatile int*)0x2000230c) {
        ...
        } else { FUN_00019c70(0xa28ee,0xa39d6,(uint)*(byte *)(param_2 + 1)); }
      }
      return 0xb;
    }
  ...
  if (2 < *(volatile int*)0x2000230c) {
    ...
    } else { FUN_00019c70(0xa291d,0xa39d6,(uint)*(byte *)(param_2 + 1)); }
  }
LAB_0002c884:
  *param_4 = 0xa3311;
  return 10;
