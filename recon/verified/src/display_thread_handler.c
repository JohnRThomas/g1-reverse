...
#define display_reflash_handler      FUN_00048e28
#define display_timer_stop           FUN_00048ff4
#define display_delay_set            FUN_00049000
#define display_thread_service_abort FUN_0004906c
#define k_msgq_get                    FUN_00072240
#define k_sleep_ticks                 FUN_00074844
#define display_power_set            FUN_0007d6f4
