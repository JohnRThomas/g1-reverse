/* Reconstructed FUN_0004e1ac @ 0x4e1ac  (parity: 300/300 trials, PROVEN) */
#include <stdint.h>
...
int FUN_0004e1ac(int *param_1, unsigned param_2, unsigned param_3, unsigned param_4)
{
  ...
  if (-1 < iVar1) {
    ...
    if (iVar1 != 0) {
      ...
      FUN_00086c78(*param_1 + param_1[2], *(unsigned char*)(iVar3 + 4), iVar1);
    }
