...
extern long long FUN_00064eb8(int,...);
extern long long FUN_00065434(int,...);
extern long long FUN_00065494(int,...);
extern int FUN_00065504(int,...);
extern int FUN_0008511a(int,...);
extern int FUN_00085130(int,...);
...
int FUN_0006567c(uint param_1, uint param_2, byte *param_3, int *param_4)
{
    ...
    if(iVar9 != 0){
        ...
        *(volatile ushort*)(0x20002bc0 + (iVar5+8)*2) = (*(volatile ushort*)(0x20002bc0 + (iVar5+8)*2) & 0xfffd) | 1;
    }
    if(param_3 != 0){
        bVar1 = *param_3;
        uVar10 = (uint)bVar1;
        uVar12 = FUN_00065494(param_1, *(unsigned*)(param_3+4));
        iVar9 = (int)((u64)uVar12 >> 0x20);
        if((int)uVar12 == 0){
            iVar11 = iVar5 + 8;
            uVar8 = *(volatile ushort*)(0x20002bc0 + iVar11*2) & 0x1fdf;
            *(volatile ushort*)(0x20002bc0 + iVar11*2) = uVar8;
            if(iVar9 != 0){
        ...
        *(volatile ushort*)(0x20002bc0 + (iVar5+8)*2) = (*(volatile ushort*)(0x20002bc0 + (iVar5+8)*2) & 0xffe3) | ((ushort)bVar1 << 2);
    }
    if(param_4 != 0){
        iVar11 = *param_4;
        iVar9 = param_4[1];
        ...
        if(iVar11 != 0){
            if(iVar11 == *(volatile int*)0x20002bc0 && iVar9 == *(volatile int*)0x20002bc4){
                uVar6 = 0;
            } else {
                iVar7 = FUN_00064eb8(0x20002c34, (int)&uStack_1c + 3, *(volatile int*)0x20002bc0, *(volatile int*)0x20002bc4, uVar6, param_2);
                if(iVar7 != 0x0bad0000) return iVar7;
                uVar6 = (uint)uStack_1c >> 0x18;
            }
            *(volatile int*)(0x20002bc0 + (uVar6*2 + 1)*4) = iVar9;
            uVar8 = *(volatile ushort*)(0x20002bc0 + (iVar5+8)*2);
            *(volatile int*)(0x20002bc0 + (uVar6*2)*4) = iVar11;
            *(volatile ushort*)(0x20002bc0 + (iVar5+8)*2) = uVar8 | ((ushort)(uVar6 << 9)) | 0x100;
        }
    }
    return 0x0bad0000;
}
