...
{
    if (param_1 == (int*)0) {
        FUN_0007e2fa(0x99cbdUL, 0xf45beUL, 0xf543aUL, 0x2bUL);
        unsigned long long rv = FUN_0007e2ec(0xf543aUL, 0x2bUL);
    ...
    FUN_0007e2fa(0x99cbdUL, 0xf5465UL, 0xf543aUL, 0x2cUL);
    unsigned long long rv = FUN_0007e2ec(0xf543aUL, 0x2cUL);
    merge_tail((unsigned int)rv, (unsigned int)(rv >> 32));
}
