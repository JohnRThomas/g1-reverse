...
extern int FUN_00086bc8(u32,...);
extern int FUN_00086e1c(u32,void*,void*,u32,u32);
extern u32 TAIL(void);

u32 FUN_00077594(u32 param_1, u32 *param_2, u32 param_3, u32 param_4, int *param_5){
    ...
    if (bVar13 < 99) {
        ...
        case 0x69:
            ...
            *param_5 = (int)(uintptr_t)(puVar5 + 1);
            ...
            if (-1 < (int)uVar8) { uVar9=10; iVar2=0xf8b88; goto L776f6; }
            param_2[2] = param_2[1];
