...
extern unsigned long long FUN_00084abe(int,...);
...
void FUN_00062f28(int param_1, unsigned char param_2){
    ...
    int *piVar7 = 0;
    int iVar3 = FUN_00086406();
    if (iVar3 != 0 || *(char*)0x2001d564 == 0){
        while (1){
            piVar7 = *(int**)(param_1+4);
            unsigned long long uVar8 = FUN_00084abe((int)(intptr_t)piVar7, 0);
    ...
    do {
        int cnt = 100;
        do {
            int iVar4 = (int)FUN_00084abe(*(int*)(param_1+4));
            if (iVar4 != 0){
                unsigned long long uVar8 = FUN_00084abe(*(int*)(param_1+4), 0);
