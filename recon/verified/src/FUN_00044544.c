...
undefined4 FUN_00044544(undefined4 param_1,undefined4 param_2,int param_3,int param_4,int param_5,int param_6,
...
LAB_a2:
    ...
    if (param_12 == 0) {
      ...
      for (local_2ec = 0; local_2ec < (int)(uint)local_2da; local_2ec = local_2ec + 1) {
        ...
        if (iVar3 == 0) {
          if (uVar13 == uVar6) {
            iVar3 = *(volatile int*)0x2000230c; uVar13 = uVar6;
...
LAB_2c: if (iVar3 == 0) DEBUG_PRINT(uVar9,0xaad8e,uVar13); else FUN_00019c70(uVar9,0xaad8e,uVar13); }
            ...
            iVar4 = FUN_0004588c(param_3,uVar13,(int)&local_2d4,(int)&local_2d0,(int)&local_2d8,0);
            ...
            if (iVar4 < 0) { if (1 < *(volatile int*)0x2000230c) { iVar3 = *(volatile int*)0x20007554; uVar9 = 0xaaa58; goto LAB_2c; } }
              ...
              iVar5 = FUN_00043e58(*puVar2,*puVar10);
              ...
              if ((uint)(param_6 - param_4) < uVar15) {
                ...
                FUN_0007d53a(*(volatile int*)0x2000a034,(int)local_2cc,iVar4,iVar1,param_4,uVar8 + param_5);
                iVar3 = FUN_00043e58(*puVar2,*puVar10);
                uVar14 = iVar3 + local_2d4; uVar15 = uVar14;
              } else {
                FUN_0007d53a(*(volatile int*)0x2000a034,(int)local_2cc,iVar4,iVar1,uVar14 + param_4,uVar8 + param_5);
                iVar3 = FUN_00043e58(*puVar2,*puVar10);
