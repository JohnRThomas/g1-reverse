...
extern int FUN_00086c78(int, unsigned int, unsigned int, int, unsigned int);
...
int FUN_0007da70(unsigned char *param_1, unsigned int param_2, int param_3, unsigned int param_4)
{
  ...
  while (1) {
    ...
    bVar1 = *pbVar2;
    FUN_00086c78(param_3 + iVar3, pbVar2[1], (unsigned int)bVar1, (int)(pbVar2 - param_1), param_4);
