...
extern void FUN_00082d2e(unsigned,unsigned,void*);
extern void FUN_00086c78(void*,int,int);
typedef int (*fp_t)(unsigned,void*,void*);

void FUN_0005bbf4(unsigned param_1, int param_2, unsigned char *param_3, int param_4, char *param_5){
  fp_t pcVar6;
  if(param_2 != 0){
