...
extern int FUN_00082ff6(int a, int b, int c, int d, unsigned int e);
unsigned char FUN_00083002(int param_1,int param_2,unsigned int param_3,unsigned int param_4)
{
  int iVar1;
  unsigned char bVar2;
  if ((param_2 != 0) && ((*(volatile unsigned short *)(param_2 + 0xe) & 0x24) != 0)) {
    ...
    if ((bVar2 < *(volatile unsigned char *)(param_2 + 0xc)) ||
       (((int)((unsigned int)*(volatile unsigned short *)(param_2 + 0xe) << 0x1a) < 0 &&
        (iVar1 = FUN_00082ff6(param_1 + 4,5,param_2,param_1,param_4), iVar1 == 0)))) {
      return 0;
    }
