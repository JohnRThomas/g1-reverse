...
extern unsigned int FUN_0007dcb8(unsigned int, unsigned int, int, unsigned int, unsigned int, unsigned int);

unsigned int FUN_0004b17c(int param_1, unsigned int param_2, unsigned int param_3)
{
    ...
    return FUN_0007dcb8(v4, v0, 0x101, param_2, param_3, param_2);
}
