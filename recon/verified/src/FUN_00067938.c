...
extern int FUN_0007e2fa(int,int,int,int,int);
...
int FUN_00067938(int param_1, int param_2, unsigned int param_3, int param_4)
{
    ...
    if (r7 > 1) goto L67956;
    r3 = R32(r6 + 4);
    if (r3 >= 0x10000) goto L67956;
    r3 = R32(r6 + 8);
    if (r3 < 0x10000) goto L6796e;

L67956:
    FUN_0007e2fa(0x99cbd, 0xf707c, 0xf6fef, 0x251, param_4);
    r1 = 0x251;
    goto L67968;

L67968:
    r0 = (uint32_t)FUN_0007e2ec(0xf6fef, (int)r1);
...
L6796e:
    ...
    r3 = R8(r1);
    if (r3 == 2) {
        FUN_0007e2fa(0x99cbd, 0xf78d1, 0xf6fef, 0x259, param_4);
        r1 = 0x259;
        goto L67968;
    }
    if (r3 == 3) {
        FUN_0007e2fa(0x99cbd, 0xf7921, 0xf6fef, 0x25a, param_4);
        r1 = 0x25a;
        goto L67968;
    }
    /* fall through */
...
L67a06:
    ...
    /* case 3 : L67a9a */
    if ((r8 & 0x10) != 0) {
        FUN_0007e2fa(0x99cbd, 0xf7971, 0xf6fef, 0x1d4, param_4);
        r1 = 0x1d4;
        goto L67968;
    }
    if (r10 != 0) {
        FUN_0007e2fa(0x99cbd, 0xf7987, 0xf6fef, 0x1d5, param_4);
        r1 = 0x1d5;
        goto L67968;
    }
    if ((r8 & 4) != 0) {
        FUN_0007e2fa(0x99cbd, 0xf799d, 0xf6fef, 0x1d6, param_4);
        r1 = 0x1d6;
        goto L67968;
    }
    r3 = 0x100;
    ...
    r3 = 1;  R32(r4 + 8) = r3;
L67b00:
    r0 = (uint32_t)FUN_0008539a((int)r4, 0x100000);
    if (r0 != 0) goto L67b00;
...
L67b50:
    ...
    r10 = 0x00040002;
L67b56:
    r0 = (uint32_t)FUN_0008539a((int)r4, (int)r1);
    r2 = 1;
...
L67c96:
    ...
    r0 = r4;
    r0 = (uint32_t)FUN_0008539a((int)r4, 0x00040202);
    r10 = r0;
    if ((r0 & 0x200) == 0) goto L67c96;
    r0 = (uint32_t)FUN_0008539a((int)r4, 0x1000000);
    r1 = R32(r4 + 0x200);
    if (r0 == 0) goto L67ce2;
    r0 = r1 & 0x200;
    if (r0 == 0) {
...
L67cce:
    ...
    r0 = (uint32_t)FUN_0008539a((int)r4, 0x40000);
    goto L67ce8;
L67cde:
    R32(r4 + 0x14) = r1;
    goto L67c96;
...
L67d28:
    ...
    r1 = r9;
    r0 = (uint32_t)FUN_00085316((int)r4, (int)r9);
    r2 = 0x0bad0001;
    if (r0 == 0) r11 = r2;
    goto L67a00;
