...
extern void FUN_00078654(uint32_t,int);

int FUN_000789f0(uint32_t param_1, int param_2, uint32_t param_3){
    ...
    do {
        if (iVar8 <= iVar5){
            iVar1 = FUN_000785d4(param_1, iVar1);
            if (iVar1 != 0){
            ...
            iVar5 = 0x000f8c42;
            iVar1 = FUN_00076a94(0x000f8cd5, 0x1d9, 0);
        }
        iVar1 = iVar1 + 1;
        iVar5 = iVar5 << 1;
    } while (1);
