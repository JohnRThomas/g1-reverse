...
typedef u32 (*fn)(u32,...);
extern int FUN_00086bc8(u32 a, u32 b, u32 c);
extern void FUN_0008789c(u32 a, u32 b);
...
u32 FUN_0007932c(u32 param_1, u32 *param_2, int *param_3, u32 *param_4){
    ...
    iVar12 = 0;
    local_34[0] = ((volatile u32*)0x885b0UL)[0];
    local_34[1] = ((volatile u32*)0x885b0UL)[1];
    local_34[2] = ((volatile u32*)0x885b0UL)[2];
    pcVar3 = (fn)0x8712bUL;
  ...
  LAB_00079384:
    do {
        iVar1 = FUN_00086bc8(local_34[iVar12], *(byte*)(uintptr_t)*param_3, 2);
        puVar8 = puVar11;
        if (iVar1 != 0) {
            if (iVar12 == 1) {
    ...
    iVar12 = 0;
    FUN_0008789c(param_2[5], 0xf8d5aUL - param_2[1]);
    while (1) {
        puVar8 = puVar11;
