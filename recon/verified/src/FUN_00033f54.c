...
unsigned char FUN_00033f54(int param_1, int param_2, int param_3)
{
    ...
    if (param_1 == 0) {
        uVar6 = 0x34f;
        iVar7 = *g88;
        format_string = 0x000a7dc5;
        uVar5 = 0x000a8248;
    } else {
        iVar7 = *g94;
        if (*(int *)(param_1 + 0x1b0) == 0) {
            uVar9 = FUN_00033f24(0x14, *(int *)(param_1 + 8), param_3, 0, param_1, param_2, param_3);
            ...
            uVar9 = FUN_00033f24(0x14, *(int *)(param_1 + 8), param_3, *(int *)(param_1 + 0x1b0), param_1, param_2, param_3);
            uVar6 = (unsigned int)((unsigned long long)uVar9 >> 0x20);
            if ((int)uVar9 != 0) goto LAB_00033fb2;
            if (iVar7 < 1) return 0;
            iVar7 = *g88;
...
LAB_00033fb2:
    pbVar1 = (unsigned char *)0x2001a22b;
    *(unsigned char *)(param_1 + 0xf) = 0;
    bVar4 = *pbVar1;
    uVar8 = (unsigned int)bVar4;
    if (uVar8 < 0x14) {
        iVar2 = uVar8 * 0x1b4 + 0x20007dac;
        ...
        *(unsigned char *)(param_1 + 0xc) = bVar4;
        ...
        do {
            if (*(char *)(iVar7 + 0xd) == '\0') {
                iVar3 = FUN_00086c04(iVar7, iVar7 + 0x1b4, 0x1b4);
        ...
        FUN_00086c04(0x20009e08, param_1, 0x1b4);
        iVar7 = 0x20009dac;
        bVar4 = 0x14;
