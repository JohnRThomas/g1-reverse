...
extern int FUN_00085da2(unsigned long, unsigned long);
extern int FUN_00085e1a(unsigned*,void*,int,unsigned,unsigned*);
int FUN_00085f06(unsigned* param_1, unsigned param_2, unsigned param_3){
  ...
  r5=FUN_00085da2(param_1, param_2);
  if(r5==0) return 0;
  ...
  if(bVar3==0x1f){
    ...
    *param_1 = *param_1 + 1;
    ...
    int t = FUN_00085e1a(param_1,&local_14,4,bVar3,puVar4);
    if(t==0) return 0;
    r5=0;
  }
