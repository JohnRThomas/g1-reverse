...
uint32_t sync_to_slave(char *param_1, uint32_t param_2, uint32_t *param_3, uint32_t param_4)
{
  ...
  buf120[0] = 0;
  FUN_00086c78(&buf120[0], 0, 0xf8);
  uVar15 = *(uint32_t *)(*(uint32_t *)(param_1 + 0xfec));
  iVar8 = FUN_00016940();
  if ((((iVar8 == 1) || ((iVar8 = (int32_t)FUN_000167a8(), *(char *)(intptr_t)(iVar8 + 1) == '\b'))) ||
       ((iVar8 = FUN_00032ee4(), iVar8 == 1))) || (*param_1 == '\x02')) {
    uVar16 = 0;
    goto LAB_00026fa0;
  }
  lVar21 = FUN_0007cb2c();
