/* Reconstructed FUN_0006ab80 @ 0x6ab80  (parity: 60/60 trials, PROVEN) */
#include <stdint.h>
...
#define FUN_00069468(...) FUN_00069468__impl(0, ##__VA_ARGS__)
extern long long FUN_0006954c__impl(int, ...);
#define FUN_0006954c(...) FUN_0006954c__impl(0, ##__VA_ARGS__)
...
#define FUN_00086c44(...) FUN_00086c44__impl(0, ##__VA_ARGS__)
...
int FUN_0006ab80(int param_1,int param_2,char *param_3,undefined4 param_4,char *param_5)

{
  ...
  local_88 = param_1;
  if (param_1 == 0) {
    FUN_00086c44(param_3 + 0x20,param_3 + 0xe0,0x240);
    ...
    FUN_00086c44(param_3 + 0x20,param_3 + 0x120,0x200);
  ...
  iVar10 = FUN_00086c44(param_3 + 800,param_3 + 800 + iVar10,iVar19);
  ...
  *(int *)((int)aiStack_98 + iVar24) = iVar19 + 9;
  FUN_0006954c(pcVar22,pcVar22 + iVar11 * 2,fVar35,local_7c + 2);
  fVar35 = local_80;
  if (iVar19 < 1) {
    iVar19 = 0x10;
  }
...
LAB_0006adce:
  ...
  *(int *)(param_5 + 4) = iVar19;
  FUN_00069468(pcVar22,local_80,0,auStack_90 + iVar17);
  puVar18 = local_8c;
  FUN_00069468(pcVar22 + ((int)uVar23 >> 2) * -2,fVar35,uVar23 & 3,local_8c);
