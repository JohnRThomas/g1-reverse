...
extern void FUN_00086c04(unsigned int a, unsigned int b, unsigned int c, unsigned int d, unsigned int e);

unsigned int FUN_00084a24(int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
    ...
    if (uVar2 == 0) {
        ...
        *(volatile unsigned int*)(*(volatile int*)(param_1+0xc) + 0x10) = *(volatile unsigned int*)(*(volatile int*)(param_1+0xc)+0x18);
        ...
        FUN_00086c04(*(volatile unsigned int*)(iVar3+0x18), *(volatile int*)(iVar3+0x1c)+*(volatile int*)(iVar3+8), uVar2, iVar3, param_4);
        uVar1 = 1;
    }
    return uVar1;
}
