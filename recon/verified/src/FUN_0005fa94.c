...
extern unsigned long long FUN_0000e244(int a,int b,int c,int d);
extern int FUN_00072240(int a, unsigned b, int c, int d);
...
int FUN_0005fa94(int param_1, unsigned param_2, unsigned param_3, unsigned *param_4, unsigned param_5){
    ...
    if ((int)((unsigned)b << 0x1e) >= 0){
        ...
        FUN_000837a2(0x000881a0, 0x1040, loc);
        return iVar2;
    }
    ...
    if (param_5 == 0xffffffffu){
        ...
        uVar4 = FUN_0000e244((int)lVar1, (int)((unsigned long long)lVar1 >> 32), 1000, 0);
    }
    iVar2 = FUN_00072240(iVar3 + 0x1c, param_3, (int)(unsigned)uVar4, (int)(unsigned)(uVar4 >> 32));
    if (iVar2 == 0){
