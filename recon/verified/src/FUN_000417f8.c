...
#define onboarding_secondary_reset_flag ((volatile unsigned char *)0x2001cdce)
#define onboarding_retry_counter ((volatile unsigned char *)0x2001cdd1)
#define onboarding_attempt_counter ((volatile unsigned char *)0x2001cdd2)

/* Onboarding text/assets; each definition retains its raw address. */
#define onboarding_text_aa608 ((unsigned int)0x000aa608)
#define onboarding_text_aa60e ((unsigned int)0x000aa60e)
#define onboarding_text_f212c ((unsigned int)0x000f212c)
#define onboarding_text_f341d ((unsigned int)0x000f341d)
#define onboarding_text_aa604 ((unsigned int)0x000aa604)
#define onboarding_text_f7b6f ((unsigned int)0x000f7b6f)
#define onboarding_text_f7a30 ((unsigned int)0x000f7a30)
#define onboarding_text_aa600 ((unsigned int)0x000aa600)
