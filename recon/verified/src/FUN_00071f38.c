...
extern u64 FUN_0000e244(int,int,int,int);
...
void FUN_00071f38(void)
{
  ...
  do {
    if (piVar2 < piVar6) {
      FUN_0007e2fa(0x00099cbd,0x000f8056,0x000f7f4b,0x2f3);
      FUN_0007e2fa(0x000f0d20,0,0,0);
      uVar3 = 0x2f3;
LAB:
      FUN_0007e2ec(0x000f7f4b,uVar3);
    }
    if (piVar2 <= piVar6) {
      FUN_00073b1c();
      uVar3 = 0x00086661;
      for (piVar6 = (int*)0x00087fc8; piVar6 <= piVar2; piVar6 = piVar6 + 0xb) {
        ...
        if (uVar5 != 0xffffffff) {
          ...
          if (iVar4 == 0 && (uVar5 & 0x1ffff) == 0) {
            ...
            uVar8 = FUN_0000e244((int)lVar1,iVar4,1000,0);
            FUN_00074bf4(iVar7 + 0x18,uVar3,(int)uVar8,(int)((u64)uVar8 >> 0x20));
          }
        }
      }
      FUN_0007e2fa(0x00099cbd,0x000f8056,0x000f7f4b,0x312);
      FUN_0007e2fa(0x000f0d20,0,0,0);
      uVar3 = 0x312;
      goto LAB;
    }
