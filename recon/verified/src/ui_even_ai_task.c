...
extern uintptr_t FUN_000432d0(void);                            /* @ 0x000432d0 */
extern uintptr_t FUN_000432ec(void);                            /* @ 0x000432ec */
extern uintptr_t FUN_00043308(void);                            /* @ 0x00043308 */
extern uintptr_t gui_bmp_bitmap_draw(int, ...);                 /* FUN_00043484 @ 0x00043484 */
extern uintptr_t FUN_000436f8(void);                            /* @ 0x000436f8 */
...
extern int FUN_000723b8(void *, int64_t);                       /* @ 0x000723b8 */
extern uintptr_t FUN_00072558(void *);                          /* @ 0x00072558 */
extern uintptr_t FUN_0007d3dc(void);                            /* @ 0x0007d3dc */
extern int FUN_0007d3ee(void);                                  /* @ 0x0007d3ee */
extern int FUN_0007d446(void);                                  /* @ 0x0007d446 */
...
#define even_ai_status_icon_render         FUN_0003be18
#define gui_set_active_canvas              FUN_000431b4
#define gui_canvas_flags_set_bit1          FUN_000432d0
#define gui_canvas_flags_clear_bit1        FUN_000432ec
#define gui_reset_dynamic_bitmap_state     FUN_00043308
#define gui_reset_render_offsets           FUN_000436f8
#define even_ai_exit_animation             FUN_0004382c
#define gui_utf_draw_scrolling             FUN_000440ec
#define k_mutex_lock_forever               FUN_000723b8
#define k_mutex_unlock                     FUN_00072558
#define gui_text_metrics_reset              FUN_0007d3dc
#define gui_text_left                       FUN_0007d3ee
#define gui_text_top                        FUN_0007d446
#define memcpy_s                            FUN_00086c1e

#define G_LOG_LEVEL             (*(volatile int32_t *)0x2000230cUL)
#define G_LOGGER_MODE           (*(volatile int32_t *)0x20007554UL)
#define G_SAVED_PAGE            (*(volatile int32_t *)0x200024ecUL)
#define G_FRAME_INDEX           (*(volatile int32_t *)0x20009fd8UL)
#define G_TEXT_RENDERED         (*(volatile int32_t *)0x20009fd4UL)
#define G_ACTIVE                ((volatile uint8_t *)0x2001b9a8UL)
#define G_RENDER_STATE          ((volatile uint32_t *)0x2000a038UL)
#define G_LINE_TEXT             ((uint8_t *)0x2001b818UL)
#define G_UI_MUTEX              ((void *)0x20007b3cUL)

#define LANGUAGE_PRIMARY_TABLE ((const uintptr_t *)0x0008a3a8UL)
#define LANGUAGE_DETAIL_TABLE  ((const uintptr_t *)0x0008a370UL)
#define MASK_BITMAP_BASE       ((const uint8_t *)0x000aae20UL)
#define MASK_FRAME_SEQUENCE    ((const uint8_t *)0x000a8e98UL)
#define RENDER_STATE_INITIAL   ((uint32_t)0x2001cdd7UL)
#define SPACE_TEXT             ((uintptr_t)0x000f7b6fUL)
#define LOG_FUNCTION           ((uintptr_t)0x000a98ceUL)
#define LOG_INIT               ((uintptr_t)0x000a9855UL)
#define LOG_SYNC_REFRESH       ((uintptr_t)0x000a9879UL)
#define LOG_EXIT               ((uintptr_t)0x000a989fUL)
