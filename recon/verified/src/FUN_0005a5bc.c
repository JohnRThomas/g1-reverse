...
#include <stdint.h>
extern uint8_t* FUN_00059c04(void);
extern void FUN_000828da(void*, int);
extern void FUN_00082a42(uint32_t, int, void*);
extern void FUN_00082bb8(void*, int);

int FUN_0005a5bc(int param_1, uint32_t param_2, uint8_t *param_3, int param_4, uint16_t param_5){
  uint8_t *puVar1;
  uint32_t uVar2;
  ...
  if (param_5 < 2){
    if ((int)((uint32_t)param_5 + param_4) < 2){
      puVar1 = FUN_00059c04();
      if (puVar1 == 0 && (puVar1 = FUN_00059c04(), puVar1 == 0)){
        param_4 = -0x11;
        local_1c = 0xf4889;
        local_20 = 2;
        FUN_00082a42(0x88128, 0x1080, (void*)&local_20);
      } else {
        if (param_4 != 0){
          uVar2 = 0;
          do {
