...
int FUN_0002e398(int param_1, unsigned param_2, unsigned param_3, unsigned param_4){
    ...
    FUN_000723b8(0x20007b54, iVar2, 0xffffffffu, 0xffffffffu);
    int r0v = *g;
    ...
    if (*(volatile int*)0x20007554 != 0){
        FUN_00019c70(0x000a3a5aUL, 0x000a3ab6UL);
        return res;
    }
