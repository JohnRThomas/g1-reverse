...
int gui_bitmps_merge_draw(unsigned int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
  ...
  if ((param_3 < (int)param_1) || (param_4 < param_2) || (0xf < (param_7 | param_8))) {
    ...
    if ((param_1 & 1) == 0) {
      ...
      if ((int)((unsigned int)uVar13 << 0x1e) < 0)
        FUN_000471cc(VI(0x2000a034),(int)(param_1&1),(int)param_1,(int)(uVar13>>0x20),iVar4,param_4);
      iVar11 = 0;
      ...
      iVar4 = (int)FUN_000431a8();
      if ((int)((unsigned int)iVar4 << 0x1e) < 0) {
        iVar4 = FUN_000167a8(); uVar9 = VI(iVar4+0xeb4);
        iVar4 = FUN_000167a8(); FUN_00047260(uVar9, VI(iVar4+0xeb8), (int)param_1, param_2, param_3, param_4);
        return 0;
      }
      return 0;
    }
  ...
  if (iVar4 == 0) DEBUG_PRINT(uVar9, 0xaacc8); else FUN_00019c70();
  return -1;
}
