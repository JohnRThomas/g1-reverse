...
unsigned int FUN_00030178(unsigned int param_1, unsigned int param_2, unsigned int param_3)
{
  ...
  *(unsigned int*)(buf+8) = param_3;
  ...
  do {
    int *piVar1 = *(volatile int **)0x20007bc0UL /* device_info_t+0x11C4  (device-state ptr region) */;
