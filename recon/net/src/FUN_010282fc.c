...
extern uint32_t FUN_0100d538(uint32_t duration, uint32_t units);

void FUN_010282fc(const uint16_t *controller, uint32_t use_default,
                  volatile uint16_t *bounds)
{
    ...
    uint32_t duration = use_default == 0u
        ? FUN_01013d90(timing)
        : FUN_0101bbc8(timing);
    uint32_t first_limit = FUN_0100d538(duration, 2u);
    uint32_t second_limit = FUN_0100d538(duration, 2u);
