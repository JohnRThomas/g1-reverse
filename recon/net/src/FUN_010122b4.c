...
extern uint32_t FUN_010109ec(uint32_t timing, uint32_t product, uint32_t octets,
                             uint32_t mode, uint32_t flags);
uint32_t FUN_010122b4(const volatile uint8_t *state, uint32_t mode,
                      uint32_t unused_r2, uint32_t preserved_r3)
{
    ...
    return FUN_010109ec(timing, product, state[5], mode, flags);
}
