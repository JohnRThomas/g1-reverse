...
#define DAT_0100a43c 0x21000bc0u
...
void FUN_0100a31c(int param_1, char param_2)
{
  ...
  if (param_2 == 0) {
    *(volatile unsigned char *)(param_1 + 1) = 0;
    ...
    uVar1 = (unsigned short)(FUN_01027b32(*(volatile unsigned short *)DAT_0100a43c) & 0xffffu);
    ...
    *(volatile unsigned char *)(param_1 + 1) = 1;
    uVar1 = (unsigned short)(FUN_01027af2(*(volatile unsigned short *)DAT_0100a43c) & 0xffffu);
