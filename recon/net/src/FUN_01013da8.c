...
void sdc_connection_event_cursor_catch_up(uint8_t *connection)
{
...
extern __typeof(sdc_connection_event_cursor_catch_up) FUN_01013da8
    __attribute__((alias("sdc_connection_event_cursor_catch_up")));
