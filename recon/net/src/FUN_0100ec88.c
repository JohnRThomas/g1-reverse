...
extern void FUN_01008d00(uint32_t domain, uint32_t reason)
...
uint32_t FUN_0100ec88(uint8_t *packet)
{
    volatile struct controller_work_queue *const queue =
        (volatile struct controller_work_queue *)0x21000ec8;
    volatile uint8_t *const flow_state = (volatile uint8_t *)0x21000eac;
    context_packet_callback *const context_callback =
        (context_packet_callback *)0x21000058;
    context_packet_callback *const release_callback =
        (context_packet_callback *)0x2100005c;
    handle_packet_callback *const handle_callback =
        (handle_packet_callback *)0x21000054;
