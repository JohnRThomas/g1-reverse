...
{
    volatile uint8_t *const sync_pending  = (volatile uint8_t *)0x21004fa3u;
    volatile uint8_t *const message       = (volatile uint8_t *)0x21004618u;
    void (*volatile *const dispatch)(volatile uint8_t *) =
        (void (*volatile *)(volatile uint8_t *))0x21004628u;
    ...
    volatile uint8_t *const rx            = (volatile uint8_t *)0x21004da1u;
    volatile uint8_t *const service_state = (volatile uint8_t *)0x21004c9cu;
    ...
    if (id == 1) {
        ...
        *sync_pending = 0;
        ...
        for (;;) {
            ...
            *service_state = 2;
            message[0] = 2;
            *(volatile uint32_t *)(message + 4) = 0x21004da6u;
