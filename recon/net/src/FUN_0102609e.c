...
void sdc_extended_adv_report_encode(volatile uint8_t *event,
...
extern __typeof(sdc_extended_adv_report_encode) FUN_0102609e
    __attribute__((alias("sdc_extended_adv_report_encode")));
