...
LAB_0101f4d4:
  if (*piVar3 != 0) {
    ...
    if ((iVar5 != 0) && (iVar5 = FUN_01029b24(iVar4), iVar5 == 0)) {
      if (cVar8 == '\0') {
        int (*fp)(int, int, int) = (int (*)(int, int, int)) *(volatile int *)0x210004dc;
        int p2 = *(volatile int *)(0x21000eac + 0xc);
        iVar4 = fp(iVar4, p2, 0);
        if (iVar4 != 0) {
          uVar7 = 0x1760;
          goto LAB_0101f4c8;
        ...
        int (*fp2)(int) = (int (*)(int)) *(volatile int *)0x210004d8;
        iVar4 = fp2(iVar4);
        if (iVar4 != 0) {
          uVar7 = 0x175b;
          goto LAB_0101f4c8;
    ...
    *puVar6 = outparam;
    ...
    if (iVar4 == 0) {
      void (*fp3)(void *, void *, int) =
          (void (*)(void *, void *, int)) *(volatile int *)(0x21001208 + 0x24);
      if (fp3 != 0) {
