...
{
    volatile unsigned int  *pcVar6b = (volatile unsigned int *)0x210010a0;
    ...
    do {
        uVar18 = uVar18 + 1;
        uVar24 = uVar24 + *(volatile int *)(0x210010a0 + (uVar20 + 2) * 4) + iVar10;
        uVar20 = uVar18 & 0xff;
    ...
    if ((uVar18 == uVar24) && (param_3 != 0)) {
        ...
        if (param_2 == 0) {
            ...
            if (*(volatile unsigned char *)0x210010a0 == 5) {
                /* pcVar6[0] == 0 -> never taken. */
            }
            FUN_0101dd48((void *)0x210010f0, puVar12);   /* C5 */
            if (puVar12 != 0) {
