...
void FUN_01032e54(void)
{
    ...
    volatile unsigned char *stage = (volatile unsigned char *)0x2100635bu;
    volatile unsigned int *q = (volatile unsigned int *)0x21004a60u;
    volatile unsigned int *slot = (volatile unsigned int *)0x21004a8cu;
    ...
    *slot = *(volatile unsigned int *)entry;
    ...
    if (cur != 0u) {
        ...
        FUN_0103b53a(0x2100635du, cur + 5u, len, 0xfbu);
    } else {
        pids[off + 3u] = 0u;
        handler(0u);
        stage[0] = 0u;
...
publish:
    *(volatile unsigned char *)0x21006458u = 5u;
    FUN_01032ad8();
    radio[0x52cu / 4u] = radio[0x408u / 4u] & 0xffu;
    radio[0x504u / 4u] = 0x2100635bu;
    *(volatile unsigned int *)0x210049a0u = 0x01033005u;
tail:
    if (fresh != 0u) {
