...
extern i32  FUN_01019204(void);
extern void FUN_0101bc3c(void);
extern i32  FUN_0101dd9c(u32,i32);
extern u32  FUN_0101de10(u32,i32,u32,u32,u32,i32);
  ...
  *(volatile u8*)((u32)iVar11 + 0x70) = 0xff;
  ...
  if (DAT_0101b748 == (u32)iVar8) {
    if (*(volatile i8*)((u32)iVar11 + 0x73) != 0) {
      ...
      uVar7 = FUN_0101de10(uVar7, iVar20, uVar17, 0,0,0);
      goto LAB_0101b666;
    }
    iVar8 = *(volatile i32*)(pcVar5 + 0x28);
    uVar7 = 0;
    ...
    uVar7 = FUN_0101de10(*(volatile u32*)((u32)iVar11 + 0x2d8), *(volatile i32*)((u32)iVar11 + 0x2dc),
...
TRAP_866:
  FUN_01008d00(0x21,0x866);
TRAP_8c3:
  FUN_01008d00(0x21,0x8c3);
TRAP_854:
  FUN_01008d00(0x21,0x854);
TRAP_40f:
