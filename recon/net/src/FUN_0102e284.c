...
extern void FUN_01039bbe(const char*,...);
...
void z_impl_z_log_msg_static_create(const void *source,uint32_t descriptor,void *package,const void *data){
 ...
 if(package_len){ uint16_t string_lengths[4]; cbprintf_buf_desc_t output={0,0,0}; int converted_len=FUN_0102bfe4(package,package_len,0,&output,10,string_lengths,4);
  ...
  if(message){output.buf=(uint8_t*)message+16;output.size=(uint32_t)converted_len;output.off=0;if(FUN_0102bfe4(package,original_package_len,(void*)0x0103aacd,&output,10,string_lengths,4)<0){FUN_01039bbe((void*)0x0103d2a7,(void*)0x0103d6b5,0x59);FUN_01039bb0((void*)0x0103d6b5,0x59);}}
