...
extern void FUN_0102e284(const void *, uint32_t, void *, const void *);
...
int FUN_0102fcec(uint32_t context)
{
    ...
    *(volatile uint32_t *)0x210047fcu = context;
    if (device == 0) {
        ...
        FUN_0102e284((const void *)0x0103c024u, 0x1040, &record, 0);
        return -19;
    }
    int status = device->init();
    if (status == 0) {
        struct log_arg3 record = {2, (const void *)0x0103de16u, 0};
        FUN_0102e284((const void *)0x0103c024u, 0x10c0, &record, 0);
    } else {
        struct log_arg3 record = {3, (const void *)0x0103ddfau, status};
        FUN_0102e284((const void *)0x0103c024u, 0x1840, &record, 0);
    }
    return status;
}
