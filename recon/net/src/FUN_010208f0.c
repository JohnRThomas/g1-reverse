...
lab_948:
        uVar3 = iVar1[0x18];
        if (iVar1[9] == 2) {
            volatile unsigned int * const p9ac = (volatile unsigned int *)0x0103c4d0; /* DAT_010209ac */
    ...
    {
        volatile unsigned short * const p9ac2 = (volatile unsigned short *)0x0103c4d0; /* DAT_010209ac halfword view */
