...
#define S ((volatile uint8_t *)0x21000a30u)
#define FPA (*(volatile uintptr_t *)0x21000044u)
#define FPB (*(volatile uintptr_t *)0x2100004cu)
#define FPC (*(volatile uintptr_t *)0x21000048u)
