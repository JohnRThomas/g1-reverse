...
#define CPU_IDLE_PREPARE_MONITOR_DUMMY ((volatile uint8_t *)0x21004fabu)
#define RTC_PRETICK_CC_SET_ON_TIME      ((volatile bool *)0x21004fa9u)
#define CPU_IDLE_PREPARE_ALLOWS_SLEEP  ((volatile bool *)0x21004faau)

#define NRF_WDT_BASE   0x4100b000u
