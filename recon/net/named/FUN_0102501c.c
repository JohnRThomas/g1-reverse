/* readable reconstruction; identity: FUN_0102501c @ 0x0102501c
 * public-name: FUN_0102501c
...
#include <stdint.h>
static volatile uint64_t * const DAT_01025024 = (volatile uint64_t *)0x21001bf8;
