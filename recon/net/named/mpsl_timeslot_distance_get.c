/* readable reconstruction; identity: FUN_010243c0 @ 0x010243c0
 * public-name: mpsl_timeslot_distance_get
 * durable-map: recon/catalogs/function_names_net.json
 * callees (readable <= raw @ address):
 *   mpsl_timeslot_distance_get               <= FUN_010243c0 @ 0x010243c0
 */
...
int32_t mpsl_timeslot_distance_get(uint32_t clock, uint32_t channel,
