/* readable reconstruction; identity: FUN_0101b230 @ 0x0101b230
 * public-name: FUN_0101b230
...
extern int controller_timing_snapshot_build(void*,int,int);
...
extern int sdc_timing_compensation_get(void);
extern int radio_transition_overhead_get(void);
...
{
    int iVar7 = controller_radio_state_get();
    ...
    int iVar10 = sdc_timing_compensation_get();
    ...
    iVar7 = FUN_0102029c();
    int iVar7c = radio_phy_airtime_base_get(iVar7);
    ...
    if (uVar15 < 0x254) {
        int iVar9b = (int)radio_phy_airtime_tail_get(uVar18,0,0);
        ...
        int iVar8b = (int)radio_phy_airtime_tail_get(uVar18,(int)lVar4,0);
        int iVar17b = radio_phy_airtime_base_get(uVar18);
        ...
        if (uVar16b < uVar18b) {
            ...
            if ((uVar16b + uVar18b) > 0xffffffu || FUN_01023ea8((int)uVar18b,(int)uVar12) != 0) {
                ...
                if (IB(0x14) != 0 && IB(1) == 0) {
                    ...
                    int r = controller_timing_snapshot_build(&local_40,0,0);
                    if (r == 0) {
                        IB(2) = 1;
                    } else {
                        volatile unsigned char *pu = (volatile unsigned char*)(long)controller_radio_state_get();
                        int r2 = sdc_conn_window_admit(*pu, &local_40);
                        if (r2 == 0) {
                            sdc_assertion_fail(0x21, 0x7cb);
                        }
                    }
                }
                goto LAB_final;
        ...
        }
        {
            ...
            if (r != 0) { sdc_assertion_fail(0x21,0x794); }
        }
        {
            int r = FUN_01018de8();
            if (r != 0) { sdc_assertion_fail(0x21,0x795); }
        }
    } else {
        if (IB(1) == 0) {
            unsigned int uVar15c = (unsigned int)iVar8 + uVar15;
            unsigned long long uVar19 = radio_phy_airtime_tail_get(uVar18,0,0);
            ...
            int iVar7f = (int)radio_phy_airtime_tail_get(uVar18,(int)(uVar19 >> 0x20),(int)lVar4);
            int iVar8c = radio_phy_airtime_base_get(uVar18);
            int iVar17c = FUN_0101a184(uVar18);
            (void)radio_transition_overhead_get();
            ...
            int r = sdc_conn_window_admit(*pu, &local_40);
            if (r == 0) {
                sdc_assertion_fail(0x21,0x751);
            }
        }
LAB_final:
        if (IB(0x14) != 0) {
