...
{
  volatile unsigned int *g1 = (volatile unsigned int*)0x21004970;
  unsigned int raw = *g1;
  ...
  if (uVar3 < 0x100000) {
    volatile unsigned int *g3 = (volatile unsigned int*)0x21002b88;
  ...
  volatile unsigned int *g3b = (volatile unsigned int*)0x21002b88;
