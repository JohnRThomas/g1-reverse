/* readable reconstruction; identity: FUN_01021a38 @ 0x01021a38
 * public-name: FUN_01021a38
 * durable-map: recon/catalogs/function_names_net.json
 * address symbols (name @ address):
 *   rodata_102a665                           @ 0x0102a665
 */
...
int FUN_01021a38(int owner, uint8_t *assigned_index)
{
    ...
    *(uint16_t *)(entry + 0x24) = 0;
    entry[0x26] = 0;
    entry[0x28] = index;
    length = FUN_01022e34((const void *)0x0102a665, entry);
