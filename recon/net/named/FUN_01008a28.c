/* readable reconstruction; identity: FUN_01008a28 @ 0x01008a28
 * public-name: FUN_01008a28
 * durable-map: recon/catalogs/function_names_net.json
 */
/* net-core FUN_01008a28 @ 0x01008a28 */
#include <stdint.h>
...
/* Square a 256-bit integer and reduce it modulo the NIST P-256 field prime. */
void FUN_01008a28(uint32_t out[8], const uint32_t value[8])
{
    uint32_t square[16];
    multiply_u256(square, value, value);
    reduce_p256(out, square);
}
