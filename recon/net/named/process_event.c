...
extern unsigned long long process_recheck(int*);
...
void process_event(int *p, int param_2, int param_3, unsigned param_4)
{
...
L_888:
  ...
  *FLp = (unsigned short)uVar7;
  ...
  while (puVar12 != 0) {
      ...
      notify_one(p, puVar12, kind, puVar14);
      puVar12 = nx;
  }
  if (pcVar9 != 0) {
...
ASSERTL:
  for (;;) {
      assert_print(0x0103d2a7, 0x0103d394, 0x156);
      assert_post_action(0x0103d394, 0x156);
  }
}
