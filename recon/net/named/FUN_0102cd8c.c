/* readable reconstruction; identity: FUN_0102cd8c @ 0x0102cd8c
...
#define P_0102ce0c 0x0103d3b6
#define P_0102ce10 0x0103d2a7
...
unsigned int FUN_0102cd8c(int param_1, unsigned char *param_2)
{
  ...
  if (iVar4 == 0) {
    assert_print(P_0102ce10, P_0102ce0c, 0x72);
    uVar3 = 0x72;
  } else {
    FUN_01036144(iVar5);
    *param_2 = *param_2 | 1;
