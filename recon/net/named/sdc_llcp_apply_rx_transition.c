/* readable reconstruction; identity: FUN_0101746c @ 0x0101746c
 * public-name: sdc_llcp_apply_rx_transition
...
#define DAT_01017650 0x21001019u
#define DAT_01017654 0x21001008u

void sdc_llcp_apply_rx_transition(int param_1, u32 param_2, int param_3)
{
  volatile u8 *b;
  volatile u16 *h;
  volatile u32 *w;
