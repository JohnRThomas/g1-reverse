/* readable reconstruction; identity: FUN_0100e83c @ 0x0100e83c
 * public-name: controller_descriptor_timing_copy
...
void controller_descriptor_timing_copy(void *destination, const void *descriptor,
