/* readable reconstruction; identity: FUN_0100d538 @ 0x0100d538
 * public-name: controller_duration_to_units
...
#include <stdint.h>
#define controller_duration_to_units controller_duration_to_units
