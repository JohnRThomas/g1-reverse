...
void FUN_0102ea40(uint32_t context, const uint32_t *values)
{
    if (values != 0) {
        ...
        record[0] = 5;
        record[1] = 0x0103d82au;
        record[2] = values[0];
        record[3] = values[1];
        record[4] = values[2];
        z_impl_z_log_msg_static_create(0x0103c0c4u, 0x2840, record, 0);

        record[0] = 5;
        record[1] = 0x0103d859u;
        record[2] = values[3];
        record[3] = values[4];
        record[4] = values[5];
        z_impl_z_log_msg_static_create(0x0103c0c4u, 0x2840, record, 0);
        ...
        record[2] = 3;
        record[3] = 0x0103d888u;
        record[4] = values[7];
        z_impl_z_log_msg_static_create(0x0103c0c4u, 0x1840, &record[2], 0);

        record[2] = 3;
        record[3] = 0x0103d897u;
        record[4] = values[6];
        z_impl_z_log_msg_static_create(0x0103c0c4u, 0x1840, &record[2], 0);
    }
