...
#define P6  ((volatile unsigned char *)0x21000c48u)
#define P7C ((volatile unsigned char *)0x21000cd0u)
#define PGL ((volatile unsigned char *)0x41008000u)
...
L2c6:
    ...
    if (RB(P6,0x24) == 0) {
        if (RB(p16,0xca) != 0) {
            ...
            controller_radio_request_configure(uVar10, 0x21000cd0u, 0xfb, uVar17, 0);
        }
        FUN_0100ac98(1);
    } else {
        if (RB(p16,0xcb) != 0) {
            ...
            controller_radio_request_configure(1, 0x21000cd0u, uVar11, uVar17, 0);
        }
        FUN_0100af3c(1);
    }
