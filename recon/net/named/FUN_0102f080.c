...
u32 FUN_0102f080(u32 param_1, i32 param_2, unsigned char *param_3)
{
    ...
    scratch[1] = 0x0103da8d;
    scratch[0] = 2;
    FUN_0103a3d6(0x0103c0c4, 0x1040, &scratch[0]);

    if ((i32)(*(volatile u32*)(SCB+0x28) << 0x1b) < 0) {
        scratch[0] = 2;
        scratch[1] = 0x0103daa3;
        uVar4 = 0x11;
        FUN_0103a3d6(0x0103c0c4, 0x1040, &scratch[0]);
    } else {
        uVar4 = 0x10;
    ...
    if ((i32)(*(volatile u32*)(SCB+0x28) << 0x1c) < 0) {
        uVar4 = 0x12;
        scratch[1] = 0x0103d922;
        scratch[0] = 2;
        FUN_0103a3d6(0x0103c0c4, 0x1040, &scratch[0]);
    }
    if ((i32)(*(volatile u32*)(SCB+0x28) << 0x1e) < 0) {
        scratch[1] = 0x0103dad6;
        scratch[0] = 2;
        FUN_0103a3d6(0x0103c0c4, 0x1040, &scratch[0]);
        uVar5 = *(volatile u32*)(SCB+0x34);
        if ((i32)(*(volatile u32*)(SCB+0x28) << 0x18) < 0) {
            scratch[1] = 0x0103daee;
            scratch[0] = 3;
            scratch[2] = uVar5;
            FUN_0103a3d6(0x0103c0c4, 0x1840, &scratch[0]);
            if (param_2 != 0) {
    ...
    if (((i32)(*(volatile u32*)(SCB+0x28) << 0x1b) < 0) || ((i32)(*(volatile u32*)(SCB+0x28) << 0x1e) < 0)) {
        if ((i32)(*(volatile u32*)(SCB+4) << 0x14) < 0) {
            ...
            if (r0v == 0) {
                if ((i32)(*(volatile u32*)(SCB+0x28) << 0x1b) < 0) {
                    FUN_01039bbe(0x0103d2a7, 0x0103db23, 0x15d);
