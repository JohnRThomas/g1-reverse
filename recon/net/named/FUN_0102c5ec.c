...
#define DAT_0102c6f0 0x0103d373u
#define DAT_0102c6f4 0x0103d2a7u
...
void FUN_0102c5ec(unsigned int *param_1, int param_2, unsigned int param_3)
{
  ...
  if (param_3 < 0x40000) {
    if (param_3 < 5) {
      ...
      assert_post_action(DAT_0102c6f0, 0x1f2);
  ...
  if (uVar3 < 0x18) {
    ...
    assert_post_action(DAT_0102c6f0, 0x1fb);
    __builtin_unreachable();
  }
  *param_1 = uVar6;
  ...
  *(volatile unsigned int *)(uVar6 + 0xc) = 0;
  ...
  assert_post_action(DAT_0102c6f0, 0x20c);
  __builtin_unreachable();
}
