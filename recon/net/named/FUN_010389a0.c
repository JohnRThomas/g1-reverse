...
void *k_aligned_alloc(size_t alignment, size_t size)
{
    if (alignment < sizeof(void *) ||
        ...
        assert_print(0x0103d2a7u, 0x0103eba0u, 0x42u);
        assert_post_action(0x0103eba0u, 0x42u);
    }
    if ((alignment & (alignment - 1u)) != 0u) {
        assert_print(0x0103d2a7u, 0x0103eba0u, 0x46u);
        assert_post_action(0x0103eba0u, 0x46u);
    }
