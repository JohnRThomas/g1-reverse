/* readable reconstruction; identity: FUN_0100cff4 @ 0x0100cff4
 * public-name: FUN_0100cff4
 * durable-map: recon/catalogs/function_names_net.json
 */
/* net-core FUN_0100cff4 @ 0x100cff4  (parity 300 trials PROVEN) */
...
void FUN_0100cff4(i32 param_1, i32 param_2, u32 param_3, u32 param_4)
{
    if (param_2 == 0) {
        FUN_01025a84((u32)param_1, 0, 0x3f0);
        ...
        *(volatile u8*)(param_1+0x364) = 0x20;
        return;
    }
    if (param_2 == 1) {
        u32 uVar4 = *(volatile u32*)(param_1+0x14);
        u32 uVar2 = 0x01c9c37fu + uVar4;
        i32 iVar3;
        *(volatile u16*)(param_1+0x2f6) = 0;
        *(volatile u8*)(param_1+0x2eb) = 0;
        *(volatile u16*)(param_1+0xf6) = 0;
        *(volatile u32*)(param_1+0xec) = uVar2 / uVar4;
        *(volatile i16*)(param_1+0xfa) = (i16)((uVar4 * (u32)(*(volatile u16*)(param_1+0xfa))) / uVar4);
        *(volatile u32*)(param_1+0xe8) = (uVar4 * (u32)(*(volatile i32*)(param_1+0xe8))) / uVar4;
        *(volatile u16*)(param_1+0xf0) = 3000;
        iVar3 = 0x02625a00 / (i32)uVar4 + 1;
        *(volatile i16*)(param_1+0xf8) = (i16)(((u32)(*(volatile u16*)(param_1+0x1e)) * 10000 + (uVar4-1)) / uVar4);
        *(volatile i16*)(param_1+0xfe) = (i16)iVar3;
        FUN_0100d840((u32)(param_1+0xcd), (u32)(param_1+0xce), (u32)iVar3, param_4);
        return;
    }
    if (param_2 == 2) {
        u32 uVar2 = *(volatile u32*)(param_1+0x3c4);
        *(volatile u16*)(param_1+0xf6) = 0;
        *(volatile i16*)(param_1+0xfa) = (i16)(((u32)(*(volatile i32*)(param_1+0x14)) * (u32)(*(volatile u16*)(param_1+0xfa))) / uVar2);
        *(volatile i16*)(param_1+0xf8) = (i16)(((u32)(*(volatile u16*)(param_1+0x3ca)) * 10000 + (uVar2-1)) / uVar2);
