...
#define DAT_sem    (*(volatile unsigned int  *)0x21004668)
#define DAT_pend   (*(volatile int  *)0x21004664)
#define DAT_tick0  (*(volatile unsigned int *)0x21002788)
#define DAT_tick1  (*(volatile unsigned int *)0x2100278c)
#define DAT_p28    ((unsigned int *)0x2100086c)
#define DAT_465c   (*(volatile unsigned int *)0x2100465c)
#define STR_A      ((void*)0x0103d2a7)
#define STR_B      ((void*)0x0103d5d7)
