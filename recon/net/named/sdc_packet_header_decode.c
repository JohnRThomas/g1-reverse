/* readable reconstruction; identity: FUN_01019f9c @ 0x01019f9c
 * public-name: sdc_packet_header_decode
...
void sdc_packet_header_decode(const uint8_t *packet, volatile uint8_t *decoded)
{
