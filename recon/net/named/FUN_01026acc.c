/* readable reconstruction; identity: FUN_01026acc @ 0x01026acc
 * public-name: FUN_01026acc
...
#include <stdint.h>
extern void controller_packed_cursor_advance(void *,void *);
extern __attribute__((noreturn)) void sdc_assertion_fail(uint32_t,uint32_t);
#define controller_packed_cursor_advance controller_packed_cursor_advance
