## review group global_1098  (1 cluster(s), kinds=global)

### proposal for global_1098
struct_name: tc_aes_key_sched_struct | is_library: True | library_name: tc_aes_key_sched_struct | is_array: True | confidence: high
purpose: AES-128 expanded key schedule buffer written by tc_aes128_set_encrypt_key (tinycrypt).
fields:
...
<ground-truth bundle for global_1098>
