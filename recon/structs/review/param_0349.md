## review group param_0349  (1 cluster(s), kinds=param)

### proposal for param_0349
struct_name: nrfx_twim_t | is_library: True | library_name: nrfx_twim_t | is_array: None | confidence: high
purpose: nrfx TWI/I2C master driver instance state (config, transfer descriptors, IRQ context) used by nrfx_twim_irq_handler and nrfx_twim_xfer
fields:
  0x1  uint8_t      drv_state  
  0x8  uint32_t     p_reg_or_addr  peripheral register base or slave address
  ...
  0x160  uint32_t     field_0x160  
  0x200  uint32_t     xfer_flags  
  0x304  uint32_t     field_0x304  
  0x308  uint32_t     field_0x308  
  0x4c4  uint32_t     field_0x4c4  
  0x500  uint32_t     field_0x500  
  0x534  uint32_t     field_0x534  
  0x538  uint32_t     field_0x538  
  0x53c  uint32_t     field_0x53c  
  0x540  uint32_t     field_0x540  
  0x544  uint32_t     field_0x544  
  0x548  uint32_t     field_0x548  
  0x54c  uint32_t     field_0x54c  
  0x550  uint32_t     field_0x550  
  0x588  uint32_t     field_0x588  

<ground-truth bundle for param_0349>
