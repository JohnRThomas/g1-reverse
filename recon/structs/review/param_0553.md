## review group param_0553  (1 cluster(s), kinds=param)

### proposal for param_0553
struct_name: smp_hdr | is_library: True | library_name: smp_hdr (mcumgr) | is_array: None | confidence: medium
purpose: Mcumgr SMP header built by smp_make_rsp_hdr
fields:
  0x0  uint32_t     field_0x0  
  0x4  uint16_t     field_0x4  read-write, overlaps per layout notes, likely length/group field
  0x8  uint32_t     field_0x8  
  0xc  uint32_t     field_0xc  

<ground-truth bundle for param_0553>
