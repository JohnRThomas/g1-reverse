## review group param_0603  (1 cluster(s), kinds=param)

### proposal for param_0603
struct_name: box_render_desc | is_library: False | library_name:  | is_array: None | confidence: low
purpose: Small descriptor struct passed to FUN_00081c8c (unnamed), likely a UI element/box render descriptor with id, size and coordinate fields.
fields:
  0x2  uint8_t      field_0x2  type/id byte
  0x4  uint16_t     field_0x4  size or length field
  0xc  uint32_t     field_0xc  pointer or index field
  0x12  uint16_t     field_0x12  coordinate or count field

<ground-truth bundle for param_0603>
