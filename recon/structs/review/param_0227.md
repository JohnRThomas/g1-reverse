## review group param_0227  (1 cluster(s), kinds=param)

### proposal for param_0227
struct_name: bt_att_chan | is_library: True | library_name: bt_att_chan | is_array: None | confidence: medium
purpose: Bluetooth ATT channel object used to create PDUs (bt_att_chan_create_pdu)
fields:
  0x1e  uint16_t     field_0x1e  likely mtu/rx_mtu
  0x2e  uint16_t     field_0x2e  likely tx_mtu
  0x144  uint32_t     field_0x144  
  0x148  uint32_t     field_0x148  

<ground-truth bundle for param_0227>
