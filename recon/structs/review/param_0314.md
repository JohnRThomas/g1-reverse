## review group param_0314  (1 cluster(s), kinds=param)

### proposal for param_0314
struct_name: uarte_driver_ctx | is_library: False | library_name:  | is_array: None | confidence: medium
purpose: UARTE/DMA driver instance context shared across TX/ISR/DMA and NVS-timer helper routines (device data with a config/callback pointer and two state words)
fields:
  0x4  void *       cfg_or_cb_ptr  
  0x10  uint32_t     state_word_0  
  0x14  uint32_t     state_word_1  

<ground-truth bundle for param_0314>
