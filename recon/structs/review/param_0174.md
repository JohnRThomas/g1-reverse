## review group param_0174  (1 cluster(s), kinds=param)

### proposal for param_0174
struct_name: zcbor_state_ctx | is_library: True | library_name: zcbor_state_t (zcbor) | is_array: None | confidence: low
purpose: zcbor/CBOR encoder state used by smp_add_cmd_err and the cbor_encode_*/zcbor_bstr_encode helpers to track payload cursor and error/length fields.
fields:
  0x8  uint32_t     payload_cursor_or_field  
  0xc  uint32_t     payload_end_or_field  
  0x14  uint32_t     field_0x14  
  0x30  uint16_t     field_0x30  
  0x32  uint16_t     field_0x32  

<ground-truth bundle for param_0174>
