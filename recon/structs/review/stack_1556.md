## review group stack_1556  (1 cluster(s), kinds=stack)

### proposal for stack_1556
struct_name: post_event_tag2_local | is_library: False | library_name:  | is_array: None | confidence: low
purpose: Local stack struct in post_event_tag2_from_node holding a tag byte and payload byte
fields:
  0x0  uint8_t      field_0x0  
  0x4  uint8_t      field_0x4  

<ground-truth bundle for stack_1556>
