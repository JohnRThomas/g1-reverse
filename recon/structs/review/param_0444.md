## review group param_0444  (1 cluster(s), kinds=param)

### proposal for param_0444
struct_name: mbedtls_aes_context | is_library: True | library_name: mbedtls_aes_context | is_array: None | confidence: high
purpose: mbedTLS AES context struct (round-key schedule fields at tail) initialized by cc_mbedtls_aes_init
fields:
  0x54  uint32_t     nr_or_rk_ptr  
  0x58  uint32_t     field_0x58  
  0x5c  uint32_t     field_0x5c  
  0x60  uint32_t     field_0x60  

<ground-truth bundle for param_0444>
