## review group param_0319  (1 cluster(s), kinds=param)

### proposal for param_0319
struct_name: flash_area | is_library: True | library_name: flash_area | is_array: False | confidence: high
purpose: Zephyr/MCUboot flash_area descriptor used pervasively by boot/flash_area/nvs routines for reading, writing and erasing flash regions
fields:
  0x4  uint32_t     fa_id_or_off  
  0x8  uint32_t     fa_off  
  0xc  uint32_t     fa_size  

<ground-truth bundle for param_0319>
