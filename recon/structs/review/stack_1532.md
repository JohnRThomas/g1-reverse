## review group stack_1532  (1 cluster(s), kinds=stack)

### proposal for stack_1532
struct_name: gatt_ccc_local_value | is_library: True | library_name: bt gatt CCC read locals | is_array: None | confidence: low
purpose: Local pair of 16-bit fields (e.g. handle and CCC value) used while reading a CCC attribute in bt_gatt_attr_read_ccc.
fields:
  0x0  uint16_t     field_0x0  
  0x6  uint16_t     field_0x6  

<ground-truth bundle for stack_1532>
