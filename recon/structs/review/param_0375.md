## review group param_0375  (1 cluster(s), kinds=param)

### proposal for param_0375
struct_name: lc3_ltpf_pitch_state | is_library: True | library_name: lc3_ltpf_analysis | is_array: True | confidence: medium
purpose: LC3 LTPF (long-term post filter) pitch-detection analysis buffer/state, uniform 32-bit sample/coefficient array
fields:
  0x4  int32_t[63]  ltpf_samples  uniform-stride array from 0x4 to 0xfc, treat as one array field

<ground-truth bundle for param_0375>
