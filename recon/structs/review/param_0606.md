## review group param_0606  (1 cluster(s), kinds=param)

### proposal for param_0606
struct_name: att_chan_ctx | is_library: True | library_name: bt_att_chan | is_array: None | confidence: medium
purpose: Zephyr ATT channel context used by att_chan_read, holding MTU and pending request handle fields
fields:
  0x8  uint32_t     field_0x8  
  0x1e  uint16_t     mtu  
  0x2e  uint16_t     handle_or_offset  

<ground-truth bundle for param_0606>
