## review group param_0493  (1 cluster(s), kinds=param)

### proposal for param_0493
struct_name: heap_chunk_hdr | is_library: True | library_name: sys_heap chunk (Zephyr heap allocator) | is_array: None | confidence: medium
purpose: Zephyr sys_heap (lib/os/heap.c style) internal chunk header manipulated by chunk_field/chunk_set/alloc_chunk/free_list_add/free_list_remove_bidx
fields:
  0x8  uint32_t     size_and_flags  
  0xc  uint32_t     free_list_link  rw

<ground-truth bundle for param_0493>
