## review group param_0641  (1 cluster(s), kinds=param)

### proposal for param_0641
struct_name: smp_c1_param | is_library: True | library_name: smp_c1_params | is_array: None | confidence: low
purpose: SMP c1 confirm-value computation parameter block used by smp_c1
fields:
  0x1  uint32_t     field_0x1  
  0x5  uint16_t     field_0x5  

<ground-truth bundle for param_0641>
