## review group param_0223  (1 cluster(s), kinds=param)

### proposal for param_0223
struct_name: net_buf_hdr | is_library: True | library_name: net_buf | is_array: None | confidence: medium
purpose: Zephyr net_buf header fields accessed by L2CAP segment/PDU receive path
fields:
  0xc  uint32_t     data_ptr_or_len  r
  0x10  uint16_t     len  r

<ground-truth bundle for param_0223>
