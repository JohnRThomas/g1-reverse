## review group param_0333  (1 cluster(s), kinds=param)

### proposal for param_0333
struct_name: pdm_pin_config | is_library: False | library_name:  | is_array: False | confidence: medium
purpose: PDM GPIO pin configuration structure consumed by pdm_configure_pins (clock/data pin numbers and related settings).
fields:
  0x4  uint32_t     pin_clk  
  0x8  uint32_t     pin_din  
...
<ground-truth bundle for param_0333>
