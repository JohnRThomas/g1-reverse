## review group param_0528  (1 cluster(s), kinds=param)

### proposal for param_0528
struct_name: svc_attr_memory_pool | is_library: False | library_name:  | is_array: None | confidence: low
purpose: GATT service attribute memory pool released by svc_attr_memory_release, tracking a size/count word plus a pair of allocation pointers near the end.
fields:
  0x134  uint32_t     field_0x134  
  0x150  void*        alloc_ptr_1  
  0x154  void*        alloc_ptr_2  
  0x158  uint32_t     field_0x158  

<ground-truth bundle for param_0528>
