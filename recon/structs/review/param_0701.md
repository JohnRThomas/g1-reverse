## review group param_0701  (1 cluster(s), kinds=param)

### proposal for param_0701
struct_name: virtqueue | is_library: True | library_name: struct virtqueue (OpenAMP libmetal/virtio) | is_array: None | confidence: medium
purpose: OpenAMP/virtio virtqueue control structure passed to virtqueue_add_buffer: ring size, descriptor table pointer, free/avail indices.
fields:
  0xa  uint16_t     field_0xa  
  0x18  int          field_0x18  
  0x1c  int          field_0x1c  
  0x24  uint16_t     field_0x24  
  0x26  uint16_t     field_0x26  
  0x28  void *       desc_table  
  0x2c  uint16_t     field_0x2c  

<ground-truth bundle for param_0701>
