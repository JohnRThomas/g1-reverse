## review group stack_1070  (1 cluster(s), kinds=stack)

### proposal for stack_1070
struct_name: flash_sector_tmp | is_library: True | library_name: flash_sector | is_array: None | confidence: medium
purpose: Local sector descriptor (offset/size/count) built while walking flash_area_get_sectors
fields:
  0x4  uint32_t     sector_off  r
  0x8  uint32_t     sector_size  r
  0xc  int32_t      sector_count  r

<ground-truth bundle for stack_1070>
