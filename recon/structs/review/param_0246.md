## review group param_0246  (1 cluster(s), kinds=param)

### proposal for param_0246
struct_name: gatt_ccc_cfg | is_library: True | library_name: bt_gatt_ccc_cfg | is_array: None | confidence: medium
purpose: Zephyr GATT CCC (client characteristic configuration) entry passed to gatt_ccc_write_store_cb
fields:
  0x0  uint16_t     value_handle_or_flags  
  0x8  uint32_t     field_0x8  
  0xc  uint32_t     field_0xc  

<ground-truth bundle for param_0246>
