...
layout notes: overlap at 0x1 (prev field ends 0x4); overlap at 0x3 (prev field ends 0x4); overlap at 0xe (prev field ends 0x10)
...
struct param_0135 {
    ...
    uint32_t   field_0xc;   /* +0xc  sz=2,4 rw=r types=idx4,ushort */
