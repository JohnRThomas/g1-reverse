...
int dev_write_config_word(int param_1, unsigned param_2, int param_3){
  ...
  uVar2 = 0;
  if ((param_3 & ((uintptr_t)&tbl_ffc8) /*=0x10000*/) == 0){
    if (param_3 & 0x400) uVar2 = 6;
    else if (param_3 & 0x800) uVar2 = 7;
    else if (param_3 & ((uintptr_t)&rodata_80000) /*=0x80000*/) uVar2 = 8;
    else { if ((param_3 & ((uintptr_t)&rodata_20000) /*=0x20000*/) == 0) goto L_c36; uVar2 = 9; }
  }
