  ...
  if(param_2 < 0xb){
    ...
    if(*piVar1 > 2){
      if(*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0)
        DEBUG_PRINT(((unsigned long)&rodata_effd2) /*=0xeffd2*/,((unsigned long)&rodata_f019a) /*=0xf019a*/,0,0);
      else
    ...
    if(iVar2 == 0){
      if(*piVar1 > 2){
        if(*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0)
          DEBUG_PRINT(((unsigned long)&rodata_efff4) /*=0xefff4*/,((unsigned long)&rodata_f019a) /*=0xf019a*/,0,0);
        else
    ...
    DEBUG_PRINT(((unsigned long)&rodata_ef058) /*=0xef058*/,((unsigned long)&rodata_f019a) /*=0xf019a*/,0,0);
  } else if(*piVar1 > 0){
    if(*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0)
      DEBUG_PRINT(((unsigned long)&rodata_ef01c) /*=0xef01c*/,((unsigned long)&rodata_f019a) /*=0xf019a*/,10,0);
    else
