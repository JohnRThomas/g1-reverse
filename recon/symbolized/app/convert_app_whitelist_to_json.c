...
int convert_app_whitelist_to_json(int param_1,int param_2,int param_3){
  ...
  FUN_0008504c(iVar9,((unsigned long)&rodata_a862c) /*=0xa862c*/,(*pbVar1)&1);
  FUN_0008504c(iVar9,((unsigned long)&rodata_a864e) /*=0xa864e*/,((unsigned int)*pbVar1<<0x1e)>>0x1f);
  FUN_0008504c(iVar9,((unsigned long)&rodata_a869b) /*=0xa869b*/,((unsigned int)*pbVar1<<0x1d)>>0x1f);
  FUN_0008504c(iVar9,((unsigned long)&rodata_a866e) /*=0xa866e*/,((unsigned int)*pbVar1<<0x1c)>>0x1f);
  iVar3 = cjson_create_object();
  if (iVar3 == 0) { uVar7=0x206; iVar3=*g50; uVar6=((unsigned long)&rodata_a88d8) /*=0xa88d8*/; goto inner; }
  FUN_0008504c(iVar3,((unsigned long)&rodata_9e235) /*=0x9e235*/,((unsigned int)*pbVar1<<0x1b)>>0x1f);
  ...
  for(;;){
    ...
    uVar10 = uVar10 + 1;
    if (iVar5 == 0) break;
    FUN_0008509e(iVar5,((unsigned long)&rodata_9a1dd) /*=0x9a1dd*/,(void*)(pbVar1 + uVar8*0x38 + 2));
    FUN_0008509e(iVar5,((unsigned long)&rodata_f33e4) /*=0xf33e4*/,(void*)(pbVar1 + uVar8*0x38 + 0x2a));
