...
/* named: gatt_cf_write */
/* Reconstructed gatt_cf_write @ 0x5a5bc  (parity: 300/300 trials, PROVEN) */
  ...
  if (param_5 < 2){
    if ((int)((uint32_t)param_5 + param_4) < 2){
      ...
      if (puVar1 == 0 && (puVar1 = find_cf_cfg(), puVar1 == 0)){
        param_4 = -0x11;
        local_1c = "No space to store Client Supported Features" /*=0xf4889*/;
        local_20 = 2;
        FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1080, (void*)&local_20);
      } else {
        if (param_4 != 0){
          uVar2 = 0;
          do {
