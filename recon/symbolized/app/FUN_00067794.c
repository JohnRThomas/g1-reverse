...
uint32_t FUN_00067794(int param_1, int *param_2, uint32_t param_3, uint32_t param_4){
    if (param_2 == 0){
        printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "p_config" /*=0xf6c00*/, "WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c" /*=0xf6fef*/, 0x102);
        assert_post_action("WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c" /*=0xf6fef*/, 0x102);
    }
    uint8_t bVar1 = *(volatile uint8_t*)(param_1+4);
    uint32_t iVar3 = (uint32_t)bVar1 * 0x28;
    volatile uint8_t *iVar6 = (volatile uint8_t*)(((uintptr_t)&g_nrfx_twim_cb) /*=0x2000b3cc*/ + iVar3);
        ...
        *(volatile uint8_t*)(iVar6+0x27) = (uint8_t)cVar2;
        ...
        if (cVar2 == 0){
            if (param_2[0] == param_2[1]){
                printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "p_config->scl_pin != p_config->sda_pin" /*=0xf702b*/, "WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c" /*=0xf6fef*/, 0xf3);
                assert_post_action("WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c" /*=0xf6fef*/, 0xf3);
            }
            nrf_gpio_pin_reconfigure(param_2[0], 0, 3, uVar4, param_4);
            nrf_gpio_pin_reconfigure(param_2[1], 0, 3, uVar4);
        }
        volatile uint8_t *iVar5b = (volatile uint8_t*)(((uintptr_t)&g_nrfx_twim_cb) /*=0x2000b3cc*/ + iVar3);
