 ...
 * adopted callees (public <= raw @ address):
...
int FUN_00051870(int param_1, uint32_t param_2, uint32_t param_3, uint32_t param_4)
{
  int iVar1;
  if (param_1 == 0) {
    iVar1 = flash_img_init_id((void *)((unsigned long)&g_img_mgmt_flash_area) /*=0x2000a954*/, *(volatile uint8_t*)((unsigned long)&g_img_mgmt_active_slot) /*=0x2000ab7c*/);
    if (iVar1 != 0) {
      return 10;
    }
  }
  iVar1 = flash_img_buffered_write((void *)((unsigned long)&g_img_mgmt_flash_area) /*=0x2000a954*/, (const void *)(uintptr_t)param_2, param_3, param_4);
  if (iVar1 != 0) {
    iVar1 = 0xc;
  }
  return iVar1;
