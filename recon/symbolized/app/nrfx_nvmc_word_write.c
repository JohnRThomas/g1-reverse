...
void nrfx_nvmc_word_write(unsigned param_1, unsigned param_2, unsigned param_3, unsigned param_4){
    ...
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f6ca8) /*=0xf6ca8*/,((unsigned long)&rodata_f6c32) /*=0xf6c32*/,0x195,param_4);
    { long long r = assert_post_action(((unsigned long)&rodata_f6c32) /*=0xf6c32*/,0x195); r0v=(unsigned)r; }
L_fae:
    if ((r0v & 3) == 0) goto L_fc6;
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f6cc2) /*=0xf6cc2*/,((unsigned long)&rodata_f6c32) /*=0xf6c32*/,0x196,param_4);
