...
int bt_att_recv(int param_1, int param_2)
{
    ...
    if (*(volatile int16_t*)(param_2 + 0x10) == 0) {
        FUN_00081ddc(((uintptr_t)&tbl_880d8) /*=0x88100*/, 0x1040, (int)(intptr_t)logbuf);
        return 0;
    }
    pbVar3 = (volatile uint8_t*)(intptr_t)net_buf_simple_pull_5f594(param_2 + 0xc, 1);
    iVar8 = ((uintptr_t)&tbl_8b264) /*=0x8b2b4*/;
    if (*(volatile int*)(param_1 - 8) == 0) return 0;
    iVar6 = 0;
    do {
        iVar7 = ((uintptr_t)&tbl_8b264) /*=0x8b2b4*/ + iVar6 * 8;
        if (*(volatile uint8_t*)(((uintptr_t)&tbl_8b264) /*=0x8b2b4*/ + iVar6 * 8) == *pbVar3) {
            ...
            joined:
                if (iVar7 != 0) {
                    FUN_00081ddc(((uintptr_t)&tbl_880d8) /*=0x88100*/, 0x1080, (int)(intptr_t)logbuf);
                    goto LAB_d9c;
                }
            }
            iVar8 = iVar8 + iVar6 * 8;
            if ((unsigned)*(volatile uint16_t*)(param_2 + 0x10) < (unsigned)*(volatile uint8_t*)(iVar8 + 1)) {
                FUN_00081ddc(((uintptr_t)&tbl_880d8) /*=0x88100*/, 0x2040, (int)(intptr_t)logbuf);
    ...
    LAB_dbc:
        printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "!att_chan->rsp_buf" /*=0xf45af*/, "WEST_TOPDIR/zephyr/subsys/bluetooth/host/att.c" /*=0xf4388*/, 0xb54);
        assert_post_action("WEST_TOPDIR/zephyr/subsys/bluetooth/host/att.c" /*=0xf4388*/, 0xb54);
    }
    {
        int t = net_buf_ref(param_2);
        *(volatile int*)(param_1 + 0x13c) = t;
    }
    FUN_00081ddc(((uintptr_t)&tbl_880d8) /*=0x88100*/, 0x1880, (int)(intptr_t)logbuf);
