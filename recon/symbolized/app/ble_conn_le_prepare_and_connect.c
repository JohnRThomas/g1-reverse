...
int ble_conn_le_prepare_and_connect(undefined1 *param_1, int param_2, undefined4 param_3, undefined4 param_4, int param_5, undefined4 param_6)
{
    ...
    if (iVar8 != 0) iVar6 = 1;
    local_54 = 0;
    uVar9 = FUN_0008117a((void *)((uintptr_t)&g_ble_dev_ncmd_sem) /*=0x200020d4*/);
    ...
    atomic_and_1(((uintptr_t)&g_ble_dev_ncmd_sem) /*=0x200020d4*/);
    uVar4 = *puVar3;
    *param_1 = uVar4;
    *(volatile undefined1 *)(((uintptr_t)&g_ble_dev_state) /*=0x20002000*/ + 0x6f) = uVar4;
    iVar6 = FUN_00055454(param_1, *(volatile unsigned *)(puVar3 + 4), iVar6, 0);
    if (iVar6 != 0) return iVar6;
    int iVar1b = 0;
    if (iVar8 == 0) {
        FUN_00081196((int)(param_1 + 9), ((uintptr_t)&rodata_f2b3a) /*=0xf2b3a*/);
...
LAB_000557f6:
    ...
    if ((*(volatile int *)(puVar3 + 4) << 0x1f < 0) && (iVar2 = ble_conn_addr_resolve_or_create(param_1, &local_54), iVar2 != 0)) {
        ...
        if (iVar2 != 0) {
            FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x880f8*/, 0x1040, (void *)0, 0);
            iVar6 = local_54;
