                  ...
                  int argument5, u32 argument6)
{
    ...
    uint64_t lookup = FUN_0008117a((const void *)((unsigned long)&g_ble_dev_ncmd_sem) /*=0x200020d4*/);
    ...
    *(volatile u8 *)((unsigned long)&g_2000206f) /*=0x2000206f*/ = resource_id;
    ...
    int kind;
    if (configured == 0) {
        FUN_00081196(output + 9, ((unsigned long)&rodata_f2b3a) /*=0xf2b3a*/);
    ...
    if (result != 0) {
        ...
        FUN_0004d944(((unsigned long)&rodata_880f8) /*=0x880f8*/, 0x1040, &error, 0);
        if (allocation != 0) {
