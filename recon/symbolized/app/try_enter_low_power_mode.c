...
void try_enter_low_power_mode(void)
{
  ...
  if (((4999 < uVar6) ||
       (iVar7 = get_device_info(0), pbVar1 = (byte*)((uintptr_t)&g_low_power_mode_enabled) /*=0x20018d94*/, *(byte *)(iVar7 + 0xfc0) < 0x62)) ||
      (*(volatile byte*)((uintptr_t)&g_low_power_mode_enabled) /*=0x20018d94*/ == 0)) {
    return;
  }
  (void)pbVar1;
  disable_watchdog(0);
