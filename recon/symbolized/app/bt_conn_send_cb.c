                 ...
                 void (*callback)(void *, void *, uint8_t), void *user_data)
{
    ...
    if (connection[0x0d] != 7U) {
        ...
        bt_conn_call_4arg_zero(((unsigned long)&log_module_bt_conn) /*=0x88108*/, 0x1040U, package);
        return -128;
    }
    ...
    if (callback != 0) {
        ...
        tx = net_buf_pool_get_727ac((void *)((unsigned long)&g_audio_module_spinlock) /*=0x200068d0*/, 0U, timeout, timeout);
        if (tx == 0)
            return -105;
        if (connection[0x0d] != 7U) {
            uint32_t package[2] = { 2U, ((unsigned long)&rodata_f3be1) /*=0xf3be1*/ };
            bt_conn_call_4arg_zero(((unsigned long)&log_module_bt_conn) /*=0x88108*/, 0x1080U, package);
            tx->callback = 0;
            tx->user_data = 0;
