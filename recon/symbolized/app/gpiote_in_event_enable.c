...
void gpiote_in_event_enable(uint32_t param_1, uint32_t param_2){
    ...
    if (iVar1 == 0){
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"pin_has_trigger(pin)") /*=0xf6b87*/,((unsigned long)&rodata_f6b00) /*=0xf6b00*/,0x364,uVar2);
  ...
  L_a08:
    ...
    printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"int_enable") /*=0xf6b9c*/,((unsigned long)&rodata_f6b00) /*=0xf6b00*/,0x373,uVar2);
