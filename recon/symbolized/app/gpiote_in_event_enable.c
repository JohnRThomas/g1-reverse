...
void gpiote_in_event_enable(uint32_t param_1, uint32_t param_2){
    ...
    if (iVar1 == 0){
        printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f6b87) /*=0xf6b87*/,((unsigned long)&rodata_f6b00) /*=0xf6b00*/,0x364,uVar2);
        assert_post_action(((unsigned long)&rodata_f6b00) /*=0xf6b00*/,0x364);
    }
  L_a08:
    ...
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f6b9c) /*=0xf6b9c*/,((unsigned long)&rodata_f6b00) /*=0xf6b00*/,0x373,uVar2);
    assert_post_action(((unsigned long)&rodata_f6b00) /*=0xf6b00*/,0x373);
}
