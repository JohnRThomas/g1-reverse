...
int sc_set(int param_1, int param_2, codeptr param_3, int param_4)
{
  ...
  if (param_1 == 0) {
    ...
    FUN_00082a42(((unsigned long)&rodata_88128) /*=0x88128*/, 0x1040, &short_diagnostic);
  } else {
    ...
    if (iVar1 == 0) {
      ...
      if (local_44 == 0 || (iStack_50 = strtol_ascii_scan(local_44, 0, 10), iStack_50 == 0)) {
        ...
        FUN_00082a42(((unsigned long)&rodata_88128) /*=0x88128*/, 0x1840, &diagnostic);
        return iVar1;
      }
      diagnostic.type = 3;
      ...
      FUN_00082a42(((unsigned long)&rodata_88128) /*=0x88128*/, 0x1c40, &diagnostic);
    }
  }
  return -0x16;
}
