...
int bt_gatt_discover(int param_1, int *param_2)
{
  uint32_t uVar4;
  if (param_1 == 0) {
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f3ebd) /*=0xf3ebd*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0x118f);
    printk(((unsigned long)&rodata_f4a0a) /*=0xf4a0a*/);
    assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/, 0x118f);
  }
  if (param_2 == 0 || param_2[1] == 0) {
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f4c07) /*=0xf4c07*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0x1190);
    printk(((unsigned long)&rodata_f4a0a) /*=0xf4a0a*/);
  ...
  if (a == 0 || b == 0) {
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f4c1e) /*=0xf4c1e*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0x1191);
    printk(((unsigned long)&rodata_f4a0a) /*=0xf4a0a*/);
    assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/, 0x1191);
  }
  if (a > b) {
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f4c4b) /*=0xf4c4b*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0x1193);
    printk(((unsigned long)&rodata_f4a0a) /*=0xf4a0a*/);
