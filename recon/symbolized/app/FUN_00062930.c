...
report_descriptor(uint8_t frame[32], uint32_t flags, uintptr_t text, uint32_t value)
{
    ...
    *(uint32_t *)(frame+8)=value;
    FUN_0004d944(((unsigned long)&rodata_88250) /*=0x88250*/,flags==3?0x1840:0x1040,frame);
}
...
uint32_t FUN_00062930(uintptr_t request)
{
    ...
    if(z_device_is_ready(instance)==0) {
        ...
        *(uintptr_t *)(frame+28)=((unsigned long)&rodata_f6521) /*=0xf6521*/;
        FUN_0004d944(((unsigned long)&rodata_88250) /*=0x88250*/,0x1040,frame+24,0);
        return 0xffffffea;
    }
    uint16_t value;
