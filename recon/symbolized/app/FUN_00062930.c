...
uint32_t FUN_00062930(int param_1){
    ...
    if(iVar1==0){ FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88250*/,0x1040,buf,0); return 0xffffffea; }
    ...
    if(local_30==0x5449){
        ...
        if(local_30==0x3001){
            ...
            FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88250*/,0x1040,buf,0);
            return 0xffffffea;
        }
    }
    FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88250*/,0x1840,buf);
    return 0xffffffea;
}
