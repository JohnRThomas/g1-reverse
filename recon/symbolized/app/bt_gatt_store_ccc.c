...
int bt_gatt_store_ccc(unsigned param_1, unsigned param_2){
  ...
  frame.count=0;
  frame.input=param_2;
  bt_gatt_foreach_attr_0(1,0xffff,((unsigned long)&rodata_5a329) /*=0x5a329*/,&frame.input);
  ...
  if(iVar2!=0){
    struct { unsigned level, message; int error; } log = { 3, ((unsigned long)&rodata_f4db4) /*=0xf4db4*/, iVar2 };
