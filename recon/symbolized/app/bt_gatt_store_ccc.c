...
int bt_gatt_store_ccc(unsigned param_1, unsigned param_2){
  ...
  local_14=0;
  local_dc=param_2;
  bt_gatt_foreach_attr_0(1,((uintptr_t)&tbl_ffc8) /*=0xffff*/,((uintptr_t)&tbl_5a248) /*=0x5a329*/,&local_dc);
  if(local_14==0){ puVar1=0; iVar2=0; }
  else { iVar2=local_14<<2; puVar1=auStack_d4; }
  iVar2=FUN_00053050(param_1,param_2,puVar1,iVar2);
  if(iVar2!=0){
    local_ec="Failed to store CCCs (err %d)" /*=0xf4db4*/; local_f0=3; iStack_e8=iVar2;
    FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/,0x1840,&local_f0);
  }
  return iVar2;
}
