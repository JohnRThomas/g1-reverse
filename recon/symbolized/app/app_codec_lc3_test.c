...
{
    volatile int *v = (volatile int *)((uintptr_t)&g_log_level) /*=0x2000230c*/;
    volatile int *dbg = (volatile int *)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/;
    volatile int *S = (volatile int *)((uintptr_t)&tbl_87b30) /*=0x87bf0*/;
    volatile uint *puVar2v = (volatile uint *)((uintptr_t)&g_audio_flash_write_offset) /*=0x20002404*/;
    int *piVar1;
    uint *puVar2;
    unsigned uVar3;
    uint uVar4;
    ...
    iVar6 = malloc(iVar11);
    iVar10 = (param_2 / iVar11 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/) * 0x14;
    iVar7 = malloc(iVar10);
    if (iVar5 == 0) {
        if (0 < *v) {
            if (*dbg == 0) DEBUG_PRINT("%s(): malloc error\r\n\n" /*=0xa3f7f*/, "app_codec_lc3_test" /*=0xa41c2*/);
            else debug_print(0);
        }
LAB_0002edf8:
        iVar5 = iVar6;
        ...
        if (iVar6 != 0) {
            if (iVar7 != 0) {
                ...
                piVar1 = (int *)S;
                if ((iVar8 == 1) && (iVar8 = z_device_is_ready(((uintptr_t)&tbl_87b30) /*=0x87bf0*/), iVar8 == 0)) {
                    if (0 < *v) {
                        iVar9 = *piVar1;
                        iVar10 = *dbg;
                        uVar3 = "%s():  [%s] device not ready.\n\n" /*=0x9e9ea*/;
LAB_0002ee5a:
                        if (iVar10 == 0) DEBUG_PRINT(uVar3, "app_codec_lc3_test" /*=0xa41c2*/, iVar9);
                        else debug_print(0);
                    }
                } else {
                    ...
                    do {
                        if (iVar8 == iVar10 + iVar7) {
                            ...
                            puVar2 = (uint *)puVar2v;
                            if (iVar11 != 1) {
                                if (*(volatile int *)((uintptr_t)&g_pending_event_word) /*=0x20007b78*/ == 0) {
                                    enqueue_dmic(iVar7);
                                } else {
                                    local_30 = 0;
                                    uStack_2c = 0;
                                    ...
                                    if (2 < *v) {
                                        if (*dbg == 0) DEBUG_PRINT("%s(): send audio stream data to storage thread,timestemp = %lld\n" /*=0xa3fdf*/, "app_codec_lc3_test" /*=0xa41c2*/, local_30, uStack_2c);
                                        else debug_print("%s(): send audio stream data to storage thread,timestemp = %lld\n" /*=0xa3fdf*/, "app_codec_lc3_test" /*=0xa41c2*/);
                                    }
                            ...
                            iVar9 = (**(int (***)(int, uint, int, int))(*(volatile int *)(((uintptr_t)&tbl_87b30) /*=0x87bf0*/ + 8) + 4))(((uintptr_t)&tbl_87b30) /*=0x87bf0*/, *puVar2v, iVar7, iVar10);
                            if (iVar9 != 0) {
                                if (*v < 1) goto LAB_0002eeb6;
                                iVar10 = *dbg;
                                uVar3 = "%s(): Flash write failed! %d\n\n" /*=0x9ebc6*/;
                                goto LAB_0002ee5a;
                            }
                            if (0 < *v) {
                                if (*dbg == 0) DEBUG_PRINT("%s(): Flash write to addr 0x%x\n\n" /*=0xa3fbe*/, "app_codec_lc3_test" /*=0xa41c2*/, *puVar2);
                                else debug_print(0);
                            }
                    ...
                    if (0 < *v) {
                        iVar10 = *dbg;
                        uVar3 = "%s(): lc3_encode did not return zero %d\n" /*=0xa3f95*/;
                        goto LAB_0002ee5a;
                    }
                }
LAB_0002eeb6:
