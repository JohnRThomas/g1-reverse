...
unsigned FUN_00072e9c(int param_1,uint32_t p2,uint32_t p3,uint32_t p4){
  ...
  if(iVar2==0){
    ...
    printk(((unsigned long)&rodata_f0935) /*=0xf0935*/,((unsigned long)&timer_spinlock) /*=0x2000b480*/,0,0,0);
  ...
  printk(((unsigned long)&rodata_f090b) /*=0xf090b*/,((unsigned long)&timer_spinlock) /*=0x2000b480*/,0,0,0);
