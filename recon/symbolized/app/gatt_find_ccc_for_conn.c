...
int gatt_find_ccc_for_conn(int param_1,int param_2,unsigned int param_3,unsigned int param_4){
  int iVar2; int buf[4];
  (void)param_4;
  if (param_1 == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f3ebd) /*=0xf3ebd*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0xd19);printk(((unsigned long)"\tinvalid parameter\n\n") /*=0xf4aa5*/);assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0xd19); return 0; }
  if (param_2 == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"attr") /*=0xf4aba*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0xd1a);printk(((unsigned long)"\tinvalid parameter\n\n") /*=0xf4aa5*/);assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0xd1a); return 0; }
  ...
  if (iVar2 == 0) {
    ...
    if (param_2 == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"attr") /*=0xf4aba*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0xd2b);printk(((unsigned long)"\tNo more attributes\n\n") /*=0xf4abf*/);assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0xd2b); return 0; }
  }
  iVar2 = bt_uuid_cmp(VI(param_2), buf);
  if (iVar2 != 0) {
    param_2 = bt_gatt_attr_next(param_2);
    if (param_2 == 0) { printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"attr") /*=0xf4aba*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0xd31);printk(((unsigned long)"\tNo more attributes\n\n") /*=0xf4abf*/);assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0xd31); return 0; }
  }
  for (;;) {
    iVar2 = bt_uuid_cmp(VI(param_2), buf);
