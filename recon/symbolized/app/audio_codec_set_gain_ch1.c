...
/* named: audio_codec_set_gain_ch1 */
/* Reconstructed audio_codec_set_gain_ch1 @ 0x7fd4e  (parity: 300/300 trials, PROVEN) */
#include <stdint.h>
...
int audio_codec_set_gain_ch1(uint32_t param_1, uint32_t param_2){
    ...
    if(iVar1==0){
        if((local_14 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/) != 0){
        ...
        int iVar2 = audio_codec_bus_read_trampoline(param_1, 0x11, &local_18, 1);
        local_18 = (local_18 & ~0xffu) | ((local_18 & 0xf) | ((param_2 & 0xf)<<4));
        iVar1 = audio_codec_bus_write_trampoline(param_1, 0x11, &local_18, 1);
        iVar1 = iVar1 + iVar2;
    }
    return iVar1;
}
