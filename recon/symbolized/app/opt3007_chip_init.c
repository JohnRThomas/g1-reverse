...
u32 opt3007_chip_init(int param_1){
    ...
    *piVar2 = param_1;
    if (2 < iVar5) {
        if (FLAG == 0) log_message(((unsigned long)&rodata_a3b3f) /*=0xa3b3f*/, ((unsigned long)&rodata_a3d00) /*=0xa3d00*/);
    ...
    if (iVar5 == 0) {
        uVar6 = frame.chip_id;
        if (1 < *piVar1) {
            if (FLAG == 0) log_message(((unsigned long)&rodata_a3b7a) /*=0xa3b7a*/, ((unsigned long)&rodata_a3d00) /*=0xa3d00*/, uVar6);
        ...
        if (uVar6 == 0x5449) {
            ...
            uVar6 = frame.chip_id;
            if (1 < *piVar1) {
                if (FLAG == 0) log_message(((unsigned long)&rodata_a3bd6) /*=0xa3bd6*/, ((unsigned long)&rodata_a3d00) /*=0xa3d00*/, uVar6);
            ...
            if (uVar6 == 0x3001) {
                ...
                if (iVar5 == 0) {
                    ...
                    if (iVar5 == 0) {
                        if (*piVar1 < 1) return 0xfffffffbUL;
                        if (FLAG == 0) log_message(((unsigned long)&rodata_a3af8) /*=0xa3af8*/, ((unsigned long)&rodata_a3cee) /*=0xa3cee*/);
                        ...
                        if (-1 < iVar5) {
                            ...
                            if (2 < *piVar1) {
                                if (FLAG == 0) log_message(((unsigned long)&rodata_a3c68) /*=0xa3c68*/, ((unsigned long)&rodata_a3d00) /*=0xa3d00*/);
                        ...
                        if (*piVar1 < 1) return 0xfffffffbUL;
                        if (FLAG == 0) log_message(((unsigned long)&rodata_a3c0c) /*=0xa3c0c*/, ((unsigned long)&rodata_a3cee) /*=0xa3cee*/);
                ...
                log_message(((unsigned long)&rodata_a3c2d) /*=0xa3c2d*/, ((unsigned long)&rodata_a3d00) /*=0xa3d00*/);
                return 0xfffffffbUL;
            }
        ...
        if (iVar5 == 0) log_message(uVar4, ((unsigned long)&rodata_a3d00) /*=0xa3d00*/, uVar6);
...
LAB_0002e6c8:
    if (iVar5 == 0) log_message(uVar4, ((unsigned long)&rodata_a3d00) /*=0xa3d00*/, (u32)frame.chip_id);
