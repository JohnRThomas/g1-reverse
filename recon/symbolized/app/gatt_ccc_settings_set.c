...
unsigned int gatt_ccc_settings_set(int param_1,int param_2,codeptr param_3,int param_4,int param_5)
{
  ...
  int dummy[16];
  iVar1 = settings_name_steq(param_5, "bt/ccc" /*=0xf4a9e*/, &local_100);
  if (iVar1 == 0) {
      ...
      if ((local_fc == 0) || (uStack_108 = strtol_ascii_scan(local_fc,0,10), uStack_108 == 0)) {
        ...
        if (iVar1 == 0) {
          if (param_2 == 0) {
            ...
            if ((int)uStack_e4 < 0) {
              FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1840, dummy);
              return uStack_e4;
            }
          }
          bt_gatt_foreach_attr_0(1, ((uintptr_t)&tbl_ffc8) /*=0xffff*/, ((uintptr_t)&tbl_59dc8) /*=0x59ded*/, dummy);
          return 0;
        }
        FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1c40, dummy);
      } else {
        FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1840, dummy);
      }
    }
