...
int FUN_00066d78(int *param_1, int *param_2){
  ...
  if (r3 == ((uintptr_t)&rodata_7a120) /*=0x7a120*/) goto L_e18;
  if (r3 > ((uintptr_t)&rodata_7a120) /*=0x7a120*/) { r2v = "size" /*=0xf4240*/; goto L_d92; }
  if (r3 == ((uintptr_t)&rodata_1e848) /*=0x1e848*/) goto L_e18;
  r2v = ((uintptr_t)&rodata_3d090) /*=0x3d090*/;
 L_d92:
 ...
 L_db6:
  ...
  goto L_dc2;
 L_dca:
  if (*param_1 != REG_5000a000 /*=0x5000a000*/) return 0x0bad0000;
