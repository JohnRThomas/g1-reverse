...
long long FUN_00075acc(unsigned p1,unsigned p2,unsigned p3,unsigned p4){
  ...
  if (*(volatile int8_t*)((uintptr_t)&g_libm_ieee_mode_flag) /*=0x200035af*/ == -1) return lv;
  ...
  if (double_is_unordered()==0){
    if (__aeabi_dcmpeq()==0){
      ...
      *(unsigned*)thunk_FUN_00071678()=0x22;
      if (__aeabi_dcmplt()!=0){ FUN_000767c8(); if (__aeabi_dcmpeq()==0) return (long long)((unsigned long long)*(volatile unsigned*)((uintptr_t)&tbl_75c1c) /*=0x75c20*/<<32);}
      return (long long)((unsigned long long)*(volatile unsigned*)((uintptr_t)&tbl_75c1c) /*=0x75c24*/<<32);
    }
    if (__aeabi_dcmpeq()==0){
      if (FUN_000869dc()==0) return lv;
      if (__aeabi_dcmplt()==0) return lv;
      *(unsigned*)thunk_FUN_00071678()=0x21;
      return (long long)((unsigned long long)*(volatile unsigned*)((uintptr_t)&tbl_75c1c) /*=0x75c20*/<<32);
    }
  } else {
    if (__aeabi_dcmpeq()==0) return lv;
  }
  return (long long)((unsigned long long)*(volatile unsigned*)((uintptr_t)&tbl_75c1c) /*=0x75c28*/<<32);
}
