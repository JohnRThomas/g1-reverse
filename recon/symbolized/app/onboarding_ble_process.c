...
u32 onboarding_ble_process(u32 param_1, u32 param_2, u32 param_3, u32 param_4)
{
  ...
  if (0x17 < *(volatile u8*)(param_3 + 1)) {
    if (0 < *(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
      if (*(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
        DEBUG_PRINT("%s(): ble rcv unknown onboarding action:%d\n" /*=0xaa611*/, "onboarding_ble_process" /*=0xaa778*/, (u32)*(volatile u8*)(param_3+1), 0, 0);
      } else {
        debug_print();
      }
    }
  ...
  *(volatile u8*)((uintptr_t)&g_onboarding_step_retry_cnt) /*=0x20004bf0*/ = 0;
  uVar9 = k_uptime_get_8();
  cVar1 = *(volatile u8*)(param_3 + 1);
  *(volatile u64*)(((uintptr_t)&g_onboarding_step_retry_cnt) /*=0x20004bf0*/ + 8) = uVar9;
  ...
  *(volatile u8*)(ctx + 2) = *(volatile u8*)(param_3 + 1);
  ...
  if (2 < *(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
    ctx = *(volatile u32*)(param_1 + 0x1014);
    if (*(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
      DEBUG_PRINT("%s(): ble rcv onboarding action:%d\n" /*=0xaa63d*/, "onboarding_ble_process" /*=0xaa778*/, (u32)*(volatile u8*)(ctx+2), 0, 0);
    } else {
      debug_print();
    }
  }
  ...
  case 2:
    ...
    goto LAB_00042b1c;
  case 3:
    *(volatile u32*)(ctx + 0x1b) = *(volatile u32*)"4/6" /*=0xaa669*/;
    *(volatile u8*)((uintptr_t)&g_onboarding_primary_reset_flag) /*=0x2001cdcf*/ = 0;
    *(volatile u8*)((uintptr_t)&onboarding_secondary_reset_flag) /*=0x2001cdce*/ = 0;
    *(volatile u8*)(ctx + 3) = 0;
  ...
  case 5:
  case 6:
    *(volatile u32*)(ctx + 0x1b) = *(volatile u32*)"3/6" /*=0xaa66d*/;
    *(volatile u8*)((uintptr_t)&onboarding_attempt_counter) /*=0x2001cdd2*/ = 0;
    *(volatile u8*)((uintptr_t)&onboarding_secondary_reset_flag) /*=0x2001cdce*/ = 0;
