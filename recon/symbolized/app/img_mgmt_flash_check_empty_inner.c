...
int img_mgmt_flash_check_empty_inner(int param_1)
{
  ...
  if ((int)uVar1 < 0) {
    ...
    iVar5 = local_64;
    if (local_6c < 0) {
      FUN_0008096a(((unsigned long)&rodata_88208) /*=0x88208*/, 0x2040, dummy);
      iVar5 = 10;
    } else {
      uVar1 = *(volatile unsigned int*)(local_64 + 8) & 3;
      if (uVar1 != 0) libc_fatal_error_and_abort(((unsigned long)&rodata_f2634) /*=0xf2634*/, 0x43, ((unsigned long)&rodata_f270e) /*=0xf270e*/, ((unsigned long)&rodata_f261f) /*=0xf261f*/);
      ...
      for (; (int)uVar1 < iVar7; uVar1 = uVar1 + 0x40) {
        ...
        if (iVar3 < 0) {
          FUN_0008096a(((unsigned long)&rodata_88208) /*=0x88208*/, 0x1840, dummy);
          iVar5 = 0xb;
          goto LAB;
        }
