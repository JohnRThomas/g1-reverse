...
{
    if (param_1 != 1) {
        printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f66a6) /*=0xf66a6*/, ((unsigned long)&rodata_f6659) /*=0xf6659*/, 0x18dUL, param_1, param_2, param_3, param_4);
        assert_post_action(((unsigned long)&rodata_f6659) /*=0xf6659*/, 0x18dUL);
    }
