...
void device_info_copy_record_fields(void){
  ...
  *(volatile unsigned*)((unsigned long)&g_dashboard_startup_mode_info_defaults) /*=0x2007fc00*/ = r1;
  ...
  *(volatile unsigned*)((unsigned long)&g_all_static_info_fc08) /*=0x2007fc08*/ = r0;
  *(volatile unsigned*)((unsigned long)&g_all_static_info_fc0c) /*=0x2007fc0c*/ = r1b;
