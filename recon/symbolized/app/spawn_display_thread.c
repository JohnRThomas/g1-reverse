...
{
    unsigned int uVar1 = FUN_00071eac(((unsigned long)&g_display_thread) /*=0x20004d18*/, ((unsigned long)&g_display_thread_stack_buf) /*=0x20028e68*/, 0x1400, ADDR_display_thread_handler_THUMB /*=0x49091*/, param_1, 0, 0, 0xfffffff2, 0);
