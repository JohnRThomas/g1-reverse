...
extern int bt_gatt_attr_read_constprop_0(unsigned,unsigned,unsigned,unsigned) __asm__("bt_gatt_attr_read.constprop.0");
void gatt_db_hash_process(unsigned p1,unsigned p2,unsigned p3,unsigned p4,unsigned short p5){
  int iVar1,iVar2;
  FUN_000735cc(((uintptr_t)&g_bt_gatt_db_hash_work_63d0) /*=0x200063d0*/ - 0x30);
  iVar1 = FUN_0008270c(((uintptr_t)&g_bt_gatt_flags) /*=0x20006448*/);
  ...
  bt_gatt_attr_read_constprop_0(p3,p4,p5,((uintptr_t)&g_bt_gatt_db_hash) /*=0x20006380*/);
  return;
}
