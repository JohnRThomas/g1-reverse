...
int flash_write_and_verify_blob(char *param_1, unsigned int param_2, int param_3, int param_4)
{
    ...
    local_1c = param_2;
    iVar6 = attr_store_set(((uintptr_t)&tbl_ff20) /*=0xff20*/, 0x3c00ffff, param_3, param_4, (int)param_1);
    if ((iVar6 == 0) && (iVar6 = attr_store_set(0x4444, ((uintptr_t)&tbl_ffc8) /*=0x10000*/, 0, 0, 0), iVar6 == 0) &&
        ...
        iVar6 = attr_store_set(((uintptr_t)&tbl_ff20) /*=0xff20*/, 0x3c00f091, 0, 0, 0);
            ...
            if ((iVar6 == 0) && (iVar6 = attr_store_set(0x4820, 4, 0, 0, 0), iVar6 == 0)) {
                ...
                if (uVar11 == 0) {
                    for (; uVar11 < uVar9; uVar11 = uVar11 + 4) {
                        iVar6 = attr_configure_pair((uVar5 + uVar11) & ((uintptr_t)&tbl_ffc8) /*=0xffff*/,
                    ...
                    if (local_1c == 0) {
                        ...
                        if ((iVar6 == 0) && (uVar9 = attr_store_set(0x4820, 4, 0, 0, 0), uVar9 == 0)) {
                            for (; uVar9 < uVar11; uVar9 = uVar9 + 4) {
                                iVar6 = attr_configure_mode3_readback(&local_1c, (*(int*)(param_1 + 0xc) + uVar9) & ((uintptr_t)&tbl_ffc8) /*=0xffff*/);
                                if (iVar6 != 0) goto LAB_00030622;
                            ...
                            iVar6 = attr_configure_pair_with_init(*(unsigned short*)(*(int*)(param_1 + 0x10) + 8), ((uintptr_t)&g_flash_write_attr_value) /*=0x20222022*/, (unsigned char)*param_1);
                            if (iVar6 == 0) {
