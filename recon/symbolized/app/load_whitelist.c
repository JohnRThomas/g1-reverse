...
unsigned int load_whitelist(void)
{
    ...
    uVar1 = flash_settings_read(FLASH_ADDR_APP_WHITELIST /*=0x131000*/, buf, 0x15e2);
    if (uVar1 == 0) {
        uVar1 = (unsigned int)buf[1];
        if (uVar1 < 0x65) {
            memcpy((g_app_whitelist_buffer) /*=0x2001a22c*/, buf, 0x15e2);
            return 0;
        }
        if (*(volatile unsigned int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ != 0) {
            uVar3 = 0x36;
            uVar2 = "[%s-%d] error,appCounts is %d \n" /*=0xa842e*/;
            debug_print(uVar2, "load_whitelist" /*=0xa8aa8*/, uVar3, uVar1);
            return 0xffffffff;
        }
        uVar3 = 0x36;
        uVar2 = "[%s-%d] error,appCounts is %d \n" /*=0xa842e*/;
        ...
        if (*(volatile unsigned int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ != 0) {
            uVar3 = 0x30;
            uVar2 = "[%s-%d] flash_settings_read error,ret is %d \n" /*=0xa8400*/;
            debug_print(uVar2, "load_whitelist" /*=0xa8aa8*/, uVar3, uVar1);
            return 0xffffffff;
        }
        uVar3 = 0x30;
