                      ...
                      uint32_t transfer_count, uint32_t direction)
{
    volatile uint8_t *const controller =
        (volatile uint8_t *)((unsigned long)&g_qspi_cb) /*=0x2000b348*/;
    volatile uint32_t *const peripheral =
        (volatile uint32_t *)NRF_QSPI_BASE /*=0x5002b000*/;
    ...
    if (((buffer0 & 0xe0000000UL) != ((unsigned long)&g_sram_base_word) /*=0x20000000*/) ||
        ((buffer0 & 3U) != 0U)) {
        return 0x0bad000aUL;
    }
