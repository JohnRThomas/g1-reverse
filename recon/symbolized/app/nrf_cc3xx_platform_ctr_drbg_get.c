 ...
 * public-name: nrf_cc3xx_platform_ctr_drbg_get
 * durable-map: recon/catalogs/function_names_app.json
 * callees (readable <= raw @ address):
 *   nrf_cc3xx_platform_ctr_drbg_get          <= FUN_00079668 @ 0x00079668
...
int nrf_cc3xx_platform_ctr_drbg_get(int *param_1, int param_2, int param_3, int *param_4)
{
  int iVar1;
