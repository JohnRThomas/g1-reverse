...
extern int FUN_00024e60(unsigned type, unsigned first, unsigned second);

int FUN_0007c3d0(unsigned first, unsigned second)
{
    return FUN_00024e60(3, first, second);
}
