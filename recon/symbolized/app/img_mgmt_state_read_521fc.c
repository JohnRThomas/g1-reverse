...
unsigned img_mgmt_state_read_521fc(int param_1)
{
    ...
    iVar3 = local_d4[0];
    puVar1 = (volatile unsigned *)((uintptr_t)&g_img_mgmt_active_slot) /*=0x2000ab7c*/;
    uVar4 = 0;
    if (uVar2 == 0) {
        if (local_e0 == '\0') {
        ...
        if (local_c8 == 0) {
            ...
            if (uVar2 != 0) {
                local_104 = "Irrecoverable error: flash write failed: %d" /*=0xf280b*/;
                local_108 = 3;
                uStack_100 = uVar2;
                FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88208*/, 0x1840, &local_108, 0);
                goto LAB_00052300;
            }
            iVar3 = puVar1[1];
        ...
        local_104 = "Image upload inspect failed: %d" /*=0xf27eb*/;
        local_108 = 3;
        uStack_100 = uVar2;
        FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88208*/, 0x1840, &local_108, 0);
LAB_00052300:
        iVar3 = smp_add_cmd_err(iVar5 + 4, 1, uVar2 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/);
        img_mgmt_read_hash_and_flags(1, 0, auStack_b8);
        FUN_00051fe4();
        if (iVar3 == 0) {
            uVar4 = 7;
