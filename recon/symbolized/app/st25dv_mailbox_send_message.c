...
int st25dv_mailbox_send_message(void){
  volatile unsigned* puVar2 = (volatile unsigned*)((uintptr_t)&g_st25dv_mailbox_msg) /*=0x20007a14*/;
  unsigned local_18; unsigned short local_12; unsigned char local_19;
  short sVar4; int iVar5;
  local_18 = puVar2[0];
  unsigned char b = *(volatile unsigned char*)((int)((uintptr_t)&g_st25dv_mailbox_msg) /*=0x20007a14*/+2);
  puVar2[3] = 4;
  if(b==0){
    unsigned h = *(volatile unsigned short*)((int)((uintptr_t)&g_st25dv_mailbox_msg) /*=0x20007a14*/+6);
    local_12 = (unsigned short)(((h&0xff)<<8) | (h>>8));
    puVar2[3]=8;
  }
  sVar4 = (short)st25dv_write_reg_pair(&local_18);
  volatile unsigned* puVar3 = (volatile unsigned*)((uintptr_t)&g_st25dv_dev) /*=0x20007a44*/;
  iVar5 = (int)sVar4;
  if(iVar5==0){
    local_19=3;
