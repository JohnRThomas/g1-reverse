...
void FUN_0000fcf0(uint8_t *s){volatile uint8_t*busy=(uint8_t*)((unsigned long)&g_20018c66) /*=0x20018c66*/,*flag=(uint8_t*)((unsigned long)&g_20003023) /*=0x20003023*/;volatile uint16_t*last=(uint16_t*)((unsigned long)&g_2000f6e4) /*=0x2000f6e4*/;volatile float*deadline=(float*)((unsigned long)&g_20007a04) /*=0x20007a04*/;
