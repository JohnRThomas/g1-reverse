...
/* readable reconstruction; identity: FUN_000680f8 @ 0x000680f8
 * public-name: metal_bus_unregister
 * durable-map: recon/catalogs/function_names_app.json
 * address symbols (name @ address):
 *   rodata_f7a8a                             @ 0x000f7a8a
...
#define METAL_LOG_STATE ((volatile struct metal_log_state_raw *)((unsigned long)&g_metal_generic_bus) /*=0x2000b424*/)
#define METAL_LOG_DEBUG 7u
#define METAL_BUS_UNREGISTERED_FORMAT ((const char *)((unsigned long)&rodata_f7a8a) /*=0xf7a8a*/)
