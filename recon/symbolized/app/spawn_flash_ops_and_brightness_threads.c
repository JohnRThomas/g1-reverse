...
void spawn_flash_ops_and_brightness_threads(int param_1){
    ...
    FUN_00071eac(((unsigned long)&g_flash_ops_thread) /*=0x20003e38*/, ((unsigned long)&g_flash_ops_thread_stack) /*=0x20021968*/, 0x800, ADDR_flash_ops_thread_THUMB /*=0x23481*/, param_1, 0, 0, 0xfffffff4, 0);
    FUN_00071eac(((unsigned long)&g_brightness_thread) /*=0x20003f10*/, ((unsigned long)&g_brightness_thread_stack) /*=0x20022168*/, 0x1400, ADDR_FUN_00023844_THUMB /*=0x23845*/, param_1, 0, 0, 0xfffffff5, 0);
}
