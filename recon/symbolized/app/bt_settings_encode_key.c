...
void bt_settings_encode_key(int param_1,int param_2,int param_3,uint8_t *param_4,int param_5){
  ...
  if(param_5 == 0){
    snprintk(param_1,param_2,"bt/%s/%02x%02x%02x%02x%02x%02x%u" /*=0xf2c25*/,param_3,b6,b5,b4,b3,b2,b1,b0);
  } else {
    snprintk(param_1,param_2,"bt/%s/%02x%02x%02x%02x%02x%02x%u/%s" /*=0xf2c01*/,param_3,b6,b5,b4,b3,b2,b1,b0,param_5);
  }
}
