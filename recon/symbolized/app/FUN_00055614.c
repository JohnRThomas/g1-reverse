...
unsigned int FUN_00055614(unsigned char* param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4){
  int iVar1=((uintptr_t)&g_ble_dev_state) /*=0x20002000*/;
  unsigned int uVar4=*(unsigned int*)(param_1+4);
  int iVar2,iVar3;
  if(((int)(uVar4<<0x15)>=0) &&
     (iVar3=*(int*)(param_1+0x10), (iVar3==0 || (uVar4&1)!=0))){
    if(*(volatile unsigned char*)(((uintptr_t)&g_ble_dev_state) /*=0x20002000*/+7) <= (unsigned int)*param_1) return 0;
    iVar2=memcmp((unsigned int)*param_1*7+((uintptr_t)&g_ble_dev_state) /*=0x20002000*/,((uintptr_t)&rodata_f2b3a) /*=0xf2b3a*/,7,*(volatile unsigned char*)(((uintptr_t)&g_ble_dev_state) /*=0x20002000*/+7),param_4);
    if(iVar2==0) return 0;
    ...
    }
    {
      ...
      if((v8<=vc)&&(v8>0x1f)&&(vc<0x4001)){
        L662:
        if((uVar4&((uintptr_t)&rodata_38000) /*=0x38000*/)!=((uintptr_t)&rodata_38000) /*=0x38000*/) return 1;
        return 0;
      }
    }
  }
