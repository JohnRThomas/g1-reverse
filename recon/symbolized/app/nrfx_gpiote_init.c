...
uint32_t nrfx_gpiote_init(void){
  int iVar1=((uintptr_t)&g_gpiote_cb) /*=0x20002bc0*/;
  uint32_t uVar3=0x0bad0005;
  int iVar2=0;
  if(*(volatile uint8_t*)(((uintptr_t)&g_gpiote_cb) /*=0x20002bc0*/+0x78)==0){
    memset_bytes(((uintptr_t)&g_gpiote_cb) /*=0x20002bc0*/+0x10,0,0x60);
    uint uVar4=0;
    do{
      iVar2=gpiote_in_event_reg_offset(uVar4&0xff);
      if((iVar2-0x100U)>>2==0x1f){
        *(volatile uint32_t*)(iVar2+REG_5000d000 /*=0x5000d000*/)=0;
      }
      iVar2=REG_5000d000 /*=0x5000d000*/;
      uVar4=uVar4+1;
    }while(uVar4!=8);
    *(volatile uint32_t*)(REG_5000d000 /*=0x5000d000*/+0x17c)=0;
    arch_irq_enable(0xd);
