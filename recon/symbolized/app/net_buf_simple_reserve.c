...
{
    if (param_1 == (int*)0) {
        printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "buf" /*=0xf45be*/, "WEST_TOPDIR/zephyr/subsys/net/buf_simple.c" /*=0xf543a*/, 0x2bUL);
        unsigned long long rv = assert_post_action("WEST_TOPDIR/zephyr/subsys/net/buf_simple.c" /*=0xf543a*/, 0x2bUL);
    ...
    printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "buf->len == 0U" /*=0xf5465*/, "WEST_TOPDIR/zephyr/subsys/net/buf_simple.c" /*=0xf543a*/, 0x2cUL);
    unsigned long long rv = assert_post_action("WEST_TOPDIR/zephyr/subsys/net/buf_simple.c" /*=0xf543a*/, 0x2cUL);
    merge_tail((unsigned int)rv, (unsigned int)(rv >> 32));
}
