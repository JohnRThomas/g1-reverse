...
void gpiote_irq_handler(void)
{
    ...
    LAB_bce:
        ...
        piVar12 = local_30;
        while (1) {
            volatile uint8_t *pbVar14 = (volatile uint8_t*)(iVar13 + ((uintptr_t)&rodata_f6bb7) /*=0xf6bb7*/);
            int iVar8;
            while ((iVar8 = piVar12[0]) != 0) {
                ...
                uint16_t uVar1 = *(volatile uint16_t*)(((uintptr_t)&g_gpiote_cb) /*=0x20002bc0*/ + ((int)uVar16 + 8) * 2);
