...
{
    volatile uint8_t *g = (volatile uint8_t*)((uintptr_t)&g_display_last_drawn_lang) /*=0x20004968*/;
    unsigned uVar1;
    ...
    if (uVar1 == 6) {
        ...
        iVar4 = device_info_text_width_get();
        iVar5 = device_info_text_height_get_clamped();
        gui_utf_draw(0, "Rechte TouchBar halten" /*=0xa8ec6*/, 0, iVar2 + 0x134, iVar3 + 0x28, iVar4 + 0x236, iVar5 + 0x43, 1, 0, 0, 0, 0);
        iVar2 = device_info_text_width_get();
        iVar4 = device_info_text_height_get_clamped();
        iVar5 = device_info_text_width_get();
        iVar3 = device_info_text_height_get_clamped();
        iVar2 = iVar2 + 0x15a;
        uVar7 = ((uintptr_t)&tbl_a892b) /*=0xa8edd*/;
        ...
        iVar4 = device_info_text_width_get();
        iVar5 = device_info_text_height_get_clamped();
        gui_utf_draw(0, "Hold Right TouchBar" /*=0xa8ea1*/, 0, iVar2 + 0x144, iVar3 + 0x28, iVar4 + 0x236, iVar5 + 0x43, 1, 0, 0, 0, 0);
        iVar2 = device_info_text_width_get();
        iVar4 = device_info_text_height_get_clamped();
        iVar5 = device_info_text_width_get();
        iVar3 = device_info_text_height_get_clamped();
        iVar2 = iVar2 + 0x150;
        uVar7 = "to Add QuickNote" /*=0xa8eb5*/;
        gui_utf_draw(0, uVar7, 0, iVar2, iVar4 + 0x43, iVar5 + 0x236, iVar3 + 0x5e, 1, 0, 0, 0, 0);
    }
}
