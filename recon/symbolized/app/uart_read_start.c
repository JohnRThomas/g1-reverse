...
unsigned uart_read_start(int param_1, unsigned param_2, unsigned param_3){
  ...
  if(param_1!=0){
    ...
    iVar1=k_mem_slab_alloc(((uintptr_t)&g_uart_rx_mem_slab) /*=0x200037b8*/,&local_14,0,0,param_1);
    if(iVar1==0){
      void **p = *(void***)(param_1+8);
      if((fp1)p[0]!=0 && (iVar1=((fp1)p[0])(param_1,((uintptr_t)&tbl_33324) /*=0x33385*/,param_1))==0){
