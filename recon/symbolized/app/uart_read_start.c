  ...
  if(param_1!=0){
    ...
    if(iVar1==0){
      ...
      if((fp1)p[0]!=0 && (iVar1=((fp1)p[0])(param_1,ADDR_uart_callback_THUMB /*=0x33385*/,param_1))==0){
        ...
        if(iVar1==0) return 0;
        DEBUG_PRINT(((unsigned long)&rodata_a7b41) /*=0xa7b41*/); return 0xfffffffd;
      }
      DEBUG_PRINT(((unsigned long)&rodata_a7b29) /*=0xa7b29*/); return 0xfffffffe;
    }
    DEBUG_PRINT(((unsigned long)&rodata_a7b13) /*=0xa7b13*/);
  }
  return 0xffffffff;
}
