...
int _vfprintf_r(int param_1, int param_2, unsigned char *param_3, uint *param_4)
{
    ...
    if (param_2 == ((uintptr_t)&rodata_9871c) /*=0x9871c*/) param_2 = *(volatile int *)(param_1 + 4);
    else if (param_2 == ((uintptr_t)&rodata_986fc) /*=0x986fc*/) param_2 = *(volatile int *)(param_1 + 8);
    else if (param_2 == ((uintptr_t)&rodata_986dc) /*=0x986dc*/) param_2 = *(volatile int *)(param_1 + 0xc);
...
LAB_00076f6a:
    pbVar6 = pbVar7;
    if (*pbVar6 != 0) goto LAB_00076f72 /*=0x76f72*/;
    goto LAB_00076f76;
LAB_00076f72 /*=0x76f72*/:
    pbVar7 = pbVar6 + 1;
...
LAB_000770da:
    ...
    while (1) {
        pbVar6 = pbVar7 + 1;
        iVar2 = mem_find_byte("#-0+ " /*=0xf8b6b*/, *pbVar7);
        iVar8 = "hlL" /*=0xf8b71*/;
        if (iVar2 == 0) break;
        local_88 = 1 << (iVar2 - 0xf8b6b /*=0xf8b6b*/ & 0xffU) | local_88;
        pbVar7 = pbVar6;
    }
    ...
    if (iVar8 == 0) {
        unaff_r7 = vfprintf_format_engine(param_1, &local_88, param_2, ((uintptr_t)&rodata_86cb7) /*=0x86cb7*/, &local_8c);
    } else {
        if (((uintptr_t)&rodata_7712d) /*=0x7712d*/ == 0) {
            local_8c = (uint *)(((int)local_8c + 7U & 0xfffffff8) + 8);
            goto LAB_00077088;
        }
        unaff_r7 = FUN_0007712c(param_1, &local_88, param_2, ((uintptr_t)&rodata_86cb7) /*=0x86cb7*/, &local_8c);
    }
