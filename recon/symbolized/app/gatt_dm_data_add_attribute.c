...
int gatt_dm_data_add_attribute(unsigned int* param_1,int param_2){
  int iVar2=((uintptr_t)&cur_service_val) /*=0x2000a154*/; int iVar3,iVar4,iVar5,iVar6; short uVar1;
  struct{unsigned int a,b;} s;
  s.b="No space for new attribute." /*=0xf1237*/;
  if(*(volatile unsigned int*)(iVar2+0x134)<0x23){
    iVar3=FUN_0004e98c(*(unsigned char*)(*param_1));
    iVar4=gatt_dm_attr_alloc(iVar3+param_2);
    s.b="No space for attribute data." /*=0xf1253*/;
    if(iVar4!=0){
  ...
  s.a=2;
  FUN_0007f406(((uintptr_t)&tbl_880d8) /*=0x88130*/,0x1040,&s);
  return 0;
}
