...
#define PW(off) (*(volatile uint32_t *)(((uintptr_t)&g_pdm_mic_ctrl_blk) /*=0x2000b008*/ + (off)))
#define CB(off) (*(volatile char *)(((uintptr_t)&g_pdm_mic_ctrl_blk) /*=0x2000b008*/ + (off)))
#define WB(off) (*(volatile unsigned char *)(((uintptr_t)&g_pdm_mic_ctrl_blk) /*=0x2000b008*/ + (off)))
...
LAB_0005ffbe:
        ...
        cVar4 = '\0';
LAB_000600b0:
        iVar2 = k_msgq_put(((uintptr_t)&g_pdm_mic_rx_msgq) /*=0x2000b024*/, (int)(param_1 + 4), 0, 0);
        if (iVar2 < 0) {
            local_1c = "No room in RX queue" /*=0xf585d*/;
            local_20 = 2;
            FUN_000837a2(((uintptr_t)&tbl_880d8) /*=0x881a0*/, 0x1040, &local_20);
            k_mem_slab_free(PW(0x14), *(int *)(param_1 + 4));
            goto LAB_00060008;
        }
    } else {
        iVar2 = k_mem_slab_alloc(PW(0x14), local_30, 0, 0);
        uVar3 = "Failed to allocate buffer: %d" /*=0xf5822*/;
        if ((iVar2 < 0) ||
            (iVar2 = nrfx_pdm_buffer_set(local_30[0], (unsigned int)(PW(0x18) << 0xf) >> 0x10), uVar3 = "Failed to set buffer: 0x%08x" /*=0xf5840*/,
             iVar2 != 0x0bad0000)) {
            local_40 = 3;
            local_3c = uVar3;
            iStack_38 = iVar2;
            FUN_000837a2(((uintptr_t)&tbl_880d8) /*=0x881a0*/, 0x1840, &local_40);
            if (CB(0x52) == '\0') {
