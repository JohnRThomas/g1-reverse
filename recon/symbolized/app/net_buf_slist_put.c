...
void net_buf_slist_put(uint32_t *param_1, uint32_t *param_2){
    if (param_1 == 0){
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f3630) /*=0xf3630*/,((unsigned long)&rodata_f539a) /*=0xf539a*/,0x1ad);
        assert_post_action(((unsigned long)&rodata_f539a) /*=0xf539a*/,0x1ad);
    } else if (param_2 == 0){
        printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f45be) /*=0xf45be*/,((unsigned long)&rodata_f539a) /*=0xf539a*/,0x1ae);
