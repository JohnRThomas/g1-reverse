...
unsigned img_mgmt_state_encode_image(unsigned param_1,unsigned param_2,unsigned param_3){
  ...
  if (iVar1==0){
    ...
    uVar2 = 0;
    if (iVar1!=0 && (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f349f) /*=0xf349f*/,5))!=0 &&
        (iVar1=cbor_encode_uint32(param_1,param_2>>1))!=0 &&
        (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f272f) /*=0xf272f*/,4))!=0 &&
        (iVar1=cbor_encode_uint32(param_1,param_2&1))!=0 &&
        (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f6589) /*=0xf6589*/,7))!=0){
      ...
      if (iVar1!=0 && (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f4a01) /*=0xf4a01*/,4))!=0 &&
          (iVar1=FUN_00086338(param_1,&local_64))!=0 &&
          (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f273a) /*=0xf273a*/,8))!=0 &&
          (iVar1=cbor_encode_simple(param_1,((local_68^0x10)>>4)&1))!=0 &&
          (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f2743) /*=0xf2743*/,7))!=0 &&
          (iVar1=cbor_encode_simple(param_1,(param_3>>1)&1))!=0 &&
          (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f274b) /*=0xf274b*/,9))!=0 &&
          (iVar1=cbor_encode_simple(param_1,(param_3>>2)&1))!=0 &&
          (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f5702) /*=0xf5702*/,6))!=0 &&
          (iVar1=cbor_encode_simple(param_1,param_3&1))!=0 &&
          (iVar1=k_heap_alloc(param_1,(void*)((unsigned long)&rodata_f2755) /*=0xf2755*/,9))!=0 &&
