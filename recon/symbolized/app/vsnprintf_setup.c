...
void vsnprintf_setup(unsigned int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
  ...
  uStack_4 = param_4;
  local_7c = strlen();
  local_5c = ((uintptr_t)&tbl_86f35) /*=0x86f57*/;
  local_4c = 0;
  local_38 = 0;
  local_72 = ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
  local_6c = local_7c;
  vfprintf_core(*(volatile unsigned int *)((uintptr_t)&g_libc_heap_ctrl) /*=0x20002d20*/, &local_80, param_2, &uStack_8);
}
