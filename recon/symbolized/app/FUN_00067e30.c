...
void FUN_00067e30(uintptr_t *device,uint32_t a,uint32_t b,uint32_t context){
 ...
 if(s[1]==0){printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f7a1b) /*=0xf7a1b*/,((unsigned long)&rodata_f79c8) /*=0xf79c8*/,0x8c,context);assert_post_action(((unsigned long)&rodata_f79c8) /*=0xf79c8*/,0x8c);}
 if(s[0]==1){*(volatile uint32_t*)*device=1;s[0]=2;return;}
 printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f7052) /*=0xf7052*/,((unsigned long)&rodata_f79c8) /*=0xf79c8*/,0x8d,context);assert_post_action(((unsigned long)&rodata_f79c8) /*=0xf79c8*/,0x8d);
}
