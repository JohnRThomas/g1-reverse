...
#define DAT_00045bac ((volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/)
#define DAT_00045bb0 ((volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/)
#define DAT_00045bb4 ("resource_manger_get" /*=0xbc083*/)
#define DAT_00045bb8 ("%s(): read flash fail\n\n" /*=0xbbfee*/)
#define DAT_00045bbc (((uintptr_t)&g_glyph_bitmap_cache_buf) /*=0x2001ce57*/)
#define DAT_00045bc0 ("%s(): read flash fail: %d\n\n" /*=0xa1ce0*/)
...
#define DAT_00045f34 (((uintptr_t)&g_glyph_bitmap_cache_buf) /*=0x2001ce57*/)
#define DAT_00045f38 (0x4f3bf0UL)
#define DAT_00045f3c (0x4d58f8UL)
#define DAT_00045f40 ((volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/)
#define DAT_00045f44 ((volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/)
#define DAT_00045f48 ("resource_manger_get" /*=0xbc083*/)
#define DAT_00045f4c ("%s(): *************** can't find resEncode = 0x%02x*****************\n" /*=0xbc006*/)
#define DAT_0004627c ((volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/)
#define DAT_00046280 ((volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/)
#define DAT_00046284 ("resource_manger_get" /*=0xbc083*/)
#define DAT_00046288 ("%s(): can't find resource ,exit .....\n" /*=0xbc04c*/)
#define DAT_0004628c (((uintptr_t)&rodata_c8162) /*=0xc8162*/)
#define DAT_00046290 (((uintptr_t)&rodata_c8f47) /*=0xc8f47*/)
#define DAT_00046294 (((uintptr_t)&rodata_c8e7f) /*=0xc8e7f*/)
#define DAT_00046298 (((uintptr_t)&rodata_c8db7) /*=0xc8db7*/)
#define DAT_0004629c (((uintptr_t)&rodata_c805e) /*=0xc805e*/)
#define DAT_000462a0 (((uintptr_t)&rodata_c87c7) /*=0xc87c7*/)
#define DAT_000462a4 (((uintptr_t)&rodata_c8b5f) /*=0xc8b5f*/)
#define DAT_000462a8 (((uintptr_t)&rodata_c8c27) /*=0xc8c27*/)
#define DAT_000462ac (((uintptr_t)&rodata_c8cef) /*=0xc8cef*/)
#define DAT_000462b0 (((uintptr_t)&rodata_c89cf) /*=0xc89cf*/)
#define DAT_000462b4 (((uintptr_t)&rodata_c8a97) /*=0xc8a97*/)
#define DAT_000462b8 (((uintptr_t)&rodata_c88cb) /*=0xc88cb*/)
#define DAT_000462bc (((uintptr_t)&rodata_bc613) /*=0xbc613*/)
#define DAT_000462c0 (((uintptr_t)&rodata_bc529) /*=0xbc529*/)
#define DAT_000462c4 (((uintptr_t)&rodata_bc43f) /*=0xbc43f*/)
#define DAT_000462c8 (((uintptr_t)&rodata_bc355) /*=0xbc355*/)
#define DAT_000462cc (((uintptr_t)&rodata_bc26b) /*=0xbc26b*/)
#define DAT_000462d0 (((uintptr_t)&rodata_bc181) /*=0xbc181*/)
#define DAT_000462d4 (((uintptr_t)&tbl_bc04c) /*=0xbc097*/)
#define DAT_000462d8 (((uintptr_t)&rodata_ca04f) /*=0xca04f*/)
#define DAT_000462dc (((uintptr_t)&rodata_c9f4b) /*=0xc9f4b*/)
#define DAT_000462e0 (((uintptr_t)&rodata_c9e47) /*=0xc9e47*/)
#define DAT_000462e4 (((uintptr_t)&rodata_c9d43) /*=0xc9d43*/)
#define DAT_0004657c (((uintptr_t)&rodata_c9c3f) /*=0xc9c3f*/)
#define DAT_00046580 (((uintptr_t)&rodata_c9b3b) /*=0xc9b3b*/)
#define DAT_00046584 (((uintptr_t)&rodata_c9a37) /*=0xc9a37*/)
#define DAT_00046588 (((uintptr_t)&rodata_c9933) /*=0xc9933*/)
#define DAT_0004658c (((uintptr_t)&rodata_c982f) /*=0xc982f*/)
#define DAT_00046590 (((uintptr_t)&rodata_c972b) /*=0xc972b*/)
#define DAT_00046594 (((uintptr_t)&rodata_c9627) /*=0xc9627*/)
#define DAT_00046598 (((uintptr_t)&rodata_c9523) /*=0xc9523*/)
#define DAT_0004659c (((uintptr_t)&rodata_c941f) /*=0xc941f*/)
#define DAT_000465a0 (((uintptr_t)&rodata_c931b) /*=0xc931b*/)
#define DAT_000465a4 (((uintptr_t)&rodata_c9217) /*=0xc9217*/)
#define DAT_000465a8 (((uintptr_t)&rodata_c9113) /*=0xc9113*/)
#define DAT_000465ac (((uintptr_t)&rodata_c900f) /*=0xc900f*/)
#define DAT_000465b0 (((uintptr_t)&rodata_c7f5a) /*=0xc7f5a*/)
#define DAT_000465b4 (((uintptr_t)&rodata_c7e92) /*=0xc7e92*/)
#define DAT_000465b8 (((uintptr_t)&rodata_c81a3) /*=0xc81a3*/)
#define DAT_000465bc (((uintptr_t)&rodata_c7c22) /*=0xc7c22*/)
#define DAT_000465c0 (((uintptr_t)&rodata_c7a90) /*=0xc7a90*/)
#define DAT_000465c4 (((uintptr_t)&rodata_c7956) /*=0xc7956*/)
#define DAT_000465c8 (((uintptr_t)&rodata_c77c4) /*=0xc77c4*/)
#define DAT_000465cc (((uintptr_t)&rodata_c768a) /*=0xc768a*/)
#define DAT_000465d0 (((uintptr_t)&rodata_c760a) /*=0xc760a*/)
#define DAT_000465d4 (((uintptr_t)&rodata_c758a) /*=0xc758a*/)
#define DAT_000465d8 (((uintptr_t)&rodata_c74c2) /*=0xc74c2*/)
#define DAT_000465dc (((uintptr_t)&rodata_c73fa) /*=0xc73fa*/)
#define DAT_000465e0 (((uintptr_t)&rodata_c86c3) /*=0xc86c3*/)
#define DAT_000465e4 (((uintptr_t)&rodata_c85fb) /*=0xc85fb*/)
#define DAT_000465e8 (((uintptr_t)&rodata_c8533) /*=0xc8533*/)
#define DAT_000465ec (((uintptr_t)&rodata_c846b) /*=0xc846b*/)
#define DAT_000465f0 (((uintptr_t)&rodata_c83a3) /*=0xc83a3*/)
#define DAT_000465f4 (((uintptr_t)&rodata_c82db) /*=0xc82db*/)
#define DAT_000465f8 (((uintptr_t)&tbl_c72d7) /*=0xc739f*/)
#define DAT_000465fc ("\"\"\"\"\"\"\"\"\"\"\"" /*=0xc736d*/)
#define DAT_00046600 (((uintptr_t)&tbl_c72d7) /*=0xc733b*/)
#define DAT_00046604 ("\"\"\"\"\"\"\"\"\"\"" /*=0xc7309*/)
#define DAT_00046608 (((uintptr_t)&tbl_c72d7) /*=0xc72d7*/)
#define DAT_0004660c (((uintptr_t)&rodata_c6df5) /*=0xc6df5*/)
#define DAT_00046610 (((uintptr_t)&rodata_c6913) /*=0xc6913*/)
#define DAT_00046614 (((uintptr_t)&rodata_c6431) /*=0xc6431*/)
#define DAT_00046618 (((uintptr_t)&rodata_c5f4f) /*=0xc5f4f*/)
#define DAT_0004661c (((uintptr_t)&rodata_c5a6d) /*=0xc5a6d*/)
#define DAT_00046620 (((uintptr_t)&rodata_c558b) /*=0xc558b*/)
#define DAT_00046624 (((uintptr_t)&rodata_c50a9) /*=0xc50a9*/)
...

{
  ...
  case 0:
    if ((int)param_2 < 0x2714) {
      uVar11 = get_default_font_glyph_offset(param_2 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/,&local_28,&local_24);
      *param_5 = (int)uVar11;
      if ((int)uVar11 != 0) {
        *param_3 = local_28;
        *param_4 = local_24;
    ...
    if (((uintptr_t)&tbl_ff20) /*=0xff41*/ < param_2 - 0xa4) goto LAB_00045caa;
    iVar8 = get_device_info();
    pcVar10 = *(code **)(iVar8 + 0x1030);
    uVar4 = get_device_info();
    iVar9 = (param_2 - 0xa4) * 4;
    uVar5 = (*pcVar10)(uVar4,iVar9 + FLASH_OFF_140000 /*=0x140000*/,&local_24);
    iVar8 = DAT_00045bbc;
    if (uVar5 == 0) {
      uVar1 = local_24 >> 0x10;
      if (uVar1 == ((uintptr_t)&tbl_ffc8) /*=0xffff*/) {
        if (param_2 - 0x1100 < 0xfa) {
          ...
          ;
          if ((*(volatile uint16_t*)((char*)&local_24 + 2)) != ((uintptr_t)&tbl_ffc8) /*=0xffff*/) {
...
LAB_00045cb8:
          if (0x5d < param_2 - ((uintptr_t)&rodata_ff01) /*=0xff01*/) {
          ...
          if (*(int *)((int)uVar12 + 0x1030) != 0) {
            ...
            if (uVar5 != ((uintptr_t)&tbl_ffc8) /*=0xffff*/) {
...
LAB_00045db4:
          ...
          if (param_2 - 0x302e < 2) {
            ...
            if (*(int *)((int)uVar12 + 0x1030) != 0) {
              ...
              uVar5 = local_24 >> 0x10;
              if (uVar5 != ((uintptr_t)&tbl_ffc8) /*=0xffff*/) goto LAB_00045a8a;
LAB_00045b4e:
              iVar6 = 0;
              uVar11 = 0;
              iVar8 = iVar6;
...
LAB_00045dfa:
            ...
            uVar5 = (uint)(*(volatile uint16_t*)((char*)&local_24 + 2));
            uVar2 = 0;
            if (uVar5 == ((uintptr_t)&tbl_ffc8) /*=0xffff*/) goto LAB_00045e48;
            memset_bytes(DAT_00045f34,0,0x138);
            iVar9 = get_device_info();
            pcVar10 = *(code **)(iVar9 + 0x1030);
            uVar4 = get_device_info();
          ...
          if (param_2 - 0x3131 < 0x5e) {
            ...
            if (*(int *)((int)uVar12 + 0x1030) != 0) {
              ...
              if (iVar8 == 0) {
                uVar3 = (*(volatile uint16_t*)((char*)&local_24 + 2));
                uVar5 = (uint)(*(volatile uint16_t*)((char*)&local_24 + 2));
                if (uVar5 == ((uintptr_t)&tbl_ffc8) /*=0xffff*/) goto LAB_00045b4e;
                memset_bytes(DAT_00045bbc,0,0x138);
                iVar8 = get_device_info();
                pcVar10 = *(code **)(iVar8 + 0x1030);
                uVar4 = get_device_info();
...
LAB_00045c68:
            if (param_2 - ((uintptr_t)&rodata_e001) /*=0xe001*/ < 0xfd) {
              iVar8 = get_device_info((int)uVar2,(int)(uVar2 >> 0x20));
              if (*(int *)(iVar8 + 0x1030) != 0) {
                iVar8 = get_device_info();
                pcVar10 = *(code **)(iVar8 + 0x1030);
...
LAB_00045e48:
              if (param_2 - ((uintptr_t)&rodata_ff01) /*=0xff01*/ < 0x9f) goto LAB_00045e4e;
            }
          }
        }
        if (*DAT_00045f40 < 3) {
...
LAB_00045902:
    ...
    goto LAB_00045912;
  case 1:
    iVar8 = get_clock_digit_glyph_offset_small(param_2 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/,&local_28,&local_24);
    *param_5 = iVar8;
    if (iVar8 != 0) {
      *param_3 = local_28;
      *param_4 = local_24;
    ...
    break;
  case 2:
    iVar8 = get_clock_digit_glyph_offset_large(param_2 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/,&local_28,&local_24);
    *param_5 = iVar8;
    if (iVar8 != 0) {
      *param_3 = local_28;
      *param_4 = local_24;
    ...
    break;
  case 3:
    iVar8 = get_font_style3_glyph_offset(param_2 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/,&local_28,&local_24);
    *param_5 = iVar8;
    *param_3 = local_28;
    *param_4 = local_24;
    return 0;
