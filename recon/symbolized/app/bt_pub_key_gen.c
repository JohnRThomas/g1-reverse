    ...
    if (param_1 == 0) iVar4 = -0x16;
      ...
      for (piVar3 = (int*)*(int*)((unsigned long)&g_bt_pub_key_cb_slist) /*=0x2000ac74*/; piVar3 != 0; piVar3 = (int*)*piVar3) {
        if (piVar3 + -1 == (int*)param_1) {
          ...
          z_log_msg_runtime_create(((unsigned long)&rodata_88120) /*=0x88120*/, 0x1080, &local_20, 0);
          return -0x78;
        }
      }
      ...
      *piVar1 = param_1 + 4;
      ...
      if ((uVar5 & 0x20) == 0) {
        ...
        iVar4 = bt_hci_cmd_send_sync(0x2025, 0, 0);
        if (iVar4 != 0) {
          local_1c = ((unsigned long)&rodata_f39ca) /*=0xf39ca*/; local_20 = 2;
          z_log_msg_runtime_create(((unsigned long)&rodata_88120) /*=0x88120*/, 0x1040, &local_20, 0);
