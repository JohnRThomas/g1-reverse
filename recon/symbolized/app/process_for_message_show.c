  ...
  do {
    while( 1 ) {
      ...
      if (((param_1[1] == '\x01') || (iVar4 = get_device_info(), *(char *)(iVar4 + 1) == '\b')) ||
        ...
        if (2 < *(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/) {
          if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
            DEBUG_PRINT(((unsigned long)&rodata_a294a) /*=0xa294a*/,((unsigned long)&rodata_a39d6) /*=0xa39d6*/,(uint)*(byte *)(param_2 + 1));
      ...
      if (*(char *)(param_2 + 1) != '\x04') {
        if (2 < *(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/) {
          if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
            DEBUG_PRINT(((unsigned long)&rodata_a2977) /*=0xa2977*/,((unsigned long)&rodata_a39d6) /*=0xa39d6*/,(uint)*(byte *)(param_2 + 1));
...
LAB_0002c894:
    ...
    if ((*(char *)(param_2 + 1) == '\x06') ||
      ...
      if (2 < *(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/) {
        if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
          DEBUG_PRINT(((unsigned long)&rodata_a28ee) /*=0xa28ee*/,((unsigned long)&rodata_a39d6) /*=0xa39d6*/,(uint)*(byte *)(param_2 + 1));
  ...
  if (2 < *(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/) {
    if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
      DEBUG_PRINT(((unsigned long)&rodata_a291d) /*=0xa291d*/,((unsigned long)&rodata_a39d6) /*=0xa39d6*/,(uint)*(byte *)(param_2 + 1));
