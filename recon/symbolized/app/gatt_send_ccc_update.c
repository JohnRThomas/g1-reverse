...
int gatt_send_ccc_update(int param_1, int param_2, int param_3)
{
    ...
    if (puVar6 == (unsigned char *)((uintptr_t)&g_bt_gatt_sc_ccc) /*=0x20002a20*/) {
        iVar4 = 0;
        iVar2 = ((uintptr_t)&g_bt_gatt_sc_cfg_addr_ff19) /*=0x2000ff19*/;
        do {
...
LAB_0005b9a4:
        ...
        local_24 = "Link is not encrypted" /*=0xf4ad5*/;
        local_28 = 2;
