...
int get_default_font_glyph_offset(unsigned int param_1, int *param_2, unsigned int *param_3)
{
  ...
  unsigned short *puVar3 = (unsigned short*)((uintptr_t)&tbl_9873c) /*=0x9890c*/;
  unsigned int key;
  unsigned char val = 0;
  while (1) {
    if (*(volatile int*)((uintptr_t)&g_default_font_glyph_table_count) /*=0x8ac28*/ <= iVar2) {
      return 0;
    }
    ...
    uVar1 = (uVar1 + (unsigned int)val * 0x1a) & ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
    iVar2 = iVar2 + 1;
  }
  *param_2 = (unsigned int)val << 1;
  *param_3 = 0x1a;
  return ((uintptr_t)&rodata_e5f62) /*=0xe5f62*/ + uVar1;
}
