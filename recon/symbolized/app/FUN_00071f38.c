...
void FUN_00071f38(void)
{
  ...
  piVar2 = (int*)((unsigned long)&rodata_87fc8) /*=0x87fc8*/;
...
LAB:
    ...
    if (piVar2 <= piVar6) {
      FUN_00073b1c();
      uVar3 = ((unsigned long)&rodata_86661) /*=0x86661*/;
      for (piVar6 = (int*)((unsigned long)&rodata_87fc8) /*=0x87fc8*/; piVar6 <= piVar2; piVar6 = piVar6 + 0xb) {
        if (piVar2 <= piVar6) {
          FUN_00073bf4();
          return;
        }
