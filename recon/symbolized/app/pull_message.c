    ...
    if (param_1 == (int *)0) {
        if (0 < *(int *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
            if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                log_message(((unsigned long)&rodata_a804b) /*=0xa804b*/, ((unsigned long)&rodata_a822e) /*=0xa822e*/, ((unsigned long)&rodata_a8221) /*=0xa8221*/, 0x3bdU, param_4);
            } else {
        ...
        if (*(unsigned char *)(iVar3 + 0xdd) <= 0xa) {
            *param_1 = (unsigned int)(*(unsigned char *)((unsigned long)&g_message_pool_index) /*=0x2001a22a*/) * 0x1b4 + ((unsigned long)g_message_pool) /*=0x20007dac*/;
            if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                log_message(((unsigned long)&rodata_a80bc) /*=0xa80bc*/);
            } else {
        ...
        if (*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
            iVar3 = get_device_info();
            log_message(((unsigned long)&rodata_a806c) /*=0xa806c*/, (unsigned int)*(unsigned char *)(iVar3 + 0xdd));
        } else {
            iVar3 = get_device_info();
