...
uint32_t ble_privacy_request_random_address(uint8_t* param_1){
  ...
  if(param_1==0){
    ...
    FUN_0008104a(((unsigned long)&rodata_88150) /*=0x88150*/,0x1080,&frame.log);
    return 0;
  }
  ...
  int r=FUN_00086be4(iVar2,((unsigned long)&rodata_f2b47) /*=0xf2b47*/,6);
  if(r!=0){
    r=FUN_00086be4(iVar2,((unsigned long)&rodata_f2b41) /*=0xf2b41*/,6);
    if(r!=0){
