...
LAB_000440a2:
            if (1 < *(volatile int *)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
                if (*(volatile int *)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) DEBUG_PRINT("%s(): can not find 0x%x font resource\n" /*=0xaaa58*/, "gui_utf_draw" /*=0xaadac*/);
                else debug_print(0);
            }
        ...
        if (param_12 == 0) {
            ...
            if (iVar3 << 0x1e < 0) {
                clean_fb_data(*(volatile unsigned *)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/, 0, param_4, param_5, param_6, param_7);
            }
