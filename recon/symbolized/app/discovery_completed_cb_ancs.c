...
void discovery_completed_cb_ancs(void *param_1, void *param_2){
  ...
  DEBUG_PRINT(((unsigned long)&rodata_9a6f2) /*=0x9a6f2*/);
  ...
  if(iVar2==0){
    *(volatile uint32_t*)((unsigned long)&g_gatt_discovery_flags) /*=0x20006ab4*/ |= 2u;
    iVar2 = FUN_0004f040((int)param_2, ((unsigned long)&rodata_18ef5) /*=0x18ef5*/);
    if(iVar2!=0) DEBUG_PRINT(((unsigned long)&rodata_9a74c) /*=0x9a74c*/, iVar2);
    iVar2 = FUN_0004f0ec((int)param_2, ADDR_bt_ancs_data_source_handler_THUMB /*=0x18c49*/);
...
L:
  ...
  if(iVar2!=0) DEBUG_PRINT(((unsigned long)&rodata_9a7bc) /*=0x9a7bc*/, iVar2);
