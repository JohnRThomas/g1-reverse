...
int FUN_0004b2b0(int *param_1, unsigned int param_2, unsigned int param_3, int param_4){
  ...
  if (uVar5 != 0) {
    ...
    if (((uVar5 - 1) & uVar5) != 0) {
      printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/,"(align & (align - 1)) == 0" /*=0xf075e*/,"WEST_TOPDIR/zephyr/lib/os/heap.c" /*=0xf0692*/,0x144,param_4);
      printk("\talign must be a power of 2\n" /*=0xf0779*/,0,0,0,0);
      assert_post_action("WEST_TOPDIR/zephyr/lib/os/heap.c" /*=0xf0692*/,0x144);
      uVar8 = uVar5;
    } else {
      n = uVar5;
    }
