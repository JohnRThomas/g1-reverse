...
unsigned int FUN_00068240(unsigned int *param_1)
{
  ...
  puVar1 = (unsigned char*)memset_bytes((void*)((uintptr_t)&g_metal_generic_bus) /*=0x2000b424*/, 0, 0x20);
  ...
  *(unsigned char**)(puVar1+0x1c) = puVar1+0x18;
  return FUN_00068170((void*)((uintptr_t)&g_module_registry_node) /*=0x20002c3c*/);
}
