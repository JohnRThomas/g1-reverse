...
unsigned char *bt_keys_find_addr(uint32_t param_1, int param_2){
  ...
  int iVar2;
  if(param_2==0){
    printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "addr != ((void *)0)" /*=0xf52ac*/, "WEST_TOPDIR/zephyr/subsys/bluetooth/host/keys.c" /*=0xf5268*/, 0x11a);
    assert_post_action("WEST_TOPDIR/zephyr/subsys/bluetooth/host/keys.c" /*=0xf5268*/, 0x11a);
    iVar2 = 1;
  ...
  if((uint32_t)*(volatile uint8_t*)pbVar1 != param_1 ||
    ...
    if((uint32_t)*(volatile uint8_t*)(pbVar1+0x5c) != param_1 ||
       memcmp(((uintptr_t)&g_bt_keys_pool_entry1_addr) /*=0x2000afa9*/, param_2, 7) != 0){
