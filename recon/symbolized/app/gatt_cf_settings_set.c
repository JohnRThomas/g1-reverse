...
int gatt_cf_settings_set(int param_1,int param_2,int param_3,int param_4){
  ...
  int stkargs[8];
  if (param_1 == 0) {
    FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1040, stkargs);
    return -0x16;
  }
  iVar1 = bt_settings_decode_key(param_1, st40);
  if (iVar1 != 0) {
    FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1c40, stkargs);
    return -0x16;
  }
  settings_name_next(param_1, &local_44);
  if (local_44 != 0 && (iVar1 = strtol_ascii_scan(local_44, 0, 10)) != 0) {
    FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1840, stkargs);
    return -0x16;
  }
  ...
  if (param_2 != 0) {
    ...
    if (iVar1 == 2) {
      ...
      FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1880, stkargs);
    } else {
      FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1080, stkargs);
    }
