...
extern void FUN_0006bd74(enum lc3_dt, enum lc3_srate, const float *, int, int, float *);
extern void FUN_0006bfc8(enum lc3_dt, enum lc3_srate, const float *, bool, const float *, float *);
#undef LC3_HOT
...
#define lc3_sns_mpvq_offsets ((const int32_t (*)[11])((unsigned long)&rodata_90128) /*=0x90128*/)
#define lc3_sns_hfcb ((const float (*)[8])((unsigned long)&rodata_90450) /*=0x90450*/)
#define lc3_sns_lfcb ((const float (*)[8])((unsigned long)&rodata_90850) /*=0x90850*/)
#define lc3_band_lim ((const int (*)[LC3_NUM_SRATE][LC3_NUM_BANDS+1])((unsigned long)&rodata_90c50) /*=0x90c50*/)
    ...
    *(volatile int *)gain_idx = 0;
    ...
    for (int ic = 0; ic < 4; ic++) {
        const struct lc3_sns_vq_gains *cgains =
            (const struct lc3_sns_vq_gains *)((unsigned long)&rodata_903e8) /*=0x903e8*/ + ic;
 ...
 * SNS analysis
 */
void FUN_0006c778(enum lc3_dt dt, enum lc3_srate sr,
