...
/* readable reconstruction; identity: FUN_0005ce6c @ 0x0005ce6c
 * public-name: smp_public_key_periph
...
uint8_t smp_public_key_periph(void *context)
{
    ...
    if (!atomic_test_bit_raw(smp + 4, 14) &&
        ...
        const struct log_record_two_raw rejected = { 2, ((unsigned long)&rodata_f4e96) /*=0xf4e96*/ };
        log_process_record(((unsigned long)&rodata_88180) /*=0x88180*/, 0x1080, &rejected);
        return 8;
    }
    ...
    default: {
        const struct log_record_three_raw unknown = {
            3, ((unsigned long)&rodata_f4e7a) /*=0xf4e7a*/, smp[8]
        };
        log_process_record(((unsigned long)&rodata_88180) /*=0x88180*/, 0x1840, &unknown);
        return 8;
    }
    }
