...
void set_pending_state_flag(unsigned int param_1,int param_2)
{
  if (param_1 < 3) {
    if (param_2 != 0) {
      *(volatile unsigned char *)(((uintptr_t)&g_ancs_inbox_flag_current) /*=0x20018da6*/ + param_1) = 1;
      return;
    }
    *(volatile unsigned char *)(((uintptr_t)&g_ancs_inbox_flag_current) /*=0x20018da6*/ + param_1) = 0;
  }
}
