...
void bt_conn_encrypt_change_handle_le(int param_1){
    ...
    unsigned loc[4];
    if (iVar2 == 0){
        loc[1] = "Unable to look up conn with handle %u" /*=0xf2e3c*/; loc[0]=3; loc[2]=uVar5;
        FUN_00080ea2(((uintptr_t)&tbl_880d8) /*=0x88138*/, 0x1840, loc);
        return;
    }
    if (cVar1 == 0 && *(volatile unsigned char*)(iVar2 + 2) == 1){
        ...
        if (iVar4 == 0){
            ...
            loc[1] = "Failed to set required security level" /*=0xf30dd*/; loc[0]=2;
            FUN_00080ea2(((uintptr_t)&tbl_880d8) /*=0x88138*/, 0x1040, loc);
