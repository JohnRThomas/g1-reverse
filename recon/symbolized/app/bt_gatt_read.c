...
int bt_gatt_read(int param_1, int *param_2){
  ...
  if (param_1==0){
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f3ebd) /*=0xf3ebd*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0x13de,0,(int)param_2);
    printk(((unsigned long)&rodata_f4a0a) /*=0xf4a0a*/); uVar3=0x13de; assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/,uVar3);
    param_2=(int*)0x13de; goto recheck;
  }
 recheck:
  if (param_2==0 || *param_2==0){
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f4c07) /*=0xf4c07*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0x13df,param_1,(int)param_2);
    printk(((unsigned long)&rodata_f4a0a) /*=0xf4a0a*/); uVar3=0x13df; assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/,uVar3);
    param_2=(int*)0x13df; goto recheck;
  }
  if ((short)param_2[1]==0){
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f4cce) /*=0xf4cce*/,((unsigned long)&rodata_f46b8) /*=0xf46b8*/,0x13e0,param_1,(int)param_2);
    printk(((unsigned long)&rodata_f4a0a) /*=0xf4a0a*/); uVar3=0x13e0; assert_post_action(((unsigned long)&rodata_f46b8) /*=0xf46b8*/,uVar3);
