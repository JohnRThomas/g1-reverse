...
int FUN_000569ec(int param_1,int param_2,unsigned param_3,unsigned param_4){
  ...
  iVar1 = k_is_in_isr();
  if(iVar1!=0){
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f3d75) /*=0xf3d75*/,((unsigned long)&rodata_f3a5d) /*=0xf3a5d*/,0x55f);
    assert_post_action(((unsigned long)&rodata_f3a5d) /*=0xf3a5d*/,0x55f);
  }
  if(param_1==0) param_1=((unsigned long)&acl_tx_pool) /*=0x20003a7c*/;
  iVar1=FUN_000836de(param_1,((unsigned long)&acl_tx_pool) /*=0x20003a7c*/,param_3,param_4);
  if(iVar1==0){
    local_1c=((unsigned long)&rodata_f3d84) /*=0xf3d84*/; local_20=2;
    FUN_000813ca(((unsigned long)&log_module_bt_conn) /*=0x88108*/,0x1080,&local_20);
  } else {
