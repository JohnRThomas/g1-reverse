 ...
 * public-name: g1_recon_nrfx_nvmc_page_erase
...
unsigned int g1_recon_nrfx_nvmc_page_erase(unsigned int *param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
  if ((unsigned int)param_1 >= 0x100000u) {
    printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f6c8e) /*=0xf6c8e*/, ((unsigned long)&rodata_f6c32) /*=0xf6c32*/, 0x107, param_4);
