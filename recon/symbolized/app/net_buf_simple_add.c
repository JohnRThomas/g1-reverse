...
int net_buf_simple_add(int *param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
    ...
    if (uVar2 < param_2) {
        printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "net_buf_simple_tailroom(buf) >= len" /*=0xf54a8*/, "WEST_TOPDIR/zephyr/subsys/net/buf_simple.c" /*=0xf543a*/, 0x3e);
        assert_post_action("WEST_TOPDIR/zephyr/subsys/net/buf_simple.c" /*=0xf543a*/, 0x3e);
    }
