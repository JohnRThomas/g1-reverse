...
void bt_gatt_disconnected(uint8_t *connection)
{
    ...
    bt_gatt_foreach_attr_0(1U, 0xffffU, (void *)ADDR_gatt_remove_peer_from_attr_THUMB /*=0x5a3c5*/, connection);
    ...
    if (bonded) {
        ...
        bt_gatt_foreach_attr_0(1U, 0xffffU, (void *)((unsigned long)&rodata_5a2d5) /*=0x5a2d5*/,
                     &address_with_id);
    }
