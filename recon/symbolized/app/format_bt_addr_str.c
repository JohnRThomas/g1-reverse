...
void format_bt_addr_str(unsigned char *param_1, void *param_2)
{
    ...
    switch (param_1[0]) {
    case 0: uVar1 = ((unsigned long)&rodata_9a1c8) /*=0x9a1c8*/; break;
    case 1: uVar1 = ((unsigned long)&rodata_9a1cf) /*=0x9a1cf*/; break;
    case 2: uVar1 = ((unsigned long)&rodata_9a1d6) /*=0x9a1d6*/; break;
    case 3: uVar1 = ((unsigned long)&rodata_9a1e0) /*=0x9a1e0*/; break;
    default:
        snprintk(auStack_1c, 10, ((unsigned long)&rodata_f5071) /*=0xf5071*/);
        goto LAB;
    }
    strcpy(auStack_1c, uVar1);
LAB:
    snprintk(param_2, 0x1e, ((unsigned long)&rodata_9a1ea) /*=0x9a1ea*/,
