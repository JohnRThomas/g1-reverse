...
void smakebuf_r(int param_1,int *param_2,int param_3){
  if(-1 < (int)((unsigned)*(uint16_t*)((int)param_2+0xc) << 0x1e)){
    ...
    if(iVar2!=0){
      *(volatile int*)(param_1+0x28)=((uintptr_t)&tbl_76b3c) /*=0x76b91*/;
      ...
      *(volatile int*)((int)param_2+0x14)=iVar3;
      if(local_1c!=0){
        ...
        if(t!=0){ *(volatile uint16_t*)((int)param_2+0xc)=(*(volatile uint16_t*)((int)param_2+0xc)&((uintptr_t)&tbl_ffc8) /*=0xfffc*/)|1; }
      }
    ...
    *(volatile uint16_t*)((int)param_2+0xc)=(*(volatile uint16_t*)((int)param_2+0xc)&((uintptr_t)&tbl_ffc8) /*=0xfffc*/)|2;
  }
