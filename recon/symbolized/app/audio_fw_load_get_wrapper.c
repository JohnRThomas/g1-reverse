...
uint32_t audio_fw_load_get_wrapper(int param_1,uint8_t* param_2,uint32_t param_3){
  if(*(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/==5){
    ...
    DEBUG_PRINT(((unsigned long)&rodata_9b2ba) /*=0x9b2ba*/,*(volatile uint32_t*)(param_1+0x14),pbVar3[0],pbVar3[1],pbVar3[2],pbVar3[3],pbVar3[0],pbVar3[1],pbVar3[2],pbVar3[3]);
  }
  uint32_t uVar2=master_process_audio_fw_load_req(param_1-0x77c,*(volatile uint32_t*)(param_1+0x10),param_2,param_3);
  if(*(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/==5){
    DEBUG_PRINT(((unsigned long)&rodata_9b2f5) /*=0x9b2f5*/,param_3,param_2[0],param_2[1],param_2[2],param_2[3],param_2[0],param_2[1],param_2[2],param_2[3]);
  }
  return uVar2;
}
