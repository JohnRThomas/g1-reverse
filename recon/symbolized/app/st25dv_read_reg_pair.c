...
{
    int iVar2 = ipc_send_len_prefixed_packet_locked_retry(*(volatile unsigned int*)((uintptr_t)&g_st25dv_dev) /*=0x20007a44*/, 0, param_1, 4, param_4);
    if (*(volatile char*)(param_1+2) == 0) {
        if (iVar2 != 0) return -1;
        iVar2 = ipc_send_len_prefixed_packet_locked_retry(*(volatile unsigned int*)((uintptr_t)&g_st25dv_dev) /*=0x20007a44*/, 4, param_1 + 4, 4, param_4);
    }
    if (iVar2 != 0) iVar2 = 1;
    return -iVar2;
}
