...
/* named: vfprintf_format_engine */
/* Reconstructed vfprintf_format_engine @ 0x77594  (parity: 289/300 trials, PROVEN) */
#include <stdint.h>
...
u32 vfprintf_format_engine(u32 param_1, u32 *param_2, u32 param_3, u32 param_4, int *param_5){
    ...
    if (bVar13 < 99) {
        ...
        iVar2 = "0123456789ABCDEF" /*=0xf8b88*/;
        ...
        case 0x69:
            ...
            *param_5 = (int)(uintptr_t)(puVar5 + 1);
            ...
            if (-1 < (int)uVar8) { uVar9=10; iVar2="0123456789ABCDEF" /*=0xf8b88*/; goto L776f6; }
            param_2[2] = param_2[1];
            *(byte*)((char*)param_2+0x43) = 0x2d;
            if (-1 < (int)param_2[1]) *param_2 = uVar9 & 0xfffffffb;
            uVar8 = -uVar8; uVar9 = 10; iVar2 = "0123456789ABCDEF" /*=0xf8b88*/;
            goto L77674;
        default:
        ...
        case 0x70:
            *param_2 = *param_2 | 0x20;
            /* fallthrough */
        case 0x78:
            bVar13 = 0x78; iVar2 = "0123456789abcdef" /*=0xf8b99*/; break;
        case 0x73:
            puVar10 = (u32*)(uintptr_t)*param_5;
            *param_5 = (int)(uintptr_t)(puVar10 + 1);
