...
unsigned int jbd_panel_resume(int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
  ...
  if (*piVar1 > 2) {
    ...
    if (sink == 0) {
      DEBUG_PRINT((void*)((unsigned long)&rodata_d73bc) /*=0xd73bc*/, (void*)((unsigned long)&rodata_d73f8) /*=0xd73f8*/, param_3, sink, param_4);
    } else {
  ...
  if (*piVar1 > 2) {
    unsigned int sink = *(volatile unsigned int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
    if (sink == 0) {
      DEBUG_PRINT((void*)((unsigned long)&rodata_d73e0) /*=0xd73e0*/, (void*)((unsigned long)&rodata_d73f8) /*=0xd73f8*/, param_3, sink, param_4);
    } else {
