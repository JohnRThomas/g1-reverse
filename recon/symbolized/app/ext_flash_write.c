...
*/
/* Reconstructed ext_flash_write @ 0x2e440  (parity: 300/300 trials, PROVEN) */
...
int ext_flash_write(int param_1, unsigned param_2, unsigned param_3, unsigned param_4){
    ...
    volatile int *g = (volatile int*)((uintptr_t)&g_ext_flash_dev) /*=0x20007b68*/;
    if (*g == 0){
        int t = (int)((unsigned)*(volatile unsigned short*)(r5 + 0x5c) << 0x1b);
        if (t >= 0) FUN_0007c082();
        return 0;
    }
    k_mutex_lock(((uintptr_t)&g_ext_flash_mutex) /*=0x20007b54*/, iVar2, 0xffffffffu, 0xffffffffu);
    int r0v = *g;
    ...
    k_mutex_unlock(((uintptr_t)&g_ext_flash_mutex) /*=0x20007b54*/);
    int t2 = (int)((unsigned)*(volatile unsigned short*)(r5 + 0x5c) << 0x1b);
    if (t2 >= 0) FUN_0007c082();
    if (res == 0) return 0;
    if (*(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/ < 1) return res;
    if (*(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ != 0){ debug_print(); return res; }
    DEBUG_PRINT(0, 0);
    return res;
}
