...
unsigned FUN_00055350(int param_1, unsigned param_2){
    ...
    int iVar1;
    local_1c = "Read Static Addresses command not available" /*=0xf376a*/;
    if( ((int)((u32)(*(volatile u8*)(((uintptr_t)&g_ble_dev_state) /*=0x20002000*/+0xc2)) << 0x1f) < 0)
        && (iVar1 = FUN_00053d70(((uintptr_t)&rodata_fc09) /*=0xfc09*/, 0, local_34), local_1c = "Failed to read static addresses" /*=0xf3796*/, iVar1 == 0) ){
        ...
        net_buf_unref();
        if(uVar5 == 0){
            local_1c = "No static addresses stored in controller" /*=0xf37b6*/;
            local_20[0] = 2;
