...
unsigned FUN_00055350(int param_1, unsigned param_2){
    ...
    if( ((int)((u32)(*(volatile u8*)(((unsigned long)&g_ble_dev_state) /*=0x20002000*/+0xc2)) << 0x1f) < 0)
        && (iVar1 = FUN_00053d70(((unsigned long)&rodata_fc09) /*=0xfc09*/, 0, local_34), local_1c = ((unsigned long)&rodata_f3796) /*=0xf3796*/, iVar1 == 0) ){
        ...
        if(uVar5 == 0){
            ...
            local_20[0] = 2;
            FUN_0008104a(((unsigned long)&rodata_88150) /*=0x88150*/, 0x1080, local_20);
        }
        return uVar5;
    } else {
        local_20[0] = 2;
