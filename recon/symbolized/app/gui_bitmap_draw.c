...
unsigned gui_bitmap_draw(uint param_1,int param_2,int param_3,int param_4,int param_5,byte param_6)
{
    ...
    if((param_3 < (int)param_1) || (param_4 < param_2) || (0xf < uVar9)){
        if(*(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/ < 2) return 0xffffffff;
        iVar7 = *(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/;
        uVar10 = "%s(): input param error,please check postion content\n" /*=0xaa96d*/;
    } else {
        if((param_1 & 1) == 0){
            iVar7 = param_3;
            uVar14 = (ulonglong)atomic_get_3_0(0);
            piVar3 = (int*)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/;
            if((uVar14 & 2) != 0){
                clean_fb_data(*(volatile int*)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/, 0, param_1 - 2, (int)(uVar14 >> 0x20), iVar7 + 2, param_4);
            }
        ...
        if(*(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/ < 2) return 0xffffffff;
        iVar7 = *(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/;
        uVar10 = "%s(): Scenarios where the starting point of x is an even number are not currently supported.\n" /*=0xaa9a3*/;
    }
    if(iVar7 == 0){ DEBUG_PRINT(uVar10, "gui_bitmap_draw" /*=0xaacde*/); }
    else { debug_print(0); }
    return 0xffffffff;
}
