...
unsigned nvs_write(int param_1, unsigned param_2, int param_3, unsigned param_4)
{
    ...
    if (*(char *)(param_1 + 0x10) == 0) {
        uVar5 = 0xfffffff3;
        local_2c = "NVS not initialized" /*=0xf0ae4*/;
        local_30 = 2;
        nvs_log_err(((uintptr_t)&tbl_880d8) /*=0x881b8*/, 0x1040, (int)&local_30);
    } else {
        ...
        if (((unsigned)*(unsigned short *)(param_1 + 0xc) + iVar2 * -4 < param_4) ||
            ...
            if (param_4 != 0) {
LAB_0004c9ba:
                if (uVar3 != 0) uVar3 = (uVar3 + iVar2) & ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
                ...
                for (uVar6 = 0; uVar6 != *(unsigned short *)(param_1 + 0xe); uVar6 = uVar6 + 1) {
                    ...
                    local_40 = ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
                    local_3a = 0xff;
                    local_3c = 0;
