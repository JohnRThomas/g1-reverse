...
int img_mgmt_ver_str(unsigned char *param_1, int param_2)
{
    ...
    int iVar1 = FUN_00077914(param_2, 0x19, ((unsigned long)&rodata_f27cf) /*=0xf27cf*/, p0, uVar3, uVar2);
    int iVar4 = *(volatile int*)(param_1 + 4);
    if (iVar4 != 0) {
        iVar4 = FUN_00077914(param_2 + iVar1, 0x19 - iVar1, ((unsigned long)&rodata_f27db) /*=0xf27db*/, iVar4, uVar3, uVar2);
    }
    return iVar1 + iVar4;
}
