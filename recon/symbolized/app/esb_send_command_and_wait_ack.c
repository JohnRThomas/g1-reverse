...
uint32_t esb_send_command_and_wait_ack(char *param_1, uint32_t param_2, uint32_t *param_3, uint32_t param_4)
{
  ...
  pcVar1 = (volatile uint8_t *)((uintptr_t)&g_esb_seg_tx_lock_flag) /*=0x20018d8c*/;
  uVar9 = 0;
  if (iVar2 != 1) {
    while (*pcVar1 != 0) {
      uVar9 = uVar9 + 1;
    ...
    *pcVar1 = 1;
    uVar9 = uVar9 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
    ...
    *(uint8_t *)(param_1 + 0x6d0) = *(uint8_t *)(param_1 + 0xfc0);
    if (param_2 - 0xbU < 2) {
      puVar6 = (uint32_t *)(((uintptr_t)&g_esb_seg_tx_frame_opcode) /*=0x20018c6f*/ + 1);
      *(volatile uint8_t *)((uintptr_t)&g_esb_seg_tx_frame_opcode) /*=0x20018c6f*/ = 4;
      puVar5 = puVar10;
      do {
        puVar4 = puVar5 + 1;
        puVar8 = puVar6 + 1;
      ...
      *(volatile uint16_t *)puVar8 = *(uint16_t *)puVar4;
      FUN_00086c1e((void *)((uintptr_t)&g_esb_seg_tx_frame_payload) /*=0x20018c71*/, param_3, param_4, 0xfa);
      uVar3 = 0xdc;
      *(uint8_t *)(param_1 + 0x105a) = 1;
      ...
      puVar5 = (uint32_t *)((uintptr_t)&g_esb_seg_ack_echo_buf) /*=0x20018d6b*/;
      if (param_2 == 1) {
        *(volatile uint8_t *)(((uintptr_t)&g_esb_seg_ack_echo_buf) /*=0x20018d6b*/ + 0x15) = *(uint8_t *)(param_1 + 0x6e1);
        iVar2 = memcmp((void *)((uintptr_t)&g_esb_seg_ack_echo_buf) /*=0x20018d6b*/, puVar10, 0x16);
    ...
    (*pcVar7)((void *)((uintptr_t)&g_esb_seg_tx_frame_opcode) /*=0x20018c6f*/, uVar3);
    while (*(uint8_t *)(param_1 + 0x105a) != 2) {
      uVar9 = (uVar9 + 1) & ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
      if (uVar9 == 2000) {
        if (param_2 == 1) {
          memset_bytes((void *)((uintptr_t)&g_esb_seg_ack_echo_buf) /*=0x20018d6b*/, 0, 0x16);
        }
        goto LAB_000275de;
      }
      k_msleep_ticks32768_a(1);
