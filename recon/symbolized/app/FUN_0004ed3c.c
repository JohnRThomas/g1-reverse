...
uint32_t FUN_0004ed3c(uint32_t collection, const void *key)
{
    ...
    for (;;) {
        ...
        if (candidate == 0) {
            printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/, ((unsigned long)&rodata_f154a) /*=0xf154a*/, ((unsigned long)&rodata_f11bc) /*=0xf11bc*/, 0x21cu);
            assert_post_action(((unsigned long)&rodata_f11bc) /*=0xf11bc*/, 0x21cu);
        }
