...
#define DAT_0000cadc  ((volatile float *)((unsigned long)&g_spline_nan_sentinel) /*=0x20002d1c*/)
#define DAT_0000d578  ((volatile float *)((unsigned long)&g_spline_nan_sentinel) /*=0x20002d1c*/)
