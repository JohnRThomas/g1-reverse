...
unsigned int deleteQuickNoteData(unsigned int param_1, unsigned int param_2, unsigned int param_3)
{
    ...
    unsigned int uVar2;
    (void)param_2;
    buf[0] = ((uintptr_t)&tbl_ffc8) /*=0x10002*/;
    buf[1] = (unsigned int)(unsigned char)param_1;
    buf[2] = param_3;
    iVar1 = k_msgq_put(((uintptr_t)&g_quicknote_flash_msgq) /*=0x20003960*/, buf, 0UL, 0UL);
    if (iVar1 == 0) {
        if (2 < *(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
            if (*(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0)
                DEBUG_PRINT("%s(): SEND QUICKNOTE TEXT delete(%d) Command...\n" /*=0x9ee23*/, "deleteQuickNoteData" /*=0x9f080*/, param_1);
            else
                debug_print();
        }
