...
unsigned int settings_save_one(unsigned int param_1, unsigned int param_2, unsigned int param_3)
{
  ...
  uStack_10 = param_2;
  local_c = param_3;
  k_mutex_lock(((uintptr_t)&g_settings_lock) /*=0x20003868*/, param_2, -1, -1, param_1);
  for (piVar1 = *(int * volatile *)((uintptr_t)&g_settings_stores) /*=0x2000a104*/; piVar1 != 0; piVar1 = *(int **)piVar1) {
    fp = *(fnptr *)(piVar1[1]);
    fp(piVar1, &local_14);
  }
