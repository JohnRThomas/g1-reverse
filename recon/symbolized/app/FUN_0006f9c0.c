...
joined:
  ...
  local_4c = ((unsigned long)&rodata_8ed50) /*=0x8ed50*/ +
             (uint)(param_5 != iVar24 &&
...
LAB_fd54:
            do {
              while (1) {
                ...
                uVar16 = (int)uVar16 >> 1;
                if (uVar7 < ((unsigned long)&rodata_10000) /*=0x10000*/) break;
...
LAB_fd7e:
            ...
            if (uVar20 < ((unsigned long)&rodata_10000) /*=0x10000*/) FUN_0006897c(param_1);
            uVar16 = (int)uVar16 >> 1;
