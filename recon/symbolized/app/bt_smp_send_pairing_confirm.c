...
u32 bt_smp_send_pairing_confirm(int param_1){
    ...
    if(uVar3 < 3){
        ...
        if(uVar3 != 3){
            u32 local[3];
            local[0]=3; local[1]="Unknown pairing method (%u)" /*=0xf4e7a*/; local[2]=uVar3;
    ...
    if(iVar1 != 0){
        ...
        int iVar2 = bt_crypto_f4(*(volatile u32*)((uintptr_t)&g_smp_local_public_key) /*=0x2000af48*/, param_1+0x57, param_1+0x27, uVar3);
        if(iVar2 == 0){
