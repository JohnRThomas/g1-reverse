...
uint32_t audioStreamFileManagerHandler(void)
{
  ...
  pcVar2 = (volatile uint8_t *)((uintptr_t)&g_audio_stream_mgr_busy_flag) /*=0x20019dab*/;
  if (*pcVar2 == 0) {
    if (*(volatile int32_t *)(((uintptr_t)&g_audio_msgq) /*=0x20003890*/ + 0x24) == 0) {
      return 0;
    }
    ...
    if (2 < *(volatile int32_t *)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
