  ...
  if (iVar2 == 0x0bad0000){
    ...
    if (iVar2 < 0){
      ...
      *(volatile uint16_t*)((volatile char*)&local_1c+2) = 0x807;
      if (api->setup != 0){
        iVar2 = api->setup((void *)((unsigned long)&rodata_87bd8) /*=0x87bd8*/, 8, ADDR_FUN_0004c418_THUMB /*=0x4c419*/, local_1c);
        if (iVar2 < 0) goto LAB;
        if (api->enable != 0){
...
LAB:
  {
    ...
    FUN_0004d944(((unsigned long)&rodata_88288) /*=0x88288*/, 0x1840, (void *)&diagnostic, 0);
  }
  return iVar2;
}
