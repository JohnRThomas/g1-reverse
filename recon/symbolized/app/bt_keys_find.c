...
unsigned char* bt_keys_find(unsigned short param_1,unsigned int param_2,int param_3,unsigned int param_4){
  ...
  if(((*(volatile unsigned short*)(((unsigned long)&bt_keys_pool) /*=0x2000af4c*/+0xe)&param_1)==0) ||
     ...
     (iVar2=FUN_00086be4(((unsigned long)&bt_keys_pool) /*=0x2000af4c*/+1,param_3,7,*(volatile unsigned char*)((unsigned long)&bt_keys_pool) /*=0x2000af4c*/,param_4),iVar2!=0)){
    if((*(volatile unsigned short*)(pbVar1+0x6a)&param_1)==0) return 0;
    if((pbVar1[0x5c]!=param_2) || (iVar2=FUN_00086be4(((unsigned long)&g_bt_keys_pool_entry1_addr) /*=0x2000afa9*/,param_3,7,pbVar1[0x5c],param_4),iVar2!=0)) return 0;
    iVar2=0x5c;
  }
  return pbVar1+iVar2;
}
