                  ...
                  int param_5, float *param_6)
{
    ...
    float fVar8 = *(volatile float *)
        (*(volatile int *)(((unsigned long)&rodata_903e8) /*=0x903e8*/ + param_4 * 8 + 4) + param_5 * 4);
    volatile float *pfVar6 = (volatile float *)(((unsigned long)&rodata_90850) /*=0x90850*/ + param_1 * 0x20);
    volatile float *pfVar4 = (volatile float *)((unsigned long)&rodata_8ce4c) /*=0x8ce4c*/ + 0x100;
    volatile float *pfVar3 = (volatile float *)(((unsigned long)&rodata_90450) /*=0x90450*/ + param_2 * 0x20);
    volatile float *pfVar5 = (volatile float *)((unsigned long)&rodata_8ce4c) /*=0x8ce4c*/;
