...
/* named: dtoa */
/* Reconstructed dtoa @ 0x78110  (parity: 300/300 trials, PROVEN) */
#include <stdint.h>
...
byte *dtoa(int param_1, int *param_2, int *param_3, int *param_4, int *param_5, uint param_6)
{
  ...
  iVar13 = *(volatile int*)((uintptr_t)&tbl_9873c) /*=0x98768*/;
  iVar6 = strlen(iVar13);
...
LAB_00078258:
  ...
  if (iVar7 == 0) {
    uVar11 = 0xde;
    libc_fatal_error_and_abort("/__w/_temp/workspace/build/.build/HOST-x86_64-w64-mingw32/arm-zephyr-eabi/src/newlib-nano/newlib/libc/stdlib/gdtoa-gethex.c" /*=0xf8c53*/, uVar11, 0);
    iVar7 = extraout_r1;
    iVar7 = iVar7 + 1;
    goto LAB_00078258;
  }
  ...
  *(volatile int*)(iVar7 + 0x10) = iVar17;
  ...
  if ((int)(long)pbVar19 < iVar8) {
    ...
    if (iVar8 < (int)(long)pbVar19) {
      ...
      iVar7 = lshift(param_1, iVar7, (int)(long)pbVar19 - iVar8);
      puVar20 = (uint*)(iVar7 + 0x14);
    }
    uVar22 = 0;
  }
    ...
    if ((int)(long)pbVar19 <= (int)(long)pbVar16) {
      ...
      if (iVar6 == 2) {
        ...
        if (iVar6 != 3) {
          ...
          param_6 = bignum_any_bit_set_from(iVar7, (int)(long)(pbVar19 - 1));
        }
        if (param_6 == 0) {
LAB_000783e8:
          Bfree(param_1, iVar7);
...
LAB_000783b6:
    ...
    pbVar21 = pbVar16 - 1;
    if (uVar22 == 0) {
      if (pbVar21 != 0) uVar22 = bignum_any_bit_set_from(iVar7, (int)(long)pbVar21);
    } else {
      uVar22 = 1;
    }
    ...
    bignum_shift_right_bits(iVar7, (int)(long)pbVar16);
  ...
  if (iVar17 != 2) {
    uVar23 = param_6;
    if (iVar17 == 3) goto joined_r_7846c /*=0x7846c*/;
    if ((iVar17 == 1) && ((uVar22 & 2) != 0)) {
      uVar23 = (uVar22 | *puVar20) & 1;
      goto joined_r_7846c /*=0x7846c*/;
    }
LAB_0007846e:
...
joined_r_7846c: /*=0x7846c*/
  ...
  if (*(volatile int*)(iVar7 + 8) <= iVar17) {
    ...
    if (iVar8 == 0) {
      uVar11 = 0x84;
      libc_fatal_error_and_abort("Balloc succeeded" /*=0xf8c42*/, uVar11, 0);
      goto LAB_00078258;
    }
