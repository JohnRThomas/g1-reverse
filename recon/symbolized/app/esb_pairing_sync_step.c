...
void esb_pairing_sync_step(void){
    ...
    if(*(volatile char*)pcVar4==1){
        ...
        if(d==1){
            *(volatile uint8_t*)((uintptr_t)&g_esb_notify_sync_substate) /*=0x20018d98*/=(uint8_t)d;
        ...
        *(volatile uint8_t*)((uintptr_t)&g_esb_notify_sync_substate) /*=0x20018d98*/=r5;
        return;
    } else {
        uint8_t r5b=*(volatile uint8_t*)((uintptr_t)&g_esb_notify_slave_role_guard) /*=0x20018d9f*/;
        if(r5b!=0) return;
        int8_t r6b=*(volatile int8_t*)(r4+0xd);
        if(r6b==0){
            *(volatile uint8_t*)((uintptr_t)&g_esb_notify_sync_substate) /*=0x20018d98*/=1;
            int u=get_device_info();
            esb_send_command_and_wait_ack(u,0xb,r4,0xda);
            *(volatile uint8_t*)((uintptr_t)&g_esb_notify_sync_retry_cnt) /*=0x20018d82*/=(uint8_t)r6b;
            return;
        }
        if(r6b!=2) return;
        uint8_t r3c=(uint8_t)(*(volatile uint8_t*)((uintptr_t)&g_esb_notify_sync_retry_cnt) /*=0x20018d82*/+1);
        *(volatile uint8_t*)((uintptr_t)&g_esb_notify_sync_retry_cnt) /*=0x20018d82*/=r3c;
        if(r3c<=9){
            int u=get_device_info();
        ...
        *(volatile uint8_t*)((uintptr_t)&g_esb_notify_sync_retry_cnt) /*=0x20018d82*/=r5b;
        set_message_pool_entry_status(c,r5b);
        *(volatile uint8_t*)((uintptr_t)&g_esb_notify_sync_substate) /*=0x20018d98*/=r5b;
        return;
    }
}
