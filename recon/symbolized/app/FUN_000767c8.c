...
double FUN_000767c8(double dd, unsigned param_1, unsigned param_2, unsigned param_3)
{
  ...
  if ((int)uVar6 < 0x14) {
    if ((int)uVar6 < 0) {
      ...
      puVar3 = (volatile unsigned*)(((uintptr_t)&tbl_887b7) /*=0x888a8*/ + iVar1*-8);
    ...
    uVar2 = ((uintptr_t)&rodata_fffff) /*=0xfffff*/ >> (uVar6 & 0xff);
    if ((uVar2 & uVar5)==0 && uVar4==0) return in.d;
    uVar4 = uVar4 | (uVar5 & (uVar2 >> 1));
    if (uVar4 != 0) {
      uVar5 = (((uintptr_t)&tbl_40000) /*=0x40000*/ >> (uVar6&0xff)) | (uVar5 & ~(uVar2>>1));
