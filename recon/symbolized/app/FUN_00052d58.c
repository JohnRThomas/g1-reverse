...
unsigned int FUN_00052d58(int param_1, int param_2, codeptr param_3, int param_4)
{
  ...
  if ((int)((unsigned)*g << 0x1f) < 0) {
    if (param_1 == 0) {
      ...
      FUN_0004d944(((unsigned long)&rodata_88178) /*=0x88178*/,0x1040,&short_log,0);
      return 0xfffffffe;
    }
    ...
    if (iVar3 == 0) {
      ...
      if ((int)uVar5 < 0) {
        ...
        FUN_0004d944(((unsigned long)&rodata_88178) /*=0x88178*/,0x1080,&short_log,0);
      } else {
        ...
        if (uVar4 < 7) {
          ...
          FUN_0004d944(((unsigned long)&rodata_88178) /*=0x88178*/,0x1040,&short_log,uVar6);
      ...
      if (iStack_48 < 0) {
        ...
        FUN_0004d944(((unsigned long)&rodata_88178) /*=0x88178*/,0x1840,&full_log,0);
      } else {
