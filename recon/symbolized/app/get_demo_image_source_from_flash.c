...
void get_demo_image_source_from_flash(void){
  ...
  puVar2 = malloc(0x50);
  if (puVar2 == 0) { DEBUG_PRINT(((unsigned long)&rodata_a8d69) /*=0xa8d69*/,((unsigned long)&rodata_a8e27) /*=0xa8e27*/,0x54); return; }
  ...
  if (iVar3 != 0) { DEBUG_PRINT(((unsigned long)&rodata_a8d7f) /*=0xa8d7f*/,((unsigned long)&rodata_a8e27) /*=0xa8e27*/,0x5a); goto END; }
  ...
  if (iVar3 != 0) { DEBUG_PRINT(((unsigned long)&rodata_a8da8) /*=0xa8da8*/); goto END; }
  ...
  if (local_42 == 1) {
    ...
    for (iVar3 = 0; iVar3 < iVar6; iVar3 = iVar3 + 1) {
      ...
      if (iVar7 != 0) { DEBUG_PRINT(((unsigned long)&rodata_a8d7f) /*=0xa8d7f*/,((unsigned long)&rodata_a8e27) /*=0xa8e27*/,0x7e); goto END; }
