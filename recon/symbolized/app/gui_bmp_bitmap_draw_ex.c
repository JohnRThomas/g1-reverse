...
unsigned int gui_bmp_bitmap_draw_ex(unsigned int param_1, int param_2, int param_3, int param_4, unsigned char param_5)
{
    ...
    if (param_5 == 0) {
        ...
        uVar5 = "%s(): dark light value parampter error,exit!\n" /*=0xaa923*/;
    } else {
        ...
        if (iVar3 >= 0) {
            ...
            if ((m & 2) != 0) {
                clean_fb_data(*(volatile uint32_t*)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/, 0, param_2, param_3, local_24 + 2 + param_2, local_20 + param_3);
            }
            fb_blit_rows_copy(*(volatile uint32_t*)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/, param_4, local_24 / 2, local_20, param_2, param_3);
        ...
        if (*(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/ < 2) return 0xffffffff;
        iVar3 = *(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/;
        uVar5 = "%s(): can't find resource,please check resource name !\n" /*=0xaa8eb*/;
    }
    if (iVar3 == 0) {
        DEBUG_PRINT(uVar5, "gui_bmp_bitmap_draw_ex" /*=0xaadb9*/);
    } else {
        debug_print();
    }
    return 0xffffffff;
