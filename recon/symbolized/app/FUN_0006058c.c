 ...
 *   g1_nrfx_clock_init_checked               <= FUN_00065190 @ 0x00065190
...
extern int g1_nrfx_clock_init_checked(unsigned);
...
int FUN_0006058c(int param_1,unsigned param_2,unsigned param_3,unsigned param_4){
  ...
  iVar2=g1_nrfx_clock_init_checked(((unsigned long)&rodata_60635) /*=0x60635*/);
  if(iVar2==0x0bad0000){
