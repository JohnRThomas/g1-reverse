...
/* named: net_buf_simple_pull_5f594 */
/* Reconstructed net_buf_simple_pull_5f594 @ 0x5f594  (parity: 300/300 trials, PROVEN) */
...
void net_buf_simple_pull_5f594(int *param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
    ...
    if (ushort_val < param_2) {
        printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "buf->len >= len" /*=0xf5474*/, "WEST_TOPDIR/zephyr/subsys/net/buf_simple.c" /*=0xf543a*/, 0x199U, param_4);
        unsigned long long rv = assert_post_action("WEST_TOPDIR/zephyr/subsys/net/buf_simple.c" /*=0xf543a*/, 0x199U);
