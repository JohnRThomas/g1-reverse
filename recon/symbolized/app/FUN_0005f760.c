...
undefined4 FUN_0005f760(undefined4 param_1, int *param_2)
{
  ...
  mutex_lock_syscall_handler(((unsigned long)&g_adc_context_lock) /*=0x200021d0*/, param_2, 0xffffffffu, 0xffffffffu);
...
LAB_f874:
      *(volatile u32*)(long)(iVar11 + 0x5f4) = uVar4;
      ...
      if ((u32)param_2[3] < uVar10) {
        ...
        FUN_0004d944(((unsigned long)&rodata_880e0) /*=0x880e0*/, 0x2040u, capacity_error, 0);
        uVar9 = 0xfffffff4u;
        goto LAB_f7d6;
      }
...
LAB_f948:
      ...
      iVar5 = mutex_lock_syscall_handler(((unsigned long)&g_adc_saadc_ctrl_mutex) /*=0x200021e8*/, (void*)(long)uVar9, 0xffffffffu, 0xffffffffu);
      if (iVar5 != 0) {
        puVar3i[0x1c] = iVar5;
      }
...
LAB_f7c6:
    ...
    FUN_0004d944(((unsigned long)&rodata_880e0) /*=0x880e0*/, 0x1840u, validation_error, 0);
  } else {
LAB_f782:
    range_error[0] = 2;
    range_error[1] = uVar9;
    FUN_0004d944(((unsigned long)&rodata_880e0) /*=0x880e0*/, 0x1040u, range_error, 0);
  }
  uVar9 = 0xffffffeau;
LAB_f7d6:
  FUN_00072880(((unsigned long)&g_adc_context_lock) /*=0x200021d0*/);
  return uVar9;
}
