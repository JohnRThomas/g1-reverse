...
undefined4 FUN_0005f760(undefined4 param_1, int *param_2)
{
  ...
  mutex_lock_syscall_handler(((uintptr_t)&g_adc_context_lock) /*=0x200021d0*/, param_2, 0xffffffffu, 0xffffffffu);
  iVar7 = ((uintptr_t)&m_adc_channel_input_cfg) /*=0x20002230*/;
  iVar5 = REG_5000e000 /*=0x5000e000*/;
  uVar10 = (u32)param_2[1];
  uVar9 = "Invalid selection of channels" /*=0xf5571*/;
  ...
  if (uVar10 - 1 < 0xff) {
    ...
    do {
      if (((uVar10 >> (uVar4 & 0xff)) & 1) == 0) {
        *(volatile u32*)(long)(iVar5 + (uVar4 + 0x51) * 0x10) = 0;
        ...
        if (bVar1 == 0) {
          uVar9 = "Channel %u not configured" /*=0xf558f*/;
          goto LAB_f7c6;
        }
    ...
    switch ((u32)*(u8*)(param_2 + 4)) {
      ...
      default:
        uVar9 = "ADC resolution value %d is not valid" /*=0xf55a9*/;
    ...
    *(volatile u32*)(REG_5000e000 /*=0x5000e000*/ + 0x5f0) = (u32)uVar9;
    ...
    if (1 < uVar6) {
      uVar9 = "Oversampling is supported for single channel only" /*=0xf55ce*/;
      if (uVar4 != 0) goto LAB_f782;
LAB_f874:
      *(volatile u32*)(long)(iVar11 + 0x5f4) = uVar4;
      puVar3i = (int*)((uintptr_t)&adc_context) /*=0x20002190*/;
      iVar5 = REG_5000e000 /*=0x5000e000*/;
      uVar10 = uVar6 * 2;
      if (*param_2 != 0) {
      ...
      if ((u32)param_2[3] < uVar10) {
        FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x880e0*/, 0x2040u, 0, 0);
        uVar9 = 0xfffffff4u;
        goto LAB_f7d6;
      }
      ...
      *(volatile u32*)(long)(iVar5 + 0x630) = uVar6;
      ...
      if (param_2 == 0) {
LAB_f948:
        r = adc_context_start_sampling(((uintptr_t)&adc_context) /*=0x20002190*/);
        uVar9 = (u32)(r >> 32);
      } else {
        int iVar8;
        iVar5 = *param_2;
        ...
        *puVar3i = 0;
        {
          long long lVar2 = (long long)(u32)puVar3i[0x22] * 0x8000LL + (long long)" size" /*=0xf423f*/;
          r = __aeabi_uldivmod((int)lVar2, (int)(lVar2>>32), "size" /*=0xf4240*/, 0);
          r = z_impl_k_timer_start((void*)(puVar3i + 2), (int)(r>>32), 0, 0);
          uVar9 = (u32)(r>>32);
        }
      }
      iVar5 = mutex_lock_syscall_handler(((uintptr_t)&g_adc_saadc_ctrl_mutex) /*=0x200021e8*/, (void*)(long)uVar9, 0xffffffffu, 0xffffffffu);
      if (iVar5 != 0) {
        puVar3i[0x1c] = iVar5;
      }
    ...
    uVar9 = "Oversampling value %d is not valid" /*=0xf5600*/;
    if (uVar4 < 9) goto LAB_f874;
LAB_f7c6:
    FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x880e0*/, 0x1840u, 0, 0);
  } else {
LAB_f782:
    FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x880e0*/, 0x1040u, 0, 0);
  }
  uVar9 = 0xffffffeau;
LAB_f7d6:
  FUN_00072880(((uintptr_t)&g_adc_context_lock) /*=0x200021d0*/);
  return uVar9;
}
