  ...
  if ((*(volatile char*)(iVar10 + 0x118) != 0) &&
    ...
    if ((*pcVar6 == 1) && (cVar1 == 0) && (iVar7 = message_table_contains_id(10,iVar13), iVar7 != 0)) {
      if (0 < *(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/) {
        if (*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) DEBUG_PRINT(((unsigned long)&rodata_a8174) /*=0xa8174*/,((unsigned long)&rodata_a8255) /*=0xa8255*/,iVar13);
        else debug_print(0);
      }
