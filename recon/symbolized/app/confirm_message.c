...
void confirm_message(int param_1)
{
  ...
  iVar10 = ((uintptr_t)&g_pending_ack_message) /*=0x20008dac*/;
  if ((*(volatile char*)(iVar10 + 0x118) != 0) &&
    ...
    if ((*pcVar6 == 1) && (cVar1 == 0) && (iVar7 = message_table_contains_id(10,iVar13), iVar7 != 0)) {
      if (0 < *(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
        if (*(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) DEBUG_PRINT("%s(): add found same message, uidtail %d\n" /*=0xa8174*/,"confirm_message" /*=0xa8255*/,iVar13);
        else debug_print(0);
      }
      memset_bytes((g_message_table_mirror) /*=0x20008eb4*/,0,0x1b4);
      return;
    }
    puVar4 = (volatile byte*)((uintptr_t)&g_msg_queue_busy) /*=0x20018d8e*/;
    *puVar4 = 1;
    iVar13 = get_device_info(0);
    if (*(char*)(iVar13 + 0xd5) != 4) clear_timeout_message(0);
    uVar8 = msg_content_used_count(0);
    iVar13 = (g_message_pool) /*=0x20007dac*/;
    iVar7 = *(volatile int*)(iVar10 + 0x2b8);
    if (iVar7 == 0) {
      if (uVar8 == 10) {
        iVar7 = 0; iVar14 = (g_message_pool) /*=0x20007dac*/;
        do {
      ...
      *(char*)(iVar10 + 0xe) = 1;
      ...
      if (uVar8 != 0) {
        bVar2 = 0; bVar15 = 0; iVar7 = (g_message_pool) /*=0x20007dac*/;
        do {
      ...
      uVar12 = 0; iVar7 = (g_message_pool) /*=0x20007dac*/;
      do {
        if (*(int*)(iVar7 + 8) == *(int*)(iVar10 + 0x110)) {
          memcpy(uVar12 * 0x1b4 + (g_message_pool) /*=0x20007dac*/, iVar10 + 0x108); break;
        }
        uVar12 = uVar12 + 1; iVar7 = iVar7 + 0x1b4;
      } while ((uVar12 & 0xff) < uVar8);
    }
    memset_bytes((g_message_table_mirror) /*=0x20008eb4*/, 0, 0x1b4);
    pbVar3 = (byte*)((uintptr_t)&g_message_table_slot_count) /*=0x2001a22b*/;
    uVar8 = 10;
    while (1) {
      bVar15 = *pbVar3;
    ...
    if (cVar1 == 0) {
      ...
      if (*(char*)(iVar13 + 0xd5) == 4) {
        ...
        if (((*(char*)(iVar10 + 0xd5) == 0) ||
          ...
          *(volatile byte*)((uintptr_t)&g_message_pending_state) /*=0x2001a229*/ = 1;
        }
      }
    }
    if (*(volatile char*)((uintptr_t)&g_esb_notify_slave_role_guard) /*=0x20018d9f*/ == 0) { msg_queue_debug_dump(0); debug_dump_message_slots_10_19(0); }
    *puVar4 = 0;
  }
  return;
}
