            ...
            undefined4 param_5,undefined4 param_6,char param_7)
{
  ...
  vdprintf_to_fd((int)local_38,0,0x10,"%d%d%s%d%d" /*=0xaaaac*/,uVar6,sVar7,((uintptr_t)&rodata_f02a3) /*=0xf02a3*/,(local_3c & ((uintptr_t)&tbl_ffc8) /*=0xffff*/) / 10,
               (local_3c & ((uintptr_t)&tbl_ffc8) /*=0xffff*/) % 10);
  ...
  case 1:
    ...
    if (iVar4 << 0x1e < 0) {
      clean_fb_data(*(volatile int*)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/,0,param_2,param_3,param_4,param_5);
    }
    piVar2 = (int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/; piVar1 = (int*)((uintptr_t)&g_log_level) /*=0x2000230c*/;
    ...
    for (iVar10 = 0; iVar3 != iVar10; iVar10 = iVar10 + 1) {
      ...
      if ((iVar5 == 0) && (local_50 != 0)) {
        fb_blit_rows_copy(*(volatile int*)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/,local_50,local_4c / 2,local_48,iVar4,param_3);
        iVar4 = iVar4 + local_4c + 6;
      } else if (1 < *(volatile int*)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
        if (*(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
          DEBUG_PRINT("%s(): The content cannot be found in the current font library,unicode content = %2d,font libray is %s\n" /*=0xaaad4*/,"gui_clock_draw" /*=0xaad0b*/,(uint)*pbVar9,"EVEN_DASHBOARD_CLOCK_32x_TTF" /*=0xaaab7*/);
        } else { debug_print("%s(): The content cannot be found in the current font library,unicode content = %2d,font libray is %s\n" /*=0xaaad4*/,"gui_clock_draw" /*=0xaad0b*/,(uint)*pbVar9,"EVEN_DASHBOARD_CLOCK_32x_TTF" /*=0xaaab7*/); }
      }
      pbVar9 = pbVar9 + 1;
    }
    goto LAB_000443e4;
