...
void gpiote_pin_event_dispatch(unsigned int param_1)
{
    ...
    if ((int)(uVar3 << 0x17) < 0) {
        ...
        (*(void (**)(unsigned int, unsigned int, unsigned int))(((unsigned long)g_gpiote_cb) /*=0x20002bc0*/ + uVar3 * 8))
            (param_1, uVar2, *(volatile unsigned int *)(((unsigned long)g_gpiote_cb) /*=0x20002bc0*/ + uVar3 * 8 + 4));
    }
