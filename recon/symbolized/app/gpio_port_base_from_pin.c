 ...
 * public-name: gpio_port_base_from_pin
...
uintptr_t gpio_port_base_from_pin(uint32_t *descriptor,uint32_t a,uint32_t b,uint32_t context){
 ...
 if((uint32_t)slot==0){printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"nrf_gpio_pin_present_check(*p_pin)") /*=0xf0a04*/,((unsigned long)&rodata_f09d1) /*=0xf09d1*/,0x32f);assert_post_action(((unsigned long)&rodata_f09d1) /*=0xf09d1*/,0x32f);}
 *(uint32_t*)(uintptr_t)(slot>>32)=encoded&0x1f;
 if((encoded>>5)==0)return 0x50842500u;
 if((encoded>>5)==1)return 0x50842800u;
 printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f7a30) /*=0xf7a30*/,((unsigned long)&rodata_f09d1) /*=0xf09d1*/,0x338);assert_post_action(((unsigned long)&rodata_f09d1) /*=0xf09d1*/,0x338);
}
