...
void FUN_00054444(const void *event)
{
    ...
    if (!connection) {
        struct log3 r = {3, ((unsigned long)&rodata_f2db7) /*=0xf2db7*/, handle};
        FUN_00080ea2(((unsigned long)&rodata_88138) /*=0x88138*/, 0x1840u, &r);
        return;
    }
    ...
    if (!command) {
        ...
        FUN_00080ea2(((unsigned long)&rodata_88138) /*=0x88138*/, 0x1040u, r);
    } else {
