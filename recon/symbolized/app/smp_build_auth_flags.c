 ...
 * public-name: smp_build_auth_flags
...
unsigned int smp_build_auth_flags(int param_1, unsigned int param_2)
{
    int iVar1;
    unsigned int *puVar2;
    unsigned char newval;

    if (*(volatile unsigned char *)((unsigned long)&g_bt_settings_load_done) /*=0x2001d532*/ == 0) {
        param_2 = param_2 & 7;
    } else {
        param_2 = param_2 & 0xf;
    }
    ...
    newval = *(volatile unsigned char *)((unsigned long)&g_smp_bondable_default) /*=0x200035ae*/;
