...
unsigned int FUN_00061c40(int param_1, unsigned int param_2, int param_3)
{
  ...
  if (param_3 != 0) {
    local_14 = "Sending data not supported" /*=0xf60c5*/;
    local_18 = 2;
    FUN_0004d944((void*)((uintptr_t)&tbl_880d8) /*=0x881f8*/, 0x1080, &local_18, 0);
  }
  if (param_2 < 0x10 && ((int)((*(unsigned int*)(*(int*)(param_1+4)+4) >> (param_2 & 0xff)) << 0x1f) < 0)) {
    uVar1 = 0;
    *(volatile unsigned int*)(NRF_GPIOTE1_S /*=0x5002a000*/ + ((param_2 & 0x3f)*4)) = 1;
  } else {
    uVar1 = 0xffffffea;
  }
  return uVar1;
