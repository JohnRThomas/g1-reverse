...
int FUN_00055d08(int param_1)
{
  ...
  piVar1 = (volatile int*)((uintptr_t)&g_bt_pub_key_cb_slist) /*=0x2000ac74*/;
  if ((*(unsigned char*)(((uintptr_t)&g_ble_dev_state) /*=0x20002000*/ + 0xa2) & 6) == 6) {
    if (param_1 == 0) iVar4 = -0x16;
    else {
      for (piVar3 = (int*)*(int*)((uintptr_t)&g_bt_pub_key_cb_slist) /*=0x2000ac74*/; piVar3 != 0; piVar3 = (int*)*piVar3) {
        if (piVar3 + -1 == (int*)param_1) {
          local_1c = "Callback already registered" /*=0xf39ae*/; local_20 = 2;
          FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88120*/, 0x1080, &local_20, 0);
          return -0x78;
        }
      }
      *(volatile int*)(param_1 + 4) = *(int*)((uintptr_t)&g_bt_pub_key_cb_slist) /*=0x2000ac74*/;
      *piVar1 = param_1 + 4;
      if (piVar1[1] == 0) piVar1[1] = param_1 + 4;
      puVar2 = (volatile unsigned*)((uintptr_t)&g_ble_dev_ncmd_sem) /*=0x200020d4*/;
      uVar5 = *puVar2;
      *puVar2 = uVar5 | 0x20;
      if ((uVar5 & 0x20) == 0) {
        *puVar2 = *puVar2 & 0xffffffef;
        ...
        if (iVar4 != 0) {
          local_1c = "Sending LE P256 Public Key command failed" /*=0xf39ca*/; local_20 = 2;
          FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88120*/, 0x1040, &local_20, 0);
    ...
    local_1c = "ECC HCI commands not available" /*=0xf398f*/; local_20 = 2; iVar4 = -0x86;
    FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88120*/, 0x1080, &local_20, 0);
  }
  return iVar4;
}
