...
int bt_hci_cmd_create(short param_1,int param_2){
  int iVar2=FUN_000836de(((uintptr_t)&g_hci_cmd_pool) /*=0x20003b4c*/,param_2,-1,-1);
  if(iVar2==0){ printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/,"buf" /*=0xf45be*/,"WEST_TOPDIR/zephyr/subsys/bluetooth/host/hci_core.c" /*=0xf2e84*/,0x10a); assert_post_action("WEST_TOPDIR/zephyr/subsys/bluetooth/host/hci_core.c" /*=0xf2e84*/,0x10a); }
  net_buf_simple_reserve(iVar2+0xc,1);
  *(volatile char*)(iVar2+0x18)=0;
  int iVar3=net_buf_id(iVar2);
  *(volatile short*)(iVar3*0xc + ((uintptr_t)&bt_hci_cmd_data) /*=0x2000abf4*/ + 2)=param_1;
  iVar3=net_buf_id(iVar2);
  *(volatile int*)(iVar3*0xc + ((uintptr_t)&bt_hci_cmd_data) /*=0x2000abf4*/ + 8)=0;
  iVar3=net_buf_id(iVar2);
  *(volatile int*)(iVar3*0xc + ((uintptr_t)&bt_hci_cmd_data) /*=0x2000abf4*/ + 4)=0;
