...
void FUN_00079780(uint32_t *param_1, uint32_t *param_2){
  volatile uint32_t *puVar1 = (volatile uint32_t*)((uintptr_t)&g_misc_deferred_call_desc) /*=0x20002f0c*/;
  ...
  int iVar3=((uintptr_t)&g_ctr_drbg_ctx) /*=0x2000cc30*/;
  volatile uint32_t *puVar2=(volatile uint32_t*)((uintptr_t)&g_misc_deferred_req_params) /*=0x20002ef8*/;
  puVar2[0]=param_2[0];
