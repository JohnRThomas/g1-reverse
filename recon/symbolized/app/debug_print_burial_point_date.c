...
void debug_print_burial_point_date(int param_1){
  ...
  uint32_t uVar3 = local_24 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
  uint32_t uVar1 = local_24 >> 0x10;
  uint32_t uVar4 = local_20 & ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
  DEBUG_PRINT("date: %u: %04d/%02d/%02d-%02d:%02d:%02d\n" /*=0x9bbbf*/, param_1, uVar3, uVar1, uVar4, local_20>>0x10, local_1c & ((uintptr_t)&tbl_ffc8) /*=0xffff*/, local_1c>>0x10);
