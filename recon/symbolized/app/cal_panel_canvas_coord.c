...
void cal_panel_canvas_coord(int *param_1, int *param_2)
{
  ...
  if (param_1 != 0) {
    ...
    *(volatile int*)param_1 = iVar1;
    ...
    if ((*param_1 != iVar3) && (1 < *(int*)((unsigned long)&g_log_level) /*=0x2000230c*/)) {
      if (*(int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
        iVar1 = get_device_info();
        DEBUG_PRINT(((unsigned long)&rodata_aa7a2) /*=0xaa7a2*/, ((unsigned long)&rodata_aa855) /*=0xaa855*/, (unsigned)*(unsigned char*)(iVar1+0xec1), *param_1);
      } else {
        iVar1 = get_device_info();
        debug_print(((unsigned long)&rodata_aa7a2) /*=0xaa7a2*/, ((unsigned long)&rodata_aa855) /*=0xaa855*/, (unsigned)*(unsigned char*)(iVar1+0xec1), *param_1);
      }
  ...
  if (param_2 != 0) {
    ...
    *(volatile int*)param_2 = iVar1;
    if ((iVar1 - iVar3 != 0) && (1 < *(int*)((unsigned long)&g_log_level) /*=0x2000230c*/)) {
      if (*(int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
        iVar1 = get_device_info();
        DEBUG_PRINT(((unsigned long)&rodata_aa7cb) /*=0xaa7cb*/, ((unsigned long)&rodata_aa855) /*=0xaa855*/, (unsigned)*(unsigned char*)(iVar1+0xec0), *param_2);
        return;
      }
      iVar1 = get_device_info();
      debug_print(((unsigned long)&rodata_aa7cb) /*=0xaa7cb*/, ((unsigned long)&rodata_aa855) /*=0xaa855*/, (unsigned)*(unsigned char*)(iVar1+0xec0), *param_2);
