...
int opt3007_get_max_lux(unsigned int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
    ...
    if (*(volatile unsigned char *)((uintptr_t)&g_opt3007_chip_ready) /*=0x20018da1*/ == 0) {
        iVar2 = -1;
    } else {
        ...
        if (1 < (unsigned int)(iVar2 + 1)) {
            ...
            if (2 < *(volatile int *)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
                if (*(volatile int *)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
                    ...
                    DEBUG_PRINT("%s(): opt3007_get_max_lux %d %f luminance_curve_a0 %d\n" /*=0xa3c82*/, "opt3007_get_max_lux" /*=0xa3d12*/, (unsigned int)iVar2, *(volatile unsigned int *)(iVar3 + 0xfb0),
                                (unsigned int)uVar5, (unsigned int)(uVar5 >> 32), *(volatile unsigned int *)(iVar3 + 0xfb0));
                } else {
                    iVar3 = get_device_info();
                    debug_print("%s(): opt3007_get_max_lux %d %f luminance_curve_a0 %d\n" /*=0xa3c82*/, "opt3007_get_max_lux" /*=0xa3d12*/, (unsigned int)iVar2, *(volatile unsigned int *)(iVar3 + 0xfb0), uVar5,
