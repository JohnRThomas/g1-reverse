...
int ble_notify_disconnected(int param_1,int param_2){
  ...
  while(1){
    if(uVar1<uVar5){ printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f3a8d) /*=0xf3a8d*/,((unsigned long)&rodata_f3a5d) /*=0xf3a5d*/,0x676); printk(((unsigned long)&rodata_f0d20) /*=0xf0d20*/); assert_post_action(((unsigned long)&rodata_f3a5d) /*=0xf3a5d*/,0x676); }
