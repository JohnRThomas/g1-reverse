...
LAB_0002a0e8:
  do {
    ...
    if (*(volatile int32_t *)((uintptr_t)&g_touch_key_irq_pending) /*=0x20006a00*/ != 0) {
      handle_touch_key_irq();
      *(volatile int32_t *)((uintptr_t)&g_touch_key_irq_pending) /*=0x20006a00*/ = 0;
    }
  } while (-1 < (int32_t)((uint32_t)*(uint16_t *)(param_1 + 0x105c) << 0x1f));
  if (*(volatile uint8_t *)((uintptr_t)&g_touch_key_irq_line_status) /*=0x20019dac*/ == 1) {
    iVar3 = get_uptime_ms();
    ...
    iVar8 = iVar7 + 1;
    *(volatile uint8_t *)((uintptr_t)&g_touch_key_irq_line_status) /*=0x20019dac*/ = 0;
  }
  else {
    iVar8 = iVar7;
    iVar3 = iVar11;
    if (*(volatile uint8_t *)((uintptr_t)&g_touch_key_irq_line_status) /*=0x20019dac*/ == 2) {
      iVar9 = get_uptime_ms();
      *(volatile uint8_t *)((uintptr_t)&g_touch_key_irq_line_status) /*=0x20019dac*/ = 0;
      *(volatile uint8_t *)((uintptr_t)&g_touch_key_press_active) /*=0x20018d89*/ = 0;
    }
  }
  iVar4 = get_uptime_ms();
  iVar5 = get_uptime_ms();
  piVar2 = (volatile int32_t *)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/;
  piVar1 = (volatile int32_t *)((uintptr_t)&g_log_level) /*=0x2000230c*/;
  iVar5 = iVar5 - iVar9;
  iVar13 = iVar9 - iVar3;
  iVar7 = iVar8;
  iVar11 = iVar3;
...
LAB_0002a222:
      ...
      if (iVar7 * 30000 < iVar4) {
        if (0 < *piVar1) {
          if (*piVar2 == 0) {
            DEBUG_PRINT("%s(): #############################Long press timeout %d################################\n\n" /*=0xa1626*/, "touch_key_thread" /*=0xa1a76*/, iVar12);
          }
          else {
            debug_print(0,0,0);
          }
        ...
        iVar10 = 0;
        *(volatile int32_t *)((uintptr_t)&g_touch_key_reset_reason) /*=0x20007b18*/ = 6;
...
LAB_0002a24e:
  ...
  if (iVar9 == 0) {
    ...
    if (15000 < iVar4) {
      if (0 < *piVar1) {
        if (*piVar2 == 0) {
          DEBUG_PRINT("%s(): ########################turn on the mic and start to speak! holdtime %d\n\n" /*=0xa15d6*/, "touch_key_thread" /*=0xa1a76*/, iVar4);
        }
        else {
          debug_print(0,0,0);
        }
      }
      *(volatile int32_t *)((uintptr_t)&g_touch_key_reset_reason) /*=0x20007b18*/ = 4;
      trigger_touch_key_hw_reset();
      goto LAB_0002a222;
    }
    if (-1 < iVar3) {
...
LAB_0002a174:
    if (0 < *piVar1) {
      if (*piVar2 == 0) {
        DEBUG_PRINT("%s(): #############################single click %d################################\n\n" /*=0xa172a*/, "touch_key_thread" /*=0xa1a76*/, *(uint32_t *)(param_1 + 0x1078));
      }
      else {
        debug_print(0,0,0);
      }
...
LAB_0002a2c0:
  ...
  if (15000 < iVar13) {
LAB_0002a260:
    if (iVar13 <= (int32_t)((uintptr_t)&rodata_11940) /*=0x11940*/) {
      if (0 < *piVar1) {
        if (*piVar2 == 0) {
          DEBUG_PRINT("%s(): #############################Long press timeout %d################################\n\n" /*=0xa1626*/, "touch_key_thread" /*=0xa1a76*/);
        }
        else {
          debug_print(0,0,0);
        }
    ...
    if (0 < *piVar1) {
      if (*piVar2 == 0) {
        DEBUG_PRINT("%s(): #############################Long press end################################\n\n" /*=0xa1681*/, "touch_key_thread" /*=0xa1a76*/);
      }
      else {
        debug_print(0,0,0);
      }
  ...
  case 2:
    if (0 < *piVar1) {
      if (*piVar2 == 0) {
        DEBUG_PRINT("%s(): #############################double click################################\n\n" /*=0xa177f*/, "touch_key_thread" /*=0xa1a76*/);
      }
      else {
        debug_print(0,0,0);
      }
  ...
  case 3:
    if (0 < *piVar1) {
      if (*piVar2 == 0) {
        DEBUG_PRINT("%s(): #############################triple click################################\n\n" /*=0xa17d1*/, "touch_key_thread" /*=0xa1a76*/);
      }
      else {
        debug_print(0,0,0);
      }
    ...
    uVar6 = 3;
LAB_0002a282:
    *(volatile int32_t *)((uintptr_t)&g_touch_key_reset_reason) /*=0x20007b18*/ = uVar6;
    trigger_touch_key_hw_reset();
    break;
  case 5:
    goto LAB_0002a410 /*=0x2a410*/;
  case 10:
  ...
  iVar7 = iVar10;
  goto LAB_0002a0e8;
LAB_0002a410 /*=0x2a410*/:
  if (0 < *(volatile int32_t *)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
    format_string = "%s(): %d click, reboot now\n\n" /*=0xa184b*/;
    if (*(volatile int32_t *)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) goto LAB_0002a476 /*=0x2a476*/;
    debug_print("%s(): %d click, reboot now\n\n" /*=0xa184b*/, "touch_key_thread" /*=0xa1a76*/, 5);
  }
  do {
    FUN_00017a28();
    if (0 < *(volatile int32_t *)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
      if (*(volatile int32_t *)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
        DEBUG_PRINT("%s(): reset_pmic_on\n\n" /*=0xa1868*/, "touch_key_thread" /*=0xa1a76*/);
      }
      else {
        debug_print(0,0,0);
      }
    ...
    if (0 < *(volatile int32_t *)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
      if (*(volatile int32_t *)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) {
        DEBUG_PRINT("%s(): reset_pmic_off\n\n" /*=0xa187e*/, "touch_key_thread" /*=0xa1a76*/);
      }
      else {
        debug_print(0,0,0);
      }
