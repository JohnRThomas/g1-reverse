...
static u16 tbl1(u32 i) { return *(volatile u16*)(((uintptr_t)&tbl_88340) /*=0x88434*/ + 2u*i); }
static u16 tbl2(u32 i) { return *(volatile u16*)(((uintptr_t)&tbl_88340) /*=0x8843e*/ + 2u*i); }
          ...
          if (iVar3 < 0) {
            ...
            if (uVar18 < param_9) {
              ...
              for (iVar5 = 0; iVar3 - iVar5 != 0 && iVar5 <= iVar3; iVar5 = iVar5 + 1) {
                *pbVar9 = *pbVar9 & *(volatile u8*)((uintptr_t)&g_gui_dark_light_dither_mask) /*=0x200034f6*/;
                pbVar9 = pbVar9 + 1;
              }
            }
            bVar20 = 0;
            if (((uVar8 >> 1) < uVar15) && (uVar14 < param_8 - 1)) {
              idx1 = 0;
LAB_000453d8:
              if (tbl1(idx1) != uVar16) goto LAB_000453e0 /*=0x453e0*/;
              if (uVar16 == 0) goto LAB_00045314;
              uVar7 = uVar18 + 1;
              uVar16 = uVar7;
              goto LAB_00045412;
LAB_000453e0: /*=0x453e0*/
              idx1 = idx1 + 1;
...
LAB_00045422:
                ...
                if (0x28 < (i32)(uVar16 - uVar18)) {
                  if (*(volatile i32*)((uintptr_t)&g_log_level) /*=0x2000230c*/ < 2) goto LAB_00045314;
                  iVar3 = *(volatile i32*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/;
                  uVar13 = "%s(): The word is too long and will not be processed\n" /*=0xaabe8*/;
                  goto LAB_00045458;
                }
                iVar3 = 0;
                ...
                if (uVar18 == uVar16) {
                  if (1 < *(volatile i32*)((uintptr_t)&g_log_level) /*=0x2000230c*/) {
                    iVar3 = *(volatile i32*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/;
                    uVar13 = "%s(): !!! end_split_character_index == start_split_character_index\n" /*=0xaac1e*/;
LAB_00045458:
                    if (iVar3 == 0) {
                      DEBUG_PRINT(uVar13, "gui_utf_Wordwrap_draw" /*=0xaad35*/);
                    } else {
                      debug_print();
                    }
                  }
...
LAB_00045314:
            ...
            if (uVar8 < uVar15) {
              ...
              fb_blit_rows_copy(*(volatile u32*)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/, local_2cc, local_2fc / 2, local_2f8, param_4, uVar12 + param_5);
              iVar3 = count_chars_in_default_font_table(*puVar17, puVar17[1]);
              uVar15 = (u32)iVar3 + (u32)local_2fc;
              uVar19 = uVar15;
            } else {
              fb_blit_rows_copy(*(volatile u32*)((uintptr_t)&g_gui_active_canvas) /*=0x2000a034*/, local_2cc, local_2fc / 2, local_2f8, param_4 + (i32)uVar19, uVar12 + param_5);
              iVar3 = count_chars_in_default_font_table(*puVar17, puVar17[1]);
