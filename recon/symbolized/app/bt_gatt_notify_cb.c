...
int bt_gatt_notify_cb(int param_1, int *param_2)
{
  ...
  if (param_2 == 0) {
    printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "params" /*=0xf4b3d*/, "WEST_TOPDIR/zephyr/subsys/bluetooth/host/gatt.c" /*=0xf46b8*/, 0xae3);
...
LAB:
          ...
          local_28[0] = 0;
          local_14 = param_2;
          bt_gatt_foreach_attr_type(local_20, ((uintptr_t)&tbl_ffc8) /*=0xffff*/, local_28, 0, 1, ((uintptr_t)&tbl_5b870) /*=0x5b891*/, &local_24);
          return local_1c;
        }
      }
      return 0xfffffffe;
    }
    printk("ASSERTION FAIL [%s] @ %s:%d\n" /*=0x99cbd*/, "params->attr || params->uuid" /*=0xf4b44*/, "WEST_TOPDIR/zephyr/subsys/bluetooth/host/gatt.c" /*=0xf46b8*/, 0xae4);
    printk("\tinvalid parameters\n\n" /*=0xf4a0a*/);
    uVar2 = 0xae4;
  }
