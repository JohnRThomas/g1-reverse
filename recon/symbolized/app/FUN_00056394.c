  ...
  if (param_3 == 1) {
    if (*(int*)(param_1+0x10) != 0) {
      ...
      if (uVar1 != 0) {
        ...
        local_20 = 2;
        FUN_000813ca(((unsigned long)&log_module_bt_conn) /*=0x88108*/, 0x1040, &local_20);
...
LAB_563ce:
      ...
      if (local_34 < uStack_38) {
        ...
        local_40 = 4;
        FUN_000813ca(((unsigned long)&log_module_bt_conn) /*=0x88108*/, 0x2040, &local_40);
        bt_conn_reset_rx_state(param_1);
        return;
      }
      *(unsigned int*)(param_1+0x10) = 0;
    ...
    local_40 = 3;
    uStack_38 = param_3;
    FUN_000813ca(((unsigned long)&log_module_bt_conn) /*=0x88108*/, 0x1840, &local_40);
  }
  bt_conn_reset_rx_state(param_1);
LAB_56432:
  net_buf_unref(param_2);
