  ...
  if (param_3 == 1) {
    if (*(int*)(param_1+0x10) != 0) {
      ...
      if (uVar1 != 0) {
        ...
        local_1c = "Not enough buffer space for L2CAP data" /*=0xf3b4d*/;
        local_20 = 2;
        FUN_000813ca(((uintptr_t)&log_module_bt_conn) /*=0x88108*/, 0x1040, &local_20);
        bt_l2cap_recv(param_1, *(unsigned int*)(param_1+0x10), 0);
        *(unsigned int*)(param_1+0x10) = 0;
      }
      goto LAB_56432;
    }
    local_1c = "Unexpected L2CAP continuation" /*=0xf3b2f*/;
    local_20 = 2;
    FUN_000813ca(((uintptr_t)&log_module_bt_conn) /*=0x88108*/, 0x1040, &local_20);
  } else {
    if (param_3 == 2) {
      if (*(int*)(param_1+0x10) != 0) {
        local_1c = "Unexpected first L2CAP frame" /*=0xf3b12*/;
        local_20 = param_3;
        FUN_000813ca(((uintptr_t)&log_module_bt_conn) /*=0x88108*/, 0x1040, &local_20);
...
LAB_563ce:
      ...
      if (local_34 < uStack_38) {
        local_3c = "ACL len mismatch (%u > %u)" /*=0xf3b92*/;
        local_40 = 4;
        FUN_000813ca(((uintptr_t)&log_module_bt_conn) /*=0x88108*/, 0x2040, &local_40);
        bt_conn_reset_rx_state(param_1);
        return;
      }
      *(unsigned int*)(param_1+0x10) = 0;
    ...
    local_3c = "Unexpected ACL flags (0x%02x)" /*=0xf3b74*/;
    local_40 = 3;
    uStack_38 = param_3;
    FUN_000813ca(((uintptr_t)&log_module_bt_conn) /*=0x88108*/, 0x1840, &local_40);
  }
  bt_conn_reset_rx_state(param_1);
LAB_56432:
  net_buf_unref(param_2);
