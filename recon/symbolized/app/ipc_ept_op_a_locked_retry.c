...
/* named: ipc_ept_op_a_locked_retry */
/* Reconstructed ipc_ept_op_a_locked_retry @ 0x256dc  (parity: 300/300 trials, PROVEN) */
extern void thunk_FUN_000723b8(unsigned,unsigned,unsigned,unsigned,int,unsigned);
extern int FUN_00025670(int,unsigned,unsigned,unsigned);
...
int ipc_ept_op_a_locked_retry(int param_1, unsigned param_2, unsigned param_3, int param_4){
    ...
    if (param_4 == 0){ iVar1 = 0; }
        ...
        while (1){
            ...
            iVar1 = FUN_00025670(iVar3, *(unsigned short*)(iVar3 + 8), param_2, param_3);
