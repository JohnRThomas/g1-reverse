...
int FUN_000530c4(void){
    volatile u32* puVar1 = (volatile u32*)((uintptr_t)&g_ble_dev_ncmd_sem) /*=0x200020d4*/;
    u32 r3 = *puVar1;
    if((r3 & 1) == 0) return 0;
    if(*(volatile u8*)(((uintptr_t)&g_ble_dev_ncmd_sem) /*=0x200020d4*/ + 0x98) == 0){
        bt_set_name_internal("Even G1" /*=0x9ac7c*/);
    }
    int iVar2;
    if(*(volatile u8*)(((uintptr_t)&g_ble_dev_ncmd_sem) /*=0x200020d4*/ - 0xcd) == 0){
...
RS: ;
    u32 local[2];
    local[0] = 2;
    local[1] = "Unable to setup an identity address" /*=0xf2c8c*/;
    FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x88178*/, 0x1040, local, 0);
    return iVar2;
}
