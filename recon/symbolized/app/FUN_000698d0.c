...
extern void lc3_ltpf_resample(const int16_t *, const int16_t *, int, float *, int);
...
bool FUN_000698d0(void *analysis, const int16_t *x, int n, int *pitch_lag)
{
    ...
    lc3_ltpf_resample(x, x - 17, n, correlation, 98);
