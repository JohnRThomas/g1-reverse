...
void uart_callback(int param_1,unsigned char *param_2,unsigned int param_3){
  ...
  switch (*param_2) {
  case 0:
    if (2 < *lvl) { if(*g8==0) DEBUG_PRINT(((unsigned long)&rodata_a797b) /*=0xa797b*/,((unsigned long)&rodata_a7b56) /*=0xa7b56*/,VI((int)param_2+8),0,param_1); else debug_print(); }
    for (uVar5=0; uVar5 < (unsigned int)VI((int)param_2+8); uVar5++)
      DEBUG_PRINT(((unsigned long)&rodata_a7993) /*=0xa7993*/, VB(VI((int)param_2+4)+uVar5));
    break;
  case 1:
    if (*lvl < 1) return;
    if (*g8 != 0) { debug_print(); return; }
    DEBUG_PRINT(((unsigned long)&rodata_a7999) /*=0xa7999*/,((unsigned long)&rodata_a7b56) /*=0xa7b56*/); return;
  case 2:
    ...
    DEBUG_PRINT(((unsigned long)&rodata_a79ab) /*=0xa79ab*/, VI((int)param_2+0xc), param_3, uVar7 & 0xffff, param_1);
    for (uVar7=0; uVar7 < (unsigned int)VI((int)param_2+0xc); uVar7++)
      DEBUG_PRINT(((unsigned long)&rodata_a7993) /*=0xa7993*/, VB(VI((int)param_2+4)+uVar5+uVar7));
    break;
  case 3:
    DEBUG_PRINT(((unsigned long)&rodata_a79bf) /*=0xa79bf*/);
  ...
  case 4:
    DEBUG_PRINT(((unsigned long)&rodata_a7a52) /*=0xa7a52*/);
