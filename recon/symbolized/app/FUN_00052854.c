...
{
    int iVar1 = FUN_00080b32(((uintptr_t)&g_misc_kobj_abac) /*=0x2000abac*/);
    if (iVar1 < 0) return iVar1;
    if (param_2 != 0) return iVar1;
    int *puVar2 = FUN_00080bfe(((uintptr_t)&g_misc_kobj_abac) /*=0x2000abac*/);
    *puVar2 = param_2;
    *(unsigned char*)((char*)puVar2+4) = (unsigned char)param_2;
    return thunk_FUN_0005f24c(((uintptr_t)&g_misc_kobj_abac) /*=0x2000abac*/);
}
