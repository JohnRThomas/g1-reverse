...
{
  int iVar1 = ((uintptr_t)&rodata_f8a6b) /*=0xf8a6b*/;
  int iVar2;
  int iVar3;
  uint uVar4, uVar5;
  byte *pbVar6;
  ...
  local_28 = ((uintptr_t)&rodata_877ed) /*=0x877ed*/;
  local_24 = (fnptr)((uintptr_t)&rodata_87863) /*=0x87863*/;
  local_2a8 = param_4;
...
LAB_00078fae:
  ...
  iVar3 = mem_find_byte("hlL" /*=0xf8b71*/, uVar5, 3);
  if (iVar3 != 0) {
...
LAB_00079156:
  ...
  if (local_18c < 3) {
    ...
    iVar2 = param_1;
    if (*(volatile unsigned*)((uintptr_t)&tbl_79238) /*=0x79274*/ == 0) goto LAB_00078fae;
  }
