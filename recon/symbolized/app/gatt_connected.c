...
int gatt_connected(unsigned param_1, int param_2, int param_3){
  ...
  int *piVar3;
  (void)param_3;
  bt_gatt_foreach_attr_0(1, ((uintptr_t)&tbl_ffc8) /*=0xffff*/, ((uintptr_t)&tbl_5a248) /*=0x5a2d5*/, &local_20);
  ...
  if (iVar1 >= 0 && (iVar1 = bt_gatt_clear_sc(param_1,param_2)) >= 0){
    ...
    iVar1 = FUN_0005306c(param_1,param_2);
    if (iVar1 >= 0){
      iVar4 = 0; iVar1 = ((uintptr_t)&g_known_device_table_addr0) /*=0x2000af19*/;
      do {
        if ((unsigned)*(volatile unsigned char*)(iVar1-1) == param_1 &&
            (iVar2 = bt_addr_le_eq_0(param_2, iVar1)) != 0){
          iVar4 = iVar4 + ((uintptr_t)&g_known_device_table) /*=0x2000af18*/;
          piVar3 = *(int**)(iVar4 + 8);
          if (piVar3 != 0){
            iVar1 = *piVar3;
