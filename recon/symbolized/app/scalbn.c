...
/* named: scalbn */
/* Reconstructed scalbn @ 0x870ea  (parity: 300/300 trials, PROVEN) */

extern void FUN_00078bf8(void);
...
double scalbn(unsigned int param_1, unsigned int param_2, int param_3)
{
    ...
    if (param_3 != 0) {
        ...
        if (iVar1 > 0) {
            unsigned int newhi = (unsigned int)iVar1 * FLASH_OFF_100000 /*=0x100000*/ + 0x3ff00000u;
