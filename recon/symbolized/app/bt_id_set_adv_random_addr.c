 ...
 * public-name: bt_id_set_adv_random_addr
...
extern int bt_id_set_random_addr_checked(uint8_t*,int);
extern int bt_id_set_adv_private_addr(uint8_t*,uint32_t);

int bt_id_set_adv_random_addr(uint8_t *param_1, int param_2, int param_3, uint8_t *param_4){
    ...
    if ((((uint32_t)param_2 << 0xc) & 0x80000000UL) != 0){          /* bit19 set */
        if ((((uint32_t)param_2 << 0x1d) & 0x80000000UL) != 0){     /* bit2 set */
            ...
            bt_id_addr_update_thunk(((unsigned long)&rodata_88150) /*=0x88150*/, 0x1040, &local_20);
            return -0x16;
        }
    ...
    if ((((uint32_t)param_2 << 0x1f) & 0x80000000UL) != 0){          /* bit0 set */
        if (param_3 == 0){
          ...
          L_554dc:
            iVar2 = bt_id_set_random_addr_checked(param_1, (int)(uVar4*7) + ((unsigned long)&g_ble_dev_state) /*=0x20002000*/ + 1);
            if (iVar2 != 0) return iVar2;
            bVar3 = tbl[uVar4*7];
            *param_4 = bVar3;
    ...
    if ((((uint32_t)param_2 << 0x1d) & 0x80000000UL) != 0){          /* bit2 set */
        bVar3 = tbl[uVar4*7];
        if (bVar3 != 1) goto L_554d8;
        iVar2 = bt_id_set_random_addr_checked(param_1, (int)((int16_t)(uint16_t)*(volatile uint8_t*)param_1 * 7) + 1 + ((unsigned long)&g_ble_dev_state) /*=0x20002000*/);
        bVar3 = tbl[uVar4*7];
        goto L_551e;
    }
    iVar2 = bt_id_set_adv_private_addr(param_1, (uint32_t)param_2 << 12);
