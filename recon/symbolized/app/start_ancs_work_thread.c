...
void start_ancs_work_thread(unsigned param_1){
  ...
  if((*(unsigned char*)pcVar1==2) && (iVar2=is_battery_critical(), iVar2!=1)){
    FUN_00071eac(((unsigned long)&g_ancs_work_thread) /*=0x20003c50*/, ((unsigned long)&g_ancs_work_thread_stack) /*=0x2001d568*/, 0x1400, ADDR_FUN_00019718_THUMB /*=0x19719*/, param_1, 0,0,0xfffffff5,0);
    if(2 < *(volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/){
      if(*(volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ != 0){
        debug_print();
        return;
      }
      DEBUG_PRINT(((unsigned long)&rodata_9af2e) /*=0x9af2e*/, ((unsigned long)&rodata_9b0f1) /*=0x9b0f1*/);
      return;
    }
  }
  return;
