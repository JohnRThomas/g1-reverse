...
unsigned FUN_0005f654(unsigned param_1, unsigned char *param_2)
{
  ...
  default: local_14 = "Selected ADC gain is not valid" /*=0xf5503*/; goto LAB;
  ...
  if (param_2[1] == 3) { iVar5 = 1; }
    ...
    local_14 = "Selected ADC reference is not valid" /*=0xf5522*/;
    if (param_2[1] != 4) goto LAB;
    iVar5 = 0;
  }
  uVar1 = *(unsigned short*)(param_2 + 2);
  if (uVar1 != 0x400a) {
    local_14 = "Selected ADC acquisition time is not valid" /*=0xf5546*/;
    if (0x400a < uVar1) {
...
LAB:
      local_18 = 2;
      FUN_0004d944(((uintptr_t)&tbl_880d8) /*=0x880e0*/, 0x1040, &local_18, 0);
      return 0xffffffea;
    }
  }
  iVar2 = 2;
LAB2:
  *(volatile unsigned*)(uVar4 * 0x10 + REG_5000e518 /*=0x5000e518*/) =
      uVar3 << 8 | (((unsigned)param_2[4] << 0x1a) >> 0x1f) << 0x14 | iVar5 << 0xc | iVar2 << 0x10;
  *(volatile unsigned*)(uVar4 * 0x10 + REG_5000e514 /*=0x5000e514*/) = (unsigned)param_2[6];
  *(volatile unsigned*)(uVar4 * 0x10 + REG_5000e510 /*=0x5000e510*/) = 0;
  *(volatile unsigned char*)(((uintptr_t)&adc_context) /*=0x20002190*/ + uVar4 + 0xa0) = param_2[5];
  return 0;
}
