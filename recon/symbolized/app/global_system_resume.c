...
/* named: global_system_resume */
/* globals referenced:
//   0x200069fc  device_info                  
*/
/* Reconstructed global_system_resume @ 0x16854  (parity: 300/300 trials, PROVEN) */
#include <stdint.h>
...
{
  volatile int *pp = (volatile int*)((uintptr_t)&device_info) /*=0x200069fc*/;
  int base = *pp;
