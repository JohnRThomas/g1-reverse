...
undefined4 is_ext_flash_burned(unsigned param_1, uint param_2, unsigned param_3)
{
    ...
    uStack_24 = param_2;
    if (2 < *piVar1) {
        if (*dbg == 0) DEBUG_PRINT("%s(): join in is_ext_flash_burned\n\n" /*=0xa74dc*/, "is_ext_flash_burned" /*=0xa766d*/, param_3, 0, param_1);
        else debug_print(0);
    }
    uVar7 = 0;
    iVar6 = 0;
    ...
    do {
        *uhi = ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
        ...
        case 1:
            ...
            if (*uhi != ((uintptr_t)&rodata_dab9) /*=0xdab9*/) return 1;
            if (2 < *piVar1) break;
            iVar6 = 2;
            goto LAB_00032caa;
        case 2:
        ...
        case 4:
            ...
            if (*uhi != ((uintptr_t)&rodata_d412) /*=0xd412*/) return 1;
        ...
        case 6:
            ...
            break;
        default:
            iVar5 = calc_flash_crc((int)&uStack_24 + 2, FLASH_OFF_140000 /*=0x140000*/, 0x10);
        ...
        if (*dbg == 0) DEBUG_PRINT("%s(): read flash idx %d, calc crc is:0x%x\n" /*=0xa7500*/, "is_ext_flash_burned" /*=0xa766d*/, iVar6, *uhi);
        else debug_print("%s(): read flash idx %d, calc crc is:0x%x\n" /*=0xa7500*/, "is_ext_flash_burned" /*=0xa766d*/, iVar6);
        iVar6 = iVar6 + 1;
        if (iVar6 == 7) return 0;
LAB_00032caa:
        uVar7 = 0;
...
LAB_00032e38:
    ...
    uVar7 = uVar7 + 1 & 0xff;
    if (0 < *piVar1) {
        if (*dbg == 0) DEBUG_PRINT("%s(): flash read fail, retry again, retry time %d\n" /*=0x9e2f1*/, "is_ext_flash_burned" /*=0xa766d*/, uVar7);
        else debug_print(0);
    }
    goto LAB_00032c54;
}
