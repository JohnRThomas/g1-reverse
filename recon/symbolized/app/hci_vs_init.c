...
#define DAT_00012388 ((uintptr_t)&g_ble_dev_state) /*=0x20002000*/
#define DAT_0001238c ((volatile int*)((uintptr_t)&g_ble_dev_acl_buf_info) /*=0x20002078*/)
#define DAT_00012390 "Non-LE capable controller detected!" /*=0xf325b*/
#define DAT_00012394 ((uintptr_t)&tbl_880d8) /*=0x88138*/
#define DAT_00012398 ((volatile int*)((uintptr_t)&g_ble_dev_le_features) /*=0x200020d8*/)
#define DAT_0001239c ((uintptr_t)&g_ble_dev_le_pkts_sem) /*=0x20002108*/
#define DAT_000123a0 "ACL BR/EDR buffers not initialized" /*=0xf327f*/
#define DAT_00012538 0x2008810UL
#define DAT_00012540 ((uintptr_t)&tbl_880d8) /*=0x88138*/
#define DAT_00012550 0x1000004UL
#define DAT_00012560 0x1000007UL
#define DAT_00012564 "Failed to read supported vendor commands" /*=0xf3324*/
#define DAT_00012568 ((uintptr_t)&g_ble_dev_state) /*=0x20002000*/
#define DAT_0001256c (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x1256c*/)
#define DAT_00012578 "Firmware: %s (0x%02x) Version %u.%u Build %u" /*=0xf32f7*/
#define _UNK_00012570 (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x12570*/)
#define _UNK_00012574 (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x12574*/)
#define PTR_s_Vendor_HCI_extensions_not_availa_0001253c (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x1253c*/)
#define PTR_s_unknown_00012548 (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x12548*/)
#define PTR_PTR_s_reserved_00012544 (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x12544*/)
#define PTR_s_HW_Platform___s__0x_04x__0001254c (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x1254c*/)
#define PTR_DAT_00012540 (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x12540*/)
#define PTR_PTR_s_reserved_00012554 (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x12554*/)
#define PTR_s_HW_Variant___s__0x_04x__00012558 (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x12558*/)
#define PTR_PTR_s_Standard_Bluetooth_controller_0001255c (*(volatile int*)((uintptr_t)&tbl_12538) /*=0x1255c*/)
...

{
  ...
  *DAT_00012398 = *(undefined4 *)(*(int *)(local_30[0] + 0xc) + 1);
  ...
  if (-1 < (int)((uint)*(byte *)(iVar5 + 0xd8) << 0x1f)) {
    uVar8 = DAT_00012538;
    uVar7 = ((uintptr_t)&g_sram_base_word) /*=0x20000000*/;
  }
  ...
  iVar5 = FUN_00053d70(((uintptr_t)&rodata_fc01) /*=0xfc01*/,0);
  ...
  if (iVar5 == 0) {
    ...
    local_40 = (local_40 & ~(0xffffL /*=0xffff*/<<0)) | (((unsigned long long)(0x200) & 0xffffL /*=0xffff*/)<<0);
    ...
    local_40 = CONCAT22(((unsigned long long)(local_40)>>16 & 0xffffL /*=0xffff*/),0x200);
    ...
    iVar1 = FUN_00053d70(((uintptr_t)&rodata_fc02) /*=0xfc02*/,0,&local_34);
    iVar5 = DAT_00012568;
    ...
    if (iVar1 == 0) {
      *(undefined2 *)(DAT_00012568 + 0xc1) = *(undefined2 *)(*(int *)(local_34 + 0xc) + 1);
      ...
      iVar1 = FUN_00053d70(((uintptr_t)&rodata_fc03) /*=0xfc03*/,0,&local_34);
