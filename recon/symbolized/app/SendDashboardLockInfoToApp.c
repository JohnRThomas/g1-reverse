...
void SendDashboardLockInfoToApp(unsigned p1, unsigned p2, unsigned p3){
  ...
  int iVar1 = FUN_0007ca4e(((uintptr_t)&g_dashboard_lock_ready_flags) /*=0x20007570*/);
  if((iVar1<<0x1e)<0){
    iVar1 = FUN_0007ca4e(((uintptr_t)&g_dashboard_reset_pending_flags) /*=0x20007aa0*/);
    if(-1 < (iVar1<<0x1e)){
      iVar1 = FUN_0007ca4e(((uintptr_t)&g_dashboard_lock_sent_flags) /*=0x2000756c*/);
      unsigned bit = (unsigned)(iVar1>>1)&1u;
      if(-1 < (iVar1<<0x1e)){
        iVar1 = FUN_0007ca4e(((uintptr_t)&g_dashboard_lock_ready_flags) /*=0x20007570*/);
        if((iVar1<<0x1e)<0){
          buf[0]=bit;
          ...
          *(volatile uint32_t*)((uintptr_t)&g_dashboard_lock_sent_flags) /*=0x2000756c*/ |= 2u;
        }
      }
    }
  }
