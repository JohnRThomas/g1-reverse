...
unsigned handle_touch_key_press_event(void){
    volatile unsigned char *puVar1 = (volatile unsigned char*)((uintptr_t)&g_esb_notify_slave_role_guard) /*=0x20018d9f*/;
    *puVar1 = 1;
    unsigned sVar7 = 1000;
    for(;;){
        ...
        sVar7 = (sVar7 - 1) & ((uintptr_t)&tbl_ffc8) /*=0xffff*/;
    ...
    if (uVar6 < 2000){
        ...
        if (*(volatile unsigned char*)(t + 0x105a) == 2){
            volatile unsigned char *pcVar2 = (volatile unsigned char*)((uintptr_t)&g_new_notification_pending_flag) /*=0x20018d8d*/;
    ...
    if (*(volatile int*)((uintptr_t)&g_log_use_alt_sink) /*=0x20007554*/ == 0) DEBUG_PRINT("#########timeout,should retry !" /*=0xa2748*/);
    else debug_print();
    uVar5 = 0xffffffffu;
out:
    *puVar1 = 0;
