...
undefined4 FUN_0004ea78(int param_1,undefined4 *param_2,int param_3)
{
  ...
  if (bVar1 == 3) {
    ...
    if (iVar3 != 0) { printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f14c2) /*=0xf14c2*/,((unsigned long)&rodata_f11bc) /*=0xf11bc*/,0x19c); uVar9 = 0x19c; goto LAB_eb7e; }
    ...
    if (piVar10 == 0) { printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f1541) /*=0xf1541*/,((unsigned long)&rodata_f11bc) /*=0xf11bc*/,0x1a8); uVar9 = 0x1a8; goto LAB_eb7e; }
  ...
  if (bVar1 < 4) {
    if (bVar1 != 2) {
      ...
      if (iVar4 != 0) {
        ...
        if (iVar4 != 0) { printk(((unsigned long)&rodata_99cbd) /*=0x99cbd*/,((unsigned long)&rodata_f12bb) /*=0xf12bb*/,((unsigned long)&rodata_f11bc) /*=0xf11bc*/,0x127); uVar9 = 0x127; goto LAB_eb7e; }
      }
...
LAB_eb88:
        ...
        *(short*)((int)piVar2 + 0x10) = *(short*)(iVar3 + 4) + 1;
        ...
        local_4c = ((unsigned long)&rodata_f1432) /*=0xf1432*/; local_50 = 3;
        FUN_0007f406(((unsigned long)&rodata_88130) /*=0x88130*/,0x1840,(int)&local_50);
      }
    ...
    if (param_2 == 0) {
      ...
      *(char*)((int)piVar2 + 0x18) = 3;
      ...
      if (uVar8 == 0) return 0;
      local_4c = ((unsigned long)&rodata_f1459) /*=0xf1459*/; local_50 = 3; uStack_48 = uVar8;
      FUN_0007f406(((unsigned long)&rodata_88130) /*=0x88130*/,0x1840,(int)&local_50);
      goto LAB_eaa6;
    }
    local_38[0] = 0; local_36 = 0x2803;
    ...
    local_4c = ((unsigned long)&rodata_f1484) /*=0xf1484*/; local_50 = 3;
    FUN_0007f406(((unsigned long)&rodata_88130) /*=0x88130*/,0x1840,(int)&local_50);
    goto LAB_ec80;
  }
