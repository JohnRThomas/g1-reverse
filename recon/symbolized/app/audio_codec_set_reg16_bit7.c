...
/* named: audio_codec_set_reg16_bit7 */
/* Reconstructed audio_codec_set_reg16_bit7 @ 0x7fa7a  (parity: 300/300 trials, PROVEN) */
...
void audio_codec_set_reg16_bit7(unsigned int param_1, unsigned int param_2, unsigned int param_3)
{
    ...
    local_14 = param_2;
    uStack_10 = param_3;
    iVar1 = audio_codec_bus_read_trampoline(param_1, 0x16, &local_14, 1, param_1);
    if (iVar1 == 0) {
        unsigned char b = (unsigned char)local_14;
        b = (b & 0x7f) | (unsigned char)((param_2 & 1) << 7);
        local_14 = (local_14 & 0xffffff00U) | b;
        audio_codec_bus_write_trampoline(param_1, 0x16, &local_14, 1);
    }
    return;
}
