...
unsigned int sc_restore(int param_1, int param_2, int *param_3)
{
  ...
  if (*(int*)(param_1+8) == ((uintptr_t)&tbl_5a458) /*=0x5a465*/) {
    ...
    if ((*(short*)(puVar9+8) != 0) &&
      ...
      if (local_48 != 0) {
        if (local_48 == 3) {
          FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1880, dummy);
          return 1;
        }
      ...
      if (puVar9 == (unsigned char*)((uintptr_t)&g_bt_gatt_sc_ccc) /*=0x20002a20*/) {
        ...
        if ((iVar4 != 0) && ((*(short*)(iVar4+8) != 0) || (*(short*)(iVar4+10) != 0))) {
          ...
          *(volatile unsigned short*)(((uintptr_t)&sc_range) /*=0x2000ff14*/ + iVar6*4) = *(unsigned short*)(iVar4+8);
          *(volatile unsigned short*)(((uintptr_t)&sc_range) /*=0x2000ff14*/ + iVar6*4 + 2) = uVar1;
          int iVar7 = iVar6*0x18 + ((uintptr_t)&g_sc_gatt_indicate_params_table) /*=0x2000aebc*/;
          *(volatile int*)(iVar7+0x10) = ((uintptr_t)&sc_range) /*=0x2000ff14*/ + (short)iVar6*4;
          *(volatile int*)(iVar7+4) = ((uintptr_t)&tbl_8b3b4) /*=0x8b3dc*/;
          *(volatile int*)(iVar7+8) = ((uintptr_t)&rodata_82bd5) /*=0x82bd5*/;
          *(volatile unsigned short*)(iVar7+0x14) = 4;
          int r = bt_gatt_indicate(iVar8, ((uintptr_t)&g_sc_gatt_indicate_params_table) /*=0x2000aebc*/ + (short)iVar6*0x18);
          if (r != 0) {
            FUN_00082a42(((uintptr_t)&tbl_880d8) /*=0x88128*/, 0x1040, dummy);
          }
        }
      }
    }
