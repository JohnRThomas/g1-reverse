...
/* named: stdio_streams_init */
/* Reconstructed stdio_streams_init @ 0x76bcc  (parity: 300/300 trials, PROVEN) */
#include <stdint.h>
...
void stdio_streams_init(int param_1){
  ...
  *(volatile uint32_t*)(param_1+0x50)=0;
  int iVar2=*(volatile int*)"$-" /*=0x9873c*/;
  *(volatile uint32_t*)(param_1+0x28)=((uintptr_t)&tbl_76b3c) /*=0x76b91*/;
