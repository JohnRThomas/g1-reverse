...
void FUN_01036f74(int force_advance)
{
    ...
    if (force_advance == 0) {
        if (head == 0) {
            FUN_01039bbe(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103eb0e) /*=0x103eb0e*/, 0x8f, 0);
            FUN_01039bb0(((unsigned long)&rodata_103eb0e) /*=0x103eb0e*/, 0x8f);
        }
        if ((head[0x0d] & 0x1f) == 0 &&
