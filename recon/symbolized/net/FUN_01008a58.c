...
#define S ((volatile unsigned char*)((uintptr_t)&g_net_layout_count_table) /*=0x21000a30*/)
#define FPA_RAW (*(volatile unsigned int*)((uintptr_t)&g_net_sdc_optfeat_fp_a) /*=0x21000044*/)
#define FPB_RAW (*(volatile unsigned int*)((uintptr_t)&g_net_sdc_optfeat_fp_b) /*=0x2100004c*/)
#define FPC_RAW (*(volatile unsigned int*)((uintptr_t)&g_net_sdc_optfeat_fp_c) /*=0x21000048*/)
#define A8(x) (((x)+7u)&~7u)
#define A4(x) (((x)+3u)&~3u)
...
int FUN_01008a58(int param_1, int param_2)
{
    ...
    if (*(volatile unsigned int*)((uintptr_t)&g_net_sdc_mempool_required_size) /*=0x21000a54*/ != 0) {
        if (param_2 == 0) {
            *(volatile unsigned int*)((uintptr_t)&g_net_sdc_mempool_required_size) /*=0x21000a54*/ = off;
        }
        off += 0x28u;
    }
