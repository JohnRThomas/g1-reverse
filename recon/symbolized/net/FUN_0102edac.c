...
/* readable reconstruction; identity: FUN_0102edac @ 0x0102edac
 * public-name: FUN_0102edac
...
extern void FUN_0103b614(int,int,int);
...
int FUN_0102edac(int param_1, int param_2)
{
  ...
  int c_ee08=((unsigned long)&rodata_103c0fc) /*=0x103c0fc*/;
