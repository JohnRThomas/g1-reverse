...
void FUN_01037768(int param_1)
{
    ...
    volatile int * const p1800 = (volatile int *)((uintptr_t)&g_zephyr_sched_spinlock) /*=0x21004b68*/;
    ...
    if (pb[0xd] < 0) {
        ...
        FUN_0103735c(((uintptr_t)&g_zephyr_sched_thread_field) /*=0x21004b40*/, param_1);
    }

    volatile int * const p1810 = (volatile int *)((uintptr_t)&g_zephyr_kernel_readyq) /*=0x21004b28*/;
    int iVar5 = p1810[2];
