...
/* readable reconstruction; identity: FUN_01032860 @ 0x01032860
 * public-name: FUN_01032860
 * durable-map: recon/catalogs/function_names_net.json
 * address symbols (name @ address):
 *   rodata_103cae8                           @ 0x0103cae8
...
void FUN_01032860(int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
  ...
  iVar2 = FUN_010218c0(((unsigned long)&rodata_103cae8) /*=0x103cae8*/, G1N_2100065c, param_3, param_4);
