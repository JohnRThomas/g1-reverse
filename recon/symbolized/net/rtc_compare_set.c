 ...
 * public-name: rtc_compare_set
 * durable-map: recon/catalogs/function_names_net.json
 * callees (readable <= raw @ address):
 *   rtc_compare_set                          <= FUN_010313ec @ 0x010313ec
...
int rtc_compare_set(unsigned int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4,
