...
void FUN_01037814(int *param_1)
{
  ...
  if (r0 == 0) {
    FUN_01039bbe(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103eb0e) /*=0x103eb0e*/, 0x2d2);
    r0 = FUN_01039bb0(((unsigned long)&rodata_103eb0e) /*=0x103eb0e*/, 0x2d2);
  }
