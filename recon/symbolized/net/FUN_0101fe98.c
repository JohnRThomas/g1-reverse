...
{
  volatile unsigned char * const pcVar2 = (volatile unsigned char *)((uintptr_t)&g_net_radio_pending_reset_flag) /*=0x210014dc*/;
  volatile unsigned int * const puVar3 = (volatile unsigned int *)REG_4100e000 /*=0x4100e000*/;
  volatile unsigned int * const p150 = (volatile unsigned int *)REG_41008000 /*=0x41008000*/;
  volatile unsigned int * const p504 = (volatile unsigned int *)REG_4100f000 /*=0x4100f000*/;
  unsigned char bVar1;
