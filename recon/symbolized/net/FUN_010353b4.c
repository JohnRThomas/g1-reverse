...
void FUN_010353b4(int param_1)
{
  if (param_1 != 0) {
    if ((*(volatile short *)(param_1 + 0x24) != *(volatile short *)(param_1 + 0xa)) &&
        (3 < *(volatile unsigned char *)((unsigned long)&g_net_debug_trace_level) /*=0x21004b04*/) &&
        (*(volatile fp3_t *)((unsigned long)&g_net_debug_trace_cb) /*=0x21004b08*/ != (fp3_t)0)) {
      (*(volatile fp3_t *)((unsigned long)&g_net_debug_trace_cb) /*=0x21004b08*/)(4, ((unsigned long)&rodata_103e867) /*=0x103e867*/, *(volatile unsigned int *)(param_1 + 4));
    }
