...
uint32_t FUN_01012ba4(int32_t param_1, int32_t param_2, uint32_t param_3, uint32_t param_4)
{
    ...
    if ((uVar1 > 1) && (param_2 != 0x1d)) {
        return FUN_01008d00(0x2f, 0xee, param_3, uVar1, param_4);
    }

    const uint32_t base = ((uintptr_t)&rodata_103c1d4) /*=0x103c1d4*/;
    ...
    default:
        return FUN_01008d00(0x2f, 0x102, param_3, uVar1, param_4);
    }
}
