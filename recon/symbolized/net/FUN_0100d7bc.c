...
{
  volatile unsigned char *flag = (volatile unsigned char *)((uintptr_t)&g_net_esb_own_addr_valid) /*=0x21000ea8*/;
  if (*flag == 0) {
    volatile unsigned char *src = (volatile unsigned char *)((uintptr_t)&g_net_esb_own_addr) /*=0x21000010*/;
