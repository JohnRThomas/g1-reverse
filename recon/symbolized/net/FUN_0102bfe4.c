...
LAB_0102c100:
          {
            ...
            blk.mc = uVar10;
            blk.m10 = 0x200;
            z_impl_z_log_msg_static_create(((unsigned long)&rodata_103c04c) /*=0x103c04c*/, 0x2480, &blk, 0);
          }
          param_2 = param_2 + -2;
          pbVar6 = pbVar14;
          goto LAB_0102c0d4;
...
LAB_0102c1dc:
  ...
  if (local_74 != 0) {
    ...
    assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103d279) /*=0x103d279*/, 0x448);
    uVar10 = 0x448;
    goto LAB_0102c006;
  }
  if (0xf < uVar13) {
    assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103d279) /*=0x103d279*/, 1099);
    uVar10 = 1099;
    goto LAB_0102c006;
  }
  uVar8 = uVar13 + 1;
...
LAB_0102c2fc:
  {
    ...
    if (push_ok) {
      if ((int)(param_5 << 0x1f) < 0) {
        if (0xf < uVar12) {
          assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103d279) /*=0x103d279*/, 0x43e);
          uVar10 = 0x43e;
          goto LAB_0102c006;
        }
LAB_0102c366:
        ...
        if (0xf < uVar13) {
          assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103d279) /*=0x103d279*/, 0x441);
          uVar10 = 0x441;
          goto LAB_0102c006;
        }
