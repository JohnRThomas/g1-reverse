...
{
    unsigned char *puVar2 = (unsigned char *)((uintptr_t)&g_net_pending_work_list) /*=0x21000ec8*/;
    unsigned int primask;
    unsigned int *puVar5;
    unsigned int uVar3;
    if (puVar2[0x20] != 0) return;
    *(unsigned int *)(puVar2 + 0x1c) = ((uintptr_t)&rodata_100f2e5) /*=0x100f2e5*/;
    puVar2[0x20] = 2;
    __asm__ volatile ("mrs %0, primask" : "=r"(primask));
    __asm__ volatile ("cpsid i" ::: "memory");
    puVar5 = (unsigned int *)(puVar2 + 8);
    *(unsigned int **)(puVar2 + 0x18) = puVar5;
    uVar3 = ((uintptr_t)&g_net_ctrl_timeout_node_addr) /*=0x21000ee0*/;
