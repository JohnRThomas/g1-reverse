...
void z_log_dropped(uint32_t buffered)
{
    volatile uint32_t *const buffered_count =
        (volatile uint32_t *)((unsigned long)&g_net_tick_pending_cnt) /*=0x21004668*/;
    FUN_0103a294((volatile uint32_t *)((unsigned long)&g_net_tick_correction_pending) /*=0x21004664*/);
    if (buffered != 0u) {
