...
unsigned int FUN_0103494c(unsigned int param_1, int param_2)
{
    ...
    unsigned short hw;
    if (param_2 == 0) {
        assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103e66f) /*=0x103e66f*/, 0x265);
        assert_post_action(((unsigned long)&rodata_103e66f) /*=0x103e66f*/, 0x265);
        return 0;
    }
    iVar1 = FUN_010344d4();
    uVar2 = 0x0bad0004;
    if (iVar1 != 0) {
        ...
        uVar2 = 0x0bad0000;
        base = ((unsigned long)&g_sdc_res_pool_slot_tbl) /*=0x210006a8*/;
