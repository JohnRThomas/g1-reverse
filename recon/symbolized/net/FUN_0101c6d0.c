...
{
    int iVar2 = ((uintptr_t)&g_net_link_ctx_b) /*=0x21001124*/;              /* DAT_0101c978 (zero page) */
...
L_c6fc:
    ...
    if (uVar4 <= uVar13) {
        S32(iVar7 + 0xe8) = 0;
        FUN_0100efc8(iVar7 + 0x1c5, ((uintptr_t)&rodata_10109cd) /*=0x10109cd*/, 2);   /* DAT_0101c97c */
        uVar8 = U16(iVar2 + 10);
    }
...
L_c89c:
    ...
    FUN_0100ef88(iVar7 + 0xdc, ((uintptr_t)&rodata_10100a1) /*=0x10100a1*/, 2);        /* DAT_0101c980 */
    S16(iVar7 + 0xc5) = 0;
    S8(iVar7 + 0xc9) = 0;
