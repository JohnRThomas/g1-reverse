...
/* readable reconstruction; identity: FUN_0101a38c @ 0x0101a38c
 * public-name: controller_timing_snapshot_build
...
#define local_30 request.target_time
  ...
  schedule_state = ((uint8_t *)((unsigned long)&g_net_session_state_block) /*=0x210010a0*/);
...
LAB_0101a514:
      ...
      schedule_node_insert_after(((unsigned long)&g_net_session_queue_obj) /*=0x210010f0*/,puVar12);
