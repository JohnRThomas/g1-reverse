...
{
    if (owner == 0) {
        assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103e628) /*=0x103e628*/, 0x4au);
        assert_post_action(((unsigned long)&rodata_103e628) /*=0x103e628*/, 0x4au);
    }
