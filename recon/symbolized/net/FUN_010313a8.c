...
{
  volatile unsigned int *g1 = (volatile unsigned int*)((uintptr_t)&g_rtc_overflow_cnt) /*=0x21004970*/;
  unsigned int raw = *g1;
  unsigned int hi = raw >> 8;
  unsigned int lo = raw << 24;
  __asm__ volatile("dmb sy" ::: "memory");
  volatile unsigned int *g2 = (volatile unsigned int*)REG_41016000 /*=0x41016000*/;
  unsigned int uVar3 = *(volatile unsigned int*)((char*)g2 + 0x504);
  unsigned int sum = uVar3 + lo;
  int carry = sum < uVar3;
  unsigned int uVar1 = hi + carry;
  if (uVar3 < 0x100000) {
    volatile unsigned int *g3 = (volatile unsigned int*)((uintptr_t)&g_sdc_rtc_wrap_limit) /*=0x21002b88*/;
  ...
  volatile unsigned int *g3b = (volatile unsigned int*)((uintptr_t)&g_sdc_rtc_wrap_limit) /*=0x21002b88*/;
