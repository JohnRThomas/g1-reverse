...
L_chain2:
  r4 = FUN_01034464(*(volatile unsigned char *)((unsigned long)&g_esb_ppi_ch_id_5) /*=0x2100645f*/);
  if (r4 != r5) goto L_abort;

  r5 = FUN_01034464(*(volatile unsigned char *)((unsigned long)&g_net_radio_trx_ppi_ch_e) /*=0x2100645e*/);
  if (r5 != r4) goto L_abort;

  r4 = FUN_01034464(*(volatile unsigned char *)((unsigned long)&g_esb_ppi_ch_id_3) /*=0x2100645d*/);
  if (r4 != r5) goto L_abort;

  r5 = FUN_01034464(*(volatile unsigned char *)((unsigned long)&g_154_dppi_channel_ack) /*=0x2100645c*/);
  if (r5 != r4) goto L_abort;

  r4 = FUN_01034464(*(volatile unsigned char *)((unsigned long)&g_esb_ppi_ch_id_1) /*=0x2100645b*/);
  if (r4 != r5) goto L_abort;

  r0 = FUN_0103448c(*(volatile unsigned char *)((unsigned long)&g_net_radio_trx_ppi_ch_a) /*=0x2100645a*/);
  if (r0 != r4) goto L_abort;

  return;

L_abort:
  FUN_01039bbe(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103e4f5) /*=0x103e4f5*/, 0x13b);
