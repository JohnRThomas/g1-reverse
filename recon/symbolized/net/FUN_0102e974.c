...
void FUN_0102e974(int param_1, unsigned int param_2, unsigned int param_3)
{
  ...
  iVar2 = FUN_0102eb70();
  if (iVar2 != 0) {
    FUN_01039bbe(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103d7fb) /*=0x103d7fb*/, 0x55);
    FUN_01039bb0(((unsigned long)&rodata_103d7fb) /*=0x103d7fb*/, 0x55);
  }
