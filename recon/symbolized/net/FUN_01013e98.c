...
void FUN_01013e98(uint8_t *ctx, uint32_t event)
{
    ...
    if (event == 4) {
        ...
        volatile uint32_t *clock_adjust = (volatile uint32_t *)((unsigned long)&g_net_txbuf_alloc_idx) /*=0x21000f60*/;
    ...
    if (event == 2) {
        ...
        if (r32(ctx, 0x36c) && r8(ctx, 0x332) && r8(ctx, 0x31c) == 3) {
            ...
            volatile uint16_t *table = (volatile uint16_t *)((unsigned long)&rodata_103c1f8) /*=0x103c1f8*/;
        ...
        if (*(volatile uint8_t *)((unsigned long)&g_21000f64) /*=0x21000f64*/) {
            w8(ctx, 0x31c, 4);
