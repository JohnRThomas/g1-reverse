...
void FUN_01012c84(undefined1 *param_1,uint param_2,undefined4 param_3,uint param_4)
{
  ...
  iVar5 = ((uintptr_t)&g_nrf802154_core_state) /*=0x210015f0*/;
  iVar8 = REG_4100c000 /*=0x4100c000*/;
  ...
  case 3:
    break;
  case 4:
    *(undefined4 *)(REG_4100c000 /*=0x4100c000*/ + 0x4c) = 1;
    ...
    *(int *)(iVar5 + 0x40) = iVar8;
    ...
    uVar15 = 0xfffffee2;
    iVar12 = REG_41008000 /*=0x41008000*/;
    *(undefined4 *)(REG_41008000 /*=0x41008000*/ + 0x80) = 0;
    ...
    *(uint *)(iVar12 + 0x200) = uVar15 & *(uint *)(iVar12 + 0x200);
    iVar10 = REG_41008000 /*=0x41008000*/;
    if (cVar6 == '\0') {
      cVar6 = *(char *)(iVar5 + 9);
      iVar12 = 0;
      if (cVar6 != '\x01') goto LAB_01020d82;
LAB_01020e60:
      uVar15 = *(uint *)(REG_41008000 /*=0x41008000*/ + 0x10c);
      if (uVar15 != 0) {
        uVar15 = 8;
        goto LAB_01020d96;
      }
LAB_01020d88:
      if (*(int *)(REG_41008000 /*=0x41008000*/ + 0x110) != 0) {
...
LAB_01020d82:
      ...
      if (*(int *)(REG_41008000 /*=0x41008000*/ + 0x10c) == 0) {
        uVar14 = 0;
        uVar15 = 4;
      }
      else {
      ...
      if ((*(uint *)(REG_41008000 /*=0x41008000*/ + 0x400) & 1) != 0) {
        uVar15 = uVar14;
      }
      if (iVar12 != 0) {
        uVar14 = uVar15 & 0xb | 1;
...
LAB_01020d96:
    iVar12 = *(int *)(REG_41008000 /*=0x41008000*/ + 0x104);
    if (iVar12 != 0) {
      iVar12 = 1;
    }
    *((char *)&uStack_24) = (char)iVar12;
    *(undefined4 *)(REG_41008000 /*=0x41008000*/ + 0x100) = 0;
    ...
    *(undefined4 *)(iVar10 + 0x16c) = 0;
    ...
    iVar12 = REG_4100c000 /*=0x4100c000*/;
    if (iVar10 != 0) {
      uVar15 = uVar15 & 0xff | 0x10;
    }
    *(undefined4 *)(REG_4100c000 /*=0x4100c000*/ + 0x144) = 0;
...
LAB_01020e02:
      ...
      iVar10 = *(int *)(REG_4100c000 /*=0x4100c000*/ + 0x548);
      uVar9 = *(undefined4 *)(REG_4100c000 /*=0x4100c000*/ + 0x544);
      *(int *)(iVar5 + 0x24) = iVar10;
      *(undefined4 *)(iVar5 + 0x20) = uVar9;
...
LAB_01020ec2:
      ...
      if ((cVar6 == '\x04') || (cVar6 == '\b')) {
        if ((*(uint *)(REG_41008000 /*=0x41008000*/ + 0x414) & 6) == 0) {
          cVar6 = '\b';
        }
        else {
          cVar6 = '\x04';
      ...
      *(undefined2 *)(iVar5 + 7) = 0;
      ...
      if (cVar6 == '\x01') {
        if (uVar14 < iVar8 + 0x3bU) {
          *(undefined4 *)(REG_41008000 /*=0x41008000*/ + 0x10) = 1;
          uVar9 = 1;
          goto LAB_01020ee8;
        }
...
LAB_01020ee8:
    iVar8 = REG_41008000 /*=0x41008000*/;
    if (*(char *)(iVar5 + 0x44) != '\0') {
      *(undefined4 *)(REG_41008000 /*=0x41008000*/ + 0x1ac) = 0;
...
LAB_01020f2e:
      ...
      if ((int)(uVar15 << 0x1e) < 0) {
        uVar14 = *(uint *)(REG_41008000 /*=0x41008000*/ + 0x450);
        if (((int)(uVar14 << 7) < 0) &&
           (((((uVar14 & 0xf00) == 0 || (uVar14 & 0xf0) == 0 || ((uVar14 & 0xf) == 0)) &&
             ((uVar14 << 8) >> 0x1d < 3)) && (*(int *)(REG_41008000 /*=0x41008000*/ + 0x454) != 0))))
        goto LAB_01020ff6;
...
LAB_01021000:
    ...
    if (cVar6 != '\0') {
      if (cVar6 == '\x02') {
        *(int *)(REG_4100c000 /*=0x4100c000*/ + 0x544) = *(int *)(iVar5 + 0x24) + *(int *)(iVar5 + 0x10);
      }
      else {
        if (cVar6 != '\x01') {
        ...
        *(uint *)(REG_4100c000 /*=0x4100c000*/ + 0x544) = *(uint *)(iVar5 + 0x10);
      }
      *(undefined4 *)(REG_4100c000 /*=0x4100c000*/ + 0x1c4) = 0x8000000b;
    }
LAB_01020f60:
  ...
  case 6:
LAB_010127f8:
    iVar8 = ((uintptr_t)&g_net_own_addr_info) /*=0x21000f20*/;
    cVar6 = *(char *)(((uintptr_t)&g_net_own_addr_info) /*=0x21000f20*/ + 0x12);
    ...
    *(undefined1 *)(iVar8 + 4) = 0;
    if (param_1[0x79] == '\0') {
      if (((byte)param_1[0xd] != 0) && ((ushort)(byte)param_1[0xd] <= *(ushort *)(param_1 + 0x40)))
      {
        ...
        param_1[0xb3] = cVar6;
        FUN_0100ef88(param_1 + 0xa6,((uintptr_t)&rodata_1011add) /*=0x1011add*/,2,param_4);
        return;
      }
