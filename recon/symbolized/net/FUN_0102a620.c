...
unsigned int FUN_0102a620(void)
{
  ...
  if (*piVar1 == -0x10) {
    ...
    volatile unsigned int *puVar2 = (volatile unsigned int*)((unsigned long)&g_net_fault_canary_flag) /*=0x20070000*/;
    if (iVar3 == -0x10) return 1;
    *piVar1 = iVar3;
    *puVar2 = 0xa5a5a5a5;
    if (*(volatile int*)((unsigned long)&g_zephyr_log_level) /*=0x21000580*/ > 1) {
      FUN_01039722(((unsigned long)&rodata_103cd20) /*=0x103cd20*/, *piVar1);
    }
  }
  return 0;
}
