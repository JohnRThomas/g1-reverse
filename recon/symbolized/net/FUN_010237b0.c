...
/* readable reconstruction; identity: FUN_010237b0 @ 0x010237b0
 * public-name: FUN_010237b0
...
int FUN_010237b0(unsigned int param_1)
{
    ...
    iVar12 = 0;
    iVar4 = ((unsigned long)&g_libc_tz_calc_state) /*=0x210016f0*/;
    iVar14 = 1;
    iVar15 = ((unsigned long)&g_libc_tz_calc_state) /*=0x210016f0*/ + 0x50;
