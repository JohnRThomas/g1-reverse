...
{
  volatile unsigned char * const pbVar3 = (volatile unsigned char *)((uintptr_t)&g_net_clk_conv_cache_key) /*=0x2100003c*/;
  ...
  volatile unsigned char * const p178c = (volatile unsigned char *)((uintptr_t)&g_net_clk_conv_cache_ext) /*=0x21000040*/;
