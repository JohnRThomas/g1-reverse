...
typedef struct { signed char b0; unsigned char b1; unsigned char b2; unsigned char b3; unsigned int w2; } callblk_t;
...
void FUN_010208f0(unsigned char param_1, int param_2, unsigned int param_3_raw)
{
    ...
    volatile unsigned char * const iVar1 = (volatile unsigned char *)((uintptr_t)&g_nrf802154_core_state) /*=0x210015f0*/; /* DAT_010209a8 */
    iVar1[7] = param_1;
    iVar1[10] = param_3;
    unsigned int uVar3;
    int local20;
    ...
    if (param_2 == 0) {
        ...
        if (iVar1[9] == 2) {
            signed char blk24;
            FUN_010216d4((unsigned int)param_3, iVar1[0x1a], (int)(signed char)iVar1[0x19], &blk24);
            FUN_010215a8((int)blk24);
            unsigned char blk23;
            int iVar2 = FUN_010218fc(&blk23);
            if (iVar2 != 0) {
...
lab_948:
        uVar3 = iVar1[0x18];
        if (iVar1[9] == 2) {
            volatile unsigned int * const p9ac = (volatile unsigned int *)"f_timer.h" /*=0x103c4d0*/; /* DAT_010209ac */
            ...
            local20 = (int)u16v - (int)(unsigned int)((dat9b0 * (unsigned long long)(unsigned int)base) >> 0x26);
            goto lab_926;
        }
    }
    {
        volatile unsigned short * const p9ac2 = (volatile unsigned short *)"f_timer.h" /*=0x103c4d0*/; /* DAT_010209ac halfword view */
        ...
        local20 = (int)u16v + (int)(unsigned int)((dat9b0 * (unsigned long long)base) >> 0x26);
    }
lab_926:
    ;
    callblk_t blk;
