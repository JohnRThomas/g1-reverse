...
/* readable reconstruction; identity: FUN_01033cd0 @ 0x01033cd0
 * public-name: FUN_01033cd0
...
void FUN_01033cd0(void)
{
    ...
    a[0x118u / 4u] = 0u;
    (void)a[0x118u / 4u];
    chB = *(volatile unsigned char *)((unsigned long)&g_net_radio_trx_ppi_ch_e) /*=0x2100645e*/;
    v = chB | 0x80000000u;
    *(volatile unsigned int *)(0x41019000u + 0x1c4u) = v;
    *(volatile unsigned int *)(0x41008000u + 0x80u) = v;
    chC = *(volatile unsigned char *)((unsigned long)&g_esb_ppi_ch_id_3) /*=0x2100645d*/;
