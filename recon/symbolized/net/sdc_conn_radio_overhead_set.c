...
/* readable reconstruction; identity: FUN_0100f48c @ 0x0100f48c
 * public-name: sdc_conn_radio_overhead_set
...
void sdc_conn_radio_overhead_set(void *connection, uint32_t fixed_overhead)
{
    ...
    if (*(volatile uint8_t *)((unsigned long)&g_21000ef2) /*=0x21000ef2*/ != 0u) {
