...
void FUN_0102ea40(unsigned int param_1, unsigned int *param_2)
{
    if (param_2 != 0) {
        ...
        blk.a1 = "mall)" /*=0x103d82a*/; /* DAT_0102eaf8 */
        blk.a0 = 5;
        {
            struct { unsigned int a0,a1,a2,a3,a4; } b2 = { blk.a0, blk.a1, blk.a3, blk.a4, t };
            FUN_0102e284(((uintptr_t)&rodata_103c0c4) /*=0x103c0c4*/ /* DAT_0102eafc */, 0x2840, &b2, 0);
        }
        blk.a3 = param_2[3];
        blk.a4 = param_2[4];
        t = param_2[5];
        blk.a1 = "l)" /*=0x103d859*/; /* DAT_0102eb00 */
        blk.a0 = 5;
        {
            struct { unsigned int a0,a1,a2,a3,a4; } b2 = { blk.a0, blk.a1, blk.a3, blk.a4, t };
            FUN_0102e284(((uintptr_t)&rodata_103c0c4) /*=0x103c0c4*/, 0x2840, &b2, 0);
        }
        t = param_2[7];
        blk.a4 = "ck\n" /*=0x103d888*/; /* DAT_0102eb04 */
        blk.a3 = 3;
        {
            struct { unsigned int a3,a4,tt; } b3 = { blk.a3, blk.a4, t };
            FUN_0102e284(((uintptr_t)&rodata_103c0c4) /*=0x103c0c4*/, 0x1840, &b3, 0);
        }
        t = param_2[6];
        blk.a3 = 3;
        blk.a4 = "a not supported" /*=0x103d897*/; /* DAT_0102eb08 */
        {
            struct { unsigned int a3,a4,tt; } b3 = { blk.a3, blk.a4, t };
            FUN_0102e284(((uintptr_t)&rodata_103c0c4) /*=0x103c0c4*/, 0x1840, &b3, 0);
        }
