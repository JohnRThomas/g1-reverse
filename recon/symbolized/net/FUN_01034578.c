    ...
    if ((int)((unsigned int)uVar1 << 0x17) < 0) {
        ...
        *(volatile unsigned int*)((char*)base + uVar5 * 8) = 0;
        ...
        if (iVar4 != (int)0x0bad0000) {
            FUN_01039bbe(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103e66f) /*=0x103e66f*/, 0x15f);
            FUN_01039bb0(((unsigned long)&rodata_103e66f) /*=0x103e66f*/, 0x15f);
        }
    }
}
