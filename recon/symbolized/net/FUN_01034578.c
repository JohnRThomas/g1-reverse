...
void FUN_01034578(void)
{
    ...
    volatile unsigned short *base = (volatile unsigned short*)((unsigned long)&g_sdc_res_pool_slot_tbl) /*=0x210006a8*/;
    ...
    if ((int)((unsigned int)uVar1 << 0x17) < 0) {
        ...
        unsigned int uVar2 = ((unsigned long)&g_net_conn_teardown_ctx_b) /*=0x2100071c*/;
        unsigned int pidx = 8;
        int i;
        for (i = 0; i < 0x30; i++) {
        ...
        *(volatile unsigned int*)((char*)base + uVar5 * 8) = 0;
        ...
        if (iVar4 != (int)0x0bad0000) {
            assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103e66f) /*=0x103e66f*/, 0x15f);
            assert_post_action(((unsigned long)&rodata_103e66f) /*=0x103e66f*/, 0x15f);
        }
    }
}
