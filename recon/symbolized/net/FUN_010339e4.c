...
{
  unsigned int r1v = *(volatile unsigned char *)((uintptr_t)&g_net_radio_busy_flag) /*=0x21006458*/;
  if (r1v == 0) {
    if (param_1 == 0) {
      return 0xffffffea;
    } else {
      unsigned int uVar3 = *param_1;
      *(volatile unsigned int *)((uintptr_t)&g_net_radio_crc_scratch) /*=0x21000684*/ = uVar3;
      unsigned long long rv = FUN_0103a80c((unsigned int *)((uintptr_t)&g_net_radio_crc_scratch) /*=0x21000684*/);
