...
#define C_01037e9c ((uintptr_t)&g_zephyr_sched_spinlock) /*=0x21004b68*/
#define C_01037ea0 "***** HARD FAULT *****" /*=0x103d3b6*/
#define C_01037ea4 "acking error (context area might be not valid)" /*=0x103d2a7*/
