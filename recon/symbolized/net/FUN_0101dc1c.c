...
void FUN_0101dc1c(void) {
  *(volatile unsigned int *)(0x21000354 + 0x58) = ((unsigned long)&rodata_102a0f1) /*=0x102a0f1*/;
  *(volatile unsigned int *)(0x21000354 + 0x5c) = 0x0102a25f;
  *(volatile unsigned int *)(0x21000400 + 0x58) = 0x01029ef9;
  *(volatile unsigned int *)(0x21000400 + 0x60) = ((unsigned long)&rodata_101ca79) /*=0x101ca79*/;
}
