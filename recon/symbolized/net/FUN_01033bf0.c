...
{
    volatile unsigned char *s54 = (volatile unsigned char*)((unsigned long)&g_esb_ppi_ch_id_1) /*=0x2100645b*/;
    volatile unsigned char *s58 = (volatile unsigned char*)((unsigned long)&g_154_dppi_channel_ack) /*=0x2100645c*/;
    volatile unsigned char *s68 = (volatile unsigned char*)((unsigned long)&g_net_radio_trx_ppi_ch_a) /*=0x2100645a*/;
    volatile unsigned char *f000 = (volatile unsigned char*)0x4100f000;
    volatile unsigned char *b8080 = (volatile unsigned char*)REG_41008080 /*=0x41008080*/;
    volatile unsigned char *b4000 = (volatile unsigned char*)0x41014000;
    volatile unsigned char *f080 = (volatile unsigned char*)0x4100f080;
    volatile unsigned char *b9000 = (volatile unsigned char*)0x41019000;
    ...
    *(volatile unsigned int*)(b4000 + 0x98) = 0;
    ...
    volatile unsigned int *fptr = (volatile unsigned int*)(0x4100f800 + v68 * 4);
    *fptr = *fptr & ~mask;
