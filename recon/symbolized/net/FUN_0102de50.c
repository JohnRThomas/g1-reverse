...
void FUN_0102de50(void)
{
    ...
    while (1) {
        if (piVar1 < piVar3) {
            assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103d5d7) /*=0x103d5d7*/, 0x1d1);
            assert_post_action(((unsigned long)&rodata_103d5d7) /*=0x103d5d7*/, 0x1d1);
        }
