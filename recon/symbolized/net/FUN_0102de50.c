...
void FUN_0102de50(void)
{
    ...
    int *piVar1 = (int *)((uintptr_t)&rodata_103c0fc) /*=0x103c0fc*/;
    int *piVar3 = (int *)((uintptr_t)&rodata_103c0ec) /*=0x103c0ec*/;
    while (1) {
        if (piVar1 < piVar3) {
            FUN_01039bbe("acking error (context area might be not valid)" /*=0x103d2a7*/, " type: %u" /*=0x103d5d7*/, 0x1d1);
            FUN_01039bb0(" type: %u" /*=0x103d5d7*/, 0x1d1);
        }
