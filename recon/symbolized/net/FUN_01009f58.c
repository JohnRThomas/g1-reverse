...
extern void *FUN_01027790(void *entry);
...
#define POOL_STATE_SLOT ((volatile uintptr_t *)((unsigned long)&g_net_obj_table_root_ptr) /*=0x21000bb4*/)
                      ...
                      uint16_t first_b, uint16_t second_b)
{
    ...
    FUN_0102759e(FUN_01027790(entry), second, second_a, 9u, second_b);
