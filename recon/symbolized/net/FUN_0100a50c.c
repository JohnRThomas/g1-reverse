...
unsigned int FUN_0100a50c(int param_1, unsigned char param_2, unsigned char param_3)
{
    ...
    if (param_1 != 0) {
        ...
        *(volatile int *)((uintptr_t)&g_net_retry_handle) /*=0x21000bc4*/ = param_1;
        *(volatile unsigned char *)((uintptr_t)&g_net_retry_param2) /*=0x21000bc8*/ = param_2;
        *(volatile unsigned char *)((uintptr_t)&g_sdc_last_cfg_param3) /*=0x21000bc9*/ = param_3;
    }
