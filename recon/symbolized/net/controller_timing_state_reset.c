...
/* readable reconstruction; identity: FUN_0101e274 @ 0x0101e274
 * public-name: controller_timing_state_reset
...
void controller_timing_state_reset(void *owner_pointer)
{
