...
{
  volatile int * const p3d0 = (volatile int *)((uintptr_t)&g_net_radio_op_state) /*=0x210005b4*/;
  volatile unsigned char * const p3d4 = (volatile unsigned char *)((uintptr_t)&g_net_radio_temp_raw) /*=0x21004b9e*/;
  volatile unsigned char * const pE100 = (volatile unsigned char *)0xe000e100;
  volatile int * const p3e8 = (volatile int *)((uintptr_t)&g_zephyr_log_level) /*=0x21000580*/;
  ...
  iVar2 = FUN_010339e4(((uintptr_t)&g_net_radio_sched_param_c) /*=0x21000767*/);
  if (iVar2 == 0) {
    iVar2 = FUN_01033a20(((uintptr_t)&g_net_radio_sched_param_b) /*=0x21000763*/);
    if (iVar2 == 0) {
      iVar2 = FUN_01033a60(((uintptr_t)&g_net_radio_sched_param_a) /*=0x21000761*/, 2);
      if (iVar2 == 0) {
