...
#define DAT_010316d0 REG_41016000 /*=0x41016000*/
#define DAT_010316d4 ((uintptr_t)&g_rtc_overflow_cnt) /*=0x21004970*/
#define DAT_010316d8 ((uintptr_t)&g_rtc_cc_data) /*=0x21002b60*/
#define DAT_010316dc ((uintptr_t)&g_rtc_cc_pending_mask) /*=0x21004964*/
#define DAT_010316e0 REG_41016140 /*=0x41016140*/
