...
{
  unsigned int base = ((uintptr_t)&g_net_gpiote_evt_handler_table) /*=0x21004af8*/;
  ...
  if (*(char*)(unsigned long)(entryAddr + 8) == 0) {
    FUN_01039bbe("acking error (context area might be not valid)" /*=0x103d2a7*/, ((uintptr_t)&rodata_103e73b) /*=0x103e73b*/, 0xca);
    r0 = FUN_01039bb0(((uintptr_t)&rodata_103e73b) /*=0x103e73b*/, 0xca);
    r1 = 0xca;
  }
