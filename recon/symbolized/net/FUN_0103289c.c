...
/* readable reconstruction; identity: FUN_0103289c @ 0x0103289c
 * public-name: FUN_0103289c
...
{
    volatile uint32_t *const attempts = (volatile uint32_t *)((unsigned long)&g_esb_tx_busy_flag) /*=0x210049a8*/;
    volatile uint32_t *const pending = (volatile uint32_t *)((unsigned long)&g_210049b0) /*=0x210049b0*/;
    void (*volatile *const handler)(struct g1_esb_event *) =
        (void (*volatile *)(struct g1_esb_event *))((unsigned long)&g_21004a90) /*=0x21004a90*/;
