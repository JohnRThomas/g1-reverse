...
{
  volatile unsigned char *p1 = (volatile unsigned char *)((unsigned long)&g_net_radio_busy_flag) /*=0x21006458*/;
  unsigned char b = *p1;
  if (b != 0) {
    return 0xfffffff0;
  }
  if (param_1 < 0x65) {
    volatile unsigned char *p2 = (volatile unsigned char *)((unsigned long)&g_net_radio_crc_scratch) /*=0x21000684*/;
