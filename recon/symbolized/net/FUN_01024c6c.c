...
/* readable reconstruction; identity: FUN_01024c6c @ 0x01024c6c
 * public-name: FUN_01024c6c
...
{
    volatile uint8_t *const state = (volatile uint8_t *)((unsigned long)&g_net_radio_timer_sync_state) /*=0x21001bf8*/;
