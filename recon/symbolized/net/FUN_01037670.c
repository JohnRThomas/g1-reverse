...
bool z_set_prio(uint8_t *thread, int priority)
{
    ...
    if ((thread[0x0d] & 0x10u) == 0u &&
        *(uint32_t *)(thread + 0x18) == 0u) {
        uint8_t *sentinel = (uint8_t *)((unsigned long)&g_zephyr_sched_thread_field) /*=0x21004b40*/;
        uint8_t *head;
        uint8_t *tail;
        uint8_t *position;
        ...
        if (thread == (uint8_t *)0x210043a8u) {
            assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103eb0e) /*=0x103eb0e*/, 0xc1u);
            assert_post_action(((unsigned long)&rodata_103eb0e) /*=0x103eb0e*/, 0xc1u);
        }
