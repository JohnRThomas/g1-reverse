...
/* readable reconstruction; identity: FUN_010337ac @ 0x010337ac
 * public-name: FUN_010337ac
...
{
    volatile uint8_t *const enabled = (volatile uint8_t *)((unsigned long)&g_esb_enabled_flag) /*=0x21006459*/;
    volatile uint8_t *volatile *const entries =
        (volatile uint8_t *volatile *)((unsigned long)&g_net_queue_stats_block_b) /*=0x21004a34*/;
    volatile uint32_t *const read_index =
        (volatile uint32_t *)(((unsigned long)&g_net_queue_stats_block_b) /*=0x21004a34*/ + 0x24u);
    volatile int32_t *const pending =
        (volatile int32_t *)(((unsigned long)&g_net_queue_stats_block_b) /*=0x21004a34*/ + 0x28u);
    uint32_t basepri;
    uint32_t length;
    uint32_t next;
