...
void FUN_01032988(unsigned int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
  ...
  iVar1 = FUN_010218cc("cast it to void * because it may cause misbehavior in certain configurations. String:\"%s\" argument:%d" /*=0x103cafc*/, ((uintptr_t)&g_net_log_state) /*=0x2100065c*/, param_3, param_4, param_4);
  if (iVar1 == 0) {
    FUN_01033c74();
