...
void *z_heap_aligned_alloc(void *heap, size_t alignment, size_t size)
{
    ...
    *(void **)memory = heap;
    ...
    if (alignment != 0u &&
        ...
        assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103eba0) /*=0x103eba0*/, 0x25u);
        assert_post_action(((unsigned long)&rodata_103eba0) /*=0x103eba0*/, 0x25u);
    }
    return memory;
}
