...
/* readable reconstruction; identity: FUN_01018df8 @ 0x01018df8
 * public-name: FUN_01018df8
...
void FUN_01018df8(uint32_t call_context)
{
    ...
    *(volatile uint16_t *)(LLCP_STATE + 0xba) = 0u;
    LLCP_STATE[0x70] = 1u;
    RADIO_PENDING[2] = 0u;
    sdc_event_publish(call_context, 1u, ((unsigned long)&g_net_radio_pending_proc_flag) /*=0x2100104a*/, 0u);
}
