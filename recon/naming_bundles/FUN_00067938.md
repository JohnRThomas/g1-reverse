### FUN_00067938  @ 0x00067938  (size=974)

callers (0): (none / root or address-taken)
callees (4): assert_post_action, printk, xfer_completeness_check, __nrfy_internal_twim_events_process
strings: "WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c" | "(0 || (((p_instance->drv_inst_idx) == NRFX_TWIM1_INST_IDX) && (((p_xfer_desc->pr" | "!((p_cb->handler == ((void *)0)) && (p_xfer_desc->type == NRFX_TWIM_XFER_TXRX))" | "!((p_cb->handler == ((void *)0)) && (p_xfer_desc->type == NRFX_TWIM_XFER_TXTX))" | "!(flags & (1UL << 4))" | "!(flags & (1UL << 3))" | "!(flags & (1UL << 2))"
