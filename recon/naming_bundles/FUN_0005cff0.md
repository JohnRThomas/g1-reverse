### FUN_0005cff0  @ 0x0005cff0  (size=536)

callers (0): (none / root or address-taken)
callees (14): bt_rand, bt_pub_key_is_debug, FUN_0005caa4, FUN_0005cac0, bt_smp_send_pdu, smp_dhkey_generate, bt_smp_send_pairing_confirm, bt_keys_get_addr, net_buf_simple_add, atomic_test_bit, FUN_00083074, atomic_set_bit, smp_create_pdu, memcmp
strings: "size" | "Unknown pairing method (%u)" | "Remote public key rejected" | "Remote is using Debug Public key"
