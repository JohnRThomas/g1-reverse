### FUN_000755f8  @ 0x000755f8  (size=376)

callers (1): hci_tx_thread
callees (8): z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, FUN_00073f6c, register_events, clear_event_registrations, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "!arch_is_in_isr()" | "WEST_TOPDIR/zephyr/kernel/poll.c" | "events != ((void *)0)" | "num_events >= 0" | "mrs %0, ipsr"
