### FUN_00057b60  @ 0x00057b60  (size=326)

callers (1): bt_l2cap_recv
callees (7): FUN_0005774c, l2cap_chan_le_recv_seg, FUN_000816a2, FUN_00081746, gatt_send_service_changed_ind, net_buf_simple_pull_le16, net_buf_simple_tailroom
strings: "err %d" | "PDU size > MPS (%u > %u)" | "Too short data packet" | "Invalid SDU length" | "Unable to allocate buffer for SDU" | "No credits to receive packet"
