### FUN_000710b4  @ 0x000710b4  (size=200)

callers (1): FUN_00071294
callees (8): assert_post_action, printk, metal_io_block_write, virtqueue_add_buffer, virtqueue_get_buffer_length, FUN_000857e0, FUN_000859b2, mutex_lock_wait_forever_dup
strings: "WEST_TOPDIR/modules/lib/open-amp/open-amp/lib/rpmsg/rpmsg_virtio.c" | "status == sizeof(rp_hdr)" | "status == 0"
