### FUN_00073f6c  @ 0x00073f6c  (size=198)

callers (9): FUN_000719f4, k_mem_slab_alloc, k_msgq_put, k_msgq_get, k_mutex_lock, FUN_000727ac, z_impl_k_sem_take, z_sched_wait, FUN_000755f8
callees (7): FUN_000501d4, z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, pend_locked, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "WEST_TOPDIR/zephyr/kernel/sched.c" | "sizeof(sched_spinlock) == 0 || lock != &sched_spinlock"
