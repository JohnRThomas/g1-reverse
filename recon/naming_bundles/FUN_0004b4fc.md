### FUN_0004b4fc  @ 0x0004b4fc  (size=858)

callers (2): FUN_0004b908, FUN_0004ba38
callees (7): z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, process_recheck, notify_one, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/lib/os/onoff.c" | "state == 0U" | "!sys_slist_is_empty(&mgr->clients)" | "transit != ((void *)0)" | "state == (1UL << (1))" | "mgr->refs == 0" | "state == (1UL << (0))" | "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "/Users/freedomcoder/ncs251/modules/hal/cmsis/CMSIS/Core/Include/cmsis_gcc.h"
