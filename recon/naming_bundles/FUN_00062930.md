### FUN_00062930  @ 0x00062930  (size=222)

callers (0): (none / root or address-taken)
callees (3): FUN_0004d944, i2c_read_reg16_be, z_device_is_ready
strings: "Bus device is not ready" | "Bad manufacturer id 0x%x" | "Bad device id 0x%x" | "Failed to set mode to continuous conversion"
