### FUN_00074bf4  @ 0x00074bf4  (size=334)

callers (8): k_work_schedule_at_ticks, bt_smp_send_pdu, FUN_00071eac, FUN_00071f38, FUN_00073788, pend_locked, FUN_000746fc, z_impl_k_timer_start
callees (8): sys_clock_set_timeout, z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, rtc_get_elapsed_cycles_since_baseline, next_timeout, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "WEST_TOPDIR/zephyr/kernel/timeout.c" | "!sys_dnode_is_linked(&to->node)" | "/Users/freedomcoder/ncs251/modules/hal/cmsis/CMSIS/Core/Include/cmsis_gcc.h"
