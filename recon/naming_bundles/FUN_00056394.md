### FUN_00056394  @ 0x00056394  (size=286)

callers (1): bt_hci_core_recv_event
callees (7): tx_notify, bt_l2cap_recv, net_buf_unref, FUN_000813ca, bt_conn_reset_rx_state, net_buf_simple_tailroom, FUN_00083740
strings: "Unexpected first L2CAP frame" | "Unexpected L2CAP continuation" | "Not enough buffer space for L2CAP data" | "Unexpected ACL flags (0x%02x)" | "ACL len mismatch (%u > %u)"
