### FUN_0004abc0  @ 0x0004abc0  (size=1058)

callers (1): FUN_0004d944
callees (6): strlen, FUN_0004d944, is_ptr, assert_post_action, printk, memcpy
strings: "WEST_TOPDIR/zephyr/lib/os/cbprintf_packaged.c" | "in_packaged != ((void *)0)" | "(unsigned) char * used for %%p argument. It's recommended to cast it to void * b" | "scpy_cnt < sizeof(cpy_str_pos)" | "keep_cnt < sizeof(keep_str_pos)"

```c
/* readable reconstruction; identity: FUN_0004abc0 @ 0x0004abc0
 * public-name: FUN_0004abc0
                 ...
                 uint param_4,uint param_5,int param_6,uint param_7)
{
  ...
  local_54 = param_3;
  if (param_1 == (byte *)0x0) {
    printk(0x99cbd,0xf0584,0xf04ef,0x394);
    assert_post_action(0xf04ef,0x394);
  }
  bVar1 = v1[2];
  uVar14 = (uint)bVar1;
...
LAB_0004adbe:
  while(1) {
    do {
      ...
      if ((0x879b0 <= *(uint *)(param_1 + (uint)bVar2 * 4)) &&
         (*(uint *)(param_1 + (uint)bVar2 * 4) < 0xf8d64)) goto LAB_0004aede;
    ...
    if (local_78 != 0) {
      ...
      printk(0x99cbd,0xf0642,0xf04ef,0x448);
      assert_post_action(0xf04ef,0x448);
    }
    if (0xf < uVar11) break;
    uVar7 = uVar11 + 1;
  ...
  printk(0x99cbd,0xf0661,0xf04ef,1099);
  assert_post_action(0xf04ef,1099);
LAB_0004aede:
  if ((local_68 == 0) || (uVar17 = is_ptr(local_5c,bVar8), ((int)uVar17) == 0)) {
    if ((int)(param_5 << 0x1f) < 0) {
      if (0xf < uVar10) {
        printk(0x99cbd,0xf0642,0xf04ef,0x43e);
        assert_post_action(0xf04ef,0x43e);
      }
LAB_0004af48:
      ...
      if (0xf < uVar11) {
        printk(0x99cbd,0xf0661,0xf04ef,0x441);
        assert_post_action(0xf04ef,0x441);
      }
