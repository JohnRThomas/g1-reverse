### FUN_0004b908  @ 0x0004b908  (size=262)

callers (2): FUN_0005fb8c, FUN_00060788
callees (8): FUN_0004b4fc, z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, validate_args, notify_one, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/lib/os/onoff.c" | "state == (1UL << (0))" | "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "/Users/freedomcoder/ncs251/modules/hal/cmsis/CMSIS/Core/Include/cmsis_gcc.h"
