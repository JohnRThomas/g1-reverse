### FUN_0005ec84  @ 0x0005ec84  (size=70)

callers (4): bt_crypto_f5, FUN_0005edac, bt_crypto_f4, bt_crypto_f6
callees (2): assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/include/zephyr/sys/byteorder.h" | "((psrc < pdst && (psrc + length) <= pdst) || (psrc > pdst && (pdst + length) <= "
