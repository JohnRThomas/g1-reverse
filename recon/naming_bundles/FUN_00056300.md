### FUN_00056300  @ 0x00056300  (size=128)

callers (2): FUN_000565c4, FUN_000571e8
callees (7): net_buf_destroy, net_buf_unref, k_work_reschedule, assert_post_action, printk, bt_conn_reset_rx_state, net_buf_get
strings: "WEST_TOPDIR/zephyr/subsys/bluetooth/host/conn.c" | "sys_slist_is_empty(&conn->tx_pending)" | "conn->pending_no_cb == 0"
