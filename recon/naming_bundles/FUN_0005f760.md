### FUN_0005f760  @ 0x0005f760  (size=488)

callers (1): adc_nfc_run
callees (6): __aeabi_uldivmod, FUN_0004d944, adc_context_start_sampling, k_sem_give, z_impl_k_sem_take, z_impl_k_timer_start
strings: "size" | "Invalid selection of channels" | "Channel %u not configured" | "ADC resolution value %d is not valid" | "Oversampling is supported for single channel only" | "Oversampling value %d is not valid" | "Provided buffer is too small (%u/%u)"
