### FUN_00052d58  @ 0x00052d58  (size=258)

callers (0): (none / root or address-taken)
callees (3): FUN_0004d944, settings_name_next, strncmp
strings: "Insufficient number of arguments" | "Ignoring identities stored in flash" | "Invalid length ID address in storage" | "Failed to read device name from storage (err %zd)" | "name" | "packed word layout"
