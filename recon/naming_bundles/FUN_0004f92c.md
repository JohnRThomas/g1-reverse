### FUN_0004f92c  @ 0x0004f92c  (size=182)

callers (0): (none / root or address-taken)
callees (3): FUN_0004d944, assert_post_action, printk
strings: "WEST_TOPDIR/nrf/subsys/caf/events/power_manager_event.c" | "event->module_idx < module_count()" | "lvl <= POWER_MANAGER_LEVEL_MAX" | "lvl >= POWER_MANAGER_LEVEL_ALIVE" | "e:%s module "%s" restricts to %s"
