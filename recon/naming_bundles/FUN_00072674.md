### FUN_00072674  @ 0x00072674  (size=286)

callers (2): net_pkt_skip, k_queue_prepend
callees (10): z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, z_ready_thread_locked, z_reschedule, z_unpend_first_thread, FUN_00075944, assert_post_action, printk, z_handle_obj_poll_events
strings: "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "/Users/freedomcoder/ncs251/modules/hal/cmsis/CMSIS/Core/Include/cmsis_gcc.h"
