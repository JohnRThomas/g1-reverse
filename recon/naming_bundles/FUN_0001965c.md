### FUN_0001965c  @ 0x0001965c  (size=166)

callers (1): FUN_00019718
callees (11): dequeue_ancs, debug_print, ble_process_req_dispatch, send_data_in_ble_chunks, is_on_whitelist_by_identifier, log_notification_fields_debug, format_log_timestamp_mmdd_hhmm, get_timestamp, log_message, memset_bytes, strncpy_zero_pad
strings: "FROM:ancs" | "com.apple.mobilephone_missed" | "ANCS record layout" | "command record layout"
