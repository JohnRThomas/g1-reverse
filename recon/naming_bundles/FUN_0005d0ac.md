### FUN_0005d0ac  @ 0x0005d0ac  (size=394)

callers (1): FUN_0008349c
callees (9): bt_smp_send_pdu, bt_crypto_f5, net_buf_simple_add, FUN_00083074, atomic_set_bit, smp_create_pdu, bt_crypto_f6, memcmp, memset_bytes
strings: "Unknown pairing method (%u)" | "Calculate LTK failed" | "Calculate local DHKey check failed" | "Calculate remote DHKey check failed"

```c
/* readable reconstruction; identity: FUN_0005d0ac @ 0x0005d0ac
 * public-name: FUN_0005d0ac
