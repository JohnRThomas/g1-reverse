### FUN_0005774c  @ 0x0005774c  (size=270)

callers (2): l2cap_chan_le_recv_seg, FUN_00057b60
callees (10): FUN_00057394, FUN_000573f4, net_buf_unref, net_buf_simple_add, assert_post_action, printk, FUN_000816a2, FUN_00081746, att_send_simple, net_buf_get
strings: "WEST_TOPDIR/zephyr/subsys/bluetooth/host/l2cap.c" | "bt_l2cap_chan_get_state(&chan->chan) == BT_L2CAP_CONNECTED" | "Unable to send credits update" | "atomic_get(&chan->rx.credits) == 0"
