### FUN_000719f4  @ 0x000719f4  (size=276)

callers (1): FUN_00075944
callees (9): FUN_0004b2b0, z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, FUN_00073f6c, assert_post_action, printk, sys_timepoint_calc, sys_timepoint_timeout
strings: "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "WEST_TOPDIR/zephyr/kernel/kheap.c" | "!arch_is_in_isr() || ((timeout).ticks == (((k_timeout_t) {0})).ticks)" | "mrs %0, basepri" | "(r));return r;}
static inline void spm(unsigned v){__asm volatile(" | "(v):" | ");}
static inline void sp(unsigned v){__asm volatile(" | ");}
static inline void ib(void){__asm volatile(" | ":::" | ");}
static inline unsigned gi(void){unsigned r;__asm volatile("
