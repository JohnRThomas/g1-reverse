### FUN_0004b214  @ 0x0004b214  (size=130)

callers (1): virtqueue_free
callees (7): chunk_field, chunk_size, set_chunk_used, mem_to_chunkid, free_chunk, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/lib/os/heap.c" | "chunk_used(h, c)" | "left_chunk(h, right_chunk(h, c)) == c"
