### FUN_00074a54  @ 0x00074a54  (size=158)

callers (1): notify_queue_locked
callees (8): z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, sched_ready_queue_insert, z_abort_thread_timeout, FUN_00074d74, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "mrs %0, basepri" | "(sb));
  __asm volatile(" | " :: " | "((uint32_t)0x20));
  __asm volatile(" | ");
