### FUN_0004cbec  @ 0x0004cbec  (size=86)

callers (1): serialization_init
callees (1): FUN_0007e9ea
strings: "Invalid backend configuration" | "Invalid instance, endpoint or configuration"
...
uint32_t FUN_0004cbec(int param_1, int *param_2, int param_3){
  uint32_t local[2];
