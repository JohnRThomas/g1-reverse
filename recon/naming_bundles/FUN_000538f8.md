### FUN_000538f8  @ 0x000538f8  (size=280)

callers (1): hci_tx_thread
callees (7): net_buf_pool_get, net_buf_id, net_buf_unref, k_sem_give, atomic_or, FUN_00080ea2, atomic_and_3
strings: "opcode 0x%04x pool id %u pool %p != &hci_cmd_pool %p" | "OpCode 0x%04x completed instead of expected 0x%04x"
