### FUN_0004d6ec  @ 0x0004d6ec  (size=194)

callers (0): (none / root or address-taken)
callees (8): activate_foreach_backend, FUN_0004d334, log_process, k_sem_give, z_impl_k_sem_take, k_current_get, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/subsys/logging/log_core.c" | "backend <= _log_backend_list_end" | "log_backend_count_get() > 0"
...
void FUN_0004d6ec(void)
{
    ...
    if ((end - begin) / 16u == 0) {
        printk(0x00099cbdu, 0x000f0d3fu, 0x000f0caeu, 0x35cu);
