### FUN_000746fc  @ 0x000746fc  (size=270)

callers (1): FUN_00074844
callees (10): FUN_000501d4, z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, unready_thread, mutex_unlock_syscall_handler, FUN_00074bf4, assert_post_action, printk, get_uptime_ms
strings: "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "!arch_is_in_isr()" | "WEST_TOPDIR/zephyr/kernel/sched.c" | "!z_is_thread_state_set(_kernel.cpus[0].current, ((1UL << (4))))" | "/Users/freedomcoder/ncs251/modules/hal/cmsis/CMSIS/Core/Include/cmsis_gcc.h"
