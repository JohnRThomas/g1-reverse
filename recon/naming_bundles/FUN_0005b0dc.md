### FUN_0005b0dc  @ 0x0005b0dc  (size=380)

callers (3): FUN_0004f518, gatt_indicate, gatt_notify
callees (5): bt_gatt_attr_next, assert_post_action, printk, bt_uuid_cmp, bt_conn_is_peer_addr_le
strings: "conn" | "WEST_TOPDIR/zephyr/subsys/bluetooth/host/gatt.c" | "attr"

```c
/* readable reconstruction; identity: FUN_0005b0dc @ 0x0005b0dc
 * public-name: FUN_0005b0dc
