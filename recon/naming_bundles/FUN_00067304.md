### FUN_00067304  @ 0x00067304  (size=498)

callers (1): spi_master_trans_data_tx_rx
callees (6): assert_post_action, printk, __nrfy_internal_spim_events_process, spim_abort, FUN_000852e6, nrf_gpio_pin_set
strings: "WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_spim.c" | "p_cb->state != NRFX_DRV_STATE_UNINITIALIZED" | "p_xfer_desc->p_tx_buffer != ((void *)0) || p_xfer_desc->tx_length == 0" | "p_xfer_desc->p_rx_buffer != ((void *)0) || p_xfer_desc->rx_length == 0" | "((p_xfer_desc->rx_length < (1UL << (easydma_support_bits[p_instance->drv_inst_id" | "!(flags & (1UL << 3)) || (p_cb->ss_pin == 0xFFFFFFFF)"
