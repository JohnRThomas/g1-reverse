### FUN_00017688  @ 0x00017688  (size=180)

callers (1): button_init
callees (2): assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/include/zephyr/drivers/gpio.h" | "(flags & ((1 << 4) | (1 << 5))) != ((1 << 4) | (1 << 5))" | "!((flags & (1U << 16)) && !(flags & (1U << 17)) && (flags & (1 << 1)))" | "(flags & (1 << 1)) != 0 || (flags & (1 << 2)) == 0" | "(cfg->port_pin_mask & (gpio_port_pins_t)(1UL << (pin))) != 0U"
