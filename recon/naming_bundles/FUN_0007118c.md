### FUN_0007118c  @ 0x0007118c  (size=252)

callers (0): (none / root or address-taken)
callees (8): assert_post_action, printk, virtqueue_add_buffer, virtqueue_get_buffer, FUN_000857e0, rpmsg_get_endpoint, FUN_000859b2, mutex_lock_wait_forever_dup
strings: "WEST_TOPDIR/modules/lib/open-amp/open-amp/lib/rpmsg/rpmsg_virtio.c" | "status >= 0"
