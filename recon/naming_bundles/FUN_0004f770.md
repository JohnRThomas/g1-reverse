### FUN_0004f770  @ 0x0004f770  (size=182)

callers (3): main, power_manager_system_off, reset_state_and_stop_timer
callees (6): z_spin_lock_valid, z_spin_unlock_valid, z_spin_lock_set_owner, k_work_submit, assert_post_action, printk
strings: "WEST_TOPDIR/zephyr/include/zephyr/spinlock.h" | "z_spin_unlock_valid(l)" | "z_spin_lock_valid(l)" | "WEST_TOPDIR/nrf/subsys/app_event_manager/app_event_manager.c" | "(aeh->type_id >= _event_type_list_start) && (aeh->type_id < _event_type_list_end" | "/Users/freedomcoder/ncs251/modules/hal/cmsis/CMSIS/Core/Include/cmsis_gcc.h"
