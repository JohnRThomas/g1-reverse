### FUN_000440ec  @ 0x000440ec  (size=450)

callers (2): ui_even_ai_task, ui_teleprompter_task
callees (9): get_device_info, atomic_get_3_0, gui_canvas_flags_set_bit1, gui_canvas_flags_clear_bit1, gui_utf_draw, clean_fb_data, reflash_fb_data_to_lcd_ex, device_info_text_height_get_clamped, fb_blit_rows_halved
