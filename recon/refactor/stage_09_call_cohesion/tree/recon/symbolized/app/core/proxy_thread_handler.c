...
LAB_00047c6a:
    G1_LOG_ROUTE(iVar16 == 0, uVar9, uVar13);
LAB_00047c76:
    do {
        if ((*(char *)(param_1 + 1) != '\x01') && (*(char *)(param_1 + 1) != '\b')) {
            ...
            if (iVar16 == 0) {
                ...
                case 0:
                    if (2 < *piVar1) {
                        G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): store app response data to cache\n") /*=0xef0a1*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                    }
                ...
                case 1:
                    if (2 < *piVar1) {
                        G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): received send response data to app command\n") /*=0xef0c9*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                    }
                    ...
                    if (*(char *)((unsigned long)&g_2001d431) /*=0x2001d431*/ != '\0') {
                        ...
                        if ((iVar16 < 0) && (1 < *piVar1)) {
                            G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)&rodata_ef0fb) /*=0xef0fb*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                        }
                ...
                case 2:
                    if (2 < *piVar1) {
                        G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): running proxy thread,send audio stream data to app \n") /*=0xef16d*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                    }
                    ...
                    if (message.field.subtype == '\0') {
                        *(byte *)((unsigned long)&g_2001d34a) /*=0x2001d34a*/ = message.field.value - 1;
                        ...
                        if (iVar16 == 0) {
                            ...
                            if (2 < *piVar1) {
                                G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): read voice manager block data,start send voice data to app\n") /*=0xef1a8*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                            }
                            clear_bytes((void *)((unsigned long)&g_2001d34b) /*=0x2001d34b*/, 0, 0xe6);
                            iVar16 = get_device_info();
                            pcVar20 = *(int (***)())(iVar16 + 0x1030);
                            ...
                            if (iVar16 == 0) {
                                ...
                                *piVar5 = *piVar5 + 1;
                                ...
                                while (iVar15 = (*(int (**)())(param_1 + 0x788))(puVar22, puVar10[1]), iVar15 < 0) {
                                    if (1 < *piVar1) {
                                        G1_LOG_ROUTE(*piVar19 == 0, ((unsigned long)"%s(): retry send audio data first packet\n") /*=0xef1ea*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                    }
                                    iVar16 = iVar16 + -1;
                                    if (iVar16 == 0) {
                                    ...
                                    if (1 < *piVar1) {
                                        G1_LOG_ROUTE(*piVar19 == 0, ((unsigned long)&rodata_ef214) /*=0xef214*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                    }
                                }
...
LAB_00047e22:
                    ...
                    if (*(char *)((unsigned long)&g_2001d262) /*=0x2001d262*/ == '\0') {
                        if (2 < *piVar1) {
                            G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): error packet order,can't send any audio data to app\n") /*=0xef260*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                        }
LAB_00048082:
                    ...
                    if (*(int *)((unsigned long)&g_2000a078) /*=0x2000a078*/ < *(int *)((unsigned long)&g_2000a080) /*=0x2000a080*/) {
                        ...
                        *piVar5 = *piVar5 + 1;
                        ...
                        if (iVar12 != 0) {
                            if (0 < *piVar1) {
                                G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)&rodata_9ea0a) /*=0x9ea0a*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, 0x400000);
                            }
LAB_0004820e:
                            *pcVar11 = '\0';
                            goto LAB_00048082;
                        ...
                        while (iVar15 = (*(int (**)())(param_1 + 0x788))(puVar10, puVar10[1]), iVar15 < 0) {
                            if (1 < *piVar1) {
                                G1_LOG_ROUTE(*piVar19 == 0, ((unsigned long)"%s(): retry send audio data\n") /*=0xef2df*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                            }
                            iVar12 = iVar12 + -1;
                            if (iVar12 == 0) {
                                if (1 < *piVar1) {
                                    G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)&rodata_ef214) /*=0xef214*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                }
                                goto LAB_0004820e;
                            }
                            if (1 < *piVar1) {
                        ...
                        *piVar4 = *piVar4 + iVar16;
                        if (2 < *piVar1) {
                            G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): send %d byte data to app,total send data length = %d\n") /*=0xef2fc*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, iVar16, *piVar4);
                        }
LAB_00048054:
                ...
                case 3:
                    if (2 < *piVar1) {
                        G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): running proxy thread,send audio infomation data to app \n") /*=0xef338*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                    }
                    piVar19 = (int *)((unsigned long)&rodata_87bf0) /*=0x87bf0*/;
                    iVar16 = device_is_ready((void *)((unsigned long)&rodata_87bf0) /*=0x87bf0*/);
                    if (iVar16 == 0) {
...
LAB_000480f4:
                ...
                case 4:
                    ...
                    *(uint16_t *)transfer_packet.bytes =
                    ...
                    do {
                        ...
                        if (iVar12 < 5000) {
                            if (2 < *piVar1) {
                                G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): SEND power event to slave success.\n") /*=0xef40d*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                            }
                        ...
                        if (1 < *piVar1) {
                            G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): SYNC TO Slave failed % times,don't exec quick note start function.\n") /*=0xa125e*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, iVar16);
                        }
                        iVar16 = iVar16 + 1;
                    } while (iVar16 != 4);
                    goto LAB_00047c76;
                case 5:
                    ...
                    *(uint16_t *)transfer_packet.bytes =
                    ...
                    do {
                        ...
                        if (iVar12 < 5000) {
                            if (2 < *piVar1) {
                                G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): Send app language upgrade msg to setting proxy task\n") /*=0xef437*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                            }
                ...
                case 6:
                    ...
                    do {
                        ...
                        if (iVar12 < 5000) {
                            if (2 < *piVar1) {
                                G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): Send Dashboard startup  mode  msg to setting proxy task\n") /*=0xef472*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                            }
                            transfer_packet.word.low =
                    ...
                    if (((iVar16 == 1) && (iVar16 = get_device_info(), *(char *)(iVar16 + 0xd5) == '\0')) &&
                        ...
                        *(uint16_t *)transfer_packet.bytes = 0x10a;
                        ...
                        do {
                            ...
                            if (iVar12 < 5000) {
                                if (2 < *piVar1) {
                                    G1_LOG_ROUTE(*(int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): SEND DELAY CLOSE TO SLAVE SUCCESS,master start delay close function\n") /*=0xa116d*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/);
                                }
                                *(int *)((unsigned long)&g_20007b38) /*=0x20007b38*/ = *(int *)((unsigned long)&g_20007b38) /*=0x20007b38*/ | 2;
                                break;
                            }
                            if (1 < *piVar1) {
                                G1_LOG_ROUTE(*piVar19 == 0, ((unsigned long)"%s(): SYNC TO Slave failed % times,don't exec double click startup dashboard function.\n") /*=0xa1027*/, ((unsigned long)&rodata_ef76f) /*=0xef76f*/, iVar16);
                            }
                            iVar16 = iVar16 + 1;
                        } while (iVar16 != 4);
                    }
