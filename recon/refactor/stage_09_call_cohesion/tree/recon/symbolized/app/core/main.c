...
#define g_ambient_light_sensor_ready   (*(volatile int32_t *)((unsigned long)&g_ambient_light_sensor_ready) /*=0x200069f8*/)
#define device_info                    (*(volatile uintptr_t *)((unsigned long)&device_info) /*=0x200069fc*/)
#define g_runtime_mode_flag            (*(volatile uint8_t *)((unsigned long)&g_runtime_mode_flag) /*=0x2000ff6e*/)
...
void main(void)
{
    ...
    if (log_record != 0)
        W32(log_record, 4) = ((unsigned long)&rodata_fa9b4) /*=0xfa9b4*/;
    W32(log_record, 8) = ((unsigned long)&rodata_faa2c) /*=0xfaa2c*/;
    ...
    if (B8(context, 1) != 1) {
        ...
        if (B8(context, 0) == 1) {
            ...
            lsm6dso_init_chip(((unsigned long)&rodata_87d58) /*=0x87d58*/);
    ...
    if (g_log_level > 1) {
        ...
        if (g_log_use_alt_sink == 0) log_message(((unsigned long)"%s(): enter\n") /*=0x99969*/, ((unsigned long)"component_init") /*=0x99b3d*/);
        else debug_print(((unsigned long)"%s(): enter\n") /*=0x99969*/, ((unsigned long)"component_init") /*=0x99b3d*/);
    }
    ...
    if (z_device_is_ready(fuel_gauge)) {
        ...
        if (z_device_is_ready(fuel_config)) {
            failure_message = ((unsigned long)&rodata_99a3e) /*=0x99a3e*/;
            if (fuel_gauge_sample_init_timestamp(fuel_config) >= 0) {
                ...
                if (fuel_gauge_configure(fuel_config) >= 0) {
                    ...
                    dashboard_mode_publish(*(volatile uint8_t *)((unsigned long)&g_2007fc70) /*=0x2007fc70*/);
