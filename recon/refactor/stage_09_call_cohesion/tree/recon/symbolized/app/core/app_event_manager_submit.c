...
{
    if (item == 0) {
        G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)&rodata_f1754) /*=0xf1754*/, ((unsigned long)&rodata_f1681) /*=0xf1681*/, 0xd1u), (((unsigned long)&rodata_f1681) /*=0xf1681*/, 0xd1u));
    }
    if (item[1] < ((unsigned long)&rodata_fa9b4) /*=0xfa9b4*/ || item[1] >= ((unsigned long)&rodata_faa14) /*=0xfaa14*/) {
        G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"(aeh->type_id >= _event_type_list_start) && (aeh->type_id < _event_type_list_end)") /*=0xf16be*/, ((unsigned long)&rodata_f1681) /*=0xf1681*/, 0xd2u), (((unsigned long)&rodata_f1681) /*=0xf1681*/, 0xd2u));
    }
    ...
    if (z_spin_lock_valid(((unsigned long)&g_notify_pending_lock) /*=0x2000a2c4*/) == 0) {
        ...
        G1_ASSERT_FAIL((((unsigned long)"\tInvalid spinlock %p\n") /*=0xf0935*/, ((unsigned long)&g_notify_pending_lock) /*=0x2000a2c4*/), (((unsigned long)&rodata_f08c7) /*=0xf08c7*/, 0x72u));
    }
    ...
    *item = 0;
    ...
    if (z_spin_unlock_valid(((unsigned long)&g_notify_pending_lock) /*=0x2000a2c4*/) == 0) {
        ...
        G1_ASSERT_FAIL((((unsigned long)"\tNot my spinlock %p\n") /*=0xf090b*/, ((unsigned long)&g_notify_pending_lock) /*=0x2000a2c4*/), (((unsigned long)&rodata_f08c7) /*=0xf08c7*/, 0xf0u));
    }
