...
LAB_00027964:
            G1_LOG_ROUTE(iVar5 == 0, _event_id2,DAT_00027a7c);
          }
        }
      }
    }
...
LAB_00027844:
  ...
  if ((*DAT_00027ac8 == -1) || (iVar5 = get_device_info(), *(int *)(iVar5 + 0x9b4) == 2)) {
    ...
    if (0 < *piVar2) {
      G1_LOG_ROUTE(*DAT_00027a78 == 0, DAT_00027a94,DAT_00027a7c);
    }
    send_event(0x11);
    *pcVar6 = -2;
    return;
  ...
  if (param_1 == 0) {
    if (bVar1) {
      if (0 < iVar5) {
        G1_LOG_ROUTE(*DAT_00027a78 == 0, DAT_00027ab0,DAT_00027a7c);
      }
      event_id = 0x6;
    }
    else {
      if (0 < iVar5) {
        G1_LOG_ROUTE(*DAT_00027a78 == 0, DAT_00027ab4,DAT_00027a7c);
      }
      event_id = 0x7;
    }
    *DAT_00027ab8 = 0xff;
    ...
    *DAT_00027ac4 = 4;
    ...
    if (0 < iVar5) {
      G1_LOG_ROUTE(*DAT_00027a78 == 0, DAT_00027aac,DAT_00027a7c);
    }
    event_id = 0x8;
  }
  else {
    if (0 < iVar5) {
      G1_LOG_ROUTE(*DAT_00027a78 == 0, DAT_00027aa4,DAT_00027a7c);
    }
    event_id = 0xb;
  }
  pbVar7 = DAT_00027aa8;
  ...
  if ((*DAT_00027cc0 != bVar8) && (bVar8 < 0x65)) {
    *DAT_00027cc0 = bVar8;
    if (0 < *piVar2) {
      G1_LOG_ROUTE(*DAT_00027cc4 == 0, DAT_00027ccc,DAT_00027cc8);
    }
    _event_id2 = 0xa;
    goto LAB_00027af8;
  }
      ...
      *DAT_00027cdc = bVar8 + 1;
      if (4 < (byte)(bVar8 + 1)) {
        ...
        *pbVar7 = (byte)new_box_charging_status;
        if (0 < iVar5) {
          G1_LOG_ROUTE(*DAT_00027cc4 == 0, DAT_00027cf0,DAT_00027cc8,new_box_charging_status);
        }
        send_event(0xe);
      }
      if (*piVar2 < 1) {
