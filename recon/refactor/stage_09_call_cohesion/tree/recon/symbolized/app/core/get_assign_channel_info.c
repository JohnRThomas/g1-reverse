...
unsigned get_assign_channel_info(int param_1, unsigned param_2, unsigned *param_3, unsigned char *param_4)
{
    ...
    if(3 < *piVar1){
        G1_LOG_ROUTE(*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): join in get_assign_channel_info\n\n") /*=0xa723e*/, ((unsigned long)"get_assign_channel_info") /*=0xa76da*/);
    }
    if(param_3 == 0 || param_4 == 0){
        if(0 < *piVar1){
            G1_LOG_ROUTE(*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): get_assign_channel_info para is NULL\n\n") /*=0xa7266*/, ((unsigned long)"get_assign_channel_info") /*=0xa76da*/);
        }
        uVar3 = 0xffffffff;
