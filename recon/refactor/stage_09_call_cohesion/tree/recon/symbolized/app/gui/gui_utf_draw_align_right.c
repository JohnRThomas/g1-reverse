 ...
 *   rodata_aad4b                             @ 0x000aad4b   [INLINED -- G6 literal batch]
            ...
            if (measure_line) {
                ...
                while ((int32_t)scan_index < (int32_t)utf16_count &&
                    ...
                    if (classify_text_character(codepoint) == 0) {
                        ...
                        if (status < 0) {
                            if (*log_level > 1) {
                                G1_LOG_ROUTE(*use_alternate_log_sink == 0, ((unsigned long)&rodata_aaa58) /*=0xaaa58*/, ((unsigned long)"gui_utf_draw_align_right") /*=0xaad4b*/,
                                                codepoint, 0);
                            }
                        } else {
