        ...
        if (iVar3 == 0) {
          ...
          if (iVar3 < 0) {
            if (1 < *(volatile i32 *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
              G1_LOG_ROUTE(*(volatile i32 *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)&rodata_aaa58) /*=0xaaa58*/, ((unsigned long)"gui_utf_Wordwrap_draw") /*=0xaad35*/, uVar16);
            }
          } else {
...
LAB_00045458:
                    G1_LOG_ROUTE(iVar3 == 0, uVar13, ((unsigned long)"gui_utf_Wordwrap_draw") /*=0xaad35*/);
                  }
                } else {
                  if ((iVar3 != 0) &&
...
LAB_0004558c:
  if (1 < *(volatile i32 *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
    G1_LOG_ROUTE(*(volatile i32 *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): exex process effect callback function\n") /*=0xaaa7f*/, ((unsigned long)"gui_utf_Wordwrap_draw") /*=0xaad35*/);
  }
