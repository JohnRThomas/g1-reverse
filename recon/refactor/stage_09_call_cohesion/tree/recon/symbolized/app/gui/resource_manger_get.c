...
#define DAT_00045bb8 (((unsigned long)"%s(): read flash fail\n\n") /*=0xbbfee*/)
...
#define DAT_00046288 (((unsigned long)"%s(): can't find resource ,exit .....\n") /*=0xbc04c*/)
...
LAB_00045902:
  ...
  case 4:
    ...
    uVar7 = DAT_00046284;
LAB_00045912:
    G1_LOG_ROUTE(iVar8 == 0, uVar4,uVar7,(uintptr_t)param_3,iVar8);
    break;
  case 5:
    switch(param_2) {
    case 1:
