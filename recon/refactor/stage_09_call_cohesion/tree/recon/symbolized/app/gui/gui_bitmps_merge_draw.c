 ...
 *   rodata_aacc8                             @ 0x000aacc8   [INLINED -- refactor stage 01]
...
int gui_bitmps_merge_draw(unsigned int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
  ...
  if (iVar4 == 0) log_message(uVar9, ((unsigned long)"gui_bitmps_merge_draw") /*=0xaacc8*/); else debug_print(uVar9, ((unsigned long)"gui_bitmps_merge_draw") /*=0xaacc8*/);
  return -1;
}
