  ...
  case 1:
    ...
    for (iVar10 = 0; iVar3 != iVar10; iVar10 = iVar10 + 1) {
      ...
      if ((iVar5 == 0) && (local_50 != 0)) {
        ...
        G1_LOG_ROUTE(*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): The content cannot be found in the current font library,unicode content = %2d,font libray is %s\n") /*=0xaaad4*/,((unsigned long)"gui_clock_draw") /*=0xaad0b*/,(uint)*pbVar9,((unsigned long)"EVEN_DASHBOARD_CLOCK_32x_TTF") /*=0xaaab7*/);
      }
      pbVar9 = pbVar9 + 1;
    }
    goto LAB_000443e4;
