...
void module_state_event_log_handler(const work_event *event)
{
    ...
    if (event->operation >= 4) {
        G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"event->state < MODULE_STATE_COUNT") /*=0xf17a1*/, ((unsigned long)"WEST_TOPDIR/nrf/subsys/caf/events/module_state_event.c") /*=0xf176a*/, 0x1cu), (((unsigned long)"WEST_TOPDIR/nrf/subsys/caf/events/module_state_event.c") /*=0xf176a*/, 0x1cu));
    }
    ...
    if (operation_name == 0) {
        G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"state_name[event->state] != ((void *)0)") /*=0xf17c3*/, ((unsigned long)"WEST_TOPDIR/nrf/subsys/caf/events/module_state_event.c") /*=0xf176a*/, 0x1du), (((unsigned long)"WEST_TOPDIR/nrf/subsys/caf/events/module_state_event.c") /*=0xf176a*/, 0x1du));
    }
    if (event->value == 0) {
        G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)&rodata_9a1dd) /*=0x9a1dd*/, ((unsigned long)"WEST_TOPDIR/nrf/include/caf/events/module_state_event.h") /*=0xf17eb*/, 0x51u), (((unsigned long)"WEST_TOPDIR/nrf/include/caf/events/module_state_event.h") /*=0xf17eb*/, 0x51u));
    }
