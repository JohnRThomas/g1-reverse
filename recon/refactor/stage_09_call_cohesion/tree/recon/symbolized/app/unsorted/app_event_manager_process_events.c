...
void app_event_manager_process_events(void){
  ...
  if (z_spin_lock_valid(((unsigned long)&g_notify_pending_lock) /*=0x2000a2c4*/) == 0) {
    ...
    G1_ASSERT_FAIL((((unsigned long)"\tInvalid spinlock %p\n") /*=0xf0935*/,((unsigned long)&g_notify_pending_lock) /*=0x2000a2c4*/,0,0), (((unsigned long)&rodata_f08c7) /*=0xf08c7*/,0x72));
  }
L5ea:
  ...
  if (r4 == 0) {
    if (z_spin_unlock_valid(((unsigned long)&g_notify_pending_lock) /*=0x2000a2c4*/) == 0) {
      ...
      G1_ASSERT_FAIL((((unsigned long)"\tNot my spinlock %p\n") /*=0xf090b*/,((unsigned long)&g_notify_pending_lock) /*=0x2000a2c4*/,0,0), (((unsigned long)&rodata_f08c7) /*=0xf08c7*/,0xf0));
      goto L5ea;
    }
    return;
  }
  ...
  for(;;){
    ...
    if (!((unsigned int)puVar12 >= ((unsigned long)&rodata_fa9b4) /*=0xfa9b4*/ && (unsigned int)puVar12 < ((unsigned long)&rodata_faa14) /*=0xfaa14*/)) {
      G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"(aeh->type_id >= _event_type_list_start) && (aeh->type_id < _event_type_list_end)") /*=0xf16be*/,((unsigned long)&rodata_f1681) /*=0xf1681*/,0xa3), (((unsigned long)&rodata_f1681) /*=0xf1681*/,0xa3));
      goto L5ea;
    }
    ...
    if ((int)((unsigned int)((int)t >> (uVar8 & 0x1f)) << 0x1f) < 0) {
      ...
      if (p3 == 0) {
        ...
        record.value = *(volatile unsigned int *)puVar12;
        record.flags = 0x200;
    ...
    while (*(volatile int *)(puVar12+8) != (int)piVar13 && iVar6 == 0) {
      if (piVar13 == 0) { G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"es != ((void *)0)") /*=0xf1710*/,((unsigned long)&rodata_f1681) /*=0xf1681*/,0xb5), (((unsigned long)&rodata_f1681) /*=0xf1681*/,0xb5)); }
      if (*piVar13 == 0) { G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"el != ((void *)0)") /*=0xf1722*/,((unsigned long)&rodata_f1681) /*=0xf1681*/,0xb9), (((unsigned long)&rodata_f1681) /*=0xf1681*/,0xb9)); }
      { int pc = *(volatile int *)(*piVar13 + 4);
        if (pc == 0) { G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"el->notification != ((void *)0)") /*=0xf1734*/,((unsigned long)&rodata_f1681) /*=0xf1681*/,0xba), (((unsigned long)&rodata_f1681) /*=0xf1681*/,0xba)); }
        iVar6 = ((int(*)(int))pc)(r4);
      }
      piVar13 = piVar13 + 1;
    }
