...
void clock_control_nrf_on_blocking(uint32_t mode)
{
    ...
    if (old == 0) {
        ...
        if (onoff_request_enqueue(((unsigned long)&g_2000b0b8) /*=0x2000b0b8*/) < 0) {
            G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)"err >= 0") /*=0xf0f1b*/, ((unsigned long)"WEST_TOPDIR/zephyr/drivers/clock_control/clock_control_nrf.c") /*=0xf5ad9*/, 0x230u), (((unsigned long)"WEST_TOPDIR/zephyr/drivers/clock_control/clock_control_nrf.c") /*=0xf5ad9*/, 0x230u));
        }
    }
    ...
    if (mode == 0)
        return;
    if (mode > 2) {
        G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)&rodata_f7a30) /*=0xf7a30*/, ((unsigned long)"WEST_TOPDIR/zephyr/drivers/clock_control/clock_control_nrf.c") /*=0xf5ad9*/, 0x242u), (((unsigned long)"WEST_TOPDIR/zephyr/drivers/clock_control/clock_control_nrf.c") /*=0xf5ad9*/, 0x242u));
    }
