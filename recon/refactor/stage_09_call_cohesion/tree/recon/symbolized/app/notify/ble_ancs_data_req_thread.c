...
void ble_ancs_data_req_thread(uint8_t *c,uint32_t p2,uint32_t p3,uint32_t p4){
 ...
 if(*lv>2){if(!*sink)log_message(((unsigned long)"%s(): enter\n") /*=0x99969*/,((unsigned long)"ble_ancs_data_req_thread") /*=0x9b0d8*/,p3,0,p4);else debug_print(((unsigned long)"%s(): enter\n") /*=0x99969*/,((unsigned long)"ble_ancs_data_req_thread") /*=0x9b0d8*/,p3,*sink,p4);}
