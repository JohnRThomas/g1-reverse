 ...
 *   post_notification_cmd_response.c
 *   msg_count_dec.c
 */
    ...
    if (bVar1 != 0){
        ...
        if (*(int*)(r3 + 4) != 0){
            ...
            *(volatile unsigned char *)((unsigned long)&g_message_pool_index) /*=0x2001a22a*/ = cVar4;
            G1_LOG_ROUTE(*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"[csh_debug_msg]msg_count_dec unread_msg_num is %d \n") /*=0xa8017*/, r5);
