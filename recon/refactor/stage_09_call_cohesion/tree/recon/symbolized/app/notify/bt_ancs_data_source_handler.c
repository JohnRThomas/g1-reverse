...
{
    volatile uint32_t *puVar1 = (volatile uint32_t*)((unsigned long)&g_ancs_notif_attr_id_latest) /*=0x20006aa0*/;
    volatile char *pcVar2 = (volatile char*)((unsigned long)&g_ancs_attr_data_pending) /*=0x2000ff71*/;
    volatile int *piVar3 = (volatile int*)((unsigned long)&g_ancs_notif_evt_id_latest) /*=0x20006aac*/;
    volatile int *piVar4 = (volatile int*)((unsigned long)&g_log_level) /*=0x2000230c*/;
    volatile int *piVar5 = (volatile int*)((unsigned long)&g_ancs_last_cmd_id) /*=0x2000231c*/;
    volatile int *g_d70 = (volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/;
    ...
    if (0 < *piVar4) {
        if (*g_d70 == 0) {
            log_message(((unsigned long)"%s(): bt_ancs_data_source_handler response->command_id %d\n") /*=0x9a992*/, ((unsigned long)"bt_ancs_data_source_handler") /*=0x9b20d*/, (unsigned int)*param_2, 0, param_1, (int)param_2, param_3);
        } else {
            debug_print(((unsigned long)"%s(): bt_ancs_data_source_handler response->command_id %d\n") /*=0x9a992*/, ((unsigned long)"bt_ancs_data_source_handler") /*=0x9b20d*/, (unsigned int)*param_2,
                            ...
                            if (*(char *)(iVar7 + 0xd5) != '\f') {
                                ...
                                if ((*(char *)(iVar7 + 0xd5) != '\x10') &&
                                    ...
                                    *(unsigned int *)(iVar6 + 0x1e4) = (unsigned int)*(unsigned char *)((int)piVar3 + 4);
                                    ...
                                    if (0 < *piVar4) {
                                        G1_LOG_ROUTE(*g_d70 == 0, ((unsigned long)"%s(): =========================>bt_ancs_get_attr_data_sem %d evt_id %d action %d\n") /*=0x9a9cd*/, ((unsigned long)"bt_ancs_data_source_handler") /*=0x9b20d*/, *piVar3, (unsigned int)*(unsigned char *)((int)piVar3 + 4),
