...
void uart_callback(int param_1,unsigned char *param_2,unsigned int param_3){
  ...
  case 0:
    ...
    for (uVar5=0; uVar5 < (unsigned int)VI((int)param_2+8); uVar5++)
      log_message(((unsigned long)"%02x ") /*=0xa7993*/, VB(VI((int)param_2+4)+uVar5));
    break;
  case 1:
    if (*lvl < 1) return;
  ...
  case 2:
    ...
    for (uVar7=0; uVar7 < (unsigned int)VI((int)param_2+0xc); uVar7++)
      log_message(((unsigned long)"%02x ") /*=0xa7993*/, VB(VI((int)param_2+4)+uVar5+uVar7));
    break;
  case 3:
    ...
    if (iVar2 == 0) {
      ...
      G1_ASSERT_FAIL((((unsigned long)"\tFailed to provide new buffer\n") /*=0xa7a33*/), (((unsigned long)&rodata_a79eb) /*=0xa79eb*/,0x54));
    } else {
      printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"err == 0") /*=0xa7a10*/,((unsigned long)&rodata_a79eb) /*=0xa79eb*/,0x51);
      G1_ASSERT_FAIL((((unsigned long)"\tFailed to allocate slab\n") /*=0xa7a19*/), (((unsigned long)&rodata_a79eb) /*=0xa79eb*/,0x51));
    }
  case 4:
