...
static void ble_privacy_id_remove(int param_1)
{
    ...
    if(*(volatile unsigned char *)((unsigned long)&g_ble_rl_entries_max) /*=0x20002120*/ == 0){
        if(bVar1==0){
            G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"bt_dev.le.rl_entries > 0") /*=0xf369a*/,((unsigned long)&rodata_f3509) /*=0xf3509*/,0x433), (((unsigned long)&rodata_f3509) /*=0xf3509*/,0x433));
        }
