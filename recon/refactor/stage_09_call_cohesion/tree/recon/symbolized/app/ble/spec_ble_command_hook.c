...
#define local_414    g1_frame.local_414
  ...
  if (iVar5 == 0) {
    if (2 < *DAT_0000f1e8) {
      G1_LOG_ROUTE(*DAT_0000f1ec == 0, PTR_s__s____test_BLE_REQ_POST_BT_UNPAI_0000f1f4,DAT_0000f1f0);
    }
    uVar12 = 1;
    local_520 = 0x47;
    goto LAB_0000ef7e;
  ...
  if (iVar5 != 0) {
    ...
    if (2 < *DAT_0000f1e8) {
      G1_LOG_ROUTE(*DAT_0000f1ec == 0, PTR_DAT_0000f1fc,DAT_0000f1f0,&local_5a0,&local_420);
    }
    ...
    if (iVar5 == 0) {
      ...
      if (iVar5 == 0) {
        ...
        if (iVar5 != 0) {
          ...
          if (2 < *DAT_0000f46c) {
            G1_LOG_ROUTE(*DAT_0000f470 == 0, DAT_0000f474,PTR_s_spec_ble_command_hook_0000f460,pcVar14,param_2);
          }
          local_5a0 = 0;
          local_5c4 = 0;
...
LAB_0000f2fc:
              ...
              if (2 < *piVar6) {
                G1_LOG_ROUTE(*DAT_0000f470 == 0, PTR_s__s____cmd_type__s__value__s__tx__0000f48c,
...
LAB_0000fc12:
              ...
              if (iVar4 == 0x4b) {
                ...
                if (2 < *piVar6) {
                  G1_LOG_ROUTE(*DAT_0000f76c == 0, PTR_s__s_____cmd_type__s__title__s__ms_0000f778,DAT_0000f770,
...
LAB_0000effe:
              ...
              if (2 < *piVar6) {
                G1_LOG_ROUTE(*DAT_0000f76c == 0, PTR_s__s______cmd_type__s__value__s__t_0000f780,DAT_0000f770,
...
LAB_0000f742:
      ...
      if (2 < iVar4) {
        G1_LOG_ROUTE(*DAT_0000f1ec == 0, PTR_s__s____pos__s__new_log_level_set__0000f218,DAT_0000f1f0,iVar5,iVar4);
      }
      uStack_51f = 2;
      ...
      if (2 < *DAT_0000f1e8) {
        G1_LOG_ROUTE(*DAT_0000f1ec == 0, PTR_s__s____pos__s__new_screen_id__d_0000f210,DAT_0000f1f0,iVar5,uVar12);
      }
      uStack_51f = 3;
    ...
    iVar4 = check_is_release_mode(iVar5);
    if (2 < *DAT_0000f1e8) {
      G1_LOG_ROUTE(*DAT_0000f1ec == 0, PTR_DAT_0000f208,DAT_0000f1f0,iVar5,iVar4);
    }
    if (iVar4 != 0) {
      iVar4 = 1;
    }
