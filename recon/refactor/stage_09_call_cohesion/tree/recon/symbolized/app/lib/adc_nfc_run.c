...
uint32_t adc_nfc_run(void)
{
    ...
    if (result < 0) {
        if (*(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/ > 0) {
            G1_LOG_ROUTE(*(volatile uint32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0u, (const void *)((unsigned long)"%s(): Could not read (%d)\n\n") /*=0x9f104*/,
    ...
    if (result == 0) {
        ...
        if (*(volatile int32_t *)((unsigned long)&g_log_level) /*=0x2000230c*/ > 0) {
            G1_LOG_ROUTE(*(volatile uint32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0u, (const void *)((unsigned long)"%s():  (value in mV not available)\n\n") /*=0x9f120*/,
                             (const void *)((unsigned long)"adc_nfc_run") /*=0x9f1c3*/);
        }
        return 0;
    }
