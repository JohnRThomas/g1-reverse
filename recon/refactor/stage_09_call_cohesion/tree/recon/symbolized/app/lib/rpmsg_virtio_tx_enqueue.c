                      ...
                      uint8_t *item_end, uint32_t tag)
{
    ...
    if (metal_io_block_write(pool, offset, &key, 16) != 16) {
        G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)&rodata_f7be9) /*=0xf7be9*/, ((unsigned long)&rodata_f7ba6) /*=0xf7ba6*/, 0x1af), (((unsigned long)&rodata_f7ba6) /*=0xf7ba6*/, 0x1af));
    }
    ...
    if (virtqueue_add_buffer(*(void **)(owner + 0xa8), &entry, 1, 0, item) != 0) {
        G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/, ((unsigned long)&rodata_f7c02) /*=0xf7c02*/, ((unsigned long)&rodata_f7ba6) /*=0xf7ba6*/, 0x1bc), (((unsigned long)&rodata_f7ba6) /*=0xf7ba6*/, 0x1bc));
    }
done:
