...
int gpio_manage_callback(int param_1, int *param_2, int param_3){
  ...
  if(param_2==0){ printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"callback") /*=0xf5e38*/,((unsigned long)&rodata_f5dfc) /*=0xf5dfc*/,0x3a); G1_ASSERT_FAIL((((unsigned long)"\tNo callback!\n") /*=0xf5e41*/), (((unsigned long)&rodata_f5dfc) /*=0xf5dfc*/,0x3a)); }
  if(param_2[1]==0){ printk(((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"callback->handler") /*=0xf5e50*/,((unsigned long)&rodata_f5dfc) /*=0xf5dfc*/,0x3b); G1_ASSERT_FAIL((((unsigned long)"\tNo callback handler!\n") /*=0xf5e62*/), (((unsigned long)&rodata_f5dfc) /*=0xf5dfc*/,0x3b)); }
