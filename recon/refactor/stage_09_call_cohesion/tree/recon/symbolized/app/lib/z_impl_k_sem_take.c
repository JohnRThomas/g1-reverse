...
int z_impl_k_sem_take(int param_1, uint32_t param_2, uint32_t param_3, uint32_t param_4){
    ...
    if (ipsr != 0 && (param_3 | param_4) != 0){
        ...
        G1_ASSERT_FAIL((((unsigned long)&rodata_f53ff) /*=0xf53ff*/), (((unsigned long)&rodata_f8198) /*=0xf8198*/,0x80));
        goto L936;
    }
  L936:
    bp = __get_BASEPRI();
    ...
    if (iVar2 == 0){
        ...
        G1_ASSERT_FAIL((((unsigned long)"\tInvalid spinlock %p\n") /*=0xf0935*/,((unsigned long)&g_mutex_lock_spinlock) /*=0x2000b474*/), (((unsigned long)&rodata_f08c7) /*=0xf08c7*/,0x72));
        goto L936;
    }
    ...
    G1_ASSERT_FAIL((((unsigned long)"\tNot my spinlock %p\n") /*=0xf090b*/,((unsigned long)&g_mutex_lock_spinlock) /*=0x2000b474*/), (((unsigned long)&rodata_f08c7) /*=0xf08c7*/,0xf0));
    goto L936;
}
