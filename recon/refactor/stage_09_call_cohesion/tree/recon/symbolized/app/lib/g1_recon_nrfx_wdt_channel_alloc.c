...
uint32_t g1_recon_nrfx_wdt_channel_alloc(int* param_1, uint8_t* param_2){
  ...
  if(param_2==0){
    G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f7a32) /*=0xf7a32*/,((unsigned long)&rodata_f79c8) /*=0xf79c8*/,0xa2), (((unsigned long)&rodata_f79c8) /*=0xf79c8*/,0xa2));
  }
  int iVar6=(int)(((unsigned long)&m_dppi_channels) /*=0x2000b41c*/ + (uint)r4byte*8);
  while(*(volatile uint8_t *)iVar6 != 1){
    G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f7052) /*=0xf7052*/,((unsigned long)&rodata_f79c8) /*=0xf79c8*/,0xa3), (((unsigned long)&rodata_f79c8) /*=0xf79c8*/,0xa3));
  }
