...
#define DAT_00058054 ((unsigned long)"Too small L2CAP signaling PDU") /*=0xf41a7*/
#define DAT_00058058 ((unsigned long)&rodata_88160) /*=0x88160*/
#define DAT_0005805c ((unsigned long)"L2CAP length mismatch (%u != %u)") /*=0xf41c5*/
#define DAT_00058060 ((unsigned long)"Invalid ident value in L2CAP PDU") /*=0xf41e6*/
#define DAT_00058064 ((unsigned long)&rodata_f4207) /*=0xf4207*/
#define DAT_00058068 ((unsigned long)&rodata_f4223) /*=0xf4223*/
#define DAT_0005806c ((unsigned long)"Invalid LE-Conn Req params: mtu %u mps %u") /*=0xf4245*/
#define DAT_00058070 ((unsigned long)"Mandatory callback 'recv' missing") /*=0xf426f*/
#define DAT_00058074 ((unsigned long)&rodata_816af) /*=0x816af*/
#define DAT_00058078 ((unsigned long)"Too small LE conn rsp packet size") /*=0xf4291*/
#define DAT_0005807c ((unsigned long)"Cannot find channel for ident %u") /*=0xf42b3*/
#define DAT_000582a0 ((unsigned long)"Too small LE disconn rsp packet size") /*=0xf42d4*/
#define DAT_000582a4 ((unsigned long)"Too small LE Credits packet size") /*=0xf42f9*/
#define DAT_000582a8 ((unsigned long)"Unable to find channel of LE Credits packet") /*=0xf431a*/
...
LAB_00057e04:
    ...
    log_msg_3arg_thunk(DAT_00058058,0x2040,&log4);
    return 0;
  }
...
LAB_00057f58:
          ...
          local_30 = 2;
          log_msg_3arg_thunk(DAT_00058058,0x1040,&local_30);
        }
        sVar20 = 0xb;
LAB_00057ed6:
...
LAB_00058032:
            ...
            log3.value = uVar18;
            log_msg_3arg_thunk(DAT_00058058,0x1840,&log3);
            return 0;
          }
          k_work_cancel_delayable(piVar10 + 0x30);
          *(undefined1 *)(piVar10 + 0x2e) = 0;
      ...
      if (3 < uVar17) {
        ...
        if (iVar21 != 0) {
          ...
          if (0xffff < (int)(iVar11 + uVar17)) {
            ...
            local_30 = 2;
            log_msg_3arg_thunk(DAT_000582b0,0x1040,&local_30);
...
switchD_00057e38_caseD_2:
    ...
    log3.value = uVar14;
    log_msg_3arg_thunk(DAT_000582b0,0x1880,&log3);
    iVar21 = *param_1;
