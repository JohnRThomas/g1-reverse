    ...
    for (;;) {
        ...
        if (!item) {
            if (*(uint32_t *)(base + 0x14)) {
                ...
                G1_ASSERT_FAIL((((unsigned long)"\tPending TX packets\n") /*=0xf3ae4*/), (((unsigned long)&rodata_f3a5d) /*=0xf3a5d*/, 0x313u));
            }
            if (*(uint32_t *)(base + 0x1c)) {
                G1_ASSERT_FAIL((((unsigned long)"sys_slist_is_empty(&conn->tx_pending)") /*=0xf3abe*/, ((unsigned long)"conn->pending_no_cb == 0") /*=0xf3af9*/, ((unsigned long)&rodata_f3a5d) /*=0xf3a5d*/, 0x314u), (((unsigned long)&rodata_f3a5d) /*=0xf3a5d*/, 0x314u));
            }
