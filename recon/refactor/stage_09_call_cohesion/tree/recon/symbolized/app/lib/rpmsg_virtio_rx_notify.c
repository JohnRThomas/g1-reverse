...
void rpmsg_virtio_rx_notify(uint8_t **arg)
{
    ...
    while (msg) {
        ...
        if (dst) {
            ...
            if (rc<0) { G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)&rodata_f7c0e) /*=0xf7c0e*/,((unsigned long)&rodata_f7ba6) /*=0xf7ba6*/,0x245), (((unsigned long)&rodata_f7ba6) /*=0xf7ba6*/,0x245)); }
        }
        mutex_lock_wait_forever_dup(lock);
        if ((int32_t)msg[2]>=0) {
