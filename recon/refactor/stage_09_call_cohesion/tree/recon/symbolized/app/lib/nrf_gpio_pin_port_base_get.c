...
invalid:G1_ASSERT_FAIL((((unsigned long)"ASSERTION FAIL [%s] @ %s:%d\n") /*=0x99cbd*/,((unsigned long)"nrf_gpio_pin_present_check(*p_pin)") /*=0xf0a04*/,((unsigned long)&rodata_f09d1) /*=0xf09d1*/,0x32f,context), (((unsigned long)&rodata_f09d1) /*=0xf09d1*/,0x32f));
}
