...
LAB_000270b8:
              G1_LOG_ROUTE(iVar8 == 0, log_format, ((unsigned long)"sync_to_slave") /*=0xa1ab1*/);
            }
          }
          else {
            if (param_1[0xd5] == '\x06') {
...
LAB_0002707a:
            G1_LOG_ROUTE(iVar8 == 0, log_format, ((unsigned long)"sync_to_slave") /*=0xa1ab1*/, param_2);
          }
          goto LAB_0002708e;
        }
LAB_0002709c:
...
LAB_00027372:
          ...
          while (param_1[0x105a] != '\x02') {
            ...
            if (uVar16 == uVar17) {
              uVar16 = uVar17;
              if (0 < *piVar6) {
                G1_LOG_ROUTE(*(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): ESB send package id is changed, ignore it.\n") /*=0xa00d0*/, ((unsigned long)"sync_to_slave") /*=0xa1ab1*/, uVar17);
