 ...
 *   rodata_a9f2a                             @ 0x000a9f2a   [INLINED -- refactor stage 01]
...
void navigation_overview_map_display(unsigned int param_1, unsigned int param_2) {
    ...
    int *piVar2 = (int*)((unsigned long)&g_log_level) /*=0x2000230c*/;
    unsigned char *pcVar4, *pcVar5;
    unsigned lbuf32[2];
    unsigned char *lbuf = (unsigned char*)lbuf32;

    iVar3 = ((unsigned long)g_ipc_or_evt_ctx) /*=0x20004bb8*/;
    if (*(volatile unsigned char *)(((unsigned long)g_ipc_or_evt_ctx) /*=0x20004bb8*/ + 5) == 0) {
        ...
        while (1) {
            uVar13 = 0;
            do {
                iVar10 = (int)(uVar13 % 0x1a) * 0xa00 + iVar11 + ((unsigned long)&rodata_aae20) /*=0xaae20*/;
                iVar9 = 0;
                do {
            ...
            uVar12 = *(volatile unsigned int *)(iVar9 + 0xeb4);
            iVar9 = get_device_info();
            reflash_fb_data_to_lcd(uVar12, *(volatile unsigned int *)(iVar9 + 0xeb8), 0, 0, 0x280, 199);
            pcVar4 = (unsigned char*)((unsigned long)&g_2001ba2d) /*=0x2001ba2d*/;
            if (iVar11 == 0x500) break;
            iVar11 = 0x500;
        }
        if ((*(volatile unsigned char *)((unsigned long)&g_20010326) /*=0x20010326*/ == 1) &&
            (*(volatile unsigned char *)((unsigned long)&g_2001ba2d) /*=0x2001ba2d*/ == 0)) {
            if (*(volatile int *)(param_2 + 0xb1) == 0x1210) {
                if (2 < *piVar2) {
                    if (*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0)
                        log_message(((unsigned long)"%s(): Data is in raw format.\n") /*=0xa9ee1*/, ((unsigned long)"navigation_overview_map_display") /*=0xaa446*/);
                    else
                        debug_print(((unsigned long)"%s(): Data is in raw format.\n") /*=0xa9ee1*/, ((unsigned long)"navigation_overview_map_display") /*=0xaa446*/);
                }
                ...
                memcpy(((unsigned long)g_buf_2001ba2e) /*=0x2001ba2e*/, ((unsigned long)&g_20015e52) /*=0x20015e52*/, 0x1210);
            } else {
                if (2 < *piVar2) {
                    if (*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0)
                        log_message(((unsigned long)"%s(): Data is in rle compress raw format.\n") /*=0xa9eff*/, ((unsigned long)"navigation_overview_map_display") /*=0xaa446*/);
                    else
                        debug_print(((unsigned long)"%s(): Data is in rle compress raw format.\n") /*=0xa9eff*/, ((unsigned long)"navigation_overview_map_display") /*=0xaa446*/);
                }
                memset_bytes(((unsigned long)g_buf_2001ba2e) /*=0x2001ba2e*/, 0, 0x1210);
                FUN_0007d376(((unsigned long)&g_ble_work_queue) /*=0x20007574*/, 0, 0xffffffff, 0xffffffff);
                decode_rle_byte_pairs(((unsigned long)&g_20015e52) /*=0x20015e52*/, *(volatile unsigned int *)(param_2 + 0xb1), ((unsigned long)g_buf_2001ba2e) /*=0x2001ba2e*/);
            }
            *pcVar4 = 1;
        ...
        do {
            clean_fb_data(iVar6, 0, 0, 0, 0x280, 199);
            {
                ...
                gui_bitmps_merge_draw(a1 + 0x1b6, a2, a3 + 0x240, a4 + 0x88,
                             ((unsigned long)&g_2001c336) /*=0x2001c336*/ - 0x908, ((unsigned long)&g_2001c336) /*=0x2001c336*/, 2, 0xf);
            }
            memset_bytes(((unsigned long)g_buf_2001b9ac) /*=0x2001b9ac*/, 0, 0x80);
            snprintf(((unsigned long)g_buf_2001b9ac) /*=0x2001b9ac*/, 0x80, ((unsigned long)"%s %s") /*=0xa9f2a*/, param_2 + 0xd, param_2 + 0x25);
            {
                int a1 = device_info_text_width_get();
                int a2 = device_info_text_height_get_clamped();
                int a3 = device_info_text_width_get();
                int a4 = device_info_text_height_get_clamped();
                gui_utf_draw(0, ((unsigned long)g_buf_2001b9ac) /*=0x2001b9ac*/, 0, a1 + 0xe8, a2, a3 + 0x1ae, a4 + 0x1b, 1, 0, 0, 0, 0);
            }
            {
                int a1 = device_info_text_width_get();
                int a2 = device_info_text_height_get_clamped();
            ...
            uVar13 = 0;
            lbuf32[0] = *(volatile unsigned int *)((unsigned long)&rodata_a8c57) /*=0xa8c57*/;
            lbuf32[1] = *(volatile unsigned int *)(((unsigned long)&rodata_a8c57) /*=0xa8c57*/ + 4);
            do {
                iVar9 = 0;
                do {
                    ...
                    if (bVar1 != 0)
                        *(volatile unsigned char *)(iVar10 + iVar9) =
                            bVar1 & *(volatile unsigned char *)(
                                ...
                                (int)(uVar13 % 0x1a) * 0xa00 + ((unsigned long)&rodata_aae20) /*=0xaae20*/ + iVar9);
                    iVar9 = iVar9 + 1;
                } while (iVar9 != 0x140);
                uVar13 = uVar13 + 1;
            } while (uVar13 != 199);
    ...
    piVar2 = (int*)((unsigned long)&g_log_level) /*=0x2000230c*/;
    pcVar5 = (unsigned char*)((unsigned long)&g_2001ba2d) /*=0x2001ba2d*/;
    pcVar4 = (unsigned char*)((unsigned long)&g_20010323) /*=0x20010323*/;
    if (*(volatile unsigned char *)((unsigned long)&g_20010323) /*=0x20010323*/ == 1) {
        int do_bd8 = 0;
        if (*(volatile unsigned char *)((unsigned long)&g_20010326) /*=0x20010326*/ == 1) {
            if (2 < *piVar2) {
                if (*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0)
            ...
            *pcVar5 = 1;
            FUN_0007d37a(((unsigned long)&g_ble_work_queue) /*=0x20007574*/);
            do_bd8 = 1;
        } else if (*(volatile unsigned char *)((unsigned long)&g_2001ba2d) /*=0x2001ba2d*/ == 1) {
            do_bd8 = 1;
        }
        if (do_bd8) {
            int a1 = device_info_text_width_get();
    ...
    pcVar4 = (unsigned char*)((unsigned long)&g_20010324) /*=0x20010324*/;
