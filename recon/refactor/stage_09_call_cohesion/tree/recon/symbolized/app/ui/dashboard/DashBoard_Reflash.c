...

{
  ...
  piVar2 = DAT_000374c0;
  if (2 < *DAT_000374c0) {
    G1_LOG_ROUTE(*DAT_000374c4 == 0, DAT_000374cc,DAT_000374c8,param_4);
  }
  if (param_4 != 1) {
    if (param_4 == 2) {
      ...
      if (((*(int *)(DAT_0003abb4 + 0x1c) != iVar4) || (*(char *)(DAT_0003abb4 + 0x19) != '\x02'))
        ...
        *(undefined1 *)(iVar9 + 0x19) = uVar1;
        if (2 < iVar14) {
          G1_LOG_ROUTE(*DAT_0003aba0 == 0, DAT_0003abb8,DAT_0003abac);
        }
      }
      ...
      if (iVar4 == 1) {
        ...
        if (2 < *piVar2) {
          G1_LOG_ROUTE(*DAT_0003aba0 == 0, DAT_0003abc0,DAT_0003abac,(uint)*(byte *)(param_1 + 4));
        }
        local_a4 = '\0';
        uStack_a3 = 0;
        uStack_a2 = 0;
...
LAB_0003803a:
          ...
          if (2 < *piVar2) {
            G1_LOG_ROUTE(*DAT_00037ea4 == 0, DAT_00037eac,DAT_00037ea8,0);
          }
