 ...
 *   onboarding_mark_retry_if_reset.c
 *   onboarding_ble_process.c
 */
/* ---- onboarding_mark_retry_if_reset.c ---- */
...
u32 onboarding_ble_process(u32 param_1, u32 param_2, u32 param_3, u32 param_4)
{
  ...
  if (0x17 < *(volatile u8 *)(param_3 + 1)) {
    if (0 < *(volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
      G1_LOG_ROUTE(*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): ble rcv unknown onboarding action:%d\n") /*=0xaa611*/, ((unsigned long)"onboarding_ble_process") /*=0xaa778*/,
  ...
  *(volatile u8 *)(ctx + 2) = *(volatile u8 *)(param_3 + 1);
  ...
  if (2 < *(volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
    ctx = *(volatile u32 *)(param_1 + 0x1014);
    G1_LOG_ROUTE(*(volatile int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): ble rcv onboarding action:%d\n") /*=0xaa63d*/, ((unsigned long)"onboarding_ble_process") /*=0xaa778*/,
