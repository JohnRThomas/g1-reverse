...
{
    G1_LOG_ROUTE(*(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, format, LOG_FUNCTION);
}

static inline __attribute__((always_inline))
void quicknote_log_value(uintptr_t format, unsigned int value)
{
    G1_LOG_ROUTE(*(volatile int32_t *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, format, LOG_FUNCTION, value);
}
