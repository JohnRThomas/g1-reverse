 ...
 *   drain_quick_note_data_queue.c
 *   upgradeQuickNoteDataToFlash.c
 *   deleteQuickNoteData.c
 */
...
int upgradeQuickNoteDataToFlash(unsigned int param_1, unsigned int param_2, unsigned int param_3)
{
    ...
    if (iVar1 == 0) {
        if (2 < *(volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
            G1_LOG_ROUTE(*(volatile unsigned int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): SEND QUICKNOTE TEXT Store(%d) Command...\n") /*=0x9edf3*/, ((unsigned long)"upgradeQuickNoteDataToFlash") /*=0x9f094*/, param_1);
        }
        k_sem_give(((unsigned long)&g_app_language_msgq) /*=0x200079e4*/);
        uVar2 = 0;
    } else {
        if (0 < *(volatile int *)((unsigned long)&g_log_level) /*=0x2000230c*/) {
            G1_LOG_ROUTE(*(volatile unsigned int *)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/ == 0, ((unsigned long)"%s(): quicknote flash store queue fill failed\r\n\n") /*=0x9edc2*/, ((unsigned long)"upgradeQuickNoteDataToFlash") /*=0x9f094*/);
        }
        uVar2 = -1;
    }
    return uVar2;
