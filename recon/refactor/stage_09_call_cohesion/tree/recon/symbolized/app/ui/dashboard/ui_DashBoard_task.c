...
extern unsigned int dashboard_read_word(volatile unsigned int*);
...
#define DAT_0003b260 (((unsigned long)"ui_DashBoard_task") /*=0xa957d*/)
#define DAT_0003b264 (((unsigned long)"%s(): Enter DASHBOARD_INIT_STATUS task....\n") /*=0xa9243*/)
#define DAT_0003b268 (((unsigned long)"%s(): dashboard function exit ...\n") /*=0xa926f*/)
#define DAT_0003b26c ((volatile int*)((unsigned long)&g_dashboard_reset_pending_flags) /*=0x20007aa0*/)
#define DAT_0003b270 (((unsigned long)"%s(): DASHBOARD INIT .......\n") /*=0xa9292*/)
...
#define DAT_0003b280 (((unsigned long)"%s(): quicknote index = %d,stocks index = %d,news index = %d\n") /*=0xa92b0*/)
#define DAT_0003b284 (((unsigned long)"%s(): db_info->schedule_disp_status = %d\n") /*=0xa92ee*/)
#define DAT_0003b288 (((unsigned long)"%s(): db_info->stocks_disp_mode = %d\n") /*=0xa9127*/)
#define DAT_0003b28c (((unsigned long)"%s(): db_info->news_disp_mode = %d\n") /*=0xa9318*/)
#define DAT_0003b290 (((unsigned long)"%s(): master sync quicknote index to slave ,index = %d\n") /*=0xa933c*/)
#define DAT_0003b294 (((unsigned long)"%s(): SYNC TO Slave failed...,don't exec key function.\n") /*=0xa0fad*/)
...
#define DAT_0003b2a4 (((unsigned long)"%s(): send dashboard lock info to app ,status = %d \n") /*=0x9f929*/)
#define DAT_0003b2a8 (0xa9374UL)
#define DAT_0003b584 ((volatile int*)((unsigned long)&g_log_use_alt_sink) /*=0x20007554*/)
#define DAT_0003b588 (((unsigned long)"ui_DashBoard_task") /*=0xa957d*/)
#define DAT_0003b58c (0xa93a8UL)
#define DAT_0003b590 (((unsigned long)"%s(): sync to slave return value = %d,exec key function. ts = %d\n") /*=0xa0fe5*/)
...
#define DAT_0003b5a4 (((unsigned long)"%s(): send dashboard lock info to app ,status = %d \n") /*=0x9f929*/)
#define DAT_0003b5a8 (((unsigned long)"%s(): notify message count has changed,send message count to app. unread messgae count = %d\n") /*=0xa93da*/)
#define DAT_0003b5ac (((unsigned long)"%s(): Enter DASHBOARD_RUNING_STATUS task....\n") /*=0xa9437*/)
#define DAT_0003b5b0 (((unsigned long)"%s(): dashboard function exit ...\n") /*=0xa926f*/)
...
#define DAT_0003b5bc (((unsigned long)"%s(): current index = %d\n") /*=0xa9465*/)
...
#define DAT_0003b764 (((unsigned long)"ui_DashBoard_task") /*=0xa957d*/)
#define DAT_0003b768 (((unsigned long)"%s(): received key press event,_dashboard_prv_data.display_mode = %d\n") /*=0xa947f*/)
#define DAT_0003b76c ((volatile byte*)((unsigned long)&g_widget0_index_raw) /*=0x2001b816*/)
#define DAT_0003b770 (((unsigned long)"%s(): current quicknote index = %d\n") /*=0xa94c5*/)
...
#define DAT_0003b784 (((unsigned long)"%s(): received system low power event.\n") /*=0xa9529*/)
#define DAT_0003b788 (((unsigned long)"%s(): received system  power resume event.\n") /*=0xa9551*/)
...

{
  ...
  if (*pcVar4 == '\0') {
    if (2 < *DAT_0003b258) {
      G1_LOG_ROUTE(*DAT_0003b25c == 0, DAT_0003b264,DAT_0003b260);
    }
    enter_dashboard_burial_point();
    if (param_3 == 2) {
      if (2 < *piVar5) {
        G1_LOG_ROUTE(*DAT_0003b25c == 0, DAT_0003b268,DAT_0003b260);
      }
      gui_screen_clear();
    ...
    if (2 < *piVar5) {
      G1_LOG_ROUTE(*DAT_0003b25c == 0, DAT_0003b270,DAT_0003b260);
    }
    send_event(0x1e);
    memset_bytes(DAT_0003b254,0,0x28);
    gui_screen_clear();
    ...
    piVar6 = DAT_0003b25c;
    if (2 < iVar14) {
      G1_LOG_ROUTE(*DAT_0003b25c == 0, DAT_0003b280,DAT_0003b260,(uint)bVar11,(uint)bVar1,uVar13);
      if (2 < *piVar5) {
        G1_LOG_ROUTE(*piVar6 == 0, DAT_0003b284,DAT_0003b260,(uint)*(byte *)(iVar12 + 0x155),0,uVar13);
        if (2 < *piVar5) {
          G1_LOG_ROUTE(*piVar6 == 0, DAT_0003b288,DAT_0003b260,(uint)*(byte *)(iVar12 + 0x157),0,uVar13);
          if (2 < *piVar5) {
            G1_LOG_ROUTE(*piVar6 == 0, DAT_0003b28c,DAT_0003b260,(uint)*(byte *)(iVar12 + 0x158));
          }
        }
      }
    }
    ...
    if (*pcVar15 == '\x01') {
      ...
      if (cVar3 == '\0') {
        ...
        if (2 < *piVar5) {
          ...
          uVar17 = DAT_0003b260;
LAB_0003b116:
          G1_LOG_ROUTE(iVar14 == 0, uVar16,uVar17);
        }
      }
      else if (cVar3 == '\x01') {
      ...
      if (iVar14 < 5000) {
        ...
        G1_LOG_ROUTE(*DAT_0003b25c == 0, DAT_0003b294,DAT_0003b260);
      }
    }
...
LAB_0003b198:
    ...
    if (2 < *DAT_0003b258) {
      G1_LOG_ROUTE(*DAT_0003b25c == 0, DAT_0003b2a4,DAT_0003b260,2);
    }
  ...
  if (((uVar13 & 2) != 0) && (iVar14 = dashboard_read_word(DAT_0003b5a0), -1 < iVar14 << 0x1e)) {
    ...
    local_2c = CONCAT22((*(volatile uint16_t *)((char*)&local_2c + 2)),0x201);
    if (2 < *piVar5) {
      G1_LOG_ROUTE(*DAT_0003b584 == 0, DAT_0003b5a4,DAT_0003b588,2);
    }
    send_response_data_to_msgqueue(&local_30,6);
    send_response_data_to_ble();
  ...
  if (uVar13 != (byte)pcVar4[0x23]) {
    ...
    pcVar4[0x23] = bVar11;
    if (2 < iVar14) {
      G1_LOG_ROUTE(*DAT_0003b584 == 0, DAT_0003b5a8,DAT_0003b588,(uint)bVar11);
    }
    send_dashboard_status_sync();
  }
  gui_canvas_flags_set_bit1();
  ...
  if (*piVar5 < 3) {
    ...
    G1_LOG_ROUTE(*DAT_0003b584 == 0, DAT_0003b5ac,DAT_0003b588);
    if (param_3 != 2) {
LAB_0003b742:
      if (param_3 == 1) {
        uVar16 = get_device_info();
      ...
      if (param_3 == 0) {
        if (2 < *piVar5) {
          G1_LOG_ROUTE(*DAT_0003b584 == 0, DAT_0003b5bc,DAT_0003b588,(uint)*(byte *)(iVar12 + 0x153));
        }
        uVar16 = get_device_info();
      ...
      if (param_3 != 4) {
        if (param_3 == 6) {
          if (2 < *piVar5) {
            G1_LOG_ROUTE(*DAT_0003b760 == 0, DAT_0003b784,DAT_0003b764);
          }
          iVar12 = get_device_info();
          uVar18 = 1;
          ...
          if (2 < *piVar5) {
            G1_LOG_ROUTE(*DAT_0003b760 == 0, DAT_0003b788,DAT_0003b764);
          }
          iVar12 = get_device_info();
          uVar18 = 0;
          iVar12 = *(int *)(iVar12 + 0xfec);
      ...
      if (2 < *piVar5) {
        G1_LOG_ROUTE(*DAT_0003b760 == 0, DAT_0003b768,DAT_0003b764,(uint)(byte)pcVar4[0x19]);
      }
      cVar3 = pcVar4[0x1a];
      if (cVar3 == '\0') {
        bVar11 = pcVar4[2];
        ...
        if (1 < uVar13) {
          ...
          *DAT_0003b774 = cVar3;
          ...
          if (2 < iVar14) {
            ...
            uVar16 = DAT_0003b778;
LAB_0003b614:
            G1_LOG_ROUTE(iVar14 == 0, uVar16,DAT_0003b764,uVar13);
          }
        }
      }
...
LAB_0003b512:
    ...
    if (2 < *piVar5) {
      G1_LOG_ROUTE(*piVar6 == 0, DAT_0003b5b0,DAT_0003b588);
    }
  }
  send_event(0x1f);
