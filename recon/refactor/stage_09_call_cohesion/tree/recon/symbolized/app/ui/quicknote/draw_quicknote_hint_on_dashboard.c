 ...
 * public-name: draw_quicknote_hint_on_dashboard
...
void draw_quicknote_hint_on_dashboard(void)
{
    volatile uint8_t *g = (volatile uint8_t*)((unsigned long)&g_display_last_drawn_lang) /*=0x20004968*/;
    unsigned uVar1;
    int iVar2, iVar3, iVar4, iVar5, iVar6;
    int uVar7, uVar8;

    uVar1 = get_ui_mode_flag_byte1();
    if ((unsigned)*g != uVar1) {
        *g = (uint8_t)uVar1;
    ...
    if (uVar1 == 6) {
        ...
        iVar4 = device_info_text_width_get();
        iVar5 = device_info_text_height_get_clamped();
        gui_utf_draw(0, ((unsigned long)&rodata_a8ec6) /*=0xa8ec6*/, 0, iVar2 + 0x134, iVar3 + 0x28, iVar4 + 0x236, iVar5 + 0x43, 1, 0, 0, 0, 0);
        iVar2 = device_info_text_width_get();
        iVar4 = device_info_text_height_get_clamped();
        iVar5 = device_info_text_width_get();
        iVar3 = device_info_text_height_get_clamped();
        iVar2 = iVar2 + 0x15a;
        uVar7 = ((unsigned long)&rodata_a8edd) /*=0xa8edd*/;
        ...
        iVar4 = device_info_text_width_get();
        iVar5 = device_info_text_height_get_clamped();
        gui_utf_draw(0, ((unsigned long)&rodata_a8ea1) /*=0xa8ea1*/, 0, iVar2 + 0x144, iVar3 + 0x28, iVar4 + 0x236, iVar5 + 0x43, 1, 0, 0, 0, 0);
        iVar2 = device_info_text_width_get();
        iVar4 = device_info_text_height_get_clamped();
        iVar5 = device_info_text_width_get();
        iVar3 = device_info_text_height_get_clamped();
        iVar2 = iVar2 + 0x150;
        uVar7 = ((unsigned long)&rodata_a8eb5) /*=0xa8eb5*/;
        gui_utf_draw(0, uVar7, 0, iVar2, iVar4 + 0x43, iVar5 + 0x236, iVar3 + 0x5e, 1, 0, 0, 0, 0);
    }
}
