...
void onboarding_retry_watchdog_update(void){
  char cVar1=*(volatile signed char *)((unsigned long)&onboarding_last_step_cache) /*=0x200034f5*/;
  int iVar3;
  ...
  if(((int)cVar1!=(unsigned int)*(volatile unsigned char *)(*(volatile int *)(iVar3+0x1014)+2)) ||
    ...
    *(volatile unsigned char *)((unsigned long)&onboarding_attempt_counter) /*=0x2001cdd2*/=0;
    *(volatile unsigned char *)((unsigned long)&onboarding_retry_counter) /*=0x2001cdd1*/=0;
  }
  *(volatile unsigned char *)((unsigned long)&onboarding_watchdog_active_flag) /*=0x2001cdd3*/=1;
  iVar3=get_device_info();
  *(volatile char *)((unsigned long)&onboarding_last_step_cache) /*=0x200034f5*/=*(volatile unsigned char *)(*(volatile int *)(iVar3+0x1014)+2);
}
