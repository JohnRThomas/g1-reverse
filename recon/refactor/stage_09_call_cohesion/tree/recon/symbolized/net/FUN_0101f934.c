...
extern void controller_work_update_or_enqueue(void *a, unsigned int b, unsigned int c);
...
void FUN_0101f934(int param_1, unsigned char param_2)
{
    ...
    *(unsigned char *)(base + 0x20f) = r;
    controller_work_update_or_enqueue(base + 0x202, ((unsigned long)&rodata_1029e3d) /*=0x1029e3d*/, 2);
