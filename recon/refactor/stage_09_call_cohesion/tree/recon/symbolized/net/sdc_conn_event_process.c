...
#define DAT_01014de8 ((uintptr_t)((unsigned long)&g_net_link_ctx_a) /*=0x21000f68*/)
#define DAT_01014dec ((uint32_t)0x010109cdu)
#define DAT_01014df0 ((uint32_t)0x10624dd3u)
#define DAT_01014df4 ((volatile uint32_t *)G1N_210001d0)
#define DAT_01014df8 ((volatile uint32_t *)G1N_21000018)
#define DAT_010151c4 ((uint32_t)((unsigned long)&rodata_10100a1) /*=0x10100a1*/)
#define DAT_010151c8 ((uintptr_t)G1N_21000124)
#define DAT_010151cc ((uint32_t)((unsigned long)&g_net_link_ctx_a) /*=0x21000f68*/)
#define DAT_01015618 ((undefined4 *)G1N_210001dc)
#define DAT_0101561c ((uint32_t)((unsigned long)&g_net_link_ctx_a) /*=0x21000f68*/)
#define DAT_01015620 ((uintptr_t)G1N_21000078)
#define DAT_01015aa8 ((volatile uint32_t *)G1N_21000204)
#define DAT_01015aac ((uint32_t)((unsigned long)&g_net_link_ctx_a) /*=0x21000f68*/)
#define DAT_01015ca0 ((uint32_t)((unsigned long)&g_net_link_ctx_a) /*=0x21000f68*/)
#define DAT_01015ca4 ((volatile uint32_t *)G1N_2100020c)
