...
/* readable reconstruction; identity: FUN_010344ec @ 0x010344ec
 * public-name: FUN_010344ec
...
unsigned short FUN_010344ec(void) {
  ...
  volatile unsigned short *DAT_01034504 = (volatile unsigned short *)((unsigned long)&g_sdc_res_pool_slot_tbl) /*=0x210006a8*/;
