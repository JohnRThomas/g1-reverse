...
/* readable reconstruction; identity: FUN_01022e34 @ 0x01022e34
 * public-name: FUN_01022e34
...
{
    volatile uint8_t *const table = (volatile uint8_t *)((unsigned long)&g_libc_tz_calc_state) /*=0x210016f0*/;
    unsigned bank;
    unsigned slot;
