...
/* readable reconstruction; identity: FUN_0102b49c @ 0x0102b49c
 * public-name: FUN_0102b49c
...
{
    volatile uint8_t *const packet = (volatile uint8_t *)((unsigned long)&g_esb_sync_response_packet) /*=0x21004ea1*/;
    volatile int *const log_level = (volatile int *)((unsigned long)&g_zephyr_log_level) /*=0x21000580*/;
    struct {
        uint32_t header;
        uint8_t tail[247];
    } scratch;
