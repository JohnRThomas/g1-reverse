...
/* readable reconstruction; identity: FUN_01012ba4 @ 0x01012ba4
 * public-name: FUN_01012ba4
...
extern void sdc_assertion_fail(uint32_t a, uint32_t b, uint32_t c,
...
uint32_t FUN_01012ba4(int32_t param_1, int32_t param_2, uint32_t param_3, uint32_t param_4)
{
    ...
    if ((uVar1 > 1) && (param_2 != 0x1d)) {
        sdc_assertion_fail(0x2f, 0xee, param_3, uVar1, param_4);
    }

    const uint32_t base = ((unsigned long)&rodata_103c1d4) /*=0x103c1d4*/;
    ...
    default:
        sdc_assertion_fail(0x2f, 0x102, param_3, uVar1, param_4);
    }
}
