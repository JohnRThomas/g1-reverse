...
void FUN_01021108(unsigned param_1, unsigned param_2)
{
  if ((W8(IVAR3+0x35) & 1u) == 0) {
    G1_NORETURN_CALL(sdc_assertion_fail(0x3e,0x716));
  }
  ...
  if (iVar8 != 0) { G1_NORETURN_CALL(sdc_assertion_fail(0x3e,0xa69)); }
  ...
  if (param_1 == 0) {
    ...
    if (iVar9 != 0) { G1_NORETURN_CALL(sdc_assertion_fail(0x3e,0x57e)); }
    ...
    if (uVar1 > 0x95) {
      ...
      if ((unsigned)(r+1) > 1u) { G1_NORETURN_CALL(sdc_assertion_fail(0x3e,0x6e9)); }
    }
  } else if (param_1 == 1) {
    ...
    if (uVar1 > 0x95) {
      ...
      if ((unsigned)(r+1) > 1u) { G1_NORETURN_CALL(sdc_assertion_fail(0x3e,0x6f6)); }
    }
  } else {
    u16 uVar1 = W16(IVAR3+0x1c);
    W32(DAT_010212dc+0x4c) = 1;
    ...
    if (uVar1 > 0x95) {
      G1_NORETURN_CALL(sdc_assertion_fail(0x3e,0x6fa,(unsigned)uVar1,r3));
    }
  }
  ...
  if (iv != 0) { G1_NORETURN_CALL(sdc_assertion_fail(0x3e,0xa8b)); }
