...
/* readable reconstruction; identity: FUN_0100aeac @ 0x0100aeac
 * public-name: FUN_0100aeac
...
#define CONNECTION_STATE ((volatile uint8_t *)((unsigned long)&g_net_radio_drv_ctx) /*=0x21000c48*/)
