                 ...
                 uint32_t timeout_lo, uint32_t timeout_hi)
{
    ...
    if (exception_number() != 0 && timeout_ticks != 0) {
        ...
        G1_NORETURN_CALL(assert_post_action((uint32_t)(uintptr_t)&rodata_103eacd, 0x80u));
    }
    ...
    if (FUN_0103610c(kernel_lock) == 0) {
        ...
        G1_NORETURN_CALL(assert_post_action((uint32_t)(uintptr_t)&rodata_103d3b6, 0x72u));
    }
    ...
    G1_NORETURN_CALL(assert_post_action((uint32_t)(uintptr_t)&rodata_103d3b6, 0xf0u));
}
