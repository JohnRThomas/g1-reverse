...
uint32_t FUN_01030dd0(uint32_t *descriptor, uint32_t a1, uint32_t a2, uint32_t a3)
{
    ...
    if (group == 0 && word == 0) {
        ...
        G1_NET_ASSERT_FAIL((((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103df89) /*=0x103df89*/, 0x32fu, word, a3), (((unsigned long)&rodata_103df89) /*=0x103df89*/, 0x32fu));
