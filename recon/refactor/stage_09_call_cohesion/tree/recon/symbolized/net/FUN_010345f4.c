...
uint32_t FUN_010345f4(uint32_t *configuration)
{
    ...
    if ((uint32_t)result == 0) {
        assert_print(((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, ((unsigned long)&rodata_103df89) /*=0x103df89*/, 0x32f);
        result = assert_post_action(((unsigned long)&rodata_103df89) /*=0x103df89*/, 0x32f);
