...
/* readable reconstruction; identity: FUN_010100f4 @ 0x010100f4
 * public-name: controller_masked_pair_sample_store
...
void controller_masked_pair_sample_store(void *output)
{
