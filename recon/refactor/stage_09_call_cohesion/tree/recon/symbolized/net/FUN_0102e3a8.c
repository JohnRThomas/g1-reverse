                  ...
                  uint32_t package_len, const void *package_arg)
{
    ...
    if (package_len == 0) {
        ...
        if (converted_len < 0) {
            G1_NET_ASSERT_FAIL(((const void *)((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, (const void *)((unsigned long)&rodata_103d6b5) /*=0x103d6b5*/, 0x78), ((const void *)((unsigned long)&rodata_103d6b5) /*=0x103d6b5*/, 0x78));
        }
    }
    ...
    if (message != 0 && package_len != 0) {
        if (FUN_0102bbec((uint8_t *)message + 0x10, (uint32_t)converted_len,
            ...
            G1_NET_ASSERT_FAIL(((const void *)((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, (const void *)((unsigned long)&rodata_103d6b5) /*=0x103d6b5*/, 0x92), ((const void *)((unsigned long)&rodata_103d6b5) /*=0x103d6b5*/, 0x92));
        }
    }
