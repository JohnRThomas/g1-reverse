...
#define RADIO_STATE ((volatile uint8_t *)(uintptr_t)((unsigned long)&g_net_own_addr_info) /*=0x21000f20*/)
...
void FUN_01011664(uint8_t *set)
{
    ...
    *(uint16_t *)(set + 0x40) = count;
    ...
    sdc_work_submit(set + 0xa6, (uintptr_t)((unsigned long)&rodata_1011add) /*=0x1011add*/, 2u);
}
