...
/* readable reconstruction; identity: FUN_01012f18 @ 0x01012f18
 * public-name: sdc_conn_event_timing_prepare
 * durable-map: recon/catalogs/function_names_net.json
 * address symbols (name @ address):
 *   rodata_103c1f8                           @ 0x0103c1f8
 *   g_net_radio_ack_pending_flag             @ 0x21000f54
 *   g_21000f58                               @ 0x21000f58
 */
...
LAB_010131f4:
  ...
  case 3:
    ...
    G58U = uVar9;
    if (uVar18 < 0x1d4c) {
      uVar7 = sdc_conn_recovery_window_update(uVar18,iVar22,((unsigned long)&g_21000f58) /*=0x21000f58*/,&local_38);
      B(0x333) = uVar7;
      uVar9 = G58U;
      uVar18 = U(0x14);
    }
