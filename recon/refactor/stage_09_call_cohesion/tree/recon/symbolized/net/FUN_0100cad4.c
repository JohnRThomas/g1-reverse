...
/* readable reconstruction; identity: FUN_0100cad4 @ 0x0100cad4
 * public-name: FUN_0100cad4
...
{
    volatile unsigned char *s = (volatile unsigned char *)((unsigned long)&g_net_radio_addr_match_tbl) /*=0x21000d18*/;
    unsigned int active;
