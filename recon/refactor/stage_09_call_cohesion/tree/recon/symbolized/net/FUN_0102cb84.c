...
int FUN_0102cb84(uint32_t state[3], uint32_t completion)
{
    ...
    case 3:
        ...
        return (int)object;
    default:
        G1_NET_ASSERT_FAIL(((const void *)((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, (const void *)((unsigned long)&rodata_103d3e3) /*=0x103d3e3*/, 0x45), ((const void *)((unsigned long)&rodata_103d3e3) /*=0x103d3e3*/, 0x45));
        return 0;
    }
}
