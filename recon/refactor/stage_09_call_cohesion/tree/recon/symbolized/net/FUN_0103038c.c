...
uint32_t FUN_0103038c(uint32_t mode)
{
    ...
    if (old_initialized == 0u) {
        ...
        if (onoff_request(G1N_21004834, G1N_21004800) < 0) {
            G1_NET_ASSERT_FAIL((((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, 0x0103dea5u, 0x230u), (0x0103dea5u, 0x230u));
        }
    }
    ...
    if (mode == 0u)
        return 0u;
    if (mode > 2u) {
        G1_NET_ASSERT_FAIL((((unsigned long)&rodata_103d2a7) /*=0x103d2a7*/, 0x0103dea5u, 0x242u), (0x0103dea5u, 0x242u));
    }
