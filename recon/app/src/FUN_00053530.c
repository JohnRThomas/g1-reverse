...
extern void FUN_0005f074(unsigned int a, unsigned int b);
extern void FUN_00080ea2(unsigned int a, unsigned int b, void *c);
extern int FUN_000865fc(unsigned int a, unsigned int b);
...
void FUN_00053530(unsigned int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4)
{
    ...
    FUN_0005f074(0x20002144UL, param_1);
    iStack_18 = FUN_000865fc(0x20005f08UL, 0x20002980UL);
    if (iStack_18 < 0) {
