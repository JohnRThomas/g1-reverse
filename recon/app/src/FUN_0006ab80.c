...
extern void FUN_0006954c(const int16_t *, const int16_t *, int, float *);
extern void FUN_00069468(const int16_t *, int, int, int16_t *);
...
bool FUN_0006ab80(int dt, int sr, struct lc3_ltpf_analysis *ltpf,
    const int16_t *x, struct lc3_ltpf_data *data)
{
    ...
    if (pitch_present) {
        ...
        FUN_00069468(x_12k8, n_12k8, 0, u);
        FUN_00069468(x_12k8 - (pitch >> 2), n_12k8, pitch & 3, v);
        nc = dot(u, v, n_12k8) /
