...
extern int FUN_00080786(int);

void FUN_00050e64(int *param_1, int param_2, uint32_t param_3){
    ...
    while (1){
        ...
        if (sl != 0){
            iVar5 = cur[0];
            iVar4 = FUN_00080786(iVar5);
            iVar8 = FUN_00080786(sl + iVar5 - 1);
            r2 = 0x14;
            if (iVar4 != iVar8){
                r2 = 0xffffffeaUL;
                *piVar6 = -0x16;
        ...
        continue;
      assert:
        FUN_0007e2fa(0x00099cbd, 0x000f7a30, 0x000f219e, 0x12b, (uint32_t)param_1, (uint32_t)iVar5, param_3);
        FUN_0007e2fa(0x000f2201, (uint32_t)param_2);
        FUN_0007e2ec(0x000f219e, 0x12b);
        goto L_ed8;
    }
}
