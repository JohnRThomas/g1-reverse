...
void FUN_00017688(const uint8_t *pin, uint32_t flags)
{
    ...
    if ((combined & 0x30) == 0x30) {
        FUN_0007e2fa((unsigned long)0x99cbd, (void *)0x99c84, (void *)0x99c53, 0x3ca);
        FUN_0007e2fa((unsigned long)0x99cda);
        FUN_0007e2ec((void *)0x99c53, 0x3ca);
    } else if ((combined & 0x30002) == 0x10002) {
        FUN_0007e2fa((unsigned long)0x99cbd, (void *)0x99d17, (void *)0x99c53, 0x3ce);
        FUN_0007e2fa((unsigned long)0x99d5e);
        FUN_0007e2ec((void *)0x99c53, 0x3ce);
    } else if ((combined & 6) == 4) {
        FUN_0007e2fa((unsigned long)0x99cbd, (void *)0x99dad, (void *)0x99c53, 0x3d1);
    ...
    bit = 1u << line;
    if ((*enabled & bit) == 0) {
        FUN_0007e2fa((unsigned long)0x99cbd, (void *)0x99de0, (void *)0x99c53, 0x3e4);
