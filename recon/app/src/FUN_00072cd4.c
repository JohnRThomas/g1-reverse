...
extern void FUN_00086588(int);

unsigned FUN_00072cd4(volatile uint32_t *param_1, volatile int *param_2, uint32_t param_3, uint32_t param_4){
    ...
    v = param_1[2];
    if (v == 0){
        FUN_0007e2fa(0x00099cbd,0x000f8247,0x000f820f,0x14e,param_4);
        FUN_0007e2ec(0x000f820f,0x14e);
    }
    uVar4 = 2;
    *param_2 = (int)v;
  L_d16:
