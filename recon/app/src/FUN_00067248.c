...
void FUN_00067248(int *param_1, uint32_t param_2, uint32_t param_3, uint32_t param_4){
  ...
  if ((int)((uint32_t)*(uint8_t*)(iVar4 + 0x1e) << 0x1f) >= 0){
    FUN_00067138(*(uint32_t*)(iVar2 + 0x508), cleanup_arg3);
    FUN_00067138(uVar6, cleanup_arg3);
    FUN_00067138(uVar5, cleanup_arg3);
    FUN_00067138(*(uint32_t*)(iVar4 + 0x20), cleanup_arg3);
    if ((char)*(uint8_t*)((char*)param_1+4) != 0){
      uVar5 = *(uint32_t*)(*param_1 + 0x514);
      FUN_00067138(*(uint32_t*)(*param_1 + 0x56c), cleanup_arg3);
      FUN_00067138(uVar5, cleanup_arg3);
    }
  }
