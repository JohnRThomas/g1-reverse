...
extern uint64_t FUN_0007ebee(uint32_t, uint32_t);
extern int32_t FUN_0004d170(uintptr_t, uint32_t);
extern void FUN_000730b4(uintptr_t);
extern void FUN_000730e8(uintptr_t, uintptr_t, uint32_t, uint32_t, uint32_t);
extern void FUN_00072e50(uintptr_t, uintptr_t);
...
extern void FUN_0007eb4e(volatile uint32_t *, uint32_t);
...
int32_t FUN_0004cd4c(uintptr_t context)
{
    ...
    while ((uint32_t)FUN_0007ebee(slots, quantum) < available)
        ++slots;
    ...
    if (slots == 1) {
        ...
        *(volatile uint32_t *)(runtime + 0x264) = (uint32_t)FUN_0007ebee(lanes, quantum);
        ...
        *(volatile uintptr_t *)(runtime + 0x2a8) = 0x0007eb37u;
        ...
        result = FUN_0004d170(runtime + 0x1c8, *(volatile uint32_t *)config);
        if (result == 0) {
            uint32_t buffer_size = *(volatile uint32_t *)(config + 0x20);
            if (*(volatile uint32_t *)(config + 0x1c) == 1)
                buffer_size -= 0x10;
            FUN_000730b4(runtime + 0x2c0);
            FUN_000730e8(runtime + 0x2c0,
                         0x2002a268u + (*(volatile uint32_t *)(config + 0x24) << 10),
                         0x400, buffer_size, 0);
            FUN_00072e50(runtime + 0x2b0, 0x0007eb1du);
    ...
    FUN_0007eb4e(busy, result == 0 ? 2u : 0u);
    return result;
}
