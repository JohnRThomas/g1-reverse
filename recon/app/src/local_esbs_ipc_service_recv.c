...
#define DAT_00015bb8 ((volatile int*)0x200069fcUL)
#define DAT_00015bbc 0x9924fUL
#define DAT_00015bc0 0x99272UL
#define DAT_00015de4 0x99b89UL
#define DAT_00015de8 0x99297UL
#define DAT_00015dec 0x992e1UL
#define DAT_00015df0 0x20018d98UL
#define PTR_s__s____slave_recv_same_package_00015b9c (*(volatile int*)0x15b9cUL)
#define PTR_s__s___________________loss_packag_00015ba0 (*(volatile int*)0x15ba0UL)
#define PTR_s__s____slave_recv_suspend_package_00015ba4 (*(volatile int*)0x15ba4UL)
#define PTR_s__s____slave_recv_resume_package_00015ba8 (*(volatile int*)0x15ba8UL)
#define PTR_s__s____slave_recv_up_recving_00015bac (*(volatile int*)0x15bacUL)
#define PTR_s__s____slave_recv_down_recving_00015bb0 (*(volatile int*)0x15bb0UL)
#define PTR_s__s____slave_even_ai_recv_down_re_00015bb4 (*(volatile int*)0x15bb4UL)
#define PTR_DAT_00015dd8 (*(volatile int*)0x15dd8UL)
#define PTR_DAT_00015ddc (*(volatile int*)0x15ddcUL)
#define PTR_IS_DEBUG_00015de0 (*(volatile int*)0x15de0UL)
  ...
  *(byte *)(puVar5 + 3) = pbVar8[0xc];
  ...
  if ((((unsigned long long)(uStack_2c)>>16 & 0xffULL) != (char)(*(char *)(param_1 + 0xda) + '\x01')) && (0 < *DAT_00015b90)) {
    if (*DAT_00015b94 == 0) {
      ...
      FUN_00019c70(PTR_s__s___________________loss_packag_00015ba0,DAT_00015b98);
    }
  }
  if ((local_30 & 0x3f) == 1) {
