...
extern int FUN_00051354(uint a, unsigned char b);
extern uintptr_t FUN_0005139c(short a);
extern void FUN_0005f558(int a, unsigned b);
extern void FUN_000807f6(void *a, void *b, int c);
extern void FUN_00080830(int a, int b);
extern void FUN_00080864(int a);
extern void FUN_00080b0e(int a, int b);
extern int FUN_00080ae6(int a, int b);
extern int FUN_0008630c(int *a, uint b);
extern int FUN_0008633e(int *a, void *b);
extern int FUN_0008634c(int *a, int b);
extern void FUN_000861aa(int *a, int b, unsigned c, unsigned short d, int e);
extern int FUN_0008635c(int *a, int b);
...
LAB_000514b2:
            ...
            if (iVar8 == 0) {
LAB_000514f4:
                FUN_0008635c(piVar6, 2);
            } else {
                error_record.message = 0xf2558;
                error_record.status = 2;
                iVar8 = FUN_0008633e(piVar6, &error_record);
                if ((iVar8 == 0) || (iVar8 = FUN_0008630c(piVar6, uVar11), iVar8 == 0)) goto LAB_000514f4;
                iVar8 = FUN_0008635c(piVar6, 2);
                if (iVar8 != 0) {
        ...
        *piVar6 = param_2;
        ...
        puVar7 = (unsigned *)FUN_00051354(uVar10, (unsigned char)(local_34w >> 0x18));
...
LAB_000515aa:
        ...
        iVar8 = FUN_0008634c((int *)(param_1[2] + 4), 0xf);
        if (iVar8 == 0) {
            uVar11 = 7;
            goto LAB_000514b2;
        }
        uVar11 = (*pcVar12)(param_1);
        iVar8 = FUN_0008635c((int *)(param_1[2] + 4), 0xf);
        if (iVar8 == 0) {
        ...
        if ((pending != 0) && ((uVar3 & 0x18) == 0)) {
            pcVar12 = (codef)FUN_0005139c((short)piVar6[0xd]);
