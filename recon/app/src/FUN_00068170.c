...
#include <stdint.h>
extern int FUN_00068134(int,int);
uint32_t FUN_00068170(uint32_t *param_1){
  ...
  int iVar3 = FUN_00068134((int)pc2, 0);
  ...
  *(volatile uint32_t*)puVar6 = base+0x24;
  if(*(volatile uint8_t*)g > 6){
    ...
    if(fp != 0){
      ((void(*)(int,int,int))(uintptr_t)fp)(7, 0x000f7a8c, *(volatile uint32_t*)base);
    }
  }
  return 0;
}
