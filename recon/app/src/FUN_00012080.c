  ...
  *DAT_00012398 = *(undefined4 *)(*(int *)(local_30[0] + 0xc) + 1);
  ...
  if ((*(short *)(iVar2 + 1) != 0) && (*(char *)(iVar2 + 3) != '\0')) {
    *(short *)(iVar5 + 0x104) = *(short *)(iVar2 + 1);
    FUN_00086534(puVar15 + 0xc,*(undefined1 *)(iVar2 + 3));
  }
  FUN_0005f24c(iVar1);
  bVar14 = *(byte *)(iVar5 + 0x7c) & 0x20;
  if ((*(byte *)(iVar5 + 0x7c) & 0x20) == 0) {
    iVar1 = FUN_00053cd4(0xc6d,2);
    if (iVar1 == 0) {
      return -0x69;
    }
    puVar3 = (undefined1 *)FUN_0005f5d0(iVar1 + 0xc,2);
    *puVar3 = 1;
    puVar3[1] = bVar14;
  ...
  uVar7 = FUN_0005f5d0(iVar1 + 0xc,8);
  ...
  if ((int)((uint)*(byte *)(iVar5 + 0x7c) << 0x1a) < 0) {
    ...
    if (*(short *)(iVar5 + 0x104) == 0) {
      ...
      *(undefined2 *)(iVar5 + 0x104) = *(undefined2 *)(iVar1 + 1);
      FUN_00086534(DAT_0001239c,*(undefined2 *)(iVar1 + 4));
    }
    FUN_0005f24c(local_30[0]);
  }
  iVar1 = FUN_00053cd4(0xc01,8);
  if (iVar1 == 0) {
    return -0x69;
  }
  uVar4 = FUN_0005f5d0(iVar1 + 0xc,8);
  uVar8 = _UNK_00012570;
  uVar7 = _UNK_00012574;
  ...
  FUN_00080eb8(uVar8,uVar7,uVar4);
