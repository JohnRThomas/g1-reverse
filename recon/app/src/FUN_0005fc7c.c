...
extern int FUN_0000e244(int,...);
extern int FUN_0006615c(int,...);
extern int FUN_000661dc(int,...);
  ...
  if (((uVar9 == uVar2) || (uVar9 == 1)) && (param_2[6] == 0)) {
    ...
    if ((char)puVar7[1] == 0x10) {
      ...
      while (1) {
        ...
        uVar2 = FUN_0000e244(uVar2 << 0x14, uVar2 >> 0xc, local_60 + (uVar2 >> 1), 0);
...
LAB_fe56:
  ...
  uVar9 = FUN_0006615c((int)stk, *puVar12);
  if (uVar9 != 0x0bad0000) {
