...
extern int FUN_0000ddc8(uint32_t,int,int,int);

char* FUN_00086cda(double in_d0, uint32_t param_1, int param_2, uint32_t param_3,
    ...
    *param_4 = uVar4;
    ...
    if (param_6 == 0x67 || param_6 == 0x47){
        ...
        pcVar7 = pcVar1 + param_2;
        if (uVar8 == 0x46){
            if (*pcVar1 == '0' && FUN_0000ddc8(uVar3, iVar5, 0, 0) == 0){
                *param_5 = 1 - param_2;
            }
            pcVar7 = pcVar7 + *param_5;
        }
    }
    if (FUN_0000ddc8(uVar3, iVar5, 0, 0) != 0){
        local_2c[0] = pcVar7;
    }
