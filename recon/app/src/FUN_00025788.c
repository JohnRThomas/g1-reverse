...
extern int FUN_00025740(int,unsigned,unsigned,unsigned);
...
int FUN_00025788(int param_1, unsigned param_2, unsigned param_3, int param_4){
    ...
    if (param_4 == 0){ iVar1 = 0; }
        ...
        while (1){
            ...
            iVar1 = FUN_00025740(*(int*)iVar3, *(unsigned short*)(iVar3 + 8), param_2, param_3);
            thunk_FUN_00072558(uVar5);
            if (iVar1 == 0) break;
            iVar4 = iVar4 - 1;
            if (iVar4 == 0){
                DEBUG_PRINT(0x9f250, *(unsigned short*)(iVar3 + 8), param_2, iVar1);
                return iVar1;
            }
            FUN_0007c87a();
        }
