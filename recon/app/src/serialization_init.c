...
unsigned int serialization_init(void)
{
    ...
    if (2 < *piVar1) {
        if (*(volatile int*)0x20007554UL == 0) {
            ...
            FUN_00019c70(0x0009f5ecUL, 0x0009f6f1UL);
        }
    }
    iVar2 = FUN_0004cb90(0x00087c08UL);
    if ((iVar2 < 0) && (iVar2 != -0x78)) {
        ...
        if (2 < *piVar1) {
            if (*(volatile int*)0x20007554UL == 0) {
                ...
                FUN_00019c70(0x0009f63cUL, 0x0009f6f1UL);
            }
        }
            ...
            *(volatile int*)0x20007a80UL = 1;
            if (1 < *piVar1) {
                if (*(volatile int*)0x20007554UL == 0) {
                    ...
                    FUN_00019c70(0x0009f67eUL, 0x0009f6f1UL);
                }
            }
            return 0;
        }
    ...
    if (iVar2 == 0) {
        ...
        FUN_00019c70(format_string, 0x0009f6f1UL);
    }
    return 0xffffffffUL;
}
