...
extern s32  FUN_000167a8(void);
extern s64  FUN_00016940(void);
extern void change_work_mode_to(int);
extern s32  FUN_00032ee4(void);
extern void FUN_000289b0(void);
extern s32  FUN_0002bed0(void*);
...
extern void FUN_00047058(void);
extern void FUN_0007d874(int);
extern void send_event_status(int);
extern s64  FUN_0000e244(int,int,int,int);
...
void display_dispatch_thread(char *P)
{
  ...
  *(volatile s32*)(P+0xeb4) = 0;      /* str.w */
  iVar5 = FUN_000167a8();
  iVar6 = FUN_000167a8();
  FUN_00042fb0(iVar5 + 0xec4, iVar6 + 0xeb8);
  ...
  *(volatile s32*)(P+0xee8) = 0;      /* str.w */
  ...
  if (B(0xfea) == 0x0b) {
    ...
    if (FUN_00032ee4() == 1) FUN_000289b0();
  }
  iVar5 = 0;
  pbVar14 = (u8*)0;
  cVar16 = 0;
 ...
 LAB_28cc8:
  for (;;) {
    while (B(1) == 1 || (*(volatile u8*)(FUN_000167a8()+1) == 8)) {
      thunk_74844(0x28000, 0);
    }
    if (B(0xfe8) == 0 && FUN_0002bed0(P) == 0) {
      if (1 < G_DBG) dbg();
      B(0xcb) = B(0xed5);
      uVar17 = FUN_00016940();
      if ((s32)uVar17 != 3) {
    ...
    if (B(0) == 1) {
     ...
     LAB_28eae:
      ...
      FUN_000723b8(0x20007b3c, (s32)(uVar17>>32), -1, -1);
      cVar1 = B(0xd5);
      pbVar15 = pbVar14;
      switch (B(0xd5)) {
      case 2:
      ...
      case 4:
        ...
        FUN_00034390();
        pbVar15 = (u8*)FUN_00033c4c();
        iVar5 = FUN_0002c214();
        pcVar10 = G_260;
        if (iVar5 == 0 && (iVar5 = FUN_000167a8(), *(volatile s8*)(iVar5+0xdd) == *pcVar10)) {
          if (cVar16 == 0) {
            FUN_00026850();
            iVar5 = 0x1b4;
            pbVar14 = pbVar15;
      ...
      if (pbVar15 != (u8*)0) {
       LAB_290d2:
        ...
        if (iVar6 != 0 || cVar16 != 0 || (u32)(u8)B(0xd5) != (u32)G_270) {
          FUN_00086c04(P+0xef, pbVar15, iVar5);
          cVar13 = cVar16;
          goto LAB_2902a;
        }
        FUN_00026850();
     ...
     LAB_2902a:
      FUN_00086c78(P + iVar5 + 0xef, 0, 0x5dc - iVar5);
      H(0xed) = (s16)iVar5;
      FUN_00026850();
      pbVar14 = pbVar15;
      if (B(0xfe6) == 0 || (cVar16 = cVar13, B(0xfe6) == 5)) {
        if (B(0) == 1) {
          if (B(0xcb) != B(0xed5)) { FUN_00047058(); B(0xcb) = B(0xed5); }
     ...
     LAB_2933e:
      if (B(0) == 1) {
        ...
        uVar17 = FUN_0000e244((s32)lVar18, (s32)(lVar18>>32), 1000, 0);
      } else {
       LAB_294ea:
