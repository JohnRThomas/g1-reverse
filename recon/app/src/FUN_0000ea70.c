...
void FUN_0000ea70(float param_1, float *param_2, unsigned int *param_3, float *param_4)
{
  ...
  pfVar4 = param_2;
  int iVar1;
  do { float fVar5 = *pfVar4; pfVar4++; iVar1 = FUN_0000e938(fVar5); if (iVar1 != 0) return; } while (param_2+3 != pfVar4);
