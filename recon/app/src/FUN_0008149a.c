...
extern void FUN_000813b4(void*, unsigned int, unsigned int, unsigned int, unsigned int);
  ...
  if (*(char*)(param_1+0xd) == 7) {
    ...
    if ((int)((unsigned int)param_2 << 0x18) < 0) {
      *puVar1 = *puVar1 | 0x800;
      ...
      FUN_000813b4((void*)puVar1, 0xfffff7ff, param_3, (unsigned int)param_2 << 0x18, param_4);
    }
