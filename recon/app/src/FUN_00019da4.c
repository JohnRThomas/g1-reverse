...
unsigned int FUN_00019da4(int param_1, unsigned char *param_2, unsigned int param_3)
{
  ...
  if (param_1 == 0) {
    ...
    else FUN_00019c70(0x9b38f,0x9e0b2,0xe9);
    return 0xca;
  }
  if (param_3 < 4) {
  ...
  }
  {
    ...
    unsigned int pb = *P;
    if (pb != b0) {
      if (*E != 0) FUN_00019c70(0x9b3e0,0x9e0b2,0x109,b0,pb);
      else DEBUG_PRINT(0x9b3e0,0x9e0b2,0x109,b0,pb);
      return 0xca;
    }
    unsigned int h0 = *H6f0;
    if (bVar1 != h0) {
      if (*E != 0) FUN_00019c70(0x9b413,0x9e0b2,0x10f,bVar1,h0);
    ...
    }
    {
      ...
      *H6f2 = (unsigned short)(param_3 + (uVar4 - 4));
      ...
      else FUN_00019c70(0x9b44a, param_1);
      return 0xc9;
    }
  }
}
