...
void FUN_00067f1c(int *param_1, int param_2, unsigned int param_3, unsigned int param_4)
{
    ...
    if (*(volatile char*)(tbl+idx*8) != 2) {
        ...
        FUN_0007e2fa(0x00099cbdUL,0x000f7a3fUL,0x000f79c8UL,0xb8);
        r = FUN_0007e2ec(0x000f79c8UL,0xb8);
