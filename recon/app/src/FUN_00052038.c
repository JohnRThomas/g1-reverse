...
#include <stdint.h>
extern int FUN_000517d8(int, int, void*, ...);
extern int FUN_00051a5c(int, void*);
extern int FUN_00086c78(void*, int, int);

int FUN_00052038(int param_1, uint32_t *param_2, int param_3, uint32_t *param_4)
{
    int iVar1, iVar2;
    ...
    if (iVar1 != 0) return 2;
    iVar2 = FUN_000517d8(param_1, 0, local_40, 0x20);
...
LAB_000520f6:
        ...
        FUN_00086c78(param_2, (unsigned int)local_45, 8);
    ...
    iVar1 = FUN_000517d8(param_1, iVar2, &local_44);
...
LAB_00052142:
                ...
                if (param_3 != 0) {
                    ...
                    iVar1 = FUN_000517d8(param_1, uVar6, (void*)(intptr_t)param_3);
                    if (iVar1 != 0) return iVar1;
                }
                uVar7 = 1;
                uVar4 = uVar6;
