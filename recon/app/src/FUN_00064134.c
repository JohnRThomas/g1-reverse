...
extern int FUN_00084d70(uint8_t, uint);
extern int FUN_00084e72(uint32_t, void*);
...
uint FUN_00064134(uint param_1, uint32_t param_2, uint param_3, uint32_t param_4){
  ...
  *(volatile uint32_t*)(S+12) = param_4;
  ...
  if (iVar1 == 1){
    iVar1 = FUN_00084e72(*(uint32_t*)(0x8bb90 + param_1*8), (void*)S);
  }
  if (iVar1 == 0){
    iVar1 = FUN_00084e72(*(uint32_t*)(0x8bb90 + param_1*8 + 4), (void*)(S+8));
    ...
    do {
      iVar2 = FUN_00084d70(puVar3[0], uVar4);
      if (iVar2 != 0 && (iVar2 = FUN_00084d70(puVar3[1], uVar5), iVar2 != 0)
