                 ...
                 uint param_4,uint param_5,int param_6,uint param_7)
{
  ...
  local_54 = param_3;
  if (param_1 == (byte *)0x0) {
    FUN_0007e2fa(0x99cbd,0xf0584,0xf04ef,0x394);
    FUN_0007e2ec(0xf04ef,0x394);
  }
  bVar1 = v1[2];
  uVar14 = (uint)bVar1;
  ...
  if ((uVar14 == 0) || (-1 < (int)(param_5 << 0x1f))) {
    ...
    if (local_54 == 0) {
      ...
      while (pbVar4 + uVar14 != pbVar13) {
        iVar15 = FUN_0000ef12(*(void **)(param_1 + (uint)*pbVar13 * 4));
...
LAB_0004acba:
      while(1) {
        ...
        if (local_68 != 0) {
          uVar17 = FUN_0007dc00(local_5c,*pbVar13);
...
LAB_0004ace6:
  ...
  FUN_00086c04(pbVar13,pbVar4,uVar14);
LAB_0004ada6:
  local_74 = local_64 << 1;
...
LAB_0004adbe:
  while(1) {
    ...
    } while ((local_68 != 0) && (uVar17 = FUN_0007dc00(local_5c,bVar8), bVar8 = (byte)((unsigned long long)uVar17 >> 0x20), ((int)uVar17) != 0));
    if (local_78 != 0) {
      if (uVar10 < 0x10) goto LAB_0004af48;
      FUN_0007e2fa(0x99cbd,0xf0642,0xf04ef,0x448);
      FUN_0007e2ec(0xf04ef,0x448);
    }
    if (0xf < uVar11) break;
    uVar7 = uVar11 + 1;
  ...
  FUN_0007e2fa(0x99cbd,0xf0661,0xf04ef,1099);
  FUN_0007e2ec(0xf04ef,1099);
LAB_0004aede:
  if ((local_68 == 0) || (uVar17 = FUN_0007dc00(local_5c,bVar8), ((int)uVar17) == 0)) {
    if ((int)(param_5 << 0x1f) < 0) {
      if (0xf < uVar10) {
        FUN_0007e2fa(0x99cbd,0xf0642,0xf04ef,0x43e);
        FUN_0007e2ec(0xf04ef,0x43e);
      }
LAB_0004af48:
      ...
      if (0xf < uVar11) {
        FUN_0007e2fa(0x99cbd,0xf0661,0xf04ef,0x441);
        FUN_0007e2ec(0xf04ef,0x441);
      }
