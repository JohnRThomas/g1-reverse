...
extern int FUN_000785d4(int a, unsigned b);
extern int FUN_000875ae(int,int,int,int,int,int,int);

int FUN_00078ac8(int param_1,int param_2,int param_3,int param_4)
{
  int iVar1;
  int iVar2;
  int iVar3;
  ...
  iVar1 = FUN_000875ae(param_2,param_3,param_3,param_4,param_1,param_2,param_3);
  bVar15 = iVar1 < 0;
  if (iVar1 == 0) {
    ...
    iVar3 = FUN_000785d4(param_1,*(unsigned *)(param_2 + 4));
    if (iVar3 != 0) {
      ...
      *(int *)(iVar3 + 0xc) = iVar1;
      ...
      do {
        ...
        iVar1 = iVar2 >> 0x10;
        *puVar11 = uVar7 & 0xffff | iVar2 * 0x10000;
        puVar11 = puVar11 + 1;
        puVar8 = puVar14;
      ...
      for (puVar6 = puVar10; puVar6 < puVar13; puVar6 = puVar6 + 1) {
        ...
        iVar1 = iVar2 >> 0x10;
        *puVar11 = uVar5 & 0xffff | iVar2 * 0x10000;
        puVar11 = puVar11 + 1;
      }
  ...
  iVar2 = FUN_00076a94(0x000f8cd5,uVar4,iVar3,0x000f8c42);
LAB_00078af6:
  *(int *)(iVar2 + 0x10) = 1;
