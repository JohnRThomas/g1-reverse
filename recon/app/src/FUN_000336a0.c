...
extern int FUN_00071c20(unsigned,void*,int,int,int);
typedef int (*fp1)(int,unsigned,int);
typedef int (*fp2)(int,unsigned,int,int);
unsigned FUN_000336a0(int param_1, unsigned param_2, unsigned param_3){
  int iVar1; unsigned local_14, uStack_10;
  if(param_1!=0){
    local_14=param_2; uStack_10=param_3;
    iVar1=FUN_00071c20(0x200037b8,&local_14,0,0,param_1);
    if(iVar1==0){
