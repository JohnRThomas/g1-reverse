...
extern int FUN_00076ad0(int,...); extern int FUN_00076d8c(int,...); extern int FUN_00076e20(int,...);
extern int FUN_00077d54(int,...); extern int FUN_00086bc8(int,...); extern int FUN_00086c04(int,...);
extern int FUN_00086c44(int,...); extern int FUN_000876ec(int,...);
typedef uint (*codeptr)(int,...);
#define PH(p) (*(volatile ushort*)((char*)(p)+0xc))

undefined4 FUN_00077e70(volatile undefined4 *param_1,volatile uint *param_2,volatile undefined4 *param_3)
{
  ...
  if (param_3[2] != 0) {
    ...
    if (((-1 < (int)(uVar4 << 0x1c)) || (uVar4 = param_2[4], uVar4 == 0)) &&
       (iVar2 = FUN_00077d54((int)param_1,(int)param_2,(int)param_3,uVar4,(int)param_1,(int)param_2,(int)param_3), iVar2 != 0)) {
      return 0xffffffff;
    }
    uVar4 = 0x7ffffc00;
    piVar7 = (int *)*param_3;
        ...
        do {
          ...
          if ((int)(uVar1 << 0x16) < 0) {
            if ((uVar9 <= uVar4) && ((uVar1 & 0x480) != 0)) {
              ...
              if ((int)(uVar1 << 0x15) < 0) {
                uVar3 = FUN_00076e20((int)param_1,uVar9);
                if (uVar3 != 0) {
                  FUN_00086c04(uVar3,param_2[4],iVar10);
                  PH(param_2) = (ushort)param_2[3] & 0xfb7f | 0x80;
LAB_fec:
                ...
                uVar3 = FUN_000876ec((int)param_1,param_2[4],uVar9);
                if (uVar3 != 0) goto LAB_fec;
                FUN_00076d8c((int)param_1,param_2[4]);
...
LAB_ffc:
            ...
            *param_2 = *param_2 + uVar9;
            if ((uVar3 - uVar9 == 0) && (iVar10 = FUN_00076ad0((int)param_1,(int)param_2), iVar10 != 0)) goto LAB_fc4;
          }
          else {
            uVar9 = 0x7fffffff;
        ...
        do {
          if (uVar9 == 0) {
            ...
            iVar10 = *piVar8;
LAB_0be:
            iVar2 = FUN_00086bc8(iVar10,10,uVar9);
          ...
          if ((param_2[4] < uVar1) && (uVar6 = param_2[2] + param_2[5], (int)uVar6 < (int)uVar3)) {
            ...
            *param_2 = *param_2 + uVar6;
            iVar2 = FUN_00076ad0((int)param_1,(int)param_2);
...
LAB_fc4:
          ...
          uVar4 = uVar4 - uVar6;
          if (uVar4 == 0) { iVar2 = FUN_00076ad0((int)param_1,(int)param_2); if (iVar2 != 0) goto LAB_fc4; }
          else iVar2 = 1;
          iVar5 = param_3[2];
          iVar10 = iVar10 + uVar6;
          uVar9 = uVar9 - uVar6;
