...
extern void FUN_000682f0(uint a, uint b, int c, void *d);
extern void FUN_000684a8(void *a, int b, unsigned c, int d);
extern void FUN_000685f4(void *a);
extern int FUN_00068908(void *a, uint b, int c);
...
undefined4 FUN_00069238(byte *param_1, int param_2, undefined4 param_3, undefined4 param_4, int param_5, undefined4 param_6)
{
    ...
    if (param_1 != (byte *)0x0) {
        if (param_5 - 0x14U < 0x17d) {
            ...
            FUN_000682f0(uVar8, local_1b4, param_5, param_1 + 4);
            FUN_0006ab80(uVar8, local_1b4, param_1 + 0x10, iVar11);
            ...
            FUN_0006f91c(auStack_128, (uint)*param_1, (uint)param_1[1], auStack_134);
