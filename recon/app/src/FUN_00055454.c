...
extern int FUN_000810f2(uint8_t*,int);
extern int FUN_00081102(uint8_t*,uint32_t);
...
int FUN_00055454(uint8_t *param_1, int param_2, int param_3, uint8_t *param_4){
    ...
    if ((((uint32_t)param_2 << 0xc) & 0x80000000UL) != 0){          /* bit19 set */
        if ((((uint32_t)param_2 << 0x1d) & 0x80000000UL) != 0){     /* bit2 set */
            ...
            FUN_0008104a(0x00088150, 0x1040, &local_20);
            return -0x16;
        }
        iVar2 = FUN_00081102(param_1, (uint32_t)param_2 << 12);
    ...
    if ((((uint32_t)param_2 << 0x1f) & 0x80000000UL) != 0){          /* bit0 set */
        if (param_3 == 0){
          ...
          L_554dc:
            iVar2 = FUN_000810f2(param_1, (int)(uVar4*7) + 0x20002000 + 1);
            if (iVar2 != 0) return iVar2;
            bVar3 = tbl[uVar4*7];
            *param_4 = bVar3;
    ...
    if ((((uint32_t)param_2 << 0x1d) & 0x80000000UL) != 0){          /* bit2 set */
        bVar3 = tbl[uVar4*7];
        if (bVar3 != 1) goto L_554d8;
        iVar2 = FUN_000810f2(param_1, (int)((int16_t)(uint16_t)*(volatile uint8_t*)param_1 * 7) + 1 + 0x20002000);
        bVar3 = tbl[uVar4*7];
        goto L_551e;
    }
    iVar2 = FUN_00081102(param_1, (uint32_t)param_2 << 12);
