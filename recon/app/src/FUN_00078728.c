...
extern int FUN_00076a94(unsigned a, unsigned b);
extern int FUN_000785d4(unsigned a, int b);
extern int FUN_00078698(unsigned a, int b, int c, int d, int e);
void FUN_00078728(unsigned param_1, int param_2, int param_3, int param_4, unsigned param_5){
    int iVar1 = 0;
    ...
    for(;;){
        if (iVar2 < iVar3){
            ...
            node = FUN_000785d4(param_1, iVar1);
            if (node != 0) goto found;
            iVar3 = 0x000f8c42;
            FUN_00076a94(0x000f8cd5, 0xce);
            iVar1 = 0;
        }
        iVar2 = iVar2 << 1;
        iVar1 = iVar1 + 1;
    ...
    *(volatile unsigned*)(node + 0x10) = 1;
    ...
    if (param_3 > 9){
        ...
        do {
            ...
            node = FUN_00078698(param_1, node, 10, ch - 0x30, iVar6);
        } while (p != endp);
        pb = (param_3 - 8) + sb;
    } else {
        pb = param_2 + 0xa; r5 = 9;
