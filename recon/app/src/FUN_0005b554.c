...
extern int FUN_00059bcc(int,...);
extern int FUN_0005b378(int,...);
extern int FUN_000814e2(int,...);
extern int FUN_000814e6(int,...);
extern int FUN_000825c0(int,...);
extern int FUN_00082a42(int,...);
extern int FUN_00082cba(int,...);
unsigned int FUN_0005b554(int param_1, int param_2, int *param_3)
{
  int dummy[16];
  int iVar8 = *param_3;
  if (*(int*)(param_1+8) == 0x5a465) {
    ...
    if ((*(short*)(puVar9+8) != 0) &&
        (FUN_000814e6(iVar8, *puVar9, (int)(puVar9+1)) != 0)) {
      int local_48 = FUN_00082cba(iVar8, param_1, 0x12a);
      if (local_48 != 0) {
        if (local_48 == 3) {
        ...
        unsigned int uVar5 = (unsigned int)FUN_000814e2(iVar8);
        if (uVar5 < uVar10) {
      ...
      FUN_000825c0(param_1, (int)puVar9);
      if (puVar9 == (unsigned char*)0x20002a20UL) {
        int iVar4 = FUN_00059bcc(*(unsigned char*)(iVar8+8), iVar8+0x90);
        if ((iVar4 != 0) && ((*(short*)(iVar4+8) != 0) || (*(short*)(iVar4+10) != 0))) {
          ...
          *(volatile unsigned short*)(iVar7+0x14) = 4;
          int r = FUN_0005b378(iVar8, 0x2000aebc + (short)iVar6*0x18);
          if (r != 0) {
