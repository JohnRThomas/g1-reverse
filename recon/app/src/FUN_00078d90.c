...
extern int FUN_00076e20(void *a, int b);
extern int FUN_0007712c(void *a, void *b, void *c, u32 d, void *e);
extern int FUN_00077594(void *a, void *b, void *c, u32 d, void *e);
extern int FUN_00086bc8(u32 a, u32 b, int c);
extern int FUN_00087736(void *a, void *b, void *c, int d);
...
LAB_df0:
  ...
  if (iVar8 != 0) {
    iVar2 = FUN_00087736(param_1, param_2, param_3, iVar8);
    if (iVar2 == -1) {
      goto LAB_f56;
    }
  ...
  while (1) {
    pbVar6 = pbVar7 + 1;
    iVar2 = FUN_00086bc8(0x000f8b6bu, *pbVar7, 5);
    if (iVar2 == 0) break;
  ...
  iVar2 = FUN_00086bc8(0x000f8b71u, *pbVar6, 3);
  if (iVar2 != 0) {
    pbVar6 = pbVar6 + 1;
  ...
  param_3 = pbVar6 + 1;
  local_70 = *pbVar6;
  iVar8 = FUN_00086bc8(0x000f8b75u, local_70, 6);
  if (iVar8 == 0) {
    iVar2 = FUN_00077594(param_1, &local_88, param_2, 0x00087737u, &local_8c);
  } else {
