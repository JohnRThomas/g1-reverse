...
extern unsigned long long FUN_0007ef3e(unsigned long);
...
void FUN_00083906(char *param_1)
{
    ...
    unsigned long long inherited = FUN_0007ef3e(param_1);
    FUN_00072908(iVar1 + 0x18, (unsigned)(inherited >> 32), 0xffffffff, 0xffffffff);
