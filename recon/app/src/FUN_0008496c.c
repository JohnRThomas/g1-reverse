...
#include <stdint.h>
extern void FUN_0007ef1c(int,void*,uint32_t,uint32_t,int);
void FUN_0008496c(int param_1,uint32_t param_2,uint32_t param_3,uint32_t param_4){
  volatile int* piVar3=*(volatile int* volatile*)(param_1+4);
  int iVar2=*(volatile int*)piVar3;
  volatile uint32_t uStack_1c=param_2;
  FUN_0007ef1c(param_1,(void*)((int)&uStack_1c+3),param_3,param_4,param_1);
