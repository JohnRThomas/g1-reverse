/* Reconstructed FUN_00024f78 @ 0x24f78  (parity: 300/300 trials, PROVEN) */

extern int FUN_00024f08(void*);
extern int FUN_000256dc(unsigned,int,void*,...);
int FUN_00024f78(void){
  ...
  sVar4 = (short)FUN_00024f08(&local_18);
  volatile unsigned* puVar3 = (volatile unsigned*)0x20007a44UL;
  iVar5 = (int)sVar4;
  if(iVar5==0){
    local_19=3;
    iVar5 = FUN_000256dc(puVar3[0], (int)puVar2[3], &local_19, 1);
    if(iVar5==0){
      local_19=0;
      iVar5 = FUN_000256dc(puVar3[0], (int)puVar2[3]+1, &local_19);
      if(iVar5!=0) iVar5=1;
      iVar5=-iVar5;
    } else { iVar5=-1; }
  }
