...
extern int FUN_0000ddf0(int,...); extern int FUN_0000de04(int,...); extern int FUN_0000de58(int,...);
extern int FUN_00064290(int,...); extern int FUN_00064b1c(int,...); extern unsigned long long FUN_00077a10(int,...);
extern int FUN_00084ed8(int,...); extern int FUN_00084fd4(int,...); extern int FUN_00087036(int,...);

undefined4 FUN_00012910(int param_1,int *param_2)
{
  ...
  if (uVar13 < uVar8 + 4) {
    if (uVar8 + 5 <= uVar13) {
LAB_74:
      iVar3 = FUN_00087036(iVar10 + uVar8,0xf698e,5);
...
LAB_52:
    ...
    if (uVar7 == 0x22) { uVar4 = FUN_00064290(param_1,param_2); return uVar4; }
...
LAB_ea:
    ...
    if (uVar7 == 0x5b) {
      ...
      if (*(char *)(iVar10 + uVar8) == ']') { piVar11 = (int *)0x0; param_2[3] = uVar7; }
        ...
        do {
          piVar5 = (int *)FUN_00084fd4(param_2[4]); piVar11 = piVar12;
          ...
          iVar10 = FUN_00012910((int)piVar5,param_2);
        ...
        if (cVar1 != ']') { LAB_c0e: FUN_00064b1c((int)piVar11); return 0; }
      ...
      if (*(char *)(iVar10 + uVar8) == '}') { piVar11 = (int *)0x0; param_2[3] = uVar7; }
        ...
        do {
          ...
          if (piVar12 != 0) { *piVar9 = (int)piVar5; piVar5[1] = (int)piVar9; piVar11 = piVar12; }
          param_2[2] = param_2[2] + 1; FUN_00084ed8((int)param_2);
          iVar10 = FUN_00064290((int)piVar5,param_2);
          if (iVar10 == 0) goto LAB_c08;
          FUN_00084ed8((int)param_2);
    ...
    *(undefined4 *)(param_1 + 0xc) = uVar4;
    ...
    iVar3 = FUN_00087036(iVar10 + uVar8,0xf6977,4);
    if (iVar3 == 0) { *(undefined4 *)(param_1 + 0xc) = 4; }
    else {
      if (uVar8 + 5 <= uVar13) goto LAB_74;
LAB_92:
      iVar3 = FUN_00087036(iVar10 + uVar8,0xf6994,4);
...
LAB_fa:
  ...
  iVar10 = FUN_0000de04(uVar4,uVar17,0,0);
  if (iVar10 == 0) {
    iVar10 = FUN_0000ddf0(uVar4,uVar17,0,0xc1e00000);
