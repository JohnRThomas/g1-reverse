...
unsigned int FUN_00024ad8(unsigned char *param_1, unsigned int *param_2,
                          int param_3)
{
  unsigned int uVar1;
  unsigned int uVar2;
  ...
  if (param_3 != 0) {
    *(volatile unsigned int *)0x20007a08 = 0;
  }
  uVar1 = *(volatile unsigned int *)0x20007a08;
  param_2[1] = 1;
  if (uVar1 > 8) {
    param_2[0] = 0;
    param_2[1] = 0;
  ...
  if (uVar1 == 0) {
    ...
    *(volatile unsigned int *)0x20007a08 = 1;
    return param_2[0];
  }
  uVar3 = param_1[0x10];
  for (uVar2 = uVar1; uVar2 < 9; uVar2++) {
    if ((uVar3 >> (uVar2 - 1)) & 1) {
      ...
      *(volatile unsigned int *)0x20007a08 = uVar2 + 1;
      return param_2[0];
    }
  }
  param_2[0] = 0;
