...
extern int FUN_0008736a(int,int,int);
typedef volatile unsigned int VU;

unsigned int FUN_000873b6(int *param_1, unsigned int *param_2, unsigned int *param_3)
{
    unsigned char bVar1;
    unsigned int uVar2;
    unsigned int uVar3;
    ...
    while (1) {
        ...
        if (local_38 < iVar14) {
            if ((puVar11 < puVar5) && (iVar12 < 8)) {
                FUN_0008736a((int)puVar11, (int)puVar5, iVar12);
            }
